...
class YamlListToStandardDefinitionsTest {
  ...
  private static final String DESTINATION_DEFINITION_ID =
  ...
  private static final String GOOD_DES_DEF_YAML = DESTINATION_DEFINITION_ID
      + DESTINATION_NAME
      + DOCKER_REPO
      + DOCKER_IMAGE_TAG
      + "  documentationUrl: https://docs.airbyte.io/integrations/destinations/local-json";
  private static final String DUPLICATE_ID = DESTINATION_DEFINITION_ID
      + DESTINATION_NAME
      + DOCKER_REPO
      + DOCKER_IMAGE_TAG
      + "  documentationUrl: https://docs.airbyte.io/integrations/destinations/local-json"
      ...
      + DOCKER_IMAGE_TAG
      + "  documentationUrl: https://docs.airbyte.io/integrations/destinations/local-json";
  private static final String DUPLICATE_NAME = DESTINATION_DEFINITION_ID
      + DESTINATION_NAME
      + DOCKER_REPO
      + DOCKER_IMAGE_TAG
      + "  documentationUrl: https://docs.airbyte.io/integrations/destinations/local-json\n"
  ...
  private static final String BAD_DATA = DESTINATION_DEFINITION_ID
      + DESTINATION_NAME
      + DOCKER_REPO
      + "  dockerImageTag: 0.1.8\n"
      + "  documentationUrl";
  ...
  class VerifyAndConvertToModelList {
    ...
    void correctlyReadTest() {
      final var defs = YamlListToStandardDefinitions.verifyAndConvertToModelList(
    ...
    void duplicateIdTest() {
      assertThrows(
          ...
          () -> YamlListToStandardDefinitions.verifyAndConvertToModelList(
              StandardDestinationDefinition.class, DUPLICATE_ID));
    }
    ...
    void duplicateNameTest() {
      assertThrows(
          RuntimeException.class,
          () -> YamlListToStandardDefinitions.verifyAndConvertToModelList(
              StandardDestinationDefinition.class, DUPLICATE_NAME));
    }
