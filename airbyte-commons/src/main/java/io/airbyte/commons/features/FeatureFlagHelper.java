...
public class FeatureFlagHelper {
  ...
  public static boolean isFieldSelectionEnabledForWorkspace(
      final FeatureFlags featureFlags, final UUID workspaceId) {
    return isWorkspaceIncludedInFlag(
            featureFlags, FeatureFlags::fieldSelectionWorkspaces, workspaceId, "field selection")
        || featureFlags.applyFieldSelection();
  }

  @VisibleForTesting
  static boolean isWorkspaceIncludedInFlag(
