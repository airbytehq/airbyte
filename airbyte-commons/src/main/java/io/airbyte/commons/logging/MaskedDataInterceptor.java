...
/**
 * Custom Log4j2 {@link RewritePolicy} used to intercept all log messages and mask any JSON properties in the message that match the list of maskable
 * properties.
 * <p>
 * The maskable properties file is generated by a Gradle task in the {@code :airbyte-config:specs} project. The file is named
 * {@code specs_secrets_mask.yaml} and is located in the {@code src/main/resources/seed} directory of the {@link :airbyte-config:init} project.
 */
