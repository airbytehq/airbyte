 ...
 * time its {@link Iterator#hasNext} function returns false, the composite iterator will call {@link
 * AutoCloseableIterator#close()} on that internal iterator.
 *
 * <p>{@link CompositeIterator}s should be closed. Calling {@link CompositeIterator#close()} will
 ...
 *
 * <p>{@link CompositeIterator#close()} gives the guarantee that it will call close on each internal
