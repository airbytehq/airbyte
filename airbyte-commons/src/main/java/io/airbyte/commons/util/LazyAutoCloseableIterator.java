...
/**
 * A {@link AutoCloseableIterator} that calls the provided supplier the first time {@link
 * AutoCloseableIterator#hasNext} or {@link AutoCloseableIterator#next} is called. If {@link
 * AutoCloseableIterator#hasNext} or {@link AutoCloseableIterator#next} are never called, then the
