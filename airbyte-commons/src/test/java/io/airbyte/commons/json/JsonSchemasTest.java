...
class JsonSchemasTest {
  ...
  void testMutateTypeToArrayStandard() {
    ...
    final JsonNode expectedWithArrayType =
    ...
    final JsonNode expectedWithoutArrayType =
        Jsons.deserialize("{\"test\":\"abc\", \"type\":[\"object\"]}");
    final JsonNode actualWithStringType =
        Jsons.deserialize("{\"test\":\"abc\", \"type\":\"object\"}");
  ...
  void testTraverse() throws IOException {
    final JsonNode jsonWithAllTypes =
    ...
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes.get(PROPERTIES).get(NAME), List.of(FieldNameOrList.fieldName(NAME)));
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes.get(PROPERTIES).get(NAME).get(PROPERTIES).get("first"),
            List.of(FieldNameOrList.fieldName(NAME), FieldNameOrList.fieldName("first")));
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes.get(PROPERTIES).get(NAME).get(PROPERTIES).get("last"),
    ...
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes.get(PROPERTIES).get(PETS), List.of(FieldNameOrList.fieldName(PETS)));
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes.get(PROPERTIES).get(PETS).get(ITEMS),
    ...
    inOrder
        ...
        .accept(
            jsonWithAllTypes
                ...
                .get("type"),
            List.of(
                FieldNameOrList.fieldName(PETS),
                FieldNameOrList.list(),
                FieldNameOrList.fieldName("type")));
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes
            ...
            List.of(
                FieldNameOrList.fieldName(PETS),
                FieldNameOrList.list(),
                FieldNameOrList.fieldName("number")));
  ...
  void testTraverseComposite(final String compositeKeyword) throws IOException {
    final String jsonSchemaString = MoreResources.readResource(
            "json_schemas/composite_json_schema.json")
    ...
    inOrder
        .verify(mock)
        .accept(jsonWithAllTypes.get(compositeKeyword).get(0), Collections.emptyList());
    inOrder
        .verify(mock)
        .accept(jsonWithAllTypes.get(compositeKeyword).get(1), Collections.emptyList());
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes.get(compositeKeyword).get(1).get(PROPERTIES).get("prop1"),
            List.of(FieldNameOrList.fieldName("prop1")));
    inOrder
        .verify(mock)
        .accept(jsonWithAllTypes.get(compositeKeyword).get(2), Collections.emptyList());
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes.get(compositeKeyword).get(2).get(ITEMS),
            List.of(FieldNameOrList.list()));
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes.get(compositeKeyword).get(3).get(compositeKeyword).get(0),
            Collections.emptyList());
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes.get(compositeKeyword).get(3).get(compositeKeyword).get(1),
            Collections.emptyList());
    inOrder
        .verify(mock)
        .accept(
  ...
  void testTraverseMultiType() throws IOException {
    final JsonNode jsonWithAllTypes = Jsons.deserialize(
    ...
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes.get(ITEMS).get(PROPERTIES).get(USER),
  ...
  void testTraverseMultiTypeComposite() throws IOException {
    ...
    final JsonNode jsonWithAllTypes = Jsons.deserialize(MoreResources.readResource(
    ...
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes.get(compositeKeyword).get(0).get(PROPERTIES).get(COMPANY),
            List.of(FieldNameOrList.fieldName(COMPANY)));
    inOrder
        .verify(mock)
        .accept(
            jsonWithAllTypes.get(compositeKeyword).get(1).get(PROPERTIES).get("organization"),
