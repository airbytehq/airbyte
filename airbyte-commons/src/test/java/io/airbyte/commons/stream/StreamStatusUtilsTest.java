...
class StreamStatusUtilsTest {
  ...
  void testCreateStreamStatusConsumerWrapper() {
    ...
    final Consumer<AirbyteMessage> wrappedMessageConsumer =
        StreamStatusUtils.statusTrackingRecordCollector(
            stream, messageConsumer, streamStatusEmitter);
  ...
  void testStreamStatusConsumerWrapperProduceStreamStatus() {
    ...
    assertEquals(
        ...
        airbyteStreamStatusHolderArgumentCaptor
            .getValue()
            .toTraceMessage()
            .getStreamStatus()
            .getStatus());
  ...
  void testEmitCompleteStreamStatusAirbyteStreamEmptyStatusEmitter() {
    ...
    assertDoesNotThrow(() -> StreamStatusUtils.emitCompleteStreamStatus(
        Optional.of(airbyteStream), streamStatusEmitter));
  }
