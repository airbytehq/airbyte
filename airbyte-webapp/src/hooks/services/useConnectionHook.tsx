...
import ConnectionResource, {
    ScheduleProperties,
} from '@app/core/resources/Connection'
...
const useConnection = (): {
    ...
    const createConnectionResource = useFetcher(
        ConnectionResource.createShape()
    )
    const updateConnectionResource = useFetcher(
        ConnectionResource.updateShape()
    )
    ...
    const deleteConnectionResource = useFetcher(
        ConnectionResource.deleteShape()
    )
    ...
    const createConnection = async ({
        ...
        try {
            ...
            analyticsService.track('New Connection - Action', {
                ...
                connector_source_definition_id:
