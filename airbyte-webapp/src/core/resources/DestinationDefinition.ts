...
import { DestinationDefinitionService } from '@app/core/domain/connector/DestinationDefinitionService'
                ...
                const result: DestinationDefinition[] =
                    definition.destinationDefinitions.map(
                        (destination: DestinationDefinition) => {
                            const withLatest =
                                latestDefinition.destinationDefinitions.find(
                                    (
