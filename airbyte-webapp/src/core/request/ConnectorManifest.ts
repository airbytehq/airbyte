...
export type DatetimeStreamSlicerAllOfCursorEnd = { [key: string]: any };

export type DatetimeStreamSlicerAllOfCursor = { [key: string]: any };
...
export type DatetimeStreamSlicerAllOf = {
  ...
  _cursor?: DatetimeStreamSlicerAllOfCursor;
  _cursor_end?: DatetimeStreamSlicerAllOfCursorEnd;
...
export type WaitUntilTimeFromHeaderAllOf = {
  header: string;
  min_wait?: number;
  regex?: string;
};
 ...
 */
export type WaitUntilTimeFromHeader = BackoffStrategy & WaitUntilTimeFromHeaderAllOf;

export type WaitTimeFromHeaderAllOf = {
  header: string;
  regex?: string;
};
 ...
 */
export type WaitTimeFromHeader = BackoffStrategy & WaitTimeFromHeaderAllOf;

export type ExponentialBackoffAllOf = {
  factor?: number;
};
 ...
 */
export type ExponentialBackoff = BackoffStrategy & ExponentialBackoffAllOf;

export type ConstantBackoffAllOf = {
  backoff_time_in_seconds: number;
};
 ...
 */
export type ConstantBackoff = BackoffStrategy & ConstantBackoffAllOf;
