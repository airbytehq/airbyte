...
export const UsersSettingsView: React.FC = () => {
    ...
    const columns = React.useMemo(
        () => [
            {
                Header: (
                    <FormattedMessage id="userSettings.table.column.fullname" />
                ),
            ...
            {
                Header: (
                    <FormattedMessage id="userSettings.table.column.email" />
                ),
                headerHighlighted: true,
                accessor: 'email',
                Cell: ({ cell }: CellProps<any>) => cell.value,
            ...
            {
                Header: (
                    <FormattedMessage id="userSettings.table.column.action" />
                ),
                headerHighlighted: true,
                accessor: 'status',
