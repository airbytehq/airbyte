...
const ConnectionForm: React.FC<ConnectionFormProps> = ({
    ...
    const errorMessage = submitError
        ? createFormErrorMessage(submitError)
        : null
            ...
            {({ isSubmitting, setFieldValue, isValid, dirty, resetForm }) => (
                <FormContainer className={className}>
                        ...
                        <SectionTitle>
                            {[
                                supportsNormalization &&
                                    formatMessage({
                                        id: 'connectionForm.normalization.title',
                                    }),
                                supportsTransformations &&
                                    formatMessage({
                                        id: 'connectionForm.transformation.title',
                                    }),
                            ]
                                .filter(Boolean)
                                .join(' & ')}
                    ...
                    {!isEditMode && (
                        <EditLaterMessage
                            message={
                                <FormattedMessage id="form.dataSync.message" />
                            }
                        />
                    )}
                    {isEditMode ? (
                        <EditControls
                            ...
                            errorMessage={
                                errorMessage || !isValid
                                    ? formatMessage({
                                          id: 'connectionForm.validation.error',
                                      })
                                    : null
                            }
