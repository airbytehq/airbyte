                    ...
                    <Field name="name">
                        {({ field, meta }: FieldProps<string>) => (
                            <ControlLabelsWithMargin
                                ...
                                message={
                                    <FormattedMessage id="connector.name.message" />
                                }
                            >
                                <Input
                                    {...field}
                    ...
                    <Field name="website">
                        {({ field, meta }: FieldProps<string>) => (
                            <ControlLabelsWithMargin
                                error={!!meta.error && meta.touched}
                                label={
                                    <FormattedMessage id="connector.website" />
                                }
                                message={
                                    <FormattedMessage id="connector.website.message" />
                                }
                            >
                                <Input
                                    {...field}
                        ...
                        <Field name="email">
                            {({ field, meta }: FieldProps<string>) => (
                                <ControlLabelsWithMargin
                                    error={!!meta.error && meta.touched}
                                    label={
                                        <FormattedMessage id="connector.email" />
                                    }
                                    message={
                                        !!meta.error &&
                                        meta.touched && (
