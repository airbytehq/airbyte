                        ...
                        <Field name="email">
                            {({ field, meta }: FieldProps<string>) => (
                                <LabeledInput
                                    {...field}
                                    label={
                                        <FormattedMessage id="form.yourEmail" />
                                    }
                        ...
                        <Field name="anonymousDataCollection">
                            {({ field }: FieldProps<string>) => (
                                <LabeledToggle
                                    ...
                                    label={
                                        <FormattedMessage id="preferences.anonymizeData" />
                                    }
                                />
                            )}
                        </Field>
                        ...
                        <Field name="news">
                            {({ field }: FieldProps<string>) => (
                                <LabeledToggle
                                    ...
                                    disabled={!values.email}
                                    label={
                                        <FormattedMessage id="preferences.featureUpdates" />
                                    }
                                    message={
                        ...
                        <Field name="securityUpdates">
                            {({ field }: FieldProps<string>) => (
                                <LabeledToggle
                                    ...
                                    disabled={!values.email}
                                    label={
                                        <FormattedMessage id="preferences.securityUpdates" />
                                    }
                                />
                            )}
                        </Field>
