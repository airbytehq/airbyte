...
class NamespacingMapperTest {
  ...
  private static final ConfiguredAirbyteCatalog CATALOG =
      CatalogHelpers.createConfiguredAirbyteCatalog(
          STREAM_NAME, INPUT_NAMESPACE, Field.of(FIELD_NAME, JsonSchemaPrimitive.STRING));
  ...
  void testSourceNamespace() {
    final NamespacingMapper mapper =
        new NamespacingMapper(NamespaceDefinitionType.SOURCE, null, OUTPUT_PREFIX);

    final ConfiguredAirbyteCatalog originalCatalog = Jsons.clone(CATALOG);
    final ConfiguredAirbyteCatalog expectedCatalog =
        CatalogHelpers.createConfiguredAirbyteCatalog(
    ...
    final AirbyteMessage expectedMessage =
        AirbyteMessageUtils.createRecordMessage(OUTPUT_PREFIX + STREAM_NAME, FIELD_NAME, "blue");
  ...
  void testEmptySourceNamespace() {
    ...
    final ConfiguredAirbyteCatalog expectedCatalog =
        CatalogHelpers.createConfiguredAirbyteCatalog(
            OUTPUT_PREFIX + STREAM_NAME, null, Field.of(FIELD_NAME, JsonSchemaPrimitive.STRING));
  ...
  void testDestinationNamespace() {
    final NamespacingMapper mapper =
        new NamespacingMapper(NamespaceDefinitionType.DESTINATION, null, OUTPUT_PREFIX);
  ...
  void testCustomFormatWithVariableNamespace() {
    final NamespacingMapper mapper =
        new NamespacingMapper(
            NamespaceDefinitionType.CUSTOMFORMAT, "${SOURCE_NAMESPACE}_suffix", OUTPUT_PREFIX);
  ...
  void testCustomFormatWithoutVariableNamespace() {
    final NamespacingMapper mapper =
        new NamespacingMapper(NamespaceDefinitionType.CUSTOMFORMAT, "output", OUTPUT_PREFIX);
  ...
  void testEmptyCustomFormatWithVariableNamespace() {
    final NamespacingMapper mapper =
        new NamespacingMapper(
            NamespaceDefinitionType.CUSTOMFORMAT, "${SOURCE_NAMESPACE}", OUTPUT_PREFIX);
  ...
  void testEmptyPrefix() {
    final NamespacingMapper mapper =
        new NamespacingMapper(NamespaceDefinitionType.SOURCE, null, null);
