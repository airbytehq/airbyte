...
class NamespacingMapperTest {
  ...
  private static AirbyteMessage createRecordMessage() {
    final AirbyteMessage message = AirbyteMessageUtils.createRecordMessage(STREAM_NAME, FIELD_NAME, BLUE).withSerializedMessage(null);
  ...
  void testSourceNamespace() {
    ...
    final AirbyteMessage expectedMessage =
        AirbyteMessageUtils.createRecordMessage(OUTPUT_PREFIX + STREAM_NAME, FIELD_NAME, BLUE).withSerializedMessage(null);
  ...
  void testEmptyPrefix() {
    ...
    final AirbyteMessage expectedMessage = AirbyteMessageUtils.createRecordMessage(
        STREAM_NAME,
        FIELD_NAME, BLUE).withSerializedMessage(null);
    expectedMessage.getRecord().withNamespace(INPUT_NAMESPACE);
    final AirbyteMessage actualMessage = mapper.mapMessage(RECORD_MESSAGE);
