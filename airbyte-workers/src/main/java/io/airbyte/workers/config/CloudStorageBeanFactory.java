...
public class CloudStorageBeanFactory {
  ...
  @Requires(property = "airbyte.cloud.storage.logs.gcs.bucket",
            value = "")
  @Requires(property = "airbyte.cloud.storage.logs.minio.bucket",
            value = "")
  @Requires(property = "airbyte.cloud.storage.logs.s3.bucket",
            value = "")
  @Named("logStorageConfigs")
  public CloudStorageConfigs defaultLogStorageConfigs() {
    return CloudStorageConfigs.none();
  }

  @Singleton
  @Requires(property = "airbyte.cloud.storage.state.gcs.bucket",
            value = "")
  @Requires(property = "airbyte.cloud.storage.state.minio.bucket",
            value = "")
  @Requires(property = "airbyte.cloud.storage.state.s3.bucket",
            value = "")
  @Named("stateStorageConfigs")
  public CloudStorageConfigs defaultStateStorageConfiguration() {
    return CloudStorageConfigs.none();
  }
