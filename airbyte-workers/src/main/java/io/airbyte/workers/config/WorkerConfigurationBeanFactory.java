...
public class WorkerConfigurationBeanFactory {
  ...
  public WorkerConfigs checkWorkerConfigs(
                                          ...
                                          @Value("${airbyte.worker.isolated.kube.image-pull-secret}") final String customImagePullSecret,
    ...
    return new WorkerConfigs(
        ...
        customImagePullSecret.isBlank() ? Optional.empty() : Optional.of(customImagePullSecret),
