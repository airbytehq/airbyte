...
/**
 * This process allows creating and managing a pod outside the lifecycle of the
 * launching application. Unlike {@link KubePodProcess} there is no heartbeat mechanism
 * that requires the launching pod and the launched pod to co-exist for the duration of
 * execution for the launched pod.
 *
 * Instead, this process creates the pod and interacts with a document store on cloud storage
 * to understand the state of the created pod.
 */
@Slf4j
