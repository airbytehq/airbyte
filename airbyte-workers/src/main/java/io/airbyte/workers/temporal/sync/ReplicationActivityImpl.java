...
public class ReplicationActivityImpl implements ReplicationActivity {
  ...
  private static StandardSyncOutput reduceReplicationOutput(final ReplicationOutput output) {
    ...
    syncSummary.setReplicationStartTime(replicationSummary.getReplicationStartTime());
    syncSummary.setReplicationEndTime(replicationSummary.getReplicationEndTime());
    syncSummary.setNormalizationStartTime(replicationSummary.getNormalizationStartTime());
    syncSummary.setNormalizationEndTime(replicationSummary.getNormalizationEndTime());
    syncSummary.setSourceReadStartTime(replicationSummary.getSourceReadStartTime());
    syncSummary.setSourceReadEndTime(replicationSummary.getSourceReadEndTime());
    syncSummary.setDestinationWriteStartTime(replicationSummary.getDestinationWriteStartTime());
    syncSummary.setDestinationWriteEndTime(replicationSummary.getDestinationWriteEndTime());
