...
public class ReplicationActivityImpl implements ReplicationActivity {
  ...
  public StandardSyncOutput replicate(final JobRunConfig jobRunConfig,
    ...
    ApmTraceUtils.addTagsToTrace(Map.of(JOB_ID_TAG_KEY, jobRunConfig.getJobId(), DESTINATION_DOCKER_IMAGE_TAG_KEY,
        destinationLauncherConfig.getDockerImage(), SOURCE_DOCKER_IMAGE_TAG_KEY, sourceLauncherConfig.getDockerImage()));
