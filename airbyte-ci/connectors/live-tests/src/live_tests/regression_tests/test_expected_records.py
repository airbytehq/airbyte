...
async def test_all_records_are_produced_in_target_version(
    ...
    control_records = list(make_comparable_records(filter_records(read_control_execution_result.airbyte_messages)))
    target_records = list(make_comparable_records(filter_records(read_target_execution_result.airbyte_messages)))
