...
```dockerfile
FROM docker.io/python:3.11.9-slim-bookworm@sha256:80bcf8d243a0d763a7759d6b99e5bf89af1869135546698be4bf7ff6c3f98a59
...
|---------|-----------|--------------|-----------|
|  3.0.0 | ❌|  | Upgrade root image to Python 3.11.9 |
