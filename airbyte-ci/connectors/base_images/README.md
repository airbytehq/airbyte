...
| ---------- | --------- | -------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| 1.2.1      | ✅        | docker.io/airbyte/python-connector-base:1.2.1@sha256:04ce17faf949ef4090d06a1a1f704eb4687fc3c5f750944149a400e2a9eaa0e1      | Upgrade to Python 3.9.19 + update pip and setuptools                                                 |
