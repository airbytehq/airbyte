...
class CraneClient:
    ...
    def login(self) -> dagger.Container:
        return (
            ...
            .with_secret_variable("DOCKER_HUB_PASSWORD", self.docker_hub_username_password).with_exec(["sh", "-c", "crane auth login index.docker.io -u $DOCKER_HUB_USERNAME -p $DOCKER_HUB_PASSWORD"])
        )
