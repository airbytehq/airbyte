...
from base_images.root_images import PYTHON_3_11_9


class AirbytePythonConnectorBaseImage(bases.AirbyteConnectorBaseImage):

    root_image: Final[published_image.PublishedImage] = PYTHON_3_11_9
    ...
    async def run_sanity_checks(self, platform: dagger.Platform):
        ...
        await python_sanity_checks.check_python_version(container, "3.11.9")
