...
@click.group(
    ...
    lazy_subcommands={
        "publish": "pipelines.airbyte_ci.cdk.java.publish.commands.publish",
        "bump_version": "pipelines.airbyte_ci.cdk.java.bump_version.commands.bump_version",
    },
)
...
async def java(
    ...
    print("SGX executing cdk java command")
