...
Our pipeline are declared with Python code, the main entrypoint is [here](https://github.com/airbytehq/airbyte/blob/main/airbyte-ci/connector_ops/connector_ops/pipelines/commands/airbyte_ci.py).
This documentation should be helpful for both local and CI use of the CLI. We indeed [power connector testing in the CI with this CLI](https://github.com/airbytehq/airbyte/blob/main/.github/workflows/connector_integration_test_single_dagger.yml#L78).
...
[Get GSM Access](https://github.com/airbytehq/airbyte/blob/main/airbyte-ci/connectors/ci_credentials/README.md#get-gsm-access)
instructions.
...
| `--diffed-branch`                          | `origin/main`                   |                               | Branch to which the git diff will happen to detect new or modified files.                 |
| `--gha-workflow-run-id`                    |                                 |                               | GHA CI only - The run id of the GitHub action workflow                                    |
| `--ci-context`                             | `manual`                        |                               | The current CI context: `manual` for manual run, `pull_request`, `nightly_builds`, `main` |
