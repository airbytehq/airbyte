...
| ------- | ---------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| 4.48.0  | [#XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX)  | Update `bump-version` command to update `enabledProgressiveRollout` in metadata when using `--rc` flag or `rc` bump type.                 |
