...
from orchestrator.resources.gcp import gcp_gcs_client, gcs_file_manager, gcs_directory_blobs
...
def debug_registry_generation():
    resources = {
        ...
        "latest_metadata_file_blobs": gcs_directory_blobs.configured({"gcs_bucket": {"env": "METADATA_BUCKET"}, "prefix": METADATA_FOLDER, "suffix": METADATA_FILE_NAME}),
    }
