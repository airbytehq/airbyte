...
# def render_connector_registry_locations_markdown(destinations_markdown: str, sources_markdown: str) -> str:
#     env = Environment(loader=PackageLoader("orchestrator", "templates"))
#     template = env.get_template("connector_registry_locations.md")
#     return template.render(destinations_markdown=destinations_markdown, sources_markdown=sources_markdown)


def render_connector_registry_report_markdown(destinations_markdown: str, sources_markdown: str) -> str:
    env = Environment(loader=PackageLoader("orchestrator", "templates"))
    template = env.get_template("connector_registry_report.md")
    return template.render(destinations_markdown=destinations_markdown, sources_markdown=sources_markdown)
