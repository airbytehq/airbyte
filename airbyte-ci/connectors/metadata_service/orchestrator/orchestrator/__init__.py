...
from orchestrator.assets.metadata import registry_derived_metadata_definitions, metadata_definitions, valid_metadata_report_dataframe
...
RESOURCES = {
    ...
    "registry_directory_manager": gcs_file_manager.configured({"gcs_bucket": {"env": "METADATA_BUCKET"}, "prefix": CATALOG_FOLDER}),
    ...
    "latest_oss_registry_gcs_file": gcs_file_blob.configured({"prefix": CATALOG_FOLDER, "gcs_filename": "oss_registry.json"}),
    "latest_cloud_registry_gcs_file": gcs_file_blob.configured({"prefix": CATALOG_FOLDER, "gcs_filename": "cloud_registry.json"}),
}
