...
@task
async def test_java_cdk_task(build_result: Container, client: Client,settings: JavaCDKSettings, ctx: PipelineContext, scan: bool = False,) -> Container:


    files_from_container=["./build.gradle",
                "./gradlew",
                "./gradle", 
                "./airbyte-cdk/java/**", 
                "./publish-repositories.gradle", 
...
@task
async def publish_java_cdk_task(build_result: Container, client: Client,settings: JavaCDKSettings, ctx: PipelineContext, scan: bool = False) -> Container:
