...
class GoogleApi:
    ...
    def get(self, url: str, params: Optional[Mapping] = None) -> Mapping[str, Any]:
        """Sends a GET request."""
    ...
    def post(self, url: str, json: Optional[Mapping] = None, params: Optional[Mapping] = None) -> Mapping[str, Any]:
