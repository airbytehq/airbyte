...
Once the command is done, you will find your connector image in your local docker registry: `airbyte/destination-{{dashCase name}}:dev`.
...
See [airbyte-ci documentation](https://github.com/airbytehq/airbyte/blob/main/airbyte-ci/connectors/pipelines/README.md#connectors-test-command)
...
1. Someone from Airbyte will take a look at your PR and iterate with you to merge it into main.
