 ...
 *
 * What kind of resource? Any really. Think long lived objects. Database connection pools, thread pool
 * executors, etc.
 *
 * To use:
 *       CloseableResourceManager.getInstance().addCloseable(() -> {
 *              // logic to perform on close, cleanup, etc.
 *       });
 *
 * Prior to the end of execution, call:
