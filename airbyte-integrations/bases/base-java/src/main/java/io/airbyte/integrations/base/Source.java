...
public interface Source extends Integration {
   ...
   * @return {@link AutoCloseableIterator} that produces message. The iterator will be consumed
   *     until no records remain or until an exception is thrown. {@link
   *     AutoCloseableIterator#close()} will always be called once regardless of success or failure.
   * @throws Exception - any exception.
   */
