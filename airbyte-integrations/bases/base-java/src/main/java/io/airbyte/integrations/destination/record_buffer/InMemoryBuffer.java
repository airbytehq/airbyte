...
/**
 * Instead of storing buffered data on disk like the {@link FileBuffer}, this {@link BufferStorage} accumulates message data in-memory instead. Thus,
 * a bigger heap size would be required.
 */
