...
public interface Destination extends Integration {
   ...
   * @return Consumer that accepts message. The {@link
   *     AirbyteMessageConsumer#accept(AirbyteMessage)} will be called n times where n is the number
   *     of messages. {@link AirbyteMessageConsumer#close()} will always be called once regardless
