...
public final class JavaBaseConstants {
  ...
  public static final String COLUMN_NAME_AB_ID = "_daspire_ab_id";
  public static final String COLUMN_NAME_EMITTED_AT = "_daspire_emitted_at";
  public static final String COLUMN_NAME_DATA = "_daspire_data";
