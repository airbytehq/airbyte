...
public final class JavaBaseConstants {
  ...
  public static final List<String> LEGACY_RAW_TABLE_COLUMNS =
  ...
  public static final List<String> V2_RAW_TABLE_COLUMN_NAMES = List.of(
      ...
      COLUMN_NAME_DATA);
  public static final List<String> V2_FINAL_TABLE_METADATA_COLUMNS =
      List.of(COLUMN_NAME_AB_RAW_ID, COLUMN_NAME_AB_EXTRACTED_AT, COLUMN_NAME_AB_META);
