...
def run_schema_change_normalization(destination_type: DestinationType, test_resource_name: str, test_root_dir: str):
    ...
    if destination_type.value in [DestinationType.SNOWFLAKE.value, DestinationType.CLICKHOUSE.value, DestinationType.TIDB.value, DestinationType.FIREBOLT.value]:
...
def setup_test_dir(destination_type: DestinationType, test_resource_name: str) -> str:
    ...
    if destination_type.value == DestinationType.MSSQL.value:
        ...
        copy_tree("../dbt-project-template-firebolt", test_root_dir)
        dbt_project_yaml = "../dbt-project-template-firebolt/dbt_project.yml"
