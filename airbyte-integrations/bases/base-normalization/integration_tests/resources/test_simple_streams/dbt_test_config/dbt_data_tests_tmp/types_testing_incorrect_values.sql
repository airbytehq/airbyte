...
(
  id = 1 and (
    ...
    or cast(big_integer as {{ dbt_utils.type_string() }}) != '1234567890123456789012345678'
    or cast(nullable_big_integer as {{ dbt_utils.type_string() }}) != '1234567890123456789012345678'
  )
) or (
  id = 2 and (
