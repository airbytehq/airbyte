  ...
  create  table
    "integrationtests".test_normalization_iakoz."exchange_rate__dbt_tmp"
...
-- depends_on: "integrationtests".test_normalization_iakoz._airbyte_raw_exchange_rate
select
...
from "integrationtests".test_normalization_iakoz._airbyte_raw_exchange_rate as table_alias
-- exchange_rate
where 1 = 1
...
-- exchange_rate from "integrationtests".test_normalization_iakoz._airbyte_raw_exchange_rate
where 1 = 1
  );