  ...
  create view "normalization_tests"._airbyte_test_normalization_vorny."dedup_exchange_rate_stg__dbt_tmp" as (
...
from "normalization_tests".test_normalization_vorny._airbyte_raw_dedup_exchange_rate as table_alias
-- dedup_exchange_rate
where 1 = 1
