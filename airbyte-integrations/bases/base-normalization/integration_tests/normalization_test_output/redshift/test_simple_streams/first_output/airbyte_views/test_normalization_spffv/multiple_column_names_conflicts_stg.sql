  ...
  create view "normalization_tests"._airbyte_test_normalization_spffv."multiple_column_names_conflicts_stg__dbt_tmp" as (
    
with __dbt__cte__multiple_column_names_conflicts_ab1 as (

-- SQL model to parse JSON blob stored in a single column and extract into separated field columns as described by the JSON Schema
-- depends_on: "normalization_tests".test_normalization_spffv._airbyte_raw_multiple_column_names_conflicts
select
...
from "normalization_tests".test_normalization_spffv._airbyte_raw_multiple_column_names_conflicts as table_alias
