  ...
  create view "integrationtests"._airbyte_test_normalization_lfocr."dedup_exchange_rate_stg__dbt_tmp" as (
    
with __dbt__cte__dedup_exchange_rate_ab1 as (

-- SQL model to parse JSON blob stored in a single column and extract into separated field columns as described by the JSON Schema
-- depends_on: "integrationtests".test_normalization_lfocr._airbyte_raw_dedup_exchange_rate
select
...
from "integrationtests".test_normalization_lfocr._airbyte_raw_dedup_exchange_rate as table_alias
-- dedup_exchange_rate
where 1 = 1
