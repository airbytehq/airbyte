...
-- depends_on: "integrationtests".test_normalization_kkvia."nested_stream_with_complex_columns_resulting_into_long_names_partition"
    ...
    with joined as (
            ...
            from "integrationtests".test_normalization_kkvia."nested_stream_with_complex_columns_resulting_into_long_names_partition" as table_alias, table_alias.double_array_data as _airbyte_nested_data
        )
select
...
-- double_array_data at nested_stream_with_complex_columns_resulting_into_long_names/partition/double_array_data from "integrationtests".test_normalization_kkvia."nested_stream_with_complex_columns_resulting_into_long_names_partition"
where 1 = 1
