  ...
  create  table
    "integrationtests".test_normalization_lpgvp."nested_stream_with_complex_columns_resulting_into_long_names_partition_double_array_data"
...
-- depends_on: "integrationtests".test_normalization_lpgvp."nested_stream_with_complex_columns_resulting_into_long_names_partition"

    with joined as (
            select
                table_alias._airbyte_partition_hashid as _airbyte_hashid,
                _airbyte_nested_data
            from "integrationtests".test_normalization_lpgvp."nested_stream_with_complex_columns_resulting_into_long_names_partition" as table_alias, table_alias.double_array_data as _airbyte_nested_data
        )
select
...
from "integrationtests".test_normalization_lpgvp."nested_stream_with_complex_columns_resulting_into_long_names_partition" as table_alias
...
-- double_array_data at nested_stream_with_complex_columns_resulting_into_long_names/partition/double_array_data from "integrationtests".test_normalization_lpgvp."nested_stream_with_complex_columns_resulting_into_long_names_partition"
where 1 = 1
