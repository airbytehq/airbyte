  ...
  create  table
    "integrationtests".test_normalization_lpgvp."nested_stream_with_complex_columns_resulting_into_long_names_partition_data"
...
-- depends_on: "integrationtests".test_normalization_lpgvp."nested_stream_with_complex_columns_resulting_into_long_names_partition"
    ...
    with joined as (
            ...
            from "integrationtests".test_normalization_lpgvp."nested_stream_with_complex_columns_resulting_into_long_names_partition" as table_alias, table_alias.data as _airbyte_nested_data
        )
select
...
-- data at nested_stream_with_complex_columns_resulting_into_long_names/partition/DATA from "integrationtests".test_normalization_lpgvp."nested_stream_with_complex_columns_resulting_into_long_names_partition"
where 1 = 1
