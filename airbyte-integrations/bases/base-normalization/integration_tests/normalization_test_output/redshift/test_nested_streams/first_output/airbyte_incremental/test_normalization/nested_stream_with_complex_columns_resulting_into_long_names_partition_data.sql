  ...
  create  table
    "integrationtests".test_normalization_kkvia."nested_stream_with_complex_columns_resulting_into_long_names_partition_data"
...
-- depends_on: "integrationtests".test_normalization_kkvia."nested_stream_with_complex_columns_resulting_into_long_names_partition"

    with joined as (
            select
                table_alias._airbyte_partition_hashid as _airbyte_hashid,
                _airbyte_nested_data
            from "integrationtests".test_normalization_kkvia."nested_stream_with_complex_columns_resulting_into_long_names_partition" as table_alias, table_alias.data as _airbyte_nested_data
        )
select
...
from "integrationtests".test_normalization_kkvia."nested_stream_with_complex_columns_resulting_into_long_names_partition" as table_alias
...
-- data at nested_stream_with_complex_columns_resulting_into_long_names/partition/DATA from "integrationtests".test_normalization_kkvia."nested_stream_with_complex_columns_resulting_into_long_names_partition"
where 1 = 1
