begin;
    ...
    merge into "AIRBYTE_DATABASE".TEST_NORMALIZATION."EXCHANGE_RATE" as DBT_INTERNAL_DEST
        using "AIRBYTE_DATABASE".TEST_NORMALIZATION."EXCHANGE_RATE__dbt_tmp" as DBT_INTERNAL_SOURCE
        on 
    ...
    when not matched then insert
        ("ID", "CURRENCY", "DATE", "TIMESTAMP_COL", "HKD@spéçiäl & characters", "HKD_SPECIAL___CHARACTERS", "NZD", "USD", "_AIRBYTE_AB_ID", "_AIRBYTE_EMITTED_AT", "_AIRBYTE_NORMALIZED_AT", "_AIRBYTE_EXCHANGE_RATE_HASHID")
    values
        ("ID", "CURRENCY", "DATE", "TIMESTAMP_COL", "HKD@spéçiäl & characters", "HKD_SPECIAL___CHARACTERS", "NZD", "USD", "_AIRBYTE_AB_ID", "_AIRBYTE_EMITTED_AT", "_AIRBYTE_NORMALIZED_AT", "_AIRBYTE_EXCHANGE_RATE_HASHID")
