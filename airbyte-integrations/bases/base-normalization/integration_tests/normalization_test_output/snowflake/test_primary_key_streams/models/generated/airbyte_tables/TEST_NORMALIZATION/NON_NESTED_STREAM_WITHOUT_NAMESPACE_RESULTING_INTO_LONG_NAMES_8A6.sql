{{ config(alias="NON_NESTED_STREAM_WITHOUT_NAMESPACE_RESULTING_INTO_LONG_NAMES", schema="TEST_NORMALIZATION", tags=["top-level"]) }}
...
from {{ ref('NON_NESTED_STREAM_WITHOUT_NAMESPACE_RESULTING_INTO_LONG_NAMES_AB3_561') }}
