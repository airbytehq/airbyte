{{ config(alias="NESTED_STREAM_WITH_COMPLEX_COLUMNS_RESULTING_INTO_LONG_NAMES_AB4", schema="_AIRBYTE_TEST_NORMALIZATION", tags=["top-level-intermediate"]) }}
...
from {{ ref('NESTED_STREAM_WITH_COMPLEX_COLUMNS_RESULTING_INTO_LONG_NAMES_AB3_301') }}
