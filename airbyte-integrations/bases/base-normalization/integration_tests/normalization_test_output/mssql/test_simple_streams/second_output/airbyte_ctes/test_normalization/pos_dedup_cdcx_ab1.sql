USE [test_normalization];
    execute('create view _airbyte_test_normalization."pos_dedup_cdcx_ab1__dbt_tmp" as
...
from "test_normalization".test_normalization._airbyte_raw_pos_dedup_cdcx as table_alias
-- pos_dedup_cdcx
where 1 = 1
    ');
