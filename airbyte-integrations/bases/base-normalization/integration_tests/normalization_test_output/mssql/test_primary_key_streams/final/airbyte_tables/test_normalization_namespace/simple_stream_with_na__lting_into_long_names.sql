...
with __dbt__CTE__simple_stream_with_na__lting_into_long_names_ab1 as (
...
),  __dbt__CTE__simple_stream_with_na__lting_into_long_names_ab2 as (
...
select
    ...
    VARCHAR(max)) as "date",
    _airbyte_emitted_at
from __dbt__CTE__simple_stream_with_na__lting_into_long_names_ab1
-- simple_stream_with_na__lting_into_long_names
),  __dbt__CTE__simple_stream_with_na__lting_into_long_names_ab3 as (
...
select
    ...
    tmp.*
from __dbt__CTE__simple_stream_with_na__lting_into_long_names_ab2 tmp
-- simple_stream_with_na__lting_into_long_names
...
from __dbt__CTE__simple_stream_with_na__lting_into_long_names_ab3
