...
-- depends_on: ref(''nested_stream_with_co__lting_into_long_names_tmp'')
with

input_data as (
    select *
    from "test_normalization"._airbyte_test_normalization."nested_stream_with_co__lting_into_long_names_tmp"
