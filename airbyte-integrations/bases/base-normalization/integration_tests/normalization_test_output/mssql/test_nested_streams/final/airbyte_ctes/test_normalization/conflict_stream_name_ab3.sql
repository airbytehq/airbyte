USE [test_normalization];
    execute('create view _airbyte_test_normalization."conflict_stream_name_ab3__dbt_tmp" as
...
select
    ...
    tmp.*
from "test_normalization"._airbyte_test_normalization."conflict_stream_name_ab2" tmp
