    ...
    merge into `dataline-integration-testing`.test_normalization.`dedup_cdc_excluded_scd` as DBT_INTERNAL_DEST
        using (
          select * from `dataline-integration-testing`.test_normalization.`dedup_cdc_excluded_scd__dbt_tmp`
