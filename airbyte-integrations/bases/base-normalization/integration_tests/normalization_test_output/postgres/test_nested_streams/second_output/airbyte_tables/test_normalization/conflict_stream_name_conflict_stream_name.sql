...
-- depends_on: "postgres".test_normalization."conflict_stream_name"
select
...
-- depends_on: __dbt__cte__conflict_stream_name_conflict_stream_name_ab1
select
    _airbyte_conflict_stream_name_hashid,
...
-- depends_on: __dbt__cte__conflict_stream_name_conflict_stream_name_ab3
select
    _airbyte_conflict_stream_name_hashid,
