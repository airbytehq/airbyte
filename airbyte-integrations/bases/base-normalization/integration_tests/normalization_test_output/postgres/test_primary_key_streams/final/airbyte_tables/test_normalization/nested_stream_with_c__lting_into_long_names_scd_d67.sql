  ...
  create  table "postgres".test_normalization."nested_stream_with_c__lting_into_long_names_scd_d67__dbt_tmp"
  as (
...
from "postgres"._airbyte_test_normalization."nested_stream_with_c__g_into_long_names_ab4"
