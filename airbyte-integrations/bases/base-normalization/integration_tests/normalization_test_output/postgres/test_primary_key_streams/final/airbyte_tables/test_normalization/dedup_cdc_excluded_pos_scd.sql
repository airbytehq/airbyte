  ...
  create  table "postgres".test_normalization."dedup_cdc_excluded_pos_scd__dbt_tmp"
  as (
...
select
    ...
    _airbyte_emitted_at
from "postgres".test_normalization._airbyte_raw_dedup_cdc_excluded_pos as table_alias
