  ...
  create  table "postgres".test_normalization."non_nested_stream_wi__lting_into_long_names_8a6__dbt_tmp"
  as (
...
from "postgres"._airbyte_test_normalization."non_nested_stream_wi__g_into_long_names_ab3"
