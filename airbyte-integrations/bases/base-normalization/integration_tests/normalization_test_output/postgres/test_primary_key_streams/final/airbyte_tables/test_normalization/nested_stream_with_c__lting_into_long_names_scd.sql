...
-- nested_stream_with_c__lting_into_long_names
),  __dbt__CTE__nested_stream_with_c__lting_into_long_names_ab3 as (
...
from __dbt__CTE__nested_stream_with_c__lting_into_long_names_ab2
-- nested_stream_with_c__lting_into_long_names
),  __dbt__CTE__nested_stream_with_c__lting_into_long_names_ab4 as (
...
select
  ...
  tmp.*
from __dbt__CTE__nested_stream_with_c__lting_into_long_names_ab3 tmp
...
from __dbt__CTE__nested_stream_with_c__lting_into_long_names_ab4
-- nested_stream_with_c__lting_into_long_names from "postgres".test_normalization._airbyte_raw_nested_stream_with_complex_columns_resulting_into_long_names
