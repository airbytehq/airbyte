{{ config(alias="nested_stream_with_comple_64a_partition_ab1", schema="_airbyte_test_normalization", tags=["nested-intermediate"]) }}
...
select
    ...
    _airbyte_emitted_at
from {{ ref('nested_stream_with_c__lting_into_long_names_d67') }}
