{{ config(alias="nested_stream_wit_e78_double_array_data_ab1", schema="_airbyte_test_normalization", tags=["nested-intermediate"]) }}
-- SQL model to parse JSON blob stored in a single column and extract into separated field columns as described by the JSON Schema
{{ unnest_cte('nested_stream_with_complex_co_64a_partition_44f', 'partition', 'double_array_data') }}
select
