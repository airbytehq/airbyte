{{ config(alias="non_nested_stream_wi__lting_into_long_names", schema="test_normalization", tags=["top-level"]) }}
...
from {{ ref('non_nested_stream_wi__g_into_long_names_ab3_561') }}
