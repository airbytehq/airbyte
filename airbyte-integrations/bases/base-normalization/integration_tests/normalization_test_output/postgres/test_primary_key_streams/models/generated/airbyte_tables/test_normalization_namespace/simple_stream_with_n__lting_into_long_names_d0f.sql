{{ config(alias="simple_stream_with_n__lting_into_long_names", schema="test_normalization_namespace", tags=["top-level"]) }}
...
from {{ ref('simple_stream_with_n__g_into_long_names_ab3_4fe') }}
