{{ config(alias="nested_stream_with_c__g_into_long_names_ab2", schema="_airbyte_test_normalization", tags=["top-level-intermediate"]) }}
...
select
    ...
    _airbyte_emitted_at
from {{ ref('nested_stream_with_c__g_into_long_names_ab1_301') }}
