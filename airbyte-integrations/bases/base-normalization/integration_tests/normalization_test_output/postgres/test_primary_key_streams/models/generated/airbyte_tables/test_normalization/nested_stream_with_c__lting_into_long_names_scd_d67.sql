{{ config(alias="nested_stream_with_c__lting_into_long_names_scd", schema="test_normalization", tags=["top-level"]) }}
...
from {{ ref('nested_stream_with_c__g_into_long_names_ab4_301') }}
