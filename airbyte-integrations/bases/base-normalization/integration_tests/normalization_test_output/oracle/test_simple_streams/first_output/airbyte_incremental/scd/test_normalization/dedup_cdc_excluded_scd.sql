...
input_data as (
    select *
    from test_normalization.dedup_cdc_excluded_ab3
...
dedup_data as (
    select
        ...
        row_number() over (
            partition by "_AIRBYTE_UNIQUE_KEY", "_AIRBYTE_START_AT", "_AIRBYTE_EMITTED_AT", cast("_AB_CDC_DELETED_AT" as varchar2(4000)), cast("_AB_CDC_UPDATED_AT" as varchar2(4000))
