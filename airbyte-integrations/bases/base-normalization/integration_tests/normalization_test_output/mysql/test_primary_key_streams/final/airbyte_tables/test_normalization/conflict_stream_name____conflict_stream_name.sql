...
with __dbt__CTE__conflict_stream_name__3flict_stream_name_ab1 as (
...
),  __dbt__CTE__conflict_stream_name__3flict_stream_name_ab2 as (
...
select
    ...
    _airbyte_emitted_at
from __dbt__CTE__conflict_stream_name__3flict_stream_name_ab1
-- conflict_stream_name at conflict_stream_name/conflict_stream_name/conflict_stream_name
),  __dbt__CTE__conflict_stream_name__3flict_stream_name_ab3 as (
...
select
    ...
    tmp.*
from __dbt__CTE__conflict_stream_name__3flict_stream_name_ab2 tmp
-- conflict_stream_name at conflict_stream_name/conflict_stream_name/conflict_stream_name
...
from __dbt__CTE__conflict_stream_name__3flict_stream_name_ab3
