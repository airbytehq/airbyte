  ...
  create view _airbyte_test_normalization.`nested_stream_with_co__g_names_partition_ab3__dbt_tmp` as (
...
from _airbyte_test_normalization.`nested_stream_with_co__g_names_partition_ab2`
