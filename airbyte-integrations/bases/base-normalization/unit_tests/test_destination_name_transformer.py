...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Identifier Name", "Firebolt", "{{ adapter.quote('Identifier Name') }}", "adapter.quote('Identifier Name')"),
        # Reserved Word for BigQuery and MySQL only
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Identifier Name8", "Firebolt", "Identifier_Name8", "{{ adapter.quote('Identifier Name8') }}"),
        # Unicode
        ...
        ("a-Unicode_name_文8", "Firebolt", "a_Unicode_name__8", "{{ adapter.quote('a-Unicode_name_文8') }}"),
        # Doesnt start with alpha or underscore
        ...
        ("100x2008", "Firebolt", "100x2008", "{{ adapter.quote('100x2008') }}"),
        ...
        ("DisTincT", "Firebolt", "DisTincT", "{{ adapter.quote('DisTincT') }}"),
        # Quoted identifiers
        ...
        ("'QuoTedFB1 IdenTifiER'", "Firebolt", "_QuoTedFB1_IdenTifiER_", "{{ adapter.quote('\\'QuoTedFB1 IdenTifiER\\'') }}"),
        ...
        ('"QuoTedFB2 IdenTifiER"', "Firebolt", "_QuoTedFB2_IdenTifiER_", '{{ adapter.quote(\'""QuoTedFB2 IdenTifiER""\') }}'),
        ...
        ("`QuoTedFB3 IdenTifiER`", "Firebolt", "_QuoTedFB3_IdenTifiER_", "{{ adapter.quote('`QuoTedFB3 IdenTifiER`') }}"),
    ],
)
