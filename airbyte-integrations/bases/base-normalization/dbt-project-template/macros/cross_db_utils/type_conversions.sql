...
{% macro boolean_to_varchar(boolean_column) -%}
  {{ adapter.dispatch('boolean_to_varchar')(adapter.quote_as_configured(boolean_column), 'identifier'|trim) }}
{%- endmacro %}
...
{% macro redshift__boolean_to_varchar(json_column, json_path_list) -%}
