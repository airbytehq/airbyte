...
{% macro json_extract(from_table, json_column, json_path_list) -%}
  {{ adapter.dispatch('json_extract')(from_table, json_column, json_path_list) }}
{%- endmacro %}

{% macro default__json_extract(from_table, json_column, json_path_list) -%}
    json_extract({{ from_table }}.{{ json_column }}, {{ format_json_path(json_path_list) }})
{%- endmacro %}

{% macro bigquery__json_extract(from_table, json_column, json_path_list) -%}
    json_extract({{ from_table }}.{{ json_column }}, {{ format_json_path(json_path_list) }})
{%- endmacro %}
...
{% macro mysql__json_extract(from_table, json_column, json_path_list) -%}
    json_extract({{ from_table }}.{{ json_column }}, {{ format_json_path(json_path_list) }})
{%- endmacro %}
...
{% macro snowflake__json_extract(from_table, json_column, json_path_list) -%}
