{#
    ...
    - Firebolt: JSON_EXTRACT_RAW(<json>, <json_pointer_expression>) -> https://docs.firebolt.io/sql-reference/functions-reference/json-extract-raw.html
#}
...
{% macro firebolt__format_json_path(json_path_list) -%}
    {%- set str_list = [] -%}
    {%- for json_path in json_path_list -%}
        {%- if str_list.append(json_path.replace("'", "''").replace('"', '\\"')) -%} {%- endif -%}
    {%- endfor -%}
