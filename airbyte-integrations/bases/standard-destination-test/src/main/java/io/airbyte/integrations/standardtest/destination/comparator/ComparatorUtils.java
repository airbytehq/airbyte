...
public class ComparatorUtils {
    ...
    public static JsonNode getActualValueByExpectedKey(final String expectedKey, final JsonNode actualJsonNode, final Function<String, List<String>> nameResolver) {
