...
public class ArgumentProviderUtil {
  ...
  /**
   * This method use {@link io.airbyte.integrations.standardtest.destination.ProtocolVersion#getPrefix()}
   * to prefix the file name. <p>
   * example: <p>
   ...
   *                current test is being executed.
