...
public class DataTypeTest {
    ...
    DataTypeTest(String sourceType, Field.JsonSchemaPrimitive airbyteType, List<String> values, String createTablePatternSQL, String insertPatternSQL, String fullSourceDataType) {
