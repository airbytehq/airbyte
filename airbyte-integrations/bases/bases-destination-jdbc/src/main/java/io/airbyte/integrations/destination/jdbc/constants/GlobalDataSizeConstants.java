...
public interface GlobalDataSizeConstants {
  ...
  int DEFAULT_MAX_BATCH_SIZE_BYTES =
      DataSize.of(25L, IEC.MEBIBYTE).toUnit(IEC.BYTE).getValue().intValue();
  /**
   ...
   */
  long MAX_FILE_SIZE =
      DataSize.of(100L, IEC.MEBIBYTE).toUnit(IEC.BYTE).getValue().longValue();
}
