...
public class S3FilenameTemplateParameterObject {
  ...
  public static class S3FilenameTemplateParameterObjectBuilder {
    ...
    public S3FilenameTemplateParameterObject build() {
      return new S3FilenameTemplateParameterObject(
          objectPath,
          recordsData,
          fileNamePattern,
          fileExtension,
    ...
    public String toString() {
      return "S3FilenameTemplateParameterObject.S3FilenameTemplateParameterObjectBuilder(objectPath="
          + this.objectPath + ", recordsData="
          + this.recordsData + ", fileNamePattern="
          + this.fileNamePattern + ", fileExtension=" + this.fileExtension + ", partId="
          + this.partId + ", s3Format=" + this.s3Format
  ...
  public boolean equals(final Object o) {
    ...
    return Objects.equals(objectPath, that.objectPath)
        && Objects.equals(recordsData, that.recordsData)
