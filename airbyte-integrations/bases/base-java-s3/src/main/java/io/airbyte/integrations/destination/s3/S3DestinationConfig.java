  ...
  protected AmazonS3 createS3Client() {
    ...
    if (S3CredentialType.DEFAULT_PROFILE == credentialType) {
      return AmazonS3ClientBuilder.standard()
          ...
          // the SDK defaults to RetryMode.LEGACY (https://docs.aws.amazon.com/sdkref/latest/guide/feature-retry-behavior.html)
          // this _can_ be configured via environment variable, but it seems more reliable to configure it programmatically
