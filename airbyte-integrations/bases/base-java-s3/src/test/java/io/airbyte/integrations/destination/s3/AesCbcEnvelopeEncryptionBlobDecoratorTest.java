...
public class AesCbcEnvelopeEncryptionBlobDecoratorTest {
  ...
  public static final String CONTENT_ENCRYPTING_KEY =
      "9ZAVuZE8L4hJCFQS49OMNeFRGTCBUHAFOgkW3iZkOq8=";
  ...
  public static final String ENCRYPTED_CEK =
  ...
  public void testEncryption() throws IOException {
    ...
    Assertions.assertArrayEquals(BASE64_DECODER.decode(CIPHERTEXT), stream.toByteArray());
  }
