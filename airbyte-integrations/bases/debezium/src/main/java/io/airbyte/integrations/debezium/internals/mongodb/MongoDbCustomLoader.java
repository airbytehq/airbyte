 ...
 * <p />
 * <p />
 * N.B. In order to extract the offset from the {@link MongoDbCustomLoader}, you must first
 * get the {@link io.debezium.connector.mongodb.ReplicaSetOffsetContext} from the {@link MongoDbOffsetContext}
 * for the replica set for which the offset is requested.  From that context, you can then request the actual
 * Debezium offset.
 */
