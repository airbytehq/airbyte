...
public class RelationalDbDebeziumPropertiesManager extends DebeziumPropertiesManager {
    ...
    public RelationalDbDebeziumPropertiesManager(final Properties properties, final JsonNode config, final ConfiguredAirbyteCatalog catalog, final AirbyteFileOffsetBackingStore offsetManager, final Optional<AirbyteSchemaHistoryStorage> schemaHistoryManager) {
