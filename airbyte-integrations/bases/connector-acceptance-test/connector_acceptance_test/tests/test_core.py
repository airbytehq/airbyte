...
class TestDiscovery(BaseTest):
    ...
    async def test_discover(self, connector_config, docker_runner: ConnectorRunner):
        ...
        assert self.streams_are_uniquely_named(catalog_messages[0].catalog.streams), "Catalog should have uniquely named streams"

    def streams_are_uniquely_named(self, streams) -> bool:
