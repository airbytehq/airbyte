...
- Setting up a Service Account for Google Secrets Manager (GSM) access. See [here](https://github.com/airbytehq/airbyte/blob/main/airbyte-ci/connectors/ci_credentials/README.md)
...
_Note: Install instructions for airbyte-ci are [here](https://github.com/airbytehq/airbyte/blob/main/airbyte-ci/connectors/pipelines/README.md) _
...
To learn how to set up `ci_credentials` and your GSM Service account see [here](https://github.com/airbytehq/airbyte/blob/main/airbyte-ci/connectors/ci_credentials/README.md)
...
11. This [Github action workflow](https://github.com/airbytehq/airbyte/blob/main/.github/workflows/cat-tests.yml) will be triggered an run the unit tests on your branch.
