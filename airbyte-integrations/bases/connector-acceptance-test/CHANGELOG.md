...
Add backward_compatibility.check_if_field_removed test to check if a field has been removed from the
catalog.
...
Basic read test: add validation that fails if undeclared columns are present in records. Add
