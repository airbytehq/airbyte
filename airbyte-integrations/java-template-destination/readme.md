...
1. Adjust the name directory structure to remove `template` and use the integration name instead.
    1. e.g. 
        ```
...
1. Update the gradle file to know how to build the integration.
    1. e.g. in `airbyte-integrations/java-template-destination/src/main/java/io/airbyte/integrations/destination/bigquery/build.grade`, set the mainClass field to be the fully qualified named of your integration.
