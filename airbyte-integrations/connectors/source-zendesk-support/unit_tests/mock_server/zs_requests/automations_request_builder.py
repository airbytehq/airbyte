...
class AutomationsRequestBuilder(ZendeskSupportBaseRequestBuilder):
    @classmethod
    def automations_endpoint(cls, authenticator: Authenticator) -> "AutomationsRequestBuilder":
        return cls("d3v-airbyte", "automations").with_authenticator(authenticator)
    ...
    def with_page_size(self, page_size: int) -> "AutomationsRequestBuilder":
        self._page_size = page_size
        return self

    def with_after_cursor(self, after_cursor: str) -> "AutomationsRequestBuilder":
