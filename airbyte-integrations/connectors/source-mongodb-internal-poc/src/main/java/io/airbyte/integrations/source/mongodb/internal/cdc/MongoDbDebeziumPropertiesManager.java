...
/**
 * Custom {@link DebeziumPropertiesManager} specific for the configuration of the Debezium MongoDB connector.
 * <p />
 * This implementation provides the specific connection properties required for the Debezium MongoDB connector.
 * These properties differ from the general relational database connection properties used by the other Debezium
 * connectors.
 */
