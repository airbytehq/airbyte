...
public class MongoUtil {
     ...
     *
     * @param mongoClient The {@link MongoClient} used to query the MongoDB server for authorized collections.
     ...
     * @return The list of {@link AirbyteStream}s that map to the available collections in the provided database.
     */
