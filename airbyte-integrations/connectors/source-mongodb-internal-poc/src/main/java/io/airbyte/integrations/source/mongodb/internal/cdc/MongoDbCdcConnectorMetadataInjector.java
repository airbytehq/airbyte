...
/**
 * MongoDB specific implementation of the {@link CdcMetadataInjector} that stores the MongoDB resume token
 * timestamp in the {@link DebeziumEventUtils#CDC_LSN} metadata field.
 */
