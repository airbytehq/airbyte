...
class MongoDbDebeziumFieldsUtilTest {
  ...
  void getFieldsNotIncludedInCatalogTest() {
    ...
    final AirbyteStream sourceAirbyteStream2 = CatalogHelpers.createAirbyteStream(COLLECTION2,
        Field.of(FIELD2, JsonSchemaType.STRING),
        Field.of(FIELD3, JsonSchemaType.STRING));
    final AirbyteStream sourceAirbyteStream3 = CatalogHelpers.createAirbyteStream(COLLECTION3,
    ...
    final Set<CollectionAndField> expectedFieldsNotIncludedInCatalog = Set.of(
        new CollectionAndField(COLLECTION1, FIELD1),
        new CollectionAndField(COLLECTION1, FIELD2),
        new CollectionAndField(COLLECTION2, FIELD3));
