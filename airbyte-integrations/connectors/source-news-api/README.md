...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-news-api:dev`.
...
```Dockerfile
FROM airbyte/source-news-api:latest
...
docker run airbyte/source-news-api:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/news-api.md`).
