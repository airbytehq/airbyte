...
This is the repository for the News-Api source connector, written in Python.
...
1. Make sure your changes are passing our test suite: `airbyte-ci connectors --name=source-news-api test`
