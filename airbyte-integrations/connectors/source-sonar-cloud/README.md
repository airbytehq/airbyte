...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-sonar-cloud:dev`.
...
```Dockerfile
FROM airbyte/source-sonar-cloud:latest
...
docker run airbyte/source-sonar-cloud:dev spec
```
#### Run
