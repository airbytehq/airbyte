...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-alpha-vantage:dev`.
...
```Dockerfile
FROM airbyte/source-alpha-vantage:latest
...
docker run airbyte/source-alpha-vantage:dev spec
```
#### Run
