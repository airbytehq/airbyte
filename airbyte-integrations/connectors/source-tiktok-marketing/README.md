...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-tiktok-marketing:dev`.
...
```Dockerfile
FROM airbyte/source-tiktok-marketing:latest
...
docker run airbyte/source-tiktok-marketing:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/tiktok-marketing.md`).
