...
class BasicReports(IncrementalTiktokStream, ABC):
    ...
    def _get_metrics(self):
        ...
        result = ["spend", "cpc", "cpm", "impressions", "clicks", "ctr", "reach", "cost_per_1000_reached", "frequency",
                  ...
                  "video_views_p25", "video_views_p50", "video_views_p75", "video_views_p100", "profile_visits", "profile_visits_rate",
                  "likes", "comments", "shares", "follows", "clicks_on_music_disc", "real_time_app_install", "real_time_app_install_cost",
                  "app_install", "cost_per_app_install", "registration", "cost_per_registration", "registration_rate", "total_registration",
                  "cost_per_total_registration", "purchase", "cost_per_purchase", "purchase_rate", "total_purchase", "cost_per_total_purchase",
                  "value_per_total_purchase", "total_purchase_value", "total_active_pay_roas", "app_event_add_to_cart",
                  ...
                  "next_day_open", "cost_per_next_day_open", "next_day_open_rate", "total_next_day_open", "cost_per_total_next_day_open",
                  "add_payment_info", "cost_per_add_payment_info", "add_payment_info_rate", "total_add_payment_info", "cost_total_add_payment_info",
                  "add_to_wishlist", "cost_per_add_to_wishlist", "add_to_wishlist_rate", "total_add_to_wishlist", "cost_per_total_add_to_wishlist",
                  "value_per_total_add_to_wishlist", "total_add_to_wishlist_value", "launch_app", "cost_per_launch_app", "launch_app_rate",
                  "total_launch_app", "cost_per_total_launch_app", "complete_tutorial", "cost_per_complete_tutorial", "complete_tutorial_rate",
                  "total_complete_tutorial", "cost_per_total_complete_tutorial", "value_per_total_complete_tutorial", "total_complete_tutorial_value",
                  "create_group", "cost_per_create_group", "create_group_rate", "total_create_group", "cost_per_total_create_group",
                  "value_per_total_create_group", "total_create_group_value", "join_group", "cost_per_join_group", "join_group_rate", "total_join_group",
                  "cost_per_total_join_group", "value_per_total_join_group", "total_join_group_value", "create_gamerole", "cost_per_create_gamerole",
                  "create_gamerole_rate", "total_create_gamerole", "cost_per_total_create_gamerole", "value_per_total_create_gamerole",
                  "total_create_gamerole_value", "spend_credits", "cost_per_spend_credits", "spend_credits_rate", "total_spend_credits",
                  "cost_per_total_spend_credits", "value_per_total_spend_credits", "total_spend_credits_value", "achieve_level", "cost_per_achieve_level",
                  "achieve_level_rate", "total_achieve_level", "cost_per_total_achieve_level", "value_per_total_achieve_level",
                  ...
                  "cost_per_total_unlock_achievement", "value_per_total_unlock_achievement", "total_unlock_achievement_value", "sales_lead",
                  "cost_per_sales_lead", "sales_lead_rate", "total_sales_lead", "cost_per_total_sales_lead", "value_per_total_sales_lead",
                  "total_sales_lead_value", "in_app_ad_click", "cost_per_in_app_ad_click", "in_app_ad_click_rate", "total_in_app_ad_click",
                  "cost_per_total_in_app_ad_click", "value_per_total_in_app_ad_click", "total_in_app_ad_click_value", "in_app_ad_impr",
                  "cost_per_in_app_ad_impr", "in_app_ad_impr_rate", "total_in_app_ad_impr", "cost_per_total_in_app_ad_impr",
                  "value_per_total_in_app_ad_impr", "total_in_app_ad_impr_value", "loan_apply", "cost_per_loan_apply", "loan_apply_rate",
                  "total_loan_apply", "cost_per_total_loan_apply", "loan_credit", "cost_per_loan_credit", "loan_credit_rate", "total_loan_credit",
                  "cost_per_total_loan_credit", "loan_disbursement", "cost_per_loan_disbursement", "loan_disbursement_rate",
                  "total_loan_disbursement", "cost_per_total_loan_disbursement", "login", "cost_per_login", "login_rate", "total_login",
                  "cost_per_total_login", "ratings", "cost_per_ratings", "ratings_rate", "total_ratings", "cost_per_total_ratings",
                  "value_per_total_ratings", "total_ratings_value", "search", "cost_per_search", "search_rate", "total_search",
                  "cost_per_total_search", "start_trial", "cost_per_start_trial", "start_trial_rate", "total_start_trial", "cost_per_total_start_trial",
                  "subscribe", "cost_per_subscribe", "subscribe_rate", "total_subscribe", "cost_per_total_subscribe", "value_per_total_subscribe",
                  "total_subscribe_value", "vta_app_install", "vta_conversion", "cost_per_vta_conversion","cost_per_cta_purchase", "complete_payment_roas",
                  "vta_registration", "cost_per_vta_registration", "vta_purchase", "cost_per_vta_purchase", "cta_app_install"]
