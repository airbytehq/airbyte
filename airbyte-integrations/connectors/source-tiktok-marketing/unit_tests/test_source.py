...
# Entity-level report keys stay on the entity id plus requested dimensions.
# TikTok campaign_id / adgroup_id / ad_id identify a single resource, so adding
# advertiser_id to those keys is a breaking change without a demonstrated collision.
# Advertiser-scoped reports already use advertiser_id as the grain.
# Records still receive advertiser_id via AddFields. See test_reports_hourly.
EXPECTED_REPORT_PRIMARY_KEYS = {
    "ads_reports_daily": [["ad_id"], ["stat_time_day"]],
    "ads_reports_by_country_daily": [["ad_id"], ["stat_time_day"], ["country_code"]],
    "ad_groups_reports_daily": [["adgroup_id"], ["stat_time_day"]],
    "ad_groups_reports_by_country_daily": [["adgroup_id"], ["stat_time_day"], ["country_code"]],
    "advertisers_reports_daily": [["advertiser_id"], ["stat_time_day"]],
    "campaigns_reports_daily": [["campaign_id"], ["stat_time_day"]],
    "campaigns_audience_reports_daily": [["campaign_id"], ["stat_time_day"], ["gender"], ["age"]],
    "ad_group_audience_reports_daily": [["adgroup_id"], ["stat_time_day"], ["gender"], ["age"]],
    "ads_audience_reports_daily": [["ad_id"], ["stat_time_day"], ["gender"], ["age"]],
    "advertisers_audience_reports_daily": [["advertiser_id"], ["stat_time_day"], ["gender"], ["age"]],
    "campaigns_audience_reports_by_country_daily": [["campaign_id"], ["stat_time_day"], ["country_code"]],
    "ad_group_audience_reports_by_country_daily": [["adgroup_id"], ["stat_time_day"], ["country_code"]],
    "ads_audience_reports_by_country_daily": [["ad_id"], ["stat_time_day"], ["country_code"]],
    "advertisers_audience_reports_by_country_daily": [["advertiser_id"], ["stat_time_day"], ["country_code"]],
    "campaigns_audience_reports_by_platform_daily": [["campaign_id"], ["stat_time_day"], ["platform"]],
    "ad_group_audience_reports_by_platform_daily": [["adgroup_id"], ["stat_time_day"], ["platform"]],
    "ads_audience_reports_by_platform_daily": [["ad_id"], ["stat_time_day"], ["platform"]],
    "advertisers_audience_reports_by_platform_daily": [["advertiser_id"], ["stat_time_day"], ["platform"]],
    "ads_audience_reports_by_province_daily": [["ad_id"], ["stat_time_day"], ["province_id"]],
    "ads_reports_hourly": [["ad_id"], ["stat_time_hour"]],
    "ads_reports_by_country_hourly": [["ad_id"], ["stat_time_hour"], ["country_code"]],
    "advertisers_reports_hourly": [["advertiser_id"], ["stat_time_hour"]],
    "campaigns_reports_hourly": [["campaign_id"], ["stat_time_hour"]],
    "ad_groups_reports_hourly": [["adgroup_id"], ["stat_time_hour"]],
    "ad_groups_reports_by_country_hourly": [["adgroup_id"], ["stat_time_hour"], ["country_code"]],
    "ads_reports_lifetime": [["ad_id"]],
    "advertisers_reports_lifetime": [["advertiser_id"]],
    "campaigns_reports_lifetime": [["campaign_id"]],
    "ad_groups_reports_lifetime": [["adgroup_id"]],
