# Imagga
This directory contains the manifest-only connector for `source-imagga`.
...
### Build
This will create a dev image (`source-imagga:dev`) that you can use to test the connector locally.
```bash
