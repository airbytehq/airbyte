...
import pytest
from source_sape.source import SapeStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SapeStream, "path", "v0/example_endpoint")
    mocker.patch.object(SapeStream, "primary_key", "test_primary_key")
    mocker.patch.object(SapeStream, "__abstractmethods__", set())
