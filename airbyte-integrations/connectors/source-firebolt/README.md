...
This is the repository for the Firebolt source connector, written in Python. For information about
how to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.io/integrations/sources/firebolt).
...
[documentation](https://docs.airbyte.io/integrations/sources/firebolt) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_firebolt/spec.json`
...
`source firebolt test creds` and place them into `secrets/config.json`.
