...
#     mocker.patch.object(IncrementalBoxFileTextStream, "path", "v0/example_endpoint")
#     mocker.patch.object(IncrementalBoxFileTextStream, "primary_key", "test_primary_key")
#     mocker.patch.object(IncrementalBoxFileTextStream, "__abstractmethods__", set())


# def test_cursor_field(patch_incremental_base_class):
#     stream = IncrementalBoxFileTextStream()
...
#     mocker.patch.object(IncrementalBoxFileTextStream, "cursor_field", "dummy_field")
#     stream = IncrementalBoxFileTextStream()
