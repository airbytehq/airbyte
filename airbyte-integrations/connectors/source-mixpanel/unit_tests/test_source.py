...
@pytest.mark.parametrize(
    ...
    (
        ({"credentials": {"api_secret": "secret"}, "project_timezone": "Miami"}, False, "Could not parse time zone: Miami, please enter a valid timezone."),
        ({"credentials": {"api_secret": "secret"}, "start_date": "20 Jan 2021"}, False, "Could not parse start date: 20 Jan 2021. Please enter a valid start date."),
        ({"credentials": {"api_secret": "secret"}, "end_date": "20 Jan 2021"}, False, "Could not parse end date: 20 Jan 2021. Please enter a valid end date."),
        ({"credentials": {"api_secret": "secret"}, "attribution_window": "20 days"}, False, "Please provide a valid integer for the `Attribution window` parameter."),
        ({"credentials": {"api_secret": "secret"}, "select_properties_by_default": "Yes"}, False, "Please provide a valid True/False value for the `Select properties by default` parameter."),
        ({"credentials": {"api_secret": "secret"}, "region": "UK"}, False, "Region must be either EU or US."),
        ({"credentials": {"api_secret": "secret"}, "date_window_size": "month"}, False, "Please provide a valid integer for the `Date slicing window` parameter."),
