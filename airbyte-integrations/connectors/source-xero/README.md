...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-xero:dev`.
...
```Dockerfile
FROM airbyte/source-xero:latest
...
docker run airbyte/source-xero:dev spec
```
#### Run
