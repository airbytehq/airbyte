...
from source_amazon_seller_partner.streams import FlatFileSettlementV2Reports, FlatFileV2SettlementV2Reports
...
@pytest.fixture
def settlement_v2_reports_stream():
    def _internal(start_date: str = START_DATE_1, end_date: str = END_DATE_1):
        stream = FlatFileV2SettlementV2Reports(
            url_base="https://test.url",
            replication_start_date=start_date,
            replication_end_date=end_date,
            marketplace_id="id",
