...
import pytest
from source_appmetrica_logs_api.source import AppmetricaLogsApiStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AppmetricaLogsApiStream, "path", "v0/example_endpoint")
    mocker.patch.object(AppmetricaLogsApiStream, "primary_key", "test_primary_key")
    mocker.patch.object(AppmetricaLogsApiStream, "__abstractmethods__", set())
