...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-sendinblue:dev`.
...
```Dockerfile
FROM airbyte/source-sendinblue:latest
...
docker run airbyte/source-sendinblue:dev spec
```
#### Run
