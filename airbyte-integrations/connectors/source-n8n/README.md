...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-n8n:dev`.
...
```Dockerfile
FROM airbyte/source-n8n:latest
...
docker run airbyte/source-n8n:dev spec
```
#### Run
