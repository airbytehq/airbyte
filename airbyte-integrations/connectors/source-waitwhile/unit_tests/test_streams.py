...
import pytest
from source_waitwhile.source import WaitwhileStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(WaitwhileStream, "path", "v0/example_endpoint")
    mocker.patch.object(WaitwhileStream, "primary_key", "test_primary_key")
    mocker.patch.object(WaitwhileStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = WaitwhileStream()
