...
```
./gradlew :airbyte-integrations:connectors:source-workramp:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-workramp:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-workramp:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-workramp:integrationTest
```
