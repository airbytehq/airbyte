...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-workramp:dev`.
...
```Dockerfile
FROM airbyte/source-workramp:latest
...
docker run airbyte/source-workramp:dev spec
```
#### Run
