...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-vantage:dev`.
...
```Dockerfile
FROM airbyte/source-vantage:latest
...
docker run airbyte/source-vantage:dev spec
```
#### Run
