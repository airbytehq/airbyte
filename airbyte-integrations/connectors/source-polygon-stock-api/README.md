...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-polygon-stock-api:dev`.
...
```Dockerfile
FROM airbyte/source-polygon-stock-api:latest
...
docker run airbyte/source-polygon-stock-api:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/polygon-stock-api.md`).
