...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-toggl:dev`.
...
```Dockerfile
FROM airbyte/source-toggl:latest
...
docker run airbyte/source-toggl:dev spec
```
#### Run
