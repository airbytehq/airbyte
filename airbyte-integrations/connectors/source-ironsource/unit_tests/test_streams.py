...
import pytest
from source_ironsource.source import IronsourceStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(IronsourceStream, "path", "v0/example_endpoint")
    mocker.patch.object(IronsourceStream, "primary_key", "test_primary_key")
    mocker.patch.object(IronsourceStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = IronsourceStream()
