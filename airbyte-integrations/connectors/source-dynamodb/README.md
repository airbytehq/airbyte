...
This is the repository for the Dynamodb source connector in Java. For information about how to use
this connector within Airbyte, see
[the User Documentation](https://docs.airbyte.io/integrations/sources/dynamodb).
...
Once built, the docker image name and tag on your host will be `airbyte/source-dynamodb:dev`. the
Dockerfile.
