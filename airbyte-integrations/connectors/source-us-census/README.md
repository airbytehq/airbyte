...
```
./gradlew :airbyte-integrations:connectors:source-us-census:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-us-census:buildDockerImage
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-us-census:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-us-census:integrationTest
```
