...
```sql
DROP DATABASE INTEGRATION_TEST_DESTINATION;
DROP USER INTEGRATION_TEST_USER_DESTINATION;
DROP ROLE INTEGRATION_TESTER_DESTINATION;
DROP WAREHOUSE INTEGRATION_TEST_WAREHOUSE_DESTINATION;
```