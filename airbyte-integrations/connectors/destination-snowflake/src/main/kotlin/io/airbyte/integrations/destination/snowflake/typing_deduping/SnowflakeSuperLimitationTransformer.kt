...
class SnowflakeSuperLimitationTransformer(
...
//        }
        ...
        if (
            ...
            // large record, the usage pattern for snowflake needs to be reevaluated
           log.warn {
...
//        }
    ...
    private fun constructMinimalJsonWithPks(
        ...
        if (rootNode!!.isObject) {
            ...
            log.error {
                "Encountered {" + rootNode.nodeType + "} as top level JSON field, this is not supported"
            }
...
//        const val SNOWFLAKE_SUPER_MAX_BYTE_SIZE: Int = 16 * 1024 * 1024
        ...
        val DEFAULT_PREDICATE_RECORD_SIZE_GT_THAN_16M: Predicate<Int> = Predicate { size: Int ->
            size > SNOWFLAKE_SUPER_MAX_BYTE_SIZE
        }
