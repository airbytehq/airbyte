...
open class SnowflakeSpecification : ConfigurationSpecification() {
    ...
    @get:JsonPropertyDescription(
        """Whether Snowflake should trim leading and trailing whitespace from unquoted CSV fields during data loading. Enabled by default for backwards compatibility. Disable this option if your data contains meaningful leading or trailing whitespace in string fields that should be preserved.""",
    )
