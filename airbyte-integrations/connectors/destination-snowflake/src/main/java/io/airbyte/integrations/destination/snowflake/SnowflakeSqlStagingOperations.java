...
public abstract class SnowflakeSqlStagingOperations extends SnowflakeSqlOperations
   ...
   */
  protected void attemptWriteToStage(
      final String outputSchema, final String stageName, final JdbcDatabase database)
      throws Exception {
