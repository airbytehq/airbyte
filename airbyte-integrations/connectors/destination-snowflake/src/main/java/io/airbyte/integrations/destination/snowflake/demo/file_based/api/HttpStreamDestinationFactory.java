...
public class HttpStreamDestinationFactory implements StreamDestinationFactory {
  @Override
  public void setup(JsonNode config) {

  }

  @Override
  public StreamDestination build(StreamConfig stream) {
