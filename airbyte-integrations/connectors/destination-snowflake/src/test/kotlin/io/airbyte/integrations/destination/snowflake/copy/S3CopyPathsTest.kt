...
class S3CopyPathsTest {
    ...
    fun `run paths include all five IDs epoch and escaped original stream`() {
        ...
        assertEquals(
            "fusion/organizations/${config.organizationId}/workspaces/${config.workspaceId}/sources/${config.sourceId}/connections/${config.connectionId}/destinations/${config.destinationId}/syncs/streams/Orders%2F%E6%97%A5%E6%9C%AC%20%25/runs/$epochSeconds/$zero/",
            path,
        )
