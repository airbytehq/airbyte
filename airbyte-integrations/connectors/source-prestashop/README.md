...
**If you are an Airbyte core member**, copy the credentials in Lastpass under the secret name `source prestashop test creds`
...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-prestashop:dev`.
...
```Dockerfile
FROM airbyte/source-prestashop:latest
...
docker run airbyte/source-prestashop:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/prestashop.md`).
