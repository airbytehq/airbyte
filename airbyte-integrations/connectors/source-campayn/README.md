# Campayn
This directory contains the manifest-only connector for `source-campayn`.
...
### Build
This will create a dev image (`source-campayn:dev`) that you can use to test the connector locally.
```bash
