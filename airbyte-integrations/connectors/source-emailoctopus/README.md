...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-emailoctopus:dev`.
...
```Dockerfile
FROM airbyte/source-emailoctopus:latest
...
docker run airbyte/source-emailoctopus:dev spec
```
#### Run
