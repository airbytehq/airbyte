 ...
 *
 * This class allows us to pass service account credentials programmatically to Iceberg without
 * relying on environment variables or file system paths.
 *
...
class GcsCredentialsProvider private constructor(private val delegate: GoogleCredentials) :
    ...
    companion object {
        /**
         * Factory method called by Iceberg's GoogleAuthManager via reflection. Properties are
         * passed from catalog configuration.
         */
        @JvmStatic
        fun create(properties: Map<String, String>): Credentials {
            val credentialsJson =
                properties[GCS_CREDENTIALS_JSON]
                    ?: throw IllegalArgumentException(
                        "Missing required property: $GCS_CREDENTIALS_JSON"
                    )
