...
import pytest
from source_egnyte.source import EgnyteStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(EgnyteStream, "path", "v0/example_endpoint")
    mocker.patch.object(EgnyteStream, "primary_key", "test_primary_key")
    mocker.patch.object(EgnyteStream, "__abstractmethods__", set())
