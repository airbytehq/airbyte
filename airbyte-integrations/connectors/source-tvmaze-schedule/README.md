...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-tvmaze-schedule:dev`.
...
```Dockerfile
FROM airbyte/source-tvmaze-schedule:latest
...
docker run airbyte/source-tvmaze-schedule:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/tvmaze-schedule.md`).
