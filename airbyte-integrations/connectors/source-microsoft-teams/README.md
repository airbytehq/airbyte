...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-microsoft-teams:dev`.
...
```Dockerfile
FROM airbyte/source-microsoft-teams:latest
...
docker run airbyte/source-microsoft-teams:dev spec
```
#### Run
