...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-square:dev`.
...
```Dockerfile
FROM airbyte/source-square:latest
...
docker run airbyte/source-square:dev spec
```
#### Run
