...
def patch_base_class(mocker):
    ...
    mocker.patch.object(HydrovuStream, "path", "v0/example_endpoint")
    mocker.patch.object(HydrovuStream, "primary_key", "test_primary_key")
    mocker.patch.object(HydrovuStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = HydrovuStream()
