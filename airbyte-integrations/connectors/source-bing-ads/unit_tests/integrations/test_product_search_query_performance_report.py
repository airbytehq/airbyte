...
class TestProductSearchPerformanceReportDailyStream(TestSuiteReportStream):
    ...
    first_read_state = {"product_search_query_performance_report_daily": {"180535609": {"TimePeriod": "2023-12-17"}}}
    second_read_state = {"product_search_query_performance_report_daily": {"180535609": {"TimePeriod": "2023-12-24"}}}
...
class TestProductSearchQueryPerformanceReportHourlyStream(TestSuiteReportStream):
    ...
    first_read_state = {"product_search_query_performance_report_hourly": {"180535609": {"TimePeriod": "2023-11-12T00:00:00+00:00"}}}
    second_read_state = {"product_search_query_performance_report_hourly": {"180535609": {"TimePeriod": "2023-11-13T00:00:00+00:00"}}}
...
class TestProductSearchQueryPerformanceReportWeeklyStream(TestSuiteReportStream):
    ...
    first_read_state = {"product_search_query_performance_report_weekly": {"180535609": {"TimePeriod": "2023-12-25"}}}
    second_read_state = {"product_search_query_performance_report_weekly": {"180535609": {"TimePeriod": "2024-01-29"}}}
...
class TestProductSearchQueryPerformanceReportMonthlyStream(TestSuiteReportStream):
    ...
    first_read_state = {"product_search_query_performance_report_monthly": {"180535609": {"TimePeriod": "2023-09-01"}}}
    second_read_state = {"product_search_query_performance_report_monthly": {"180535609": {"TimePeriod": "2024-03-01"}}}
