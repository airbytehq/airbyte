...
import pytest
from source_hi_platform.source import HiPlatformStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(HiPlatformStream, "path", "v0/example_endpoint")
    mocker.patch.object(HiPlatformStream, "primary_key", "test_primary_key")
    mocker.patch.object(HiPlatformStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = HiPlatformStream()
