...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-smartengage:dev`.
...
```Dockerfile
FROM airbyte/source-smartengage:latest
...
docker run airbyte/source-smartengage:dev spec
```
#### Run
