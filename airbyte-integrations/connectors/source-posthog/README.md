...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-posthog:dev`.
...
```Dockerfile
FROM airbyte/source-posthog:latest
...
docker run airbyte/source-posthog:dev spec
```
#### Run
