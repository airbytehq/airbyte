...
```
./gradlew :airbyte-integrations:connectors:source-posthog:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-posthog:buildDockerImage
```
...
To run unittest run:
```
./gradlew :airbyte-integrations:connectors:source-posthog:unitTest
```
To run acceptance and custom integration tests run:
```
./gradlew :airbyte-integrations:connectors:source-posthog:IntegrationTest
```
