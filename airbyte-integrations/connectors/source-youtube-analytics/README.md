...
This is the repository for the Youtube Analytics configuration based source connector.
...
to generate the necessary credentials. Then create a file `secrets/config.json` conforming to the `src/source_youtube_analytics/spec.yaml` file.
