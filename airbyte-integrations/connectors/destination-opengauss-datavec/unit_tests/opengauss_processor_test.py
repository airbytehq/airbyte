...
class TestOpenGaussDataVecProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.schema_exists_patcher = patch(
            "destination_opengauss_datavec.common.sql.sql_processor.SqlProcessorBase._ensure_schema_exists"
        )
    ...
    @patch("destination_opengauss_datavec.opengauss_processor.embedder")
    @patch("destination_opengauss_datavec.opengauss_processor.DocumentSplitter")
    def test_emulated_merge_temp_table_to_final_table(
        self, mock_splitter, mock_embedder, mock_delete, mock_select, mock_insert
    ):
        ...
        with (
            patch.object(processor, "_get_table_by_name") as mock_get_table,
