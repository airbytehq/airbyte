...
import pytest
from source_ebay.source import EbayStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(EbayStream, "path", "v0/example_endpoint")
    mocker.patch.object(EbayStream, "primary_key", "test_primary_key")
    mocker.patch.object(EbayStream, "__abstractmethods__", set())
