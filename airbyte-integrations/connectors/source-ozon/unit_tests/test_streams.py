...
import pytest
from source_ozon.source import OzonStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(OzonStream, "path", "v0/example_endpoint")
    mocker.patch.object(OzonStream, "primary_key", "test_primary_key")
    mocker.patch.object(OzonStream, "__abstractmethods__", set())
