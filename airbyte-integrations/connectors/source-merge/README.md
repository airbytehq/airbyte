...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-merge:dev`.
...
```Dockerfile
FROM airbyte/source-merge:latest
...
docker run airbyte/source-merge:dev spec
```
#### Run
