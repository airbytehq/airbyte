...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-yahoo-finance-price:dev`.
...
```Dockerfile
FROM airbyte/source-yahoo-finance-price:latest
...
docker run airbyte/source-yahoo-finance-price:dev spec
```
#### Run
