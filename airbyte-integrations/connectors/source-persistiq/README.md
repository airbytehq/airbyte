...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-persistiq:dev`.
...
```Dockerfile
FROM airbyte/source-persistiq:latest
...
docker run airbyte/source-persistiq:dev spec
```
#### Run
