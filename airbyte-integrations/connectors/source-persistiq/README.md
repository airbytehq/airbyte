...
This is the repository for the Persistiq configuration based source connector. For information about
how to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.com/integrations/sources/persistiq).
...
[documentation](https://docs.airbyte.com/integrations/sources/persistiq) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_persistiq/spec.yaml`
...
`source persistiq test creds` and place them into `secrets/config.json`.
