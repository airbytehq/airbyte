...
import pytest
from source_glific.source import GlificStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GlificStream, "path", "v0/example_endpoint")
    mocker.patch.object(GlificStream, "primary_key", "test_primary_key")
    mocker.patch.object(GlificStream, "__abstractmethods__", set())
