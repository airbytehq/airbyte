...
import pytest
from source_discord.source import DiscordStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(DiscordStream, "path", "v0/example_endpoint")
    mocker.patch.object(DiscordStream, "primary_key", "test_primary_key")
    mocker.patch.object(DiscordStream, "__abstractmethods__", set())
