...
import pytest
from source_yandex_disk.source import YandexDiskStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(YandexDiskStream, "path", "v0/example_endpoint")
    mocker.patch.object(YandexDiskStream, "primary_key", "test_primary_key")
    mocker.patch.object(YandexDiskStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = YandexDiskStream()
