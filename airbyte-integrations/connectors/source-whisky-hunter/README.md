...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-whisky-hunter:dev`.
...
```Dockerfile
FROM airbyte/source-whisky-hunter:latest
...
docker run airbyte/source-whisky-hunter:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/whisky-hunter.md`).
