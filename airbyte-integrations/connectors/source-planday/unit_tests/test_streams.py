...
import pytest
from source_planday.source import PlandayStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(PlandayStream, "path", "v0/example_endpoint")
    mocker.patch.object(PlandayStream, "primary_key", "test_primary_key")
    mocker.patch.object(PlandayStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = PlandayStream()
