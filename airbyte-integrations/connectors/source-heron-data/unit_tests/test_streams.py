...
import pytest
from source_heron_data.source import HeronDataStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(HeronDataStream, "path", "v0/example_endpoint")
    mocker.patch.object(HeronDataStream, "primary_key", "test_primary_key")
    mocker.patch.object(HeronDataStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = HeronDataStream()
