...
class MongoDbResumeTokenHelperTest {
  ...
  @Test
  void testRetrievingResumeTokenWithUnauthorizedError() {
    final BsonDocument unauthorizedResponse = new BsonDocument("code", new BsonInt32(MongoConstants.UNAUTHORIZED_ERROR_CODE));
    ...
    assertEquals(MongoConstants.CDC_UNAUTHORIZED_ERROR_MESSAGE, exception.getDisplayMessage());
    assertEquals(unauthorizedException.toString(), exception.getInternalMessage());
  }
