...
class MongoDbSourceTest {
  ...
  void testCheckOperation() throws IOException {
    ...
    mockChangeStreamCursor(mongoDatabase);
  ...
  void testCheckOperationChangeStreamUnauthorized() throws IOException {
    ...
    final BsonDocument errorResponse = new BsonDocument()
        ...
        .append("errmsg", new org.bson.BsonString("not authorized on " + DB_NAME));
  ...
  private static void mockChangeStreamCursor(final MongoDatabase mongoDatabase) {
    final ChangeStreamIterable<BsonDocument> changeStreamIterable = mock(ChangeStreamIterable.class);
