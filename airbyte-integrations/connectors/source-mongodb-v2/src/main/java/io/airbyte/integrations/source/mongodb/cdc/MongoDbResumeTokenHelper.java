...
public class MongoDbResumeTokenHelper {
  ...
  private static final String CHANGE_STREAM_PRIVILEGE_ERROR_MESSAGE =
    ...
    try {
      ...
      if (e.getErrorCode() == MONGODB_UNAUTHORIZED_ERROR_CODE) {
        throw new ConfigErrorException(
            CHANGE_STREAM_PRIVILEGE_ERROR_MESSAGE,
            e,
            "MongoDB command failed during CDC change stream resume token initialization: " + e.getMessage());
      }
      throw e;
    }
  }
