...
public class MongoDbSource extends BaseConnector implements Source {
  ...
  private AutoCloseableIterator<AirbyteMessage> wrapIteratorWithCdcErrorHandling(final AutoCloseableIterator<AirbyteMessage> iterator) {
  ...
  private static RuntimeException handlePotentialCdcError(final Exception e) {
