  ...
  public List<AutoCloseableIterator<AirbyteMessage>> createCdcIterators(
    ...
    try {
      ...
      if (MongoUtil.isMongoUnauthorizedException(e)) {
        LOGGER.error("MongoDB user is not authorized to open a change stream on database(s) {}.", databaseNames);
        throw new ConfigErrorException(
            String.format(MongoConstants.UNAUTHORIZED_CDC_ERROR_MESSAGE_TEMPLATE, databaseNames),
            e);
      }
      throw e;
    }
