  ...
  public List<AutoCloseableIterator<AirbyteMessage>> createCdcIterators(
    ...
    try {
      ...
      if (MongoUtil.isMongoCommandUnauthorizedException(e)) {
        final String databaseLabel = databaseNames.size() == 1 ? databaseNames.getFirst() : String.join(", ", databaseNames);
        throw new ConfigErrorException(
            String.format(MongoConstants.CHANGE_STREAM_UNAUTHORIZED_ERROR_MESSAGE_TEMPLATE, databaseLabel),
            e);
      }
      throw e;
    }
