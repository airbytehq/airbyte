...
public class MongoConstants {
  ...
  public static final String CHANGE_STREAM_UNAUTHORIZED_ERROR_MESSAGE =
      "MongoDB user lacks changeStream privilege for the configured database.";
  public static final String CHANGE_STREAM_UNAUTHORIZED_INTERNAL_MESSAGE =
      "MongoDB returned Unauthorized error code 13 while opening a CDC change stream.";
