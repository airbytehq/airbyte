...
public class MongoConstants {
  ...
  public static final String CDC_CHANGE_STREAM_UNAUTHORIZED_ERROR_MESSAGE =
      "MongoDB user lacks the required change stream privileges for CDC. Grant read and changeStream privileges on the selected databases or readAnyDatabase for cluster-wide CDC.";
  public static final String CDC_CHANGE_STREAM_UNAUTHORIZED_INTERNAL_MESSAGE =
      "MongoDB returned unauthorized error code 13 while opening the CDC change stream.";
