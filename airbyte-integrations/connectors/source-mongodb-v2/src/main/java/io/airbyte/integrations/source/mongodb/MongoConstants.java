...
public class MongoConstants {
  ...
  public static final String CHANGE_STREAM_UNAUTHORIZED_ERROR_MESSAGE =
      "Insufficient MongoDB privileges to read change events. " +
          "Grant the changeStream and find privileges on the database (or each selected collection) to the configured user.";
