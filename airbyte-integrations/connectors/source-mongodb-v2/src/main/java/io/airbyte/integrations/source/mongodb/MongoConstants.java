...
public class MongoConstants {
  ...
  public static final String MONGODB_CHANGE_STREAM_PERMISSION_ERROR_MESSAGE =
      "MongoDB credentials lack required change stream permissions. Grant readAnyDatabase access or equivalent find and changeStream privileges.";
