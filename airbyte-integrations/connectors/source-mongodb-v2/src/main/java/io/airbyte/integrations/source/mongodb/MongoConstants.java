...
public class MongoConstants {
  ...
  public static final String MONGODB_CHANGE_STREAM_UNAUTHORIZED_ERROR_MESSAGE =
      "MongoDB source user is not authorized to open change streams for selected incremental streams.";
  public static final String MONGODB_CHANGE_STREAM_UNAUTHORIZED_INTERNAL_MESSAGE =
      "MongoDB returned error code 13 while opening a change stream for CDC.";
