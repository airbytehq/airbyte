...
public class MongoConstants {
  ...
  public static final String CHANGE_STREAM_PERMISSION_ERROR_MESSAGE =
      "MongoDB user lacks permissions to open change streams. Grant readAnyDatabase or equivalent change stream access to the MongoDB user.";
  public static final String CHANGE_STREAM_PERMISSION_INTERNAL_MESSAGE = "MongoCommandException code 13 while opening MongoDB change streams.";
