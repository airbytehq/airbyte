...
public class MongoConstants {
  ...
  public static final String MONGODB_CHANGE_STREAM_PRIVILEGES_ERROR_MESSAGE =
      "MongoDB user lacks change stream privileges. Grant change stream privileges to the configured MongoDB user.";
