...
public class MongoConstants {
  ...
  public static final String UNAUTHORIZED_CDC_ERROR_MESSAGE_TEMPLATE =
      "MongoDB user is not authorized to open a change stream on database(s) %s. "
          + "Grant the user a role with the \"find\" and \"changeStream\" actions on this database "
