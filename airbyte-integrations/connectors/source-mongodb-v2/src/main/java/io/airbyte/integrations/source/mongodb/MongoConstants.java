...
public class MongoConstants {
  ...
  public static final int CHANGE_STREAM_FATAL_ERROR_CODE = 280;
  public static final String CHANGE_STREAM_FATAL_ERROR_MESSAGE =
      "CDC resume token is no longer valid. The oplog entry referenced by the saved resume token has been rotated out. "
          + "Reset the connection and increase the MongoDB oplog size or sync frequency to prevent this from happening in the future. "
          + "See https://docs.airbyte.com/integrations/sources/mongodb-v2/mongodb-v2-troubleshooting#mongodb-oplog-and-change-streams for more details.";
