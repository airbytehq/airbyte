...
public class MongoConstants {
  ...
  public static final String CDC_CHANGE_STREAM_UNAUTHORIZED_ERROR_MESSAGE =
      "MongoDB credentials lack the required permissions for CDC change streams. "
          + "Grant readAnyDatabase or equivalent changeStream and find privileges for the configured databases.";
