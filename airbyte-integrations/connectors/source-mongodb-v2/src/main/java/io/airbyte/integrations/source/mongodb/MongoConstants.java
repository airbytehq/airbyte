...
public class MongoConstants {
  ...
  public static final String UNAUTHORIZED_CDC_ERROR_MESSAGE =
      "MongoDB credentials lack the required changeStream permission for CDC. Grant changeStream and find privileges to the configured MongoDB user.";
