...
public class MongoConstants {
  ...
  public static final String MONGODB_CHANGE_STREAM_AUTHORIZATION_ERROR_MESSAGE =
      "MongoDB user lacks the change stream privilege for the configured database. Grant the required MongoDB read permissions.";
