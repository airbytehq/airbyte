...
public class MongoConstants {
  ...
  public static final String MONGODB_CHANGESTREAM_UNAUTHORIZED_ERROR_MESSAGE =
      "MongoDB user lacks required 'changeStream' privilege on the configured database. "
          + "Grant the 'changeStream' and 'find' privileges to the database user configured in the connection settings.";
