...
public class MongoConstants {
  ...
  public static final String CDC_CHANGE_STREAM_PERMISSION_ERROR_MESSAGE =
      "MongoDB user lacks readAnyDatabase privilege required for CDC change streams. Grant readAnyDatabase to the configured MongoDB user.";
