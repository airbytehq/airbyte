    ...
    final BsonDocument bsonDocument = new BsonDocument()
        ...
        .append(
            ...
            new BsonJavaScriptWithScope(
                "function (x){ return ++x; }",
                new BsonDocument()
                    .append("x1", new BsonInt32(256))
                    .append("x2", new BsonInt32(142))))
        .append(
            "document",
            new BsonDocument("test", new BsonString("let's test!"))
                .append("number", new BsonInt32(1352)))
        .append(
            "arrayWithDocs",
            new BsonArray(Arrays.asList(
                new BsonDocument()
                    .append("title", new BsonString("One Hundred Years of Solitude"))
                    .append("yearPublished", new BsonInt32(1967)),
                new BsonDocument()
                    .append("title", new BsonString("Chronicle of a Death Foretold"))
                    .append("yearPublished", new BsonInt32(1981)),
                new BsonDocument()
                    .append("title", new BsonString("Love in the Time of Cholera"))
                    .append("yearPublished", new BsonInt32(1985)))))
        .append(
            "arrayWithStrings",
            new BsonArray(
                List.of(new BsonString("test"), new BsonString("mongo"), new BsonString("types"))));
    database
        .getDatabase()
        .getCollection("acceptance_test", BsonDocument.class)
        ...
        .withStreams(Lists.newArrayList(new ConfiguredAirbyteStream()
            ...
            .withStream(CatalogHelpers.createAirbyteStream(
                ...
                .withSupportedSyncModes(
                    Lists.newArrayList(SyncMode.INCREMENTAL, SyncMode.FULL_REFRESH))
                .withSourceDefinedPrimaryKey(List.of(List.of("_id"))))));
  }

  private List<AirbyteMessage> getExpectedMessages() {
    return Lists.newArrayList(new AirbyteMessage()
            ...
            .withData(Jsons.jsonNode(ImmutableMap.builder()
                ...
                .put(
                    ...
                    Jsons.jsonNode(ImmutableMap.of(
                        ...
                        "function (x){ return ++x; }",
                        "scope",
                        Jsons.jsonNode(ImmutableMap.of("x1", 256, "x2", 142)))))
                .put(
                    "document",
                    Jsons.jsonNode(ImmutableMap.of("test", "let's test!", "number", 1352)))
                .put(
                    "arrayWithDocs",
                    Jsons.jsonNode(Lists.newArrayList(
                        Jsons.jsonNode(ImmutableMap.of(
                ...
                .put(
                    "arrayWithStrings",
                    Jsons.jsonNode(Lists.newArrayList("test", "mongo", "types")))
                .build()))));
  }
