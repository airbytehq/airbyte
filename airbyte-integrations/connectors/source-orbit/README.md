...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-orbit:dev`.
...
```Dockerfile
FROM airbyte/source-orbit:latest
...
docker run airbyte/source-orbit:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/orbit.md`).
