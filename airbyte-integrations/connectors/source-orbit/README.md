...
This is the repository for the Orbit configuration based source connector. For information about how
to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.com/integrations/sources/orbit).
...
[documentation](https://docs.airbyte.com/integrations/sources/orbit) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_orbit/spec.yaml`
...
`source orbit test creds` and place them into `secrets/config.json`.
