...
import pytest
from source_infinicept.source import InfiniceptStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(InfiniceptStream, "path", "v0/example_endpoint")
    mocker.patch.object(InfiniceptStream, "primary_key", "test_primary_key")
    mocker.patch.object(InfiniceptStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = InfiniceptStream()
