...
public class SelectdbDestinationAcceptanceTest extends DestinationAcceptanceTest {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(SelectdbDestinationAcceptanceTest.class);
  ...
  private static final String DB_URL_PATTERN =
      "jdbc:mysql://%s?rewriteBatchedStatements=true&useSSL=true&useUnicode=true&characterEncoding=utf8";
  ...
  protected String getImageName() {
    return "airbyte/destination-selectdb:dev";
  }
