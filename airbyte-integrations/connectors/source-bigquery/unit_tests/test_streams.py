...
def patch_base_class(mocker):
    ...
    mocker.patch.object(BigqueryStream, "path", "v0/example_endpoint")
    mocker.patch.object(BigqueryStream, "primary_key", "test_primary_key")
    mocker.patch.object(BigqueryStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = BigqueryStream()
