...
// private static final String CREATE_SQL_PATTERN = "CREATE TABLE %1$s(%2$s NUMERIC(29), %3$s
/// %4$s)";
//
...
// .build());
//
// database = new TempBigQueryJoolDatabaseImpl(config.get(CONFIG_PROJECT_ID).asText(),
...
// .airbyteType(JsonSchemaType.NUMBER)
// .createTablePatternSql(CREATE_SQL_PATTERN)
// .addInsertValues("null", "-128", "127", "999999999999999999", "-999999999999999999",
/// "0.123456789", "-0.123456789")
// .addExpectedValues(null, "-128", "127", "999999999999999999", "-999999999999999999",
/// "0.123456789", "-0.123456789")
// .build());
//
// addDataTypeTestData(
...
// .airbyteType(JsonSchemaType.STRING)
// .createTablePatternSql(CREATE_SQL_PATTERN)
// .addInsertValues("datetime('2021-10-20 11:22:33')", "datetime('9999-12-31 11:22:33')",
/// "datetime('0001-01-01 11:22:33')", "null")
...
// TestDataHolder.builder()
// .sourceType("struct")
// .fullSourceDataType("STRUCT<frst String, sec int64, obbj STRUCT<id_col int64, mega_obbj
/// STRUCT<last_col time>>>")
// .airbyteType(JsonSchemaType.STRING)
// .createTablePatternSql(CREATE_SQL_PATTERN)
// .addInsertValues("STRUCT('s' as frst, 1 as sec, STRUCT(555 as id_col, STRUCT(TIME(15, 30, 00) as
/// time) as mega_obbj) as obbj)")
...
// .airbyteType(JsonSchemaType.STRING)
// .createTablePatternSql(CREATE_SQL_PATTERN)
// .addInsertValues("[STRUCT('qqq' as fff, [STRUCT('fff' as ooo, 1 as kkk), STRUCT('hhh' as ooo, 2
/// as kkk)] as ggg)]")
