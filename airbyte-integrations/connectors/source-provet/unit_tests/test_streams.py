...
import pytest
from source_provet.source import ProvetStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ProvetStream, "path", "v0/example_endpoint")
    mocker.patch.object(ProvetStream, "primary_key", "test_primary_key")
    mocker.patch.object(ProvetStream, "__abstractmethods__", set())
