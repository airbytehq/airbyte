...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-trello:dev`.
...
```Dockerfile
FROM airbyte/source-trello:latest
...
docker run airbyte/source-trello:dev spec
```
#### Run
