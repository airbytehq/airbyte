...
This is the repository for the Databricks source connector in Java.
For information about how to use this connector within Airbyte, see [the User Documentation](https://docs.airbyte.com/integrations/sources/databricks).
...
```
./gradlew :airbyte-integrations:connectors:source-databricks:airbyteDocker
```
...
`src/test-integration/java/io/airbyte/integrations/sources/databricksSourceAcceptanceTest.java`.

### Using gradle to run tests
All commands should be run from airbyte project root.
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-databricks:unitTest
```
