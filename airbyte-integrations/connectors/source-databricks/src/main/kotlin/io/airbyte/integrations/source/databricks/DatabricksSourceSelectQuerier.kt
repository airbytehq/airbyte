...
@Singleton
@Primary
class DatabricksSourceSelectQuerier(
    private val jdbcConnectionFactory: DatabricksSourceConnectionFactory,
) : SelectQuerier {
    ...
    class Result(
        val jdbcConnectionFactory: DatabricksSourceConnectionFactory,
        val q: SelectQuery,
        ...
        fun initQueryExecution() {
            ...
            for (binding in q.bindings) {
                log.info { "Setting parameter #$paramIdx to ${binding.value}." }
