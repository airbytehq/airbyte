...
import pytest
from source_datadog_rum.source import DatadogRumStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(DatadogRumStream, "path", "v0/example_endpoint")
    mocker.patch.object(DatadogRumStream, "primary_key", "test_primary_key")
    mocker.patch.object(DatadogRumStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = DatadogRumStream()
