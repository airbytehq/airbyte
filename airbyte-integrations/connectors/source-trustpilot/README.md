...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-trustpilot:dev`.
...
```Dockerfile
FROM airbyte/source-trustpilot:latest
...
docker run airbyte/source-trustpilot:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/trustpilot.md`).
