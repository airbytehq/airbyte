...
@Singleton
@Primary
class SalesforceSpecificationExtender(private val decorated: DestinationSpecificationExtender) :
                ...
                .withOauthConfigSpecification(
                    OAuthConfigSpecification()
                        .withOauthUserInputFromConnectorConfigSpecification(
                            Jsons.readTree(oauthUserInputFromConnectorConfigSpecification)
                        )
