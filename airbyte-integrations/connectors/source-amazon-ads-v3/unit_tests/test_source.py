...
def test_source_streams(config):
    ...
    expected_stream_names = set(
        [
            "profiles",
            'airbyte_camp_placement_sp', 
            'airbyte_search_term_last_month_sp', 
            'airbyte_purchased_product_sp', 
            'airbyte_advertised_product_last_month_sp', 
            'airbyte_camp_adgroups_sp', 
            'airbyte_camp_adgroups_last_month_sp', 
            'airbyte_camp_placement_last_month_sp', 
            'airbyte_camp_sp', 
            'airbyte_search_term_sp', 
            'airbyte_camp_last_month_sp', 
            'airbyte_purchased_product_last_month_sp', 
            'airbyte_targeting_last_month_sp', 
            'airbyte_targeting_sp', 
            'airbyte_advertised_product_sp'
        ]
    )
