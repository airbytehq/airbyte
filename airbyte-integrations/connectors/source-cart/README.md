...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-cart:dev`.
...
```Dockerfile
FROM airbyte/source-cart:latest
...
docker run airbyte/source-cart:dev spec
```
#### Run
