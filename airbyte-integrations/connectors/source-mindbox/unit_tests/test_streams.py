...
import pytest
from source_mindbox.source import MindboxStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MindboxStream, "path", "v0/example_endpoint")
    mocker.patch.object(MindboxStream, "primary_key", "test_primary_key")
    mocker.patch.object(MindboxStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = MindboxStream()
