...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-dockerhub:dev`.
...
```Dockerfile
FROM airbyte/source-dockerhub:latest
...
docker run airbyte/source-dockerhub:dev spec
```
#### Run
