...
This is the repository for the Workable source connector, written in Python.
...
poetry run source-workable read --config secrets/config.json --catalog sample_files/configured_catalog.json
```
