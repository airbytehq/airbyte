...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-workable:dev`.
...
```Dockerfile
FROM airbyte/source-workable:latest
...
docker run airbyte/source-workable:dev spec
```
#### Run
