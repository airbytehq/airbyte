# Apptivo
This directory contains the manifest-only connector for `source-apptivo`.
...
### Build
This will create a dev image (`source-apptivo:dev`) that you can use to test the connector locally.
```bash
