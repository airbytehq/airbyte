...
Place unit tests under `src/test/io/airbyte/integrations/destinations/singlestore`.

#### Acceptance Tests
Airbyte has a standard test suite that all destination connectors must pass. Implement the `TODO`s in
`src/test-integration/java/io/airbyte/integrations/destinations/SingleStoreDestinationAcceptanceTest.java`.
