...
def _get_source(args: List[str]):
    ...
    try:
        return SourceAirtable(
            SourceAirtable.read_catalog(catalog_path) if catalog_path else None,
            SourceAirtable.read_config(config_path) if config_path else None,
            SourceAirtable.read_state(state_path) if state_path else None,
        )
