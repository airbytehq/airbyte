...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-coinmarketcap:dev`.
...
```Dockerfile
FROM airbyte/source-coinmarketcap:latest
...
docker run airbyte/source-coinmarketcap:dev spec
```
#### Run
