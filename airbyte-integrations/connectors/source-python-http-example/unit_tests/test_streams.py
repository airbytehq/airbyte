...
import pytest
from source_python_http_example.source import ExchangeRates


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ExchangeRates, "path", "v0/example_endpoint")
    mocker.patch.object(ExchangeRates, "primary_key", "test_primary_key")
    mocker.patch.object(ExchangeRates, "__abstractmethods__", set())
