...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/destination-google-sheets:dev`.
...
```Dockerfile
FROM airbyte/destination-google-sheets:latest
...
docker run airbyte/destination-google-sheets:dev spec
```
#### Run
