...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/destination-qdrant:dev`.
...
```Dockerfile
FROM airbyte/destination-qdrant:latest
...
docker run airbyte/destination-qdrant:dev spec
```
#### Run
