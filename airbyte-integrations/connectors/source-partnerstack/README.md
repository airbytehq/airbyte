...
```
./gradlew :airbyte-integrations:connectors:source-partnerstack:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-partnerstack:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-partnerstack:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-partnerstack:integrationTest
```
