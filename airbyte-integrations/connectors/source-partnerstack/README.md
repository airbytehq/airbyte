...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-partnerstack:dev`.
...
```Dockerfile
FROM airbyte/source-partnerstack:latest
...
docker run airbyte/source-partnerstack:dev spec
```
#### Run
