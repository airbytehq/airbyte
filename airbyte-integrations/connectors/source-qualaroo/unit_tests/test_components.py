...
def test_extract_records_with_answered_questions():
        ...
        assert (extracted_records[0]["id"], 1)
        assert (extracted_records[0]["answered_questions"], ["A1", "A2"])
        assert (extracted_records[1]["id"], 2)
        assert (extracted_records[1]["answered_questions"], ["A3"])
