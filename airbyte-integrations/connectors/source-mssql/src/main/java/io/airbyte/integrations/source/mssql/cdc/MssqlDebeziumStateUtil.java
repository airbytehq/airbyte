...
public class MssqlDebeziumStateUtil implements DebeziumStateUtil {
  ...
  public static synchronized JsonNode constructInitialDebeziumState(final Properties properties,
    ...
    if (initialState.get() == null) {
      ...
      final var debeziumPropertiesManager = new RelationalDbDebeziumPropertiesManager(properties, database.getSourceConfig(), catalog, Collections.emptyList());
      try {
  ...
  public Optional<MssqlDebeziumStateAttributes> savedOffset(final Properties baseProperties,
    ...
    final DebeziumPropertiesManager debeziumPropertiesManager = new RelationalDbDebeziumPropertiesManager(baseProperties, config, catalog, Collections.emptyList());
