  ...
  protected void initTests() {
    ...
    addDataTypeTestData(TestDataHolder.builder()
        ...
        .addInsertValues(
            ...
            "'9999-12-31'",
            "'9999-12-31T13:00:04'",
            "'9999-12-31T13:00:04.123'",
            "null")
        .addExpectedValues(
            "1753-01-01T00:00:00.000000",
            "9999-12-31T00:00:00.000000",
            "9999-12-31T13:00:04",
            "9999-12-31T13:00:04.123",
            null)
        .createTablePatternSql(CREATE_TABLE_SQL)
    ...
    // sql_variant is not supported by debezium, always getting null. So only works for regular
    // sync.
    ...
    // if we have hierarchyid. But this option is not available as we use a third-party tool
    // "Debezium"
    // as a CDC client.
    if (this instanceof MssqlSourceDatatypeTest) {
      ...
      // select test_column ,test_column.ToString() AS [Node Text],test_column.GetLevel() [Node
      // Level]
