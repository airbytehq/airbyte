  ...
  protected void initTests() {
    ...
    addDataTypeTestData(
        TestDataHolder.builder()
            ...
            .addExpectedValues(
                null,
                String.valueOf(Math.pow(10, 38) * -3.4),
    ...
    addDataTypeTestData(
        TestDataHolder.builder()
            ...
            .addExpectedValues(
                null,
                String.valueOf(Math.pow(10, 308) * -1.79),
    ...
    addDataTypeTestData(
        TestDataHolder.builder()
            ...
            .addInsertValues(
                "'a'",
                "'abc'",
                "N'Миші ççуть на південь, не питай чому;'",
                "N'櫻花分店'",
                "''",
                "null",
                "N'\\xF0\\x9F\\x9A\\x80'")
            .addExpectedValues(
                "a",
                "abc",
                "Миші ççуть на південь, не питай чому;",
                "櫻花分店",
                "",
                null,
                "\\xF0\\x9F\\x9A\\x80")
    ...
    addDataTypeTestData(
        TestDataHolder.builder()
            ...
            // TODO: Debezium is returning DATE/DATETIME from mssql as integers (days or
            // milli/micro/nanoseconds
            // since the epoch)
            // still useable but requires transformation if true date/datetime type required in
            // destination
    ...
    addDataTypeTestData(
        TestDataHolder.builder()
            ...
            // TODO: BUG - seem to be getting back 0001-01-08T00:00:00+01:00 ... this is clearly
            // wrong
    ...
    addDataTypeTestData(
        TestDataHolder.builder()
            ...
            .addInsertValues(
                ...
                "null",
                "N'\\xF0\\x9F\\x9A\\x80'")
            // TODO: BUG - These all come through as nulls, Debezium doesn't mention sql_variant at
            // all so
            // assume unsupported
