...
abstract class AbstractMssqlSourceDatatypeTest : AbstractSourceDatabaseTypeTest() {
    @JvmField
    ...
    override fun initTests() {
        ...
        addDataTypeTestData(
            TestDataHolder.builder()
                ...
                .airbyteType(JsonSchemaType.STRING_TIMESTAMP_WITHOUT_TIMEZONE)
                .addInsertValues(
                    "'1753-01-01'", "'9999-12-31'", "'9999-12-31T13:00:04'",
                    "'9999-12-31T13:00:04.123'", "null"
                )
                .addExpectedValues(
                    "1753-01-01T00:00:00.000000", "9999-12-31T00:00:00.000000", "9999-12-31T13:00:04.000000",
        ...
        addDataTypeTestData(
            TestDataHolder.builder()
                ...
                .addExpectedValues(
                    "0001-01-01T00:00:00.000000", "9999-12-31T00:00:00.000000", "9999-12-31T13:00:04.123456", null,
        ...
        addDataTypeTestData(
            TestDataHolder.builder()
                ...
                .addInsertValues("null", "'13:00:01'", "'13:00:04'", "'13:00:04.123456'")
        ...
        addDataTypeTestData(
            TestDataHolder.builder()
                ...
                .addInsertValues(
                    "'2001-01-10 00:00:00 +01:00'", "'9999-01-10 00:00:00 +01:00'", "null", "'2024-05-10 19:00:01.604805 +03:00'",
                    "'2024-03-02 19:08:07.1234567 +09:00'", "'2024-03-02 19:08:07.12345678 +09:00'"
                )
                .addExpectedValues(
                    "2001-01-10T00:00:00.000000+01:00",
        ...
        addDataTypeTestData(
            TestDataHolder.builder()
                ...
                .airbyteType(JsonSchemaType.STRING)
                .addInsertValues(
                    "'a'", "'abc'", "N'Миші йдуть на південь, не питай чому;'", "N'櫻花分店'",
    ...
    companion object {
        protected const val CREATE_TABLE_SQL: String = "CREATE TABLE %1\$s(%2\$s INTEGER PRIMARY KEY, %3\$s %4\$s)"
    }
}
