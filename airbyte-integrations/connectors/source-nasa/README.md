...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-nasa:dev`.
...
```Dockerfile
FROM airbyte/source-nasa:latest
...
docker run airbyte/source-nasa:dev spec
```
#### Run
