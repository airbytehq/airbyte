...
This is the repository for the Zoom configuration based source connector. For information about how
to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.io/integrations/sources/zoom).
...
[documentation](https://docs.airbyte.io/integrations/sources/zoom) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the
`source_survey_sparrow/spec.yaml` file. Note that any directory named `secrets` is gitignored across
...
`source zoom test creds` and place them into `secrets/config.json`.
