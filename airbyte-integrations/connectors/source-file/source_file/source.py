...
class SourceFile(Source):
    ...
    def discover(self, logger: Logger, config: Mapping) -> AirbyteCatalog:
        """
    ...
    def read(
        self, logger: Logger, config: Mapping, catalog: ConfiguredAirbyteCatalog, state_path: Mapping[str, any]
