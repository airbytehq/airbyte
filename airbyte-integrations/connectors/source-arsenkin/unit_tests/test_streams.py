...
import pytest
from source_arsenkin.source import ArsenkinStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ArsenkinStream, "path", "v0/example_endpoint")
    mocker.patch.object(ArsenkinStream, "primary_key", "test_primary_key")
    mocker.patch.object(ArsenkinStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ArsenkinStream()
