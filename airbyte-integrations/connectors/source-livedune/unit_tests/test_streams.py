...
import pytest
from source_livedune.source import LiveduneStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(LiveduneStream, "path", "v0/example_endpoint")
    mocker.patch.object(LiveduneStream, "primary_key", "test_primary_key")
    mocker.patch.object(LiveduneStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = LiveduneStream()
