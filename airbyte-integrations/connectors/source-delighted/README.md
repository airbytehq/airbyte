...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-delighted:dev`.
...
```Dockerfile
FROM airbyte/source-delighted:latest
...
docker run airbyte/source-delighted:dev spec
```
#### Run
