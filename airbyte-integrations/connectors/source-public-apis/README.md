...
```
./gradlew :airbyte-integrations:connectors:source-public-apis:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-public-apis:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-public-apis:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-public-apis:integrationTest
```
