...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-public-apis:dev`.
...
```Dockerfile
FROM airbyte/source-public-apis:latest
...
docker run airbyte/source-public-apis:dev spec
```
#### Run
