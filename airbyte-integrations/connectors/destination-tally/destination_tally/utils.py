...
def prepare_ledger_master_payload(data: Dict[str, Any], logger: AirbyteLogger):
    ...
    ledger_fields = ["Ledger Name","Alias1","Alias2","Alias3","Alias4","Group Name",
                     "Credit Period","Address Line 1","Address Line 2","Address Line 3",
                     "Address Line 4","Country","State","Pincode","Contact Person","Phone No",
                     "Mobile No","Fax No","Email","Email CC","Website","PAN No","GSTIN","GST Reg Type",
                     "Service Tax No","VAT Tin No","CST No","VAT Reg Type","Opening Balance",
                     "Dr / Cr","Bill Name","Bill Date"]
...
def insert_ledger_master_to_tally(config: Mapping[str, Any] , data: Dict[str, Any], ledger_master_template_url: str, logger: AirbyteLogger):
    ...
    try:
        response = requests.request(method="POST", url=ledger_master_template_url, data=ledger_master_payload, headers=ledger_master_headers)
    except:
...
def prepare_journal_voucher_payload(data: Dict[str, Any], logger: AirbyteLogger):
    ...
    journal_voucher_fields = ["Date","Voucher Number","Voucher Type","Ledger Name","Debit / Credit",
                              "Amount","Voucher Ref Date","Bill Ref No","Cost Center","Stock Item",
                              "Godown","Batch No","QTY","Rate","UOM","Item Amount","Narration"]
...
def insert_journal_voucher_to_tally(config: Mapping[str, Any], data: Dict[str, Any], journal_voucher_template_url: str, logger: AirbyteLogger):
    ...
    try:
        response = requests.request(method="POST", url=journal_voucher_template_url, data=journal_voucher_payload, headers=journal_voucher_headers)
    except:
...
def prepare_item_master_payload(data: Dict[str, Any], logger: AirbyteLogger):
    ...
    item_master_fields = ["Item Name","UOM","Item Code / Alias 1","Item Code / Alias 2",
                          "Item Code / Alias 3","Item Code / Alias 4","Item Code / Alias 5","Item Code / Alias 6",
                          "Part No","Item Description","Standard Cost","Standard Selling Price","Applicable From (SC / SP)",
                          "MRP","MRP Applicable From","HSN Code","HSN Description","Taxability","GST Rate","Applicable From","Group Name",
                          "Category Name","Godown","Batch","Opening QTY","Rate","Amount"]
...
def prepare_sales_order_payload(data: Dict[str, Any], logger: AirbyteLogger):
    ...
    sales_order_fields = ["Date","Voucher Number","Voucher Type","Customer Name","Address 1",
                          "Address 2","Address 3","State","Tin No","CST No","GSTIN","Term of Payment",
                          "Other Reference","Terms of Delivery","Dispatch Through","Destination","Order No",
                          "Due On","Item Name","Item Description","Tax Rate","Batch No","Mfg Date","Exp Date",
                          "QTY","UOM","Rate","Discount %","Amount","Sales Ledger","Other Charges_1 Amount",
                          "Other Charges_1 Ledger","Other Charges_2 Amount","Other Charges_2 Ledger",
                          "SGST Amount","SGST Ledger","CGST Amount","CGST Ledger","IGST Amount","IGST Ledger",
                          "Cost Center","Godown","Narration"]
...
def prepare_payment_voucher_payload(data: Dict[str, Any], logger: AirbyteLogger):
    ...
    payment_voucher_fields = ["Voucher Date","Reco Date","Voucher Number","Voucher Type",
                              "Cash/Bank Ledger","Debit Ledgers","Bill Name","Amount",
                              "Instrument Type","Instrument Number","Instrument Date","Cost Center","Narration"]
...
def insert_payment_voucher_to_tally(config: Mapping[str, Any], data: Dict[str, Any], payment_voucher_template_url: str, logger: AirbyteLogger):
    """
    ...
    try:
        response = requests.request(method="POST", url=payment_voucher_template_url, data=payment_voucher_payload, headers=payment_voucher_headers)
    except:
...
def prepare_receipt_voucher_payload(data: Dict[str, Any], logger: AirbyteLogger):
    ...
    receipt_voucher_fields = ["Voucher Date","Voucher Number","Voucher Type","Bank Reco Date",
                              "Is Advance Receipt","Credit Ledgers","Party Name","Add 1","Add 2",
                              "Add 3","State","Place of Supply","Registration Type","GSTIN",
                              "Cash / Bank Ledger","Bill Name","Amount","Ledger / Item","Taxable Value",
                              "CGST Rate","CGST Amount","SGST Rate","SGST Amount","IGST Rate","IGST Amount",
                              "Instrument Type","Instrument Number","Instrument Date","Issued Bank","Branch",
...
def insert_receipt_voucher_to_tally(config: Mapping[str, Any], data: Dict[str, Any], receipt_voucher_template_url: str, logger: AirbyteLogger):
    ...
    try:
        response = requests.request(method="POST", url=receipt_voucher_template_url, data=receipt_voucher_payload, headers=receipt_voucher_headers)
    except:
...
def prepare_debitnote_without_inventory_payload(data: Dict[str, Any], logger: AirbyteLogger):
    ...
    debitnote_without_inventory_fields = ["Date","Voucher No","Voucher Type","Original Invoice No",
                                          "Original Invoice Date","Reason Description","Reason Code",
                                          "Supplier DN No","Supplier DN Date","Credit Period","Debit / Party Ledger",
                                          "Address 1","Address 2","Address 3","Address 4","State","Place of Supply",
                                          "Country","GSTIN","GST Registration Type","Credit Ledger 1",
                                          "Credit Ledger 1 Amount","Credit Ledger 2","Credit Ledger 2 Amount",
                                          "Credit Ledger 3","Credit Ledger 3 Amount","Credit Ledger 4",
                                          "Credit Ledger 4 Amount","Credit Ledger 5","Credit Ledger 5 Amount",
                                          "Credit Ledger 6","Credit Ledger 6 Amount","Credit Ledger 7",
                                          "Credit Ledger 7 Amount","Credit Ledger 8","Credit Ledger 8 Amount",
                                          "Credit Ledger 9","Credit Ledger 9 Amount","Credit Ledger 10",
                                          "Credit Ledger 10 Amount","Credit Ledger 11","Credit Ledger 11 Amount",
                                          "Credit Ledger 12","Credit Ledger 12 Amount","Credit Ledger 13",
                                          "Credit Ledger 13 Amount","Credit Ledger 14","Credit Ledger 14 Amount",
                                          "Credit Ledger 15","Credit Ledger 15 Amount","Credit Ledger 16",
                                          "Credit Ledger 16 Amount","Credit Ledger 17","Credit Ledger 17 Amount",
                                          "Credit Ledger 18","Credit Ledger 18 Amount","Credit Ledger 19",
                                          "Credit Ledger 19 Amount","Credit Ledger 20","Credit Ledger 20 Amount",
                                          "Credit Ledger 21","Credit Ledger 21 Amount","Credit Ledger 22",
                                          "Credit Ledger 22 Amount","Credit Ledger 23","Credit Ledger 23 Amount",
                                          "Credit Ledger 24","Credit Ledger 24 Amount","Credit Ledger 25",
                                          "Credit Ledger 25 Amount","Credit Ledger 26","Credit Ledger 26 Amount",
                                          "Credit Ledger 27","Credit Ledger 27 Amount","Credit Ledger 28",
                                          "Credit Ledger 28 Amount","Credit Ledger 29","Credit Ledger 29 Amount",
                                          "Credit Ledger 30","Credit Ledger 30 Amount","Cost Center","Narration"]
...
def insert_debitnote_without_inventory_to_tally(config: Mapping[str, Any], data: Dict[str, Any], debitnote_without_inventory_template_url: str, logger: AirbyteLogger):
    ...
    try:
        response = requests.request(method="POST", url=debitnote_without_inventory_template_url, data=debitnote_without_inventory_payload, headers=debitnote_without_inventory_headers)
    except:
...
def prepare_purchase_without_inventory_payload(data: Dict[str, Any], logger: AirbyteLogger):
    ...
    purchase_without_inventory_fields = ["Date","Voucher No","Voucher Type","IS Invoice","Supplier Inv No",
                                         "Supplier Inv Date","Credit / Party Ledger","Address 1","Address 2",
                                         "Address 3","Address 4","State","Place of Supply","VAT Tin No","CST No",
                                         "Service Tax No","GSTIN","GST Registration Type","Debit Ledger 1",
                                         "Debit Ledger 1 Amount","Ledger 1 Description","Debit Ledger 2",
                                         "Debit Ledger 2 Amount","Ledger 2 Description","Debit Ledger 3",
                                         "Debit Ledger 3 Amount","Ledger 3 Description","Debit Ledger 4",
                                         "Debit Ledger 4 Amount","Ledger 4 Description","Debit Ledger 5",
                                         "Debit Ledger 5 Amount","Ledger 5 Description","Debit Ledger 6",
                                         "Debit Ledger 6 Amount","Ledger 6 Description","Debit Ledger 7",
                                         "Debit Ledger 7 Amount","Ledger 7 Description","Debit Ledger 8",
                                         "Debit Ledger 8 Amount","Ledger 8 Description","Debit Ledger 9",
                                         "Debit Ledger 9 Amount","Ledger 9 Description","Debit Ledger 10",
                                         "Debit Ledger 10 Amount","Ledger 10 Description","Debit Ledger 11",
                                         "Debit Ledger 11 Amount","Ledger 11 Description","Debit Ledger 12",
                                         "Debit Ledger 12 Amount","Ledger 12 Description","Debit Ledger 13",
                                         "Debit Ledger 13 Amount","Ledger 13 Description","Debit Ledger 14",
                                         "Debit Ledger 14 Amount","Ledger 14 Description","Debit Ledger 15",
                                         "Debit Ledger 15 Amount","Ledger 15 Description","Debit Ledger 16",
                                         "Debit Ledger 16 Amount","Ledger 16 Description","Debit Ledger 17",
                                         "Debit Ledger 17 Amount","Ledger 17 Description","Debit Ledger 18",
                                         "Debit Ledger 18 Amount","Ledger 18 Description","Debit Ledger 19",
                                         "Debit Ledger 19 Amount","Ledger 19 Description","Debit Ledger 20",
                                         "Debit Ledger 20 Amount","Ledger 20 Description","Debit Ledger 21",
                                         "Debit Ledger 21 Amount","Ledger 21 Description","Debit Ledger 22",
                                         "Debit Ledger 22 Amount","Ledger 22 Description","Debit Ledger 23",
                                         "Debit Ledger 23 Amount","Ledger 23 Description","Debit Ledger 24",
                                         "Debit Ledger 24 Amount","Ledger 24 Description","Debit Ledger 25",
                                         "Debit Ledger 25 Amount","Ledger 25 Description","Debit Ledger 26",
                                         "Debit Ledger 26 Amount","Ledger 26 Description","Debit Ledger 27",
                                         "Debit Ledger 27 Amount","Ledger 27 Description","Debit Ledger 28",
                                         "Debit Ledger 28 Amount","Ledger 28 Description","Debit Ledger 29",
                                         "Debit Ledger 29 Amount","Ledger 29 Description","Debit Ledger 30",
                                         "Debit Ledger 30 Amount","Ledger 30 Description","Debit Period",
                                         "Cost Center","Narration"]
...
def insert_purchase_without_inventory_to_tally(config: Mapping[str, Any], data: Dict[str, Any], purchase_without_inventory_template_url: str, logger: AirbyteLogger):
    ...
    try:
        response = requests.request(method="POST", url=purchase_without_inventory_template_url, data=purchase_without_inventory_payload, headers=purchase_without_inventory_headers)
    except:
...
def prepare_creditnote_without_inventory_payload(data: Dict[str, Any], logger: AirbyteLogger):
    ...
    debitnote_without_inventory_fields = ["Date","Voucher No","Voucher Type","Original Invoice No","Original Invoice Date",
                                          "Ref No / Order No","Reason Description","Reason Code","Buyers DN No",
                                          "Buyers DN Date","Credit Period","Credit / Party Ledger","Address 1",
                                          "Address 2","Address 3","Address 4","State","Place of Supply","Country",
                                          "GSTIN","GST Registration Type","Debit Ledger 1","Debit Ledger 1 Amount",
                                          "Debit Ledger 2","Debit Ledger 2 Amount","Debit Ledger 3","Debit Ledger 3 Amount",
                                          "Debit Ledger 4","Debit Ledger 4 Amount","Debit Ledger 5","Debit Ledger 5 Amount",
                                          "Debit Ledger 6","Debit Ledger 6 Amount","Debit Ledger 7","Debit Ledger 7 Amount","Debit Ledger 8",
                                          "Debit Ledger 8 Amount","Debit Ledger 9","Debit Ledger 9 Amount","Debit Ledger 10",
                                          "Debit Ledger 10 Amount","Debit Ledger 11","Debit Ledger 11 Amount","Debit Ledger 12",
                                          "Debit Ledger 12 Amount","Debit Ledger 13","Debit Ledger 13 Amount","Debit Ledger 14",
                                          "Debit Ledger 14 Amount","Debit Ledger 15","Debit Ledger 15 Amount","Debit Ledger 16",
                                          "Debit Ledger 16 Amount","Debit Ledger 17","Debit Ledger 17 Amount","Debit Ledger 18",
                                          "Debit Ledger 18 Amount","Debit Ledger 19","Debit Ledger 19 Amount","Debit Ledger 20",
                                          "Debit Ledger 20 Amount","Debit Ledger 21","Debit Ledger 21 Amount","Debit Ledger 22",
                                          "Debit Ledger 22 Amount","Debit Ledger 23","Debit Ledger 23 Amount","Debit Ledger 24",
                                          "Debit Ledger 24 Amount","Debit Ledger 25","Debit Ledger 25 Amount","Debit Ledger 26",
                                          "Debit Ledger 26 Amount","Debit Ledger 27","Debit Ledger 27 Amount","Debit Ledger 28",
                                          "Debit Ledger 28 Amount","Debit Ledger 29","Debit Ledger 29 Amount","Debit Ledger 30",
                                          "Debit Ledger 30 Amount","Cost Center","Narration"]
...
def insert_creditnote_without_inventory_to_tally(config: Mapping[str, Any], data: Dict[str, Any], creditnote_without_inventory_template_url: str, logger: AirbyteLogger):
    ...
    try:
        response = requests.request(method="POST", url=creditnote_without_inventory_template_url, data=creditnote_without_inventory_payload, headers=creditnote_without_inventory_headers)
    except:
...
def prepare_sales_without_inventory_payload(data: Dict[str, Any], logger: AirbyteLogger):
    ...
    sales_without_inventory_fields = ["Date","Voucher No","Voucher Type","IS Invoice","Bill Wise Details",
                                      "Debit / Party Ledger","Address 1","Address 2","Address 3","Address 4",
                                      "Pincode","State","Place of Supply","Country","VAT Tin No","CST No",
                                      "Service Tax No","GSTIN","GST Registration Type","Consignee Name",
                                      "Consignee Add 1","Consignee Add 2","Consignee Add 3","Consignee Add 4",
                                      "Consignee State","Consignee Country","Consignee Pincode","Consignee GSTIN",
                                      "Credit Ledger 1","Credit Ledger 1 Amount","Ledger 1 Description",
                                      "Credit Ledger 2","Credit Ledger 2 Amount","Ledger 2 Description",
                                      "Credit Ledger 3","Credit Ledger 3 Amount","Ledger 3 Description",
                                      "Credit Ledger 4","Credit Ledger 4 Amount","Ledger 4 Description",
                                      "Credit Ledger 5","Credit Ledger 5 Amount","Ledger 5 Description",
                                      "Credit Ledger 6","Credit Ledger 6 Amount","Ledger 6 Description",
                                      "Credit Ledger 7","Credit Ledger 7 Amount","Ledger 7 Description",
                                      "Credit Ledger 8","Credit Ledger 8 Amount","Ledger 8 Description",
                                      "Credit Ledger 9","Credit Ledger 9 Amount","Ledger 9 Description",
                                      "Credit Ledger 10","Credit Ledger 10 Amount","Ledger 10 Description",
                                      "Credit Ledger 11","Credit Ledger 11 Amount","Ledger 11 Description",
                                      "Credit Ledger 12","Credit Ledger 12 Amount","Ledger 12 Description",
                                      "Credit Ledger 13","Credit Ledger 13 Amount","Ledger 13 Description",
                                      "Credit Ledger 14","Credit Ledger 14 Amount","Ledger 14 Description",
                                      "Credit Ledger 15","Credit Ledger 15 Amount","Ledger 15 Description",
                                      "Credit Ledger 16","Credit Ledger 16 Amount","Ledger 16 Description",
                                      "Credit Ledger 17","Credit Ledger 17 Amount","Ledger 17 Description",
                                      "Credit Ledger 18","Credit Ledger 18 Amount","Ledger 18 Description",
                                      "Credit Ledger 19","Credit Ledger 19 Amount","Ledger 19 Description",
                                      "Credit Ledger 20","Credit Ledger 20 Amount","Ledger 20 Description",
                                      "Credit Ledger 21","Credit Ledger 21 Amount","Ledger 21 Description",
                                      "Credit Ledger 22","Credit Ledger 22 Amount","Ledger 22 Description",
                                      "Credit Ledger 23","Credit Ledger 23 Amount","Ledger 23 Description",
                                      "Credit Ledger 24","Credit Ledger 24 Amount","Ledger 24 Description",
                                      "Credit Ledger 25","Credit Ledger 25 Amount","Ledger 25 Description",
                                      "Credit Ledger 26","Credit Ledger 26 Amount","Ledger 26 Description",
                                      "Credit Ledger 27","Credit Ledger 27 Amount","Ledger 27 Description",
                                      "Credit Ledger 28","Credit Ledger 28 Amount","Ledger 28 Description",
                                      "Credit Ledger 29","Credit Ledger 29 Amount","Ledger 29 Description",
                                      "Credit Ledger 30","Credit Ledger 30 Amount","Ledger 30 Description",
                                      "Credit Period","Cost Center","Narration","IRN Ack No","IRN Ack Date",
                                      "IRN No","IRN Bill to Place","IRN Ship to State"]
...
def insert_sales_without_inventory_to_tally(config: Mapping[str, Any], data: Dict[str, Any], sales_without_inventory_template_url: str, logger: AirbyteLogger):
    ...
    try:
        response = requests.request(method="POST", url=sales_without_inventory_template_url, data=sales_without_inventory_payload, headers=sales_without_inventory_headers)
    except:
