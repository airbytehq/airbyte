...
import pytest
from source_comagic.source import ComagicStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ComagicStream, "path", "v0/example_endpoint")
    mocker.patch.object(ComagicStream, "primary_key", "test_primary_key")
    mocker.patch.object(ComagicStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ComagicStream()
