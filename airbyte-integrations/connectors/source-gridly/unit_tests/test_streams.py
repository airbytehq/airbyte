...
import pytest
from source_gridly.source import GridlyStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GridlyStream, "path", "v0/example_endpoint")
    mocker.patch.object(GridlyStream, "primary_key", "test_primary_key")
    mocker.patch.object(GridlyStream, "__abstractmethods__", set())
