...
This is the repository for the Gridly configuration based source connector.
...
```
./gradlew :airbyte-integrations:connectors:source-gridly:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-gridly:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-gridly:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-gridly:integrationTest
```
