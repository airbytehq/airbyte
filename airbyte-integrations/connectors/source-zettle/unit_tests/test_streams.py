...
import pytest
from source_zettle.source import ZettleStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ZettleStream, "path", "v0/example_endpoint")
    mocker.patch.object(ZettleStream, "primary_key", "test_primary_key")
    mocker.patch.object(ZettleStream, "__abstractmethods__", set())
