...
class PervasiveJdbcSourceAcceptanceTest extends JdbcSourceAcceptanceTest {

  private static final Logger LOGGER = LoggerFactory.getLogger(PervasiveJdbcSourceAcceptanceTest.class);
  ...
  public String getDriverClass() {
    return PervasiveSource.DRIVER_CLASS;
  }
