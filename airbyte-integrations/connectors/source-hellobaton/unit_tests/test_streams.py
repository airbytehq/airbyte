...
import pytest
from source_hellobaton.source import HellobatonStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(HellobatonStream, "path", "v0/example_endpoint")
    mocker.patch.object(HellobatonStream, "primary_key", "test_primary_key")
    mocker.patch.object(HellobatonStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = HellobatonStream()
