...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-hellobaton:dev`.
...
```Dockerfile
FROM airbyte/source-hellobaton:latest
...
docker run airbyte/source-hellobaton:dev spec
```
#### Run
