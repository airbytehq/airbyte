...
import io.airbyte.cdk.read.Key
import io.airbyte.cdk.read.State
...
@Requires(env = ["source"])
class ReadOperation(
    val globalWorkerFactory: GlobalWorkerFactory,
    val streamWorkerFactory: StreamWorkerFactory,
    ...
    override fun execute() {
        ...
        val runnables =
            stateManager.currentStates().map { startingState: State<out Key> ->
