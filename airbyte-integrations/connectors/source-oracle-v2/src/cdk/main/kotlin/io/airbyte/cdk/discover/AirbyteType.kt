 ...
 *
 *  This maps to the subset of [JsonSchemaType] which is used in practice.
 *  Its main reason for existing is to provide type-safety and convenient comparisons and string representations.
 */
