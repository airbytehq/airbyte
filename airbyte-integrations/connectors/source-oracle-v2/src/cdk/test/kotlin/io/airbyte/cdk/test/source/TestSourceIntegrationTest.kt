...
class TestSourceIntegrationTest {
    ...
    @Test
    fun testCheckFailNoConnection() {
        SyncsTestFixture.testCheck(
            TestSourceConfigurationJsonObject(),
        ...
        H2TestFixture().use { h2: H2TestFixture ->
            val configPojo =
                TestSourceConfigurationJsonObject().apply {
                    ...
                    timeout = Duration.ofDays(1L).toString()
                }
            SyncsTestFixture.testSyncs(
                configPojo,
                h2::createConnection,
    ...
    companion object {
        ...
        const val INSERT_EVENTS =
            "INSERT INTO events (id, ts, msg) VALUES " +
                "('cc449902-30da-5ea8-c4d3-02732e5bfce9', '2024-04-29T00:00:00.000000-04:00', 'bar')," +
                "('dd55aa13-41eb-6fb4-d5e4-13843f6c0dfa', '2024-04-30T00:00:00.000000-04:00', NULL);"
    }
}
