...
import io.airbyte.integrations.destination.bigquery.write.typing_deduping.SkeletonDirectLoadDatabaseHandler
...
class BigQueryDatabaseHandlerTest {
    ...
    fun `billing errors are wrapped as ConfigErrorException`() {
        ...
        val handler = SkeletonDirectLoadDatabaseHandler(bq, "location")
