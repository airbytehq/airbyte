...
class SkeletonDirectLoadBeansFactory {
    ...
    fun getWriter(
        ...
        val sqlTableOperations = DefaultDirectLoadTableSqlOperations(
    ...
    @Singleton
    fun getSkeletonDirectLoadClient(config: SkeletonDirectLoadConfiguration): SkeletonDirectLoadClient {
