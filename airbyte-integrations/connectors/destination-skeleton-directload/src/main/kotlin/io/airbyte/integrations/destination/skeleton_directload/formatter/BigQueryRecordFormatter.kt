...
import io.airbyte.integrations.destination.bigquery.write.typing_deduping.direct_load_tables.SkeletonDirectLoadSqlGenerator
        ...
        fun getDirectLoadSchema(
            ...
            val userDefinedFields: List<Field> =
                stream.schema
                    ...
                    .mapValues { (_, type) ->
                        SkeletonDirectLoadSqlGenerator.toDialectType(type.type)
                    }
