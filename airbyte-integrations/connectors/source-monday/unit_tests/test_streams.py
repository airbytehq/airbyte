...
import pytest
from source_monday.source import MondayStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MondayStream, "path", "v0/example_endpoint")
    mocker.patch.object(MondayStream, "primary_key", "test_primary_key")
    mocker.patch.object(MondayStream, "__abstractmethods__", set())
