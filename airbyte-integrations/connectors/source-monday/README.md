...
```
./gradlew :airbyte-integrations:connectors:source-monday:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-monday:airbyteDocker
```
...
```
./gradlew :airbyte-integrations:connectors:source-monday:integrationTest
```
