...
def _get_source(args: List[str]):
    ...
    try:
        return SourceMonday(
            SourceMonday.read_catalog(catalog_path) if catalog_path else None,
            SourceMonday.read_config(config_path) if config_path else None,
            SourceMonday.read_state(state_path) if state_path else None,
        )
