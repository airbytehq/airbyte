...
This is the repository for the Callrail configuration based source connector. For information about
how to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.io/integrations/sources/callrail).
...
[documentation](https://docs.airbyte.io/integrations/sources/callrail) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_callrail/spec.yaml`
...
`source callrail test creds` and place them into `secrets/config.json`.
...
An image will be built with the tag `airbyte/source-callrail:dev`.
