...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-callrail:dev`.
...
```Dockerfile
FROM airbyte/source-callrail:latest
...
docker run airbyte/source-callrail:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/callrail.md`).
