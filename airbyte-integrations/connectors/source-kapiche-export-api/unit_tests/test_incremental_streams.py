...
def patch_incremental_base_class(mocker):
    ...
    mocker.patch.object(IncrementalKapicheExportApiStream, "path", "v0/example_endpoint")
    mocker.patch.object(IncrementalKapicheExportApiStream, "primary_key", "test_primary_key")
