...
This is the repository for the Configcat configuration based source connector. For information about
how to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.io/integrations/sources/configcat).
...
[documentation](https://docs.airbyte.io/integrations/sources/configcat) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_configcat/spec.yaml`
...
`source configcat test creds` and place them into `secrets/config.json`.
