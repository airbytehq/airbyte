...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-configcat:dev`.
...
```Dockerfile
FROM airbyte/source-configcat:latest
...
docker run airbyte/source-configcat:dev spec
```
#### Run
