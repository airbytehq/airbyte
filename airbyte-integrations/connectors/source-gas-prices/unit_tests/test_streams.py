...
import pytest
from source_gas_prices.source import GasPricesStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GasPricesStream, "path", "v0/example_endpoint")
    mocker.patch.object(GasPricesStream, "primary_key", "test_primary_key")
    mocker.patch.object(GasPricesStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = GasPricesStream()
