...
import pytest
from source_magento.source import MagentoStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MagentoStream, "path", "v0/example_endpoint")
    mocker.patch.object(MagentoStream, "primary_key", "test_primary_key")
    mocker.patch.object(MagentoStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = MagentoStream()
