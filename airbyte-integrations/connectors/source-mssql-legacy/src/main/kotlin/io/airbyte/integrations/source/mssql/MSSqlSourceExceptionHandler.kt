    ...
    override fun initializeErrorDictionary() {
        ...
        add(
            ConnectorErrorProfile(
                ...
                sampleInternalMessage =
                    "java.sql.SQLException: SQL Server returned an incomplete response. The connection has been closed.",
        ...
        add(
            ConnectorErrorProfile(
                ...
                sampleInternalMessage =
                    "java.sql.SQLException: SQL Server did not return a response. The connection has been closed.",
        ...
        add(
            ConnectorErrorProfile(
                ...
                sampleInternalMessage =
                    "java.sql.SQLException: The connection is closed.",
