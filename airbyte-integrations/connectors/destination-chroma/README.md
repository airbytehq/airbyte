...
```
./gradlew :airbyte-integrations:connectors:destination-chroma:build
```
...
```
./gradlew :airbyte-integrations:connectors:destination-chroma:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:destination-chroma:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:destination-chroma:integrationTest
```
