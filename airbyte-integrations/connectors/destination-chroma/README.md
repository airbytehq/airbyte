...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/destination-chroma:dev`.
...
```Dockerfile
FROM airbyte/destination-chroma:latest
...
docker run airbyte/destination-chroma:dev spec
```
#### Run
