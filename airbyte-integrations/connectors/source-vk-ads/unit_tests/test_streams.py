...
import pytest
from source_vk_ads.source import VkAdsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(VkAdsStream, "path", "v0/example_endpoint")
    mocker.patch.object(VkAdsStream, "primary_key", "test_primary_key")
    mocker.patch.object(VkAdsStream, "__abstractmethods__", set())
