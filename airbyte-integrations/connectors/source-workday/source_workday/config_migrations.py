...
class MigrateRAASCredentials:
    message_repository: MessageRepository = InMemoryMessageRepository()
    username_field_to_migrate = "username"
    password_field_to_migrate = "password"
    report_ids_field_to_migrate = "report_ids"
