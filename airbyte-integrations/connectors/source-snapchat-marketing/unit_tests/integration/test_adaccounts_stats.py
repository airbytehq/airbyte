...
class TestAdaccountsStatsHourly(TestCase):
    ...
    def test_read_records(self, http_mocker: HttpMocker) -> None:
        ...
        http_mocker.get(
            RequestBuilder.adaccounts_stats_endpoint(AD_ACCOUNT_ID).with_granularity("HOUR").build(),
...
class TestAdaccountsStatsDaily(TestCase):
    ...
    def test_read_records(self, http_mocker: HttpMocker) -> None:
        _setup_parent_mocks(http_mocker)
        http_mocker.get(
            RequestBuilder.adaccounts_stats_endpoint(AD_ACCOUNT_ID).with_granularity("DAY").build(),
...
class TestAdaccountsStatsLifetime(TestCase):
    ...
    def test_read_records(self, http_mocker: HttpMocker) -> None:
        _setup_parent_mocks(http_mocker)
        http_mocker.get(
            RequestBuilder.adaccounts_stats_endpoint(AD_ACCOUNT_ID).with_granularity("LIFETIME").build(),
