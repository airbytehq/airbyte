...
"""
Tests for the product_attributes stream.
...
_STREAM_NAME = "product_attributes"
...
class TestProductAttributesFullRefresh(TestCase):
    """Tests for the product_attributes stream in full refresh mode."""
    ...
    def test_read_records(self, http_mocker: HttpMocker) -> None:
        ...
        assert output.records[0].record.data["name"] == "Color"
        assert output.records[1].record.data["name"] == "Size"
