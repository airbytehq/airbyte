...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-woocommerce:dev`.
...
```Dockerfile
FROM airbyte/source-woocommerce:latest
...
docker run airbyte/source-woocommerce:dev spec
```
#### Run
