...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/destination-convex:dev`.
...
```Dockerfile
FROM airbyte/destination-convex:latest
...
docker run airbyte/destination-convex:dev spec
```
#### Run
