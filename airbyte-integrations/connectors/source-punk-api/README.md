...
This is the repository for the Punk Api configuration based source connector. For information about
how to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.io/integrations/sources/punk-api).
...
[documentation](https://docs.airbyte.io/integrations/sources/punk-api) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_punk_api/spec.yaml`
...
`source punk-api test creds` and place them into `secrets/config.json`.
...
4. Make the connector documentation and its changelog is up to date
   (`docs/integrations/sources/punk-api.md`).
