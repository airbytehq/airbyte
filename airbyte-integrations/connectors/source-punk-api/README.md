...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-punk-api:dev`.
...
```Dockerfile
FROM airbyte/source-punk-api:latest
...
docker run airbyte/source-punk-api:dev spec
```
#### Run
