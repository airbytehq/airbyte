...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-freshservice:dev`.
...
```Dockerfile
FROM airbyte/source-freshservice:latest
...
docker run airbyte/source-freshservice:dev spec
```
#### Run
