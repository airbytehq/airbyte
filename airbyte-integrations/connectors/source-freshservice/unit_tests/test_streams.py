...
import pytest
from source_freshservice.source import FreshserviceStream
...
def patch_base_class(mocker):
    ...
    mocker.patch.object(FreshserviceStream, "primary_key", "test_primary_key")
    mocker.patch.object(FreshserviceStream, "__abstractmethods__", set())
