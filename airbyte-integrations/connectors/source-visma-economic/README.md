...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-visma-economic:dev`.
...
```Dockerfile
FROM airbyte/source-visma-economic:latest
...
docker run airbyte/source-visma-economic:dev spec
```
#### Run
