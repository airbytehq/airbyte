...
```
./gradlew :airbyte-integrations:connectors:source-kyriba:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-kyriba:buildDockerImage
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-kyriba:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-kyriba:integrationTest
```
