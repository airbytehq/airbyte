...
import pytest
from source_vk.source import VkStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(VkStream, "path", "v0/example_endpoint")
    mocker.patch.object(VkStream, "primary_key", "test_primary_key")
    mocker.patch.object(VkStream, "__abstractmethods__", set())
