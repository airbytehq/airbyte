...
```
poetry run source-shortio spec
poetry run source-shortio check --config secrets/config.json
poetry run source-shortio discover --config secrets/config.json
poetry run source-shortio read --config secrets/config.json --catalog sample_files/configured_catalog.json
```
