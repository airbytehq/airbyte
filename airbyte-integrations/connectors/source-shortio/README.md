...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-shortio:dev`.
...
```Dockerfile
FROM airbyte/source-shortio:latest
...
docker run airbyte/source-shortio:dev spec
```
#### Run
