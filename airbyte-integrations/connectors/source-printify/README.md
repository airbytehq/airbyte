# Printify
This directory contains the manifest-only connector for `source-printify`.
...
### Build
This will create a dev image (`source-printify:dev`) that you can use to test the connector locally.
```bash
