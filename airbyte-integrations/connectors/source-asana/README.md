...
```
./gradlew :airbyte-integrations:connectors:source-asana:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-asana:buildDockerImage
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-asana:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-asana:integrationTest
```
