...
from source_asana.streams import AsanaStream, Sections, StoriesCompact, Stories, Tags, Tasks, TeamMemberships, Users


@pytest.mark.parametrize(
    "stream",
    [Tasks, Sections, Users, TeamMemberships, Tags, StoriesCompact, Stories],
)
