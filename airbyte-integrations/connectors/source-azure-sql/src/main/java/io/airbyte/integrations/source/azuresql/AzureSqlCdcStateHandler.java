...
import static io.airbyte.integrations.source.azuresql.AzureSqlSource.MSSQL_CDC_OFFSET;
import static io.airbyte.integrations.source.azuresql.AzureSqlSource.MSSQL_DB_HISTORY;
...
public class AzureSqlCdcStateHandler implements CdcStateHandler {

  private static final Logger LOGGER = LoggerFactory.getLogger(AzureSqlCdcStateHandler.class);
  private final StateManager stateManager;

  public AzureSqlCdcStateHandler(final StateManager stateManager) {
