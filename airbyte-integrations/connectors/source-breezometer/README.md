...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-breezometer:dev`.
...
```Dockerfile
FROM airbyte/source-breezometer:latest
...
docker run airbyte/source-breezometer:dev spec
```
#### Run
