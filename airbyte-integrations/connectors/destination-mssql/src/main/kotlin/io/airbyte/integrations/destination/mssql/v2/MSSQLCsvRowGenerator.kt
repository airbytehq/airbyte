...
/**
 * Serializes a value for the MSSQL bulk-load CSV. Booleans are always emitted as 0/1 because SQL
 * Server BIT columns reject true/false during BULK INSERT, regardless of validateValuesPreLoad.
 */
