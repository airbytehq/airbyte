 ...
 * when a pre-1753 timestamp is sent. The [ValueCohercer.validateTimestamp] function should nullify
 * the value and `setAsNullValue` should set the parameter to SQL NULL, allowing the INSERT to
 * succeed.
 */
