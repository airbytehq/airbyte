...
import pytest
from source_cian.source import CianStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(CianStream, "path", "v0/example_endpoint")
    mocker.patch.object(CianStream, "primary_key", "test_primary_key")
    mocker.patch.object(CianStream, "__abstractmethods__", set())
