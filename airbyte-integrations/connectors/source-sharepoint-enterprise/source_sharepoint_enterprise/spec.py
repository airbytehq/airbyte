...
class SourceMicrosoftSharePointSpec(AbstractFileBasedSpec, BaseModel):
    ...
    def documentation_url(cls) -> str:
        ...
        return "https://docs.airbyte.com/integrations/enterprise-connectors/source-sharepoint-enterprise"
    ...
    def schema(cls, *args: Any, **kwargs: Any) -> Dict[str, Any]:
        ...
        dpath.util.delete(
            schema,
            "properties/streams/items/properties/format/oneOf/*/properties/inference_type",
        )

        # Hide API processing option until https://github.com/airbytehq/airbyte-platform-internal/issues/10354 is fixed
        processing_options = dpath.util.get(
            schema,
            "properties/streams/items/properties/format/oneOf/4/properties/processing/oneOf",
        )
        dpath.util.set(
            schema,
            "properties/streams/items/properties/format/oneOf/4/properties/processing/oneOf",
