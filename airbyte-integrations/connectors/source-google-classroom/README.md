# Google Classroom
This directory contains the manifest-only connector for `source-google-classroom`.
...
### Build
This will create a dev image (`source-google-classroom:dev`) that you can use to test the connector locally.
```bash
