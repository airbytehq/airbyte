...
to generate the necessary credentials. Then create a file `secrets/config.json` conforming to the `destination_xata/spec.yaml` file.
...
An image will be available on your host with the tag `airbyte/destination-xata:dev`.
...
4. Make sure the connector documentation and its changelog is up to date (`docs/integrations/destinations/xata.md`).
