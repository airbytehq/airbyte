...
```
./gradlew :airbyte-integrations:connectors:destination-xata:build
```
...
```
./gradlew :airbyte-integrations:connectors:destination-xata:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:destination-xata:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:destination-xata:integrationTest
```
