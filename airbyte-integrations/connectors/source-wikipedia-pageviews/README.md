...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-wikipedia-pageviews:dev`.
...
```Dockerfile
FROM airbyte/source-wikipedia-pageviews:latest
...
docker run airbyte/source-wikipedia-pageviews:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/wikipedia-pageviews.md`).
