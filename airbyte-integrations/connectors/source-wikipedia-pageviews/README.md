...
This is the repository for the Wikipedia-Pageviews source connector, written in Python.
...
poetry run source-wikipedia-pageviews read --config secrets/config.json --catalog sample_files/configured_catalog.json
```
