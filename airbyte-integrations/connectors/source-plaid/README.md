...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-plaid:dev`.
...
```Dockerfile
FROM airbyte/source-plaid:latest
...
docker run airbyte/source-plaid:dev spec
```
#### Run
