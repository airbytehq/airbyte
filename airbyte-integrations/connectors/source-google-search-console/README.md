...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-google-search-console:dev`.
...
```Dockerfile
FROM airbyte/source-google-search-console:latest
...
docker run airbyte/source-google-search-console:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/google-search-console.md`).
