...
from source_google_search_console.streams import ROW_LIMIT, GoogleSearchConsole, SearchAnalyticsByDate, SearchAnalyticsByCustomDimensions
...
def test_check_connection_ok(config, mocker, requests_mock):
    ...
    requests_mock.get(
        ...
        json={"siteEntry": [{"siteUrl": "https://example.com"}]}
    )
