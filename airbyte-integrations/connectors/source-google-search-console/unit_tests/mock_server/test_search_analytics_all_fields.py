            ...
            if body.get("type") == "web":
                return json.dumps(
                    _build_search_analytics_response(
                        [
                            _build_search_analytics_row(
                                "2024-01-01", "usa", "DESKTOP", "https://example.com/page1", "test query", clicks=100, impressions=1000
                            ),
                            _build_search_analytics_row(
                                "2024-01-02", "gbr", "MOBILE", "https://example.com/page2", "another query", clicks=150, impressions=1500
                            ),
                        ]
                    )
                )
            ...
            if body.get("type") == "web":
                return json.dumps(
                    _build_search_analytics_response(
                        [
                            _build_search_analytics_row(
                                "2024-01-03", "usa", "DESKTOP", "https://example.com/page3", "new query", clicks=200, impressions=2000
                            ),
                            _build_search_analytics_row(
                                "2024-01-04", "deu", "TABLET", "https://example.com/page4", "fresh query", clicks=250, impressions=2500
                            ),
                        ]
                    )
                )
