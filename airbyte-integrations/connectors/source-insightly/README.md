...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-insightly:dev`.
...
```Dockerfile
FROM airbyte/source-insightly:latest
...
docker run airbyte/source-insightly:dev spec
```
#### Run
