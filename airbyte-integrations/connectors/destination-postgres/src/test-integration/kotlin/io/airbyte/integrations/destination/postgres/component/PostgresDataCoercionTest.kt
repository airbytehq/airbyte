...
class PostgresDataCoercionTest(
    ...
    @ParameterizedTest
    @MethodSource(
        "io.airbyte.integrations.destination.postgres.component.PostgresDataCoercionTest#union"
    )
    ...
    @ParameterizedTest
    @MethodSource(
        "io.airbyte.integrations.destination.postgres.component.PostgresDataCoercionTest#unknown"
    )
    ...
    companion object {
        @JvmStatic
        fun integers() =
            DataCoercionIntegerFixtures.int64
                .filter { it.changeReason != Reason.DESTINATION_FIELD_SIZE_LIMITATION }
                .toArgs()
        ...
        fun timestampTz() =
            DataCoercionTimestampTzFixtures.commonWarehouse
                .filter { it.name != io.airbyte.cdk.load.component.OUT_OF_RANGE_TIMESTAMP }
                .toArgs()
