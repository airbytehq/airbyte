# OpenFDA
This directory contains the manifest-only connector for `source-openfda`.
...
### Build
This will create a dev image (`source-openfda:dev`) that you can use to test the connector locally.
```bash
