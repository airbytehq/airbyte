...
import pytest
from source_ziniao.source import ZiniaoStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ZiniaoStream, "path", "v0/example_endpoint")
    mocker.patch.object(ZiniaoStream, "primary_key", "test_primary_key")
    mocker.patch.object(ZiniaoStream, "__abstractmethods__", set())
