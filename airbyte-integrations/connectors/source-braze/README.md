...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-braze:dev`.
...
```Dockerfile
FROM airbyte/source-braze:latest
...
docker run airbyte/source-braze:dev spec
```
#### Run
