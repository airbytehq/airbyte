...
```
poetry run source-braze spec
poetry run source-braze check --config secrets/config.json
poetry run source-braze discover --config secrets/config.json
poetry run source-braze read --config secrets/config.json --catalog sample_files/configured_catalog.json
```
