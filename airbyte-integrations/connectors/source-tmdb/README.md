...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-tmdb:dev`.
...
```Dockerfile
FROM airbyte/source-tmdb:latest
...
docker run airbyte/source-tmdb:dev spec
```
#### Run
