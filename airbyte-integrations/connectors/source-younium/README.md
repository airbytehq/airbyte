...
This is the repository for the Younium configuration based source connector.
...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-younium:dev`.
...
```Dockerfile
FROM airbyte/source-younium:latest
...
docker run airbyte/source-younium:dev spec
