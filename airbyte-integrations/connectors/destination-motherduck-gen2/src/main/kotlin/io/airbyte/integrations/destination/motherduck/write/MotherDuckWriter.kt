...
import io.airbyte.integrations.destination.motherduck.client.MotherDuckAirbyteClient
...
class MotherDuckWriter(
    ...
    private val motherDuckClient: MotherDuckAirbyteClient,
    ...
    override suspend fun setup() {
        names.values
            ...
            .forEach { motherDuckClient.createNamespace(it) }
