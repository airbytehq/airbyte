...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-gocardless:dev`.
...
```Dockerfile
FROM airbyte/source-gocardless:latest
...
docker run airbyte/source-gocardless:dev spec
```
#### Run
