...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-appsflyer:dev`.
...
```Dockerfile
FROM airbyte/source-appsflyer:latest
...
docker run airbyte/source-appsflyer:dev spec
```
#### Run
