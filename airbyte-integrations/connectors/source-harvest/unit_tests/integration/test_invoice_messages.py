...
class TestInvoiceMessagesStream(TestCase):
    ...
    def test_full_refresh(self, http_mocker: HttpMocker) -> None:
        """
        Test full_refresh sync for invoice_messages stream.
        This is a substream of invoices, so we need to mock both.
        """
        ...
        # ASSERT: Should retrieve all invoice_messages records
