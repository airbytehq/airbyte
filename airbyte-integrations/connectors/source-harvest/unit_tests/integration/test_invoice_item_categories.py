...
class TestInvoiceItemCategoriesStream(TestCase):
    ...
    def test_incremental_sync_with_state(self, http_mocker: HttpMocker) -> None:
        ...
        http_mocker.get(
            HarvestRequestBuilder.invoice_item_categories_endpoint(_ACCOUNT_ID, _API_TOKEN)
            .with_per_page(50)
            .with_updated_since("2024-01-01T00:00:00Z")
            .build(),
            HttpResponse(
                body=json.dumps({
                    "invoice_item_categories": [{"id": 9001, "created_at": "2024-01-02T10:00:00Z", "updated_at": "2024-01-02T10:00:00Z"}],
                    "per_page": 50,
                    "total_pages": 1,
                    "page": 1,
                    "links": {}
    ...
    def test_unauthorized_error_handling(self, http_mocker: HttpMocker) -> None:
        ...
        http_mocker.get(
            HarvestRequestBuilder.invoice_item_categories_endpoint(_ACCOUNT_ID, "invalid_token")
            .with_per_page(50)
