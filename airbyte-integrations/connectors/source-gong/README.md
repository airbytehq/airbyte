...
This is the repository for the Gong configuration based source connector. For information about how
to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.io/integrations/sources/gong).
...
[documentation](https://docs.airbyte.io/integrations/sources/gong) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_gong/spec.yaml`
...
`source gong test creds` and place them into `secrets/config.json`.
