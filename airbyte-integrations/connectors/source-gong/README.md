...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-gong:dev`.
...
```Dockerfile
FROM airbyte/source-gong:latest
...
docker run airbyte/source-gong:dev spec
```
#### Run
