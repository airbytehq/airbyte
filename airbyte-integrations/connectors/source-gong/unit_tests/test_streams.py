...
import pytest
from source_gong.source import GongStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GongStream, "path", "v0/example_endpoint")
    mocker.patch.object(GongStream, "primary_key", "test_primary_key")
    mocker.patch.object(GongStream, "__abstractmethods__", set())
