...
class SourceFaker(AbstractSource):
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        ...
        generate_errors_in_wide_columns: bool = config["generate_errors_in_wide_columns"] if "generate_errors_in_wide_columns" in config else False
        ...
        return [
            ...
            *[WideColumns(count, seed, parallelism, records_per_slice, always_updated, wide_data_set_columns, generate_errors_in_wide_columns, i) for i in range(wide_data_set_tables)]
        ]
