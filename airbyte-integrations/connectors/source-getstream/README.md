# getStream
This directory contains the manifest-only connector for `source-getstream`.
...
### Build
This will create a dev image (`source-getstream:dev`) that you can use to test the connector locally.
```bash
airbyte-ci connectors --name=source-getstream build
```

### Test
This will run the acceptance tests for the connector.
```bash
airbyte-ci connectors --name=source-getstream test
```
