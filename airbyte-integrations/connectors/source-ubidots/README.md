# Ubidots
This directory contains the manifest-only connector for `source-ubidots`.
...
### Build
This will create a dev image (`source-ubidots:dev`) that you can use to test the connector locally.
```bash
