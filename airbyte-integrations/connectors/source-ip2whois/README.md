...
```
./gradlew :airbyte-integrations:connectors:source-ip2whois:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-ip2whois:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-ip2whois:unitTest
```
