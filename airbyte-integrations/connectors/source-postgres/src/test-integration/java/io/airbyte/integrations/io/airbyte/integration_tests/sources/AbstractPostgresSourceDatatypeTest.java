  ...
  protected void initTests() {
    addDataTypeTestData(
        TestDataHolder.builder()
            .sourceType("bigint")
            .airbyteType(JsonSchemaType.INTEGER_V1)
    ...
    addDataTypeTestData(
        TestDataHolder.builder()
            ...
            .airbyteType(JsonSchemaType.STRING_V1)
            .addInsertValues("B'0'")
            .addExpectedValues("0")
            .build());
    ...
    for (final String type : Set.of("boolean", "bool")) {
      addDataTypeTestData(
          TestDataHolder.builder()
              .sourceType(type)
              .airbyteType(JsonSchemaType.BOOLEAN_V1)
    ...
    for (final String type : Set.of("date", "date not null default now()")) {
      addDataTypeTestData(
          TestDataHolder.builder()
              ...
              .airbyteType(JsonSchemaType.DATE_V1)
    ...
    for (final String type : Set.of("double precision", "float", "float8")) {
      addDataTypeTestData(
          TestDataHolder.builder()
              .sourceType(type)
              .airbyteType(JsonSchemaType.NUMBER_V1)
    ...
    for (final String fullSourceType : Set.of("time", "time without time zone", "time without time zone not null default now()")) {
      addDataTypeTestData(
          TestDataHolder.builder()
              ...
              .airbyteType(JsonSchemaType.TIME_WITHOUT_TIMEZONE_V1)
    ...
    for (final String fullSourceType : Set.of("timestamptz", "timestamp with time zone")) {
      addDataTypeTestData(
          TestDataHolder.builder()
              ...
              .fullSourceDataType(fullSourceType)
              .airbyteType(JsonSchemaType.TIMESTAMP_WITH_TIMEZONE_V1)
              .addInsertValues(
                  // 10:23-08 == 18:23Z
