...
import io.airbyte.integrations.source.postgres.xmin.XminCtidUtils.CtidStreams;
...
public class CdcCtidUtils {
  ...
  public static StreamsCategorised categoriseStreams(final CdcStateManager stateManager,
      final ConfiguredAirbyteCatalog fullCatalog) {
    // 1. If the state is empty
    // 2. if the offset is behind LSN of replication slot of the source db
    // 3.
