...
public class XminTestConstants {
  ...
  public static final AirbyteStreamNameNamespacePair PAIR1 =
      new AirbyteStreamNameNamespacePair(STREAM_NAME1, NAMESPACE);

  public static final String STREAM_NAME2 = "motorcycles";
  public static final AirbyteStreamNameNamespacePair PAIR2 =
      new AirbyteStreamNameNamespacePair(STREAM_NAME2, NAMESPACE);

  public static final long XID1 = 123123;
  public static final XminStatus XMIN_STATUS1 =
      new XminStatus().withNumWraparound(0L).withXminRawValue(XID1).withXminXidValue(XID1);
  public static final AirbyteMessage XMIN_STATE_MESSAGE_1 = new AirbyteMessage()
      .withType(Type.STATE)
  ...
  public static final XminStatus XMIN_STATUS2 =
      new XminStatus().withNumWraparound(0L).withXminRawValue(XID2).withXminXidValue(XID2);
  public static final AirbyteMessage XMIN_STATE_MESSAGE_2 = new AirbyteMessage()
      .withType(Type.STATE)
      .withState(new AirbyteStateMessage()
          .withType(AirbyteStateType.STREAM)
          .withStream(new AirbyteStreamState()
