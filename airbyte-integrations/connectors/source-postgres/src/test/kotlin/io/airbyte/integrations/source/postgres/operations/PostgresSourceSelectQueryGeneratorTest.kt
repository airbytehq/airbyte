...
class PostgresSourceSelectQueryGeneratorTest {
    ...
    @Test
    fun testSelectMaxCursorUsesMaxForTimestamp() {
        SelectQuerySpec(
                SelectColumnMaxValue(EmittedField("updated_at", OffsetDateTimeFieldType)),
                From("orders", "public"),
            )
            .assertSqlEquals("""SELECT MAX("updated_at") FROM "public"."orders"""")
    }

    @Test
    fun testSelectMaxCursorUsesOrderingForUuid() {
        SelectQuerySpec(
                SelectColumnMaxValue(EmittedField("id", PostgresUuidFieldType)),
    ...
    @Test
    fun testSelectMaxUuidCursorWithWhereClause() {
        val cursor = EmittedField("id", PostgresUuidFieldType)
        ...
        SelectQuerySpec(
            ...
            .assertSqlEquals(
                ...
                lowerBound to PostgresUuidFieldType,
            )
    }
