...
class PostgresExceptionClassifierTest {
    ...
    fun testSocketTimeoutConnectTimedOut() {
        ...
        assertEquals(
            TransientError("Postgres connection timeout: Postgres database connection timed out."),
            result,
        )
    }
    ...
    fun testConnectionAttemptFailed() {
        ...
        assertEquals(
            TransientError("Postgres connection error: Postgres database connection failed."),
            result,
        )
    }
