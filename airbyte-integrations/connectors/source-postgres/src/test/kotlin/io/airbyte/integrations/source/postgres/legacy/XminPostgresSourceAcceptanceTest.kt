...
class XminPostgresSourceAcceptanceTest : AbstractPostgresSourceAcceptanceTest() {
    ...
    @get:Throws(Exception::class) override val configuredCatalog: ConfiguredAirbyteCatalog
                ...
                ConfiguredAirbyteStream()
                    ...
                    .withStream(
                        CatalogHelpers.createAirbyteStream(
                            ...
                            .withSupportedSyncModes(Lists.newArrayList<SyncMode?>(SyncMode.INCREMENTAL))
    ...
    @get:Throws(Exception::class) override val state: JsonNode?
