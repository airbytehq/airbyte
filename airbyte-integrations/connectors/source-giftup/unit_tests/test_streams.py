...
import pytest
from source_giftup.source import GiftupStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GiftupStream, "path", "v0/example_endpoint")
    mocker.patch.object(GiftupStream, "primary_key", "test_primary_key")
    mocker.patch.object(GiftupStream, "__abstractmethods__", set())
