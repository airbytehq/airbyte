...
import pytest
from source_graffle.source import GraffleStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GraffleStream, "path", "v0/example_endpoint")
    mocker.patch.object(GraffleStream, "primary_key", "test_primary_key")
    mocker.patch.object(GraffleStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = GraffleStream()
