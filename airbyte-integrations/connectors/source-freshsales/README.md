...
This is the repository for the Freshsales Yaml configuration based source connector.
...
```
./gradlew :airbyte-integrations:connectors:source-freshsales:build
```
...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-freshsales:dev`.
...
```Dockerfile
FROM airbyte/source-freshsales:latest
...
docker run airbyte/source-freshsales:dev spec
```
#### Run
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-freshsales:check
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-freshsales:integrationTest
```
