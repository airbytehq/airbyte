...
import pytest
from source_freshsales.source import FreshsalesStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(FreshsalesStream, "path", "v0/example_endpoint")
    mocker.patch.object(FreshsalesStream, "primary_key", "test_primary_key")
    mocker.patch.object(FreshsalesStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = FreshsalesStream()
