# Zoho Books
This directory contains the manifest-only connector for `source-zoho-books`.
...
### Build
This will create a dev image (`source-zoho-books:dev`) that you can use to test the connector locally.
```bash
