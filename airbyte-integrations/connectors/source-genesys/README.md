...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-genesys:dev`.
...
```Dockerfile
FROM airbyte/source-genesys:latest
...
docker run airbyte/source-genesys:dev spec
```
#### Run
