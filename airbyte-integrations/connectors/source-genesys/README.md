...
This is the repository for the Genesys source connector, written in Python. For information about
how to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.io/integrations/sources/genesys).
...
[documentation](https://docs.airbyte.io/integrations/sources/genesys) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_genesys/spec.yaml`
...
`source genesys test creds` and place them into `secrets/config.json`.
