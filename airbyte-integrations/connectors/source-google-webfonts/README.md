...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-google-webfonts:dev`.
...
```Dockerfile
FROM airbyte/source-google-webfonts:latest
...
docker run airbyte/source-google-webfonts:dev spec
```
#### Run
