...
import pytest
from source_compusense.source import CompusenseStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(CompusenseStream, "path", "v0/example_endpoint")
    mocker.patch.object(CompusenseStream, "primary_key", "test_primary_key")
    mocker.patch.object(CompusenseStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = CompusenseStream()
