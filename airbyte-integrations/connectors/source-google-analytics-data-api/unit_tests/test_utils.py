...
class TestSerializeToDateString:
    ...
    @pytest.mark.parametrize("input_date, date_format, date_type, expected", [
...
class TestTransformFilters:
    ...
    @pytest.mark.parametrize("filter_data, expected", [
        ({
            "fromValue": {"value_type": "doubleValue", "value": "10.5"},
            "toValue": {"value_type": "doubleValue", "value": "20.5"}
         }, {
            "betweenFilter": {
                "fromValue": {"doubleValue": 10.5},
                "toValue": {"doubleValue": 20.5}
            }
         }),
        ({
            "fromValue": {"value_type": "stringValue", "value": "hello"},
            "toValue": {"value_type": "stringValue", "value": "world"}
         }, {
            "betweenFilter": {
                "fromValue": {"stringValue": "hello"},
                "toValue": {"stringValue": "world"}
            }
         }),
        ({
            "fromValue": {"value_type": "doubleValue", "value": 10.5},
...
class TestGetSourceDefinedPrimaryKey:
    ...
    @pytest.mark.parametrize("stream_name, mocked_content, expected", [
        ("sample_stream", {
            "streams": [{
                "stream": {
                    "name": "sample_stream",
...
class TestTransformJson:
    ...
    @pytest.mark.parametrize("original, expected", [
        ({
            ...
            "expressions": [
                {"field": "field1", "condition": "cond1"},
                {"field": "field2", "condition": "cond2"}
            ]
         }, {
            "andGroup": {
                "expressions": [
        ...
        ({
            "filter_type": "orGroup",
            "expressions": [{"field": "field1", "condition": "cond1"}]
         }, {
            "orGroup": {
                "expressions": [{"transformed": {"field": "field1", "condition": "cond1"}}]
            }
         }),
        ({
            "filter_type": "notExpression",
            "expression": {"field": "field1", "condition": "cond1"}
         }, {
            "notExpression": {
                "transformed": {"field": "field1", "condition": "cond1"}
            }
