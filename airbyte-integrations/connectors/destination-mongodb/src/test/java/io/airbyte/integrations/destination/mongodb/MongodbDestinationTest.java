...
class MongodbDestinationTest {
  ...
  private static final JsonNode standaloneConfig =
      Jsons.jsonNode(
          ImmutableMap.builder()
              ...
              .put("tls", false)
              .build());
  private static final JsonNode standaloneTlsConfig =
      Jsons.jsonNode(
          ImmutableMap.builder()
              .put("instance", "standalone")
              .put("host", "localhost")
              ...
              .put("tls", true)
              .build());
  private static final JsonNode replicaWithNameConfig =
      Jsons.jsonNode(
          ImmutableMap.builder()
              ...
              .build());
  private static final JsonNode replicaWithoutNameConfig =
      Jsons.jsonNode(
          ImmutableMap.builder()
              .put("instance", "replica")
              .put("server_addresses", "localhost1:27017,localhost2:27017")
              .build());
  private static final JsonNode atlasConfig =
      Jsons.jsonNode(
          ImmutableMap.builder()
              .put("instance", "atlas")
  ...
  private static final JsonNode authConfig =
      Jsons.jsonNode(
          ImmutableMap.builder()
