...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-gainsight-px:dev`.
...
```Dockerfile
FROM airbyte/source-gainsight-px:latest
...
docker run airbyte/source-gainsight-px:dev spec
```
#### Run
