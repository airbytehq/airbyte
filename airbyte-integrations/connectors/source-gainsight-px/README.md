...
This is the repository for the Gainsight-Px source connector, written in Python.
...
```
poetry run source-gainsight-px spec
poetry run source-gainsight-px check --config secrets/config.json
poetry run source-gainsight-px discover --config secrets/config.json
poetry run source-gainsight-px read --config secrets/config.json --catalog sample_files/configured_catalog.json
```
