...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-close-com:dev`.
...
```Dockerfile
FROM airbyte/source-close-com:latest
...
docker run airbyte/source-close-com:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/close-com.md`).
