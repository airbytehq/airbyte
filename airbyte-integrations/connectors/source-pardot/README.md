...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-pardot:dev`.
...
```Dockerfile
FROM airbyte/source-pardot:latest
...
docker run airbyte/source-pardot:dev spec
```
#### Run
