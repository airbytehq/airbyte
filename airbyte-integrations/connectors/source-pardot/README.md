...
This is the repository for the Pardot source connector, written in Python. For information about how
to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.io/integrations/sources/pardot).
...
[documentation](https://docs.airbyte.io/integrations/sources/pardot) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_pardot/spec.json`
...
`source pardot test creds` and place them into `secrets/config.json`.
