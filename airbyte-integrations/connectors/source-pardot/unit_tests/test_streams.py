...
import pytest
from source_pardot.source import PardotStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(PardotStream, "path", "v0/example_endpoint")
    mocker.patch.object(PardotStream, "primary_key", "test_primary_key")
    mocker.patch.object(PardotStream, "__abstractmethods__", set())
