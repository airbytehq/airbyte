...
import pytest
from source_huawei_ads.source import HuaweiAdsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(HuaweiAdsStream, "path", "v0/example_endpoint")
    mocker.patch.object(HuaweiAdsStream, "primary_key", "test_primary_key")
    mocker.patch.object(HuaweiAdsStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = HuaweiAdsStream()
