...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-senseforce:dev`.
...
```Dockerfile
FROM airbyte/source-senseforce:latest
...
docker run airbyte/source-senseforce:dev spec
```
#### Run
