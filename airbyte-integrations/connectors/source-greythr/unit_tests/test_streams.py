...
import pytest
from source_greythr.source import GreythrStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GreythrStream, "path", "v0/example_endpoint")
    mocker.patch.object(GreythrStream, "primary_key", "test_primary_key")
    mocker.patch.object(GreythrStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = GreythrStream()
