...
import pytest
from source_mintegral.source import MintegralStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MintegralStream, "path", "v0/example_endpoint")
    mocker.patch.object(MintegralStream, "primary_key", "test_primary_key")
    mocker.patch.object(MintegralStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = MintegralStream()
