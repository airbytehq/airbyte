...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-commercetools:dev`.
...
```Dockerfile
FROM airbyte/source-commercetools:latest
...
docker run airbyte/source-commercetools:dev spec
```
#### Run
