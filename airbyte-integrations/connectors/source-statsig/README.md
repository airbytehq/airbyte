# Statsig
This directory contains the manifest-only connector for `source-statsig`.
...
### Build
This will create a dev image (`source-statsig:dev`) that you can use to test the connector locally.
```bash
