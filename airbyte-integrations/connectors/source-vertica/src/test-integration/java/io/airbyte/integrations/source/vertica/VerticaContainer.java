...
public class VerticaContainer extends JdbcDatabaseContainer<VerticaContainer> {
    ...
    private static final DockerImageName DEFAULT_IMAGE_NAME = DockerImageName.parse("vertica/vertica-ce:latest");
...
//        this(DEFAULT_IMAGE_NAME.withTag(DEFAULT_TAG));
    ...
    public String getJdbcUrl() {
        String jdbcUrl = "jdbc:vertica://140.236.88.151:5433/airbyte";
        return jdbcUrl;
    }
