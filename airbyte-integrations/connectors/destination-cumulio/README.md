...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/destination-cumulio:dev`.
...
```Dockerfile
FROM airbyte/destination-cumulio:latest
...
docker run airbyte/destination-cumulio:dev spec
```
#### Run
