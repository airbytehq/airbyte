...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-twitter:dev`.
...
```Dockerfile
FROM airbyte/source-twitter:latest
...
docker run airbyte/source-twitter:dev spec
```
#### Run
