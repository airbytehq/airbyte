...
This is the repository for the Klaviyo configuration based source connector.
...
```
./gradlew :airbyte-integrations:connectors:source-klaviyo:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-klaviyo:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-klaviyo:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-klaviyo:integrationTest
```
