...
class SomeIncrementalStream(SomeStream):
...
class TestKlaviyoStream:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ({"end": 108, "total": 0, "page": 9}, {"page": 10}),  # first page
...
class TestIncrementalKlaviyoStream:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (None, {"updated_at": START_DATE.int_timestamp + 1}, {"api_key": "some_key", "count": 100, "sort": "asc", "since": 123}),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ({"updated_at": 11}, {"updated_at": 10, "some_field": 100}, {"updated_at": 10}),
...
class TestReverseIncrementalKlaviyoStream:
    ...
    def test_state_checkpoint_interval(self):
        ...
        stream.request_params(stream_state={"updated_at": 1000})
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (None, {"updated_at": 1000}, {"api_key": "some_key", "count": 100, "sort": "asc"}),
            ({"page": 10}, {"updated_at": 1000}, {"api_key": "some_key", "count": 100, "sort": "asc", "page": 10}),
        ],
    )
    def test_request_params(self, next_page_token, stream_state, expected_params):
        stream = SomeReverseIncrementalStream(api_key="some_key", start_date=START_DATE.isoformat())
