...
from source_klaviyo.streams import Campaigns, CampaignsDetailed, CampaignMessages, IncrementalKlaviyoStream, KlaviyoStream
...
class TestCampaignsAndCampaignMessagesStream:
    def test_read_records(self, requests_mock):
        ...
        requests_mock.register_uri(
            ...
            status_code=200,
            json={"data": campaigns_input_records},
            complete_qs=True,
        )
        requests_mock.register_uri(
            "GET",
        ...
        inputs = {"sync_mode": SyncMode.full_refresh, "cursor_field": campaigns_stream.cursor_field, "stream_state": None}
        ...
        records = [_record for _slice in campaigns_stream.stream_slices(**inputs) for _record in campaigns_stream.read_records(stream_slice=_slice, **inputs)]
        assert records == expected_records
