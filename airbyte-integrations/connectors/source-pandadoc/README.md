# PandaDoc
This directory contains the manifest-only connector for `source-pandadoc`.
...
### Build
This will create a dev image (`source-pandadoc:dev`) that you can use to test the connector locally.
```bash
