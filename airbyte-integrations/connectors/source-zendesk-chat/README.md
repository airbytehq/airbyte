...
This is the repository for the Zendesk-Chat source connector, written in Python. For information
about how to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.com/integrations/sources/zendesk-chat).
...
[documentation](https://docs.airbyte.com/integrations/sources/zendesk-chat) to generate the
necessary credentials. Then create a file `secrets/config.json` conforming to the
`source_zendesk_chat/spec.yaml` file. Note that any directory named `secrets` is gitignored across
