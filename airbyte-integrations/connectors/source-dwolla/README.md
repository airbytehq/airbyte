# Dwolla
This directory contains the manifest-only connector for `source-dwolla`.
...
### Build
This will create a dev image (`source-dwolla:dev`) that you can use to test the connector locally.
```bash
