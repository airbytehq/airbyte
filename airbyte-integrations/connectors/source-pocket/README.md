...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-pocket:dev`.
...
```Dockerfile
FROM airbyte/source-pocket:latest
...
docker run airbyte/source-pocket:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/pocket.md`).
