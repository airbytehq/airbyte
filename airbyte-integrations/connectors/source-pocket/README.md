...
This is the repository for the Pocket configuration based source connector. For information about
how to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.io/integrations/sources/pocket).
...
[documentation](https://docs.airbyte.io/integrations/sources/pocket) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_pocket/spec.yaml`
...
`source pocket test creds` and place them into `secrets/config.json`.
...
An image will be built with the tag `airbyte/source-pocket:dev`.
