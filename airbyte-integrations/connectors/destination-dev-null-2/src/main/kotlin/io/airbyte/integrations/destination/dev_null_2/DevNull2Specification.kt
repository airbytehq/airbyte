...
sealed class DevNull2Specification : ConfigurationSpecification() {
...
class DevNull2SpecificationOss : DevNull2Specification() {
...
data class LoggingDestination(
    ...
    @JsonPropertyDescription("Configure how the messages are logged.")
...
class DevNull2SpecificationCloud : DevNull2Specification() {
    @JsonProperty("test_destination")
    @JsonSchemaTitle("Test Destination")
    @JsonPropertyDescription("The type of destination to be used")
...
@Singleton
class DevNull2SpecificationExtension : DestinationSpecificationExtension {
