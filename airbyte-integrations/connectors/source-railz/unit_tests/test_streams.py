...
import pytest
from source_railz.source import RailzStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(RailzStream, "path", "v0/example_endpoint")
    mocker.patch.object(RailzStream, "primary_key", "test_primary_key")
    mocker.patch.object(RailzStream, "__abstractmethods__", set())
