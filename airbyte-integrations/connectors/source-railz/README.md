...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-railz:dev`.
...
```Dockerfile
FROM airbyte/source-railz:latest
...
docker run airbyte/source-railz:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/railz.md`).
