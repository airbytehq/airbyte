...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-looker:dev`.
...
```Dockerfile
FROM airbyte/source-looker:latest
...
docker run airbyte/source-looker:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/looker.md`).
