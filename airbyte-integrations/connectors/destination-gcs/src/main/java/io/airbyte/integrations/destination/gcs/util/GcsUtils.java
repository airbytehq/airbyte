...
public class GcsUtils {
  ...
  private static final Schema NULLABLE_TIMESTAMP_MILLIS = SchemaBuilder.builder()
      .unionOf()
      .nullType()
      .and()
  ...
  public static Schema getDefaultAvroSchema(
      final String name, @Nullable final String namespace, final boolean appendAirbyteFields) {
