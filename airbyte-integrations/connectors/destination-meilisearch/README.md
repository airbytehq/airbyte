...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/destination-meilisearch:dev`.
...
```Dockerfile
FROM airbyte/destination-meilisearch:latest
...
docker run airbyte/destination-meilisearch:dev spec
```
#### Run
