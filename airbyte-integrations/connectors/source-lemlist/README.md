...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-lemlist:dev`.
...
```Dockerfile
FROM airbyte/source-lemlist:latest
...
docker run airbyte/source-lemlist:dev spec
```
#### Run
