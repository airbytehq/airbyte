...
```
poetry run source-lemlist spec
poetry run source-lemlist check --config secrets/config.json
poetry run source-lemlist discover --config secrets/config.json
poetry run source-lemlist read --config secrets/config.json --catalog sample_files/configured_catalog.json
```
