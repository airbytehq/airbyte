...
### Integration Tests
1. From the airbyte project root, run `./gradlew :airbyte-integrations:connectors:source-scaffold-source-python:integrationTest` to run the standard integration test suite.
