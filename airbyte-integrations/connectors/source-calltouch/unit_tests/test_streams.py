...
import pytest
from source_calltouch.source import CalltouchStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(CalltouchStream, "path", "v0/example_endpoint")
    mocker.patch.object(CalltouchStream, "primary_key", "test_primary_key")
    mocker.patch.object(CalltouchStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = CalltouchStream()
