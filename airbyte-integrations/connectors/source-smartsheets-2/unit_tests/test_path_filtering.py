...
@pytest.mark.parametrize(
    ("sheets", "patterns"),
    [
        ([(MockObject("Foxtrot Golf Hotel v1.5"), ["/", "Alpha", "Beta", "Charlie Delta", "Echo"])], ["/*/*beta*/*/*/*golf hotel*"]),
        ([(MockObject("Foxtrot Golf Hotel v1.5"), ["/", "Alpha", "Charlie Delta", "Echo"])], ["/*/*/*/*golf hotel*"]),
    ],
)
...
@pytest.mark.parametrize(
    ("sheets", "patterns"),
    [
        ([(MockObject("Foxtrot Golf Hotel v1.5"), ["/", "Alpha", "Beta", "Charlie Delta", "Echo"])], ["/*/*beta*/*/*/*indigo juliet*"]),
        ([(MockObject("Foxtrot Golf Hotel v1.5"), ["/", "Alpha", "Charlie Delta", "Echo"])], ["/*/*/*/*indigo juliet*"]),
    ],
)
...
@pytest.mark.parametrize(
    ("folders", "patterns"),
    [
        ([(MockObject("Charlie Delta"), ["/", "Alpha", "Beta"])], ["/*/*/* delta*"]),
        ([(MockObject("Echo"), ["/", "Alpha", "Beta", "Charlie Delta"])], ["**/echo"]),
    ],
)
...
@pytest.mark.parametrize(
    ("folders", "patterns"),
    [
        ([(MockObject("Echo"), ["/", "Alpha", "Beta", "Charlie Delta"])], ["/foxtrot"]),
        ([(MockObject("Echo"), ["/", "Alpha", "Beta", "Charlie Delta"])], ["**/foxtrot"]),
    ],
)
