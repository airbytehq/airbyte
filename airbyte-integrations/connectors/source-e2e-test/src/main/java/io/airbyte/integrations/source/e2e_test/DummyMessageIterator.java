...
import static io.airbyte.integrations.source.e2e_test.DummyIterator.OBJECT_MAPPER;

public class DummyMessageIterator implements AutoCloseableIterator<AirbyteMessage> {

    public static final ObjectMapper SMILE_MAPPER = initSmileMapper();
    ...
    private static final Map<String, String> CONSTANT_DATA_MAP = createConstantData();

    private static final JsonNode CONSTANT_JSON_DATA = OBJECT_MAPPER.valueToTree(CONSTANT_DATA_MAP);
    ...
    public static ObjectMapper initSmileMapper() {
        return configure(new SmileMapper());
    }
