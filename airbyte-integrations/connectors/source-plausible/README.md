...
```
./gradlew :airbyte-integrations:connectors:source-plausible:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-plausible:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-plausible:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-plausible:integrationTest
```
