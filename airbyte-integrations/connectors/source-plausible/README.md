...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-plausible:dev`.
...
```Dockerfile
FROM airbyte/source-plausible:latest
...
docker run airbyte/source-plausible:dev spec
```
#### Run
