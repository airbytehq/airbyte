...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-spacex-api:dev`.
...
```Dockerfile
FROM airbyte/source-spacex-api:latest
...
docker run airbyte/source-spacex-api:dev spec
```
#### Run
