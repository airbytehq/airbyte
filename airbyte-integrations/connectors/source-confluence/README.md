...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-confluence:dev`.
...
```Dockerfile
FROM airbyte/source-confluence:latest
...
docker run airbyte/source-confluence:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/confluence.md`).
