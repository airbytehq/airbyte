...
import pytest
from source_confluence.source import ConfluenceStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ConfluenceStream, "path", "v0/example_endpoint")
    mocker.patch.object(ConfluenceStream, "primary_key", "test_primary_key")
    mocker.patch.object(ConfluenceStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ConfluenceStream()
