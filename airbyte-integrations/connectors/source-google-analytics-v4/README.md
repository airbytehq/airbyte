...
[the documentation](https://docs.airbyte.com/integrations/sources/google-analytics-v4).
...
[documentation](https://docs.airbyte.com/integrations/sources/google-analytics-v4) to generate the
necessary credentials. Then create a file `secrets/config.json` conforming to the
`source_google_analytics_v4/spec.yaml` file. Note that any directory named `secrets` is gitignored
