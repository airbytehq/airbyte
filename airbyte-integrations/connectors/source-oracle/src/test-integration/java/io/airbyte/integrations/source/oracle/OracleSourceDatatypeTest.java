...
public class OracleSourceDatatypeTest extends AbstractSourceDatabaseTypeTest {
  ...
  protected void initTests() {
    ...
    addDataTypeTestData(TestDataHolder.builder()
        ...
        .addInsertValues(
            "null", "1", "123.45", "power(10, -130)", "9.99999999999999999999 * power(10, 125)")
        ...
        .addExpectedValues(
            ...
            "1",
            "123.45",
            String.valueOf(Math.pow(10, -130)),
    ...
    addDataTypeTestData(TestDataHolder.builder()
        ...
        .airbyteType(JsonSchemaType.NUMBER)
        .addInsertValues(
            "126.45d", "2.22507485850720E-308", "1.79769313486231E+308d", "BINARY_DOUBLE_INFINITY")
    ...
    addDataTypeTestData(TestDataHolder.builder()
        ...
        .airbyteType(JsonSchemaType.STRING)
        .addInsertValues(
            "to_timestamp('2020-06-10 06:14:00.742', 'YYYY-MM-DD HH24:MI:SS.FF')",
    ...
    addDataTypeTestData(TestDataHolder.builder()
        ...
        .addInsertValues(
            "to_timestamp_tz('21-FEB-2009 18:00:00 EST', 'DD-MON-YYYY HH24:MI:SS TZR')",
        ...
        .addExpectedValues(
            "2009-02-21 18:00:00.0 EST",
            "2009-02-21 18:00:00.123456 EST",
            "2009-02-21 18:00:00.0 -5:00",
            "2009-02-21 18:00:00.123456 -5:00")
        .build());
    ...
    addDataTypeTestData(TestDataHolder.builder()
        ...
        .addInsertValues(
            "to_timestamp_tz('21-FEB-2009 18:00:00.000456', 'DD-MON-YYYY HH24:MI:SS.FF')")
