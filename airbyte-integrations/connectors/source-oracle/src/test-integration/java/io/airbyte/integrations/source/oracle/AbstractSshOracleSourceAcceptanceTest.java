...
public abstract class AbstractSshOracleSourceAcceptanceTest extends SourceAcceptanceTest {
  ...
  private AirbyteOracteTestContainer db;
  ...
  private void initAndStartJdbcContainer() {
    db = new AirbyteOracteTestContainer()
        .withUsername("test")
        .withPassword("oracle")
        .usingSid()
        .withNetwork(network);
  ...
  public ImmutableMap.Builder<Object, Object> getBasicOracleDbConfigBuider(final AirbyteOracteTestContainer db) {
