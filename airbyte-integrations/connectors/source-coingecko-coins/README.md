...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-coingecko-coins:dev`.
...
```Dockerfile
FROM airbyte/source-coingecko-coins:latest
...
docker run airbyte/source-coingecko-coins:dev spec
```
#### Run
