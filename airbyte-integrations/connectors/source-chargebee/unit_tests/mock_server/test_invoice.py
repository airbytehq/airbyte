...
from .response_builder import configuration_incompatible_response, invoice_response
...
class TestInvoiceStream(TestCase):
    ...
    def test_incremental_emits_state(self, http_mocker: HttpMocker) -> None:
        ...
        assert latest_cursor_value == 1705312800  # From invoice.json
    ...
    def test_incremental_sync_with_state_and_params(self, http_mocker: HttpMocker) -> None:
        ...
        http_mocker.get(
            RequestBuilder.invoices_endpoint()
    ...
    def test_error_configuration_incompatible_ignored(self, http_mocker: HttpMocker) -> None:
        """Test configuration_incompatible error is ignored for invoice stream as configured in manifest."""
        http_mocker.get(
            RequestBuilder.invoices_endpoint().with_any_query_params().build(),
