...
from .response_builder import configuration_incompatible_response, payment_source_response
...
class TestPaymentSourceStream(TestCase):
    ...
    def test_incremental_emits_state(self, http_mocker: HttpMocker) -> None:
        ...
        assert latest_cursor_value == 1705312800  # From payment_source.json
    ...
    def test_incremental_sync_with_state_and_params(self, http_mocker: HttpMocker) -> None:
        ...
        http_mocker.get(
            RequestBuilder.payment_sources_endpoint()
    ...
    def test_error_configuration_incompatible_ignored(self, http_mocker: HttpMocker) -> None:
        """Test configuration_incompatible error is ignored for payment_source stream as configured in manifest."""
        http_mocker.get(
            RequestBuilder.payment_sources_endpoint().with_any_query_params().build(),
