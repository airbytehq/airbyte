...
from .response_builder import configuration_incompatible_response, transaction_response
from .utils import config, read_output


_STREAM_NAME = "transaction"
...
class TestTransactionStream(TestCase):
    ...
    def test_incremental_emits_state(self, http_mocker: HttpMocker) -> None:
        ...
        assert latest_cursor_value == 1705312800  # From transaction.json
    ...
    def test_error_configuration_incompatible_ignored(self, http_mocker: HttpMocker) -> None:
        """Test configuration_incompatible error is ignored for transaction stream as configured in manifest."""
        http_mocker.get(
            RequestBuilder.transactions_endpoint().with_any_query_params().build(),
