...
def patch_base_class(mocker):
    ...
    mocker.patch.object(Crm_365Stream, "path", "v0/example_endpoint")
    mocker.patch.object(Crm_365Stream, "primary_key", "test_primary_key")
    mocker.patch.object(Crm_365Stream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = Crm_365Stream()
