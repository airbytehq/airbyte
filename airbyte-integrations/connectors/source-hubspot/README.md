...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-hubspot:dev`.
...
```Dockerfile
FROM airbyte/source-hubspot:latest
...
docker run airbyte/source-hubspot:dev spec
```
#### Run
