# Paperform
This directory contains the manifest-only connector for `source-paperform`.
...
### Build
This will create a dev image (`source-paperform:dev`) that you can use to test the connector locally.
```bash
