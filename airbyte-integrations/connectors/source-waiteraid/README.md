...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-waiteraid:dev`.
...
```Dockerfile
FROM airbyte/source-waiteraid:latest
...
docker run airbyte/source-waiteraid:dev spec
```
#### Run
