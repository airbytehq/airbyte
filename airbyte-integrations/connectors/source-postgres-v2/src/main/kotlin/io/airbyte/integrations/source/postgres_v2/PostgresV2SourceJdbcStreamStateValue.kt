...
/** State value for PostgreSQL streams. Tracks checkpoint position for resumability. */
data class PostgresV2SourceJdbcStreamStateValue(
    ...
    companion object {
        ...
        val snapshotCompleted: OpaqueStateValue
            get() =
                Jsons.valueToTree(PostgresV2SourceJdbcStreamStateValue(stateType = "primary_key"))
