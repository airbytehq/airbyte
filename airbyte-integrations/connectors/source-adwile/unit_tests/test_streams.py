...
import pytest
from source_adwile.source import AdwileStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AdwileStream, "path", "v0/example_endpoint")
    mocker.patch.object(AdwileStream, "primary_key", "test_primary_key")
    mocker.patch.object(AdwileStream, "__abstractmethods__", set())
