...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/destination-firestore:dev`.
...
```Dockerfile
FROM airbyte/destination-firestore:latest
...
docker run airbyte/destination-firestore:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/destinations/firestore.md`).
