...
This is the repository for the Teradata source connector in Java. For information about how to use
this connector within Airbyte, see
[the User Documentation](https://docs.airbyte.com/integrations/sources/teradata).
...
Once built, the docker image name and tag on your host will be `airbyte/source-teradata:dev`. the
Dockerfile.
