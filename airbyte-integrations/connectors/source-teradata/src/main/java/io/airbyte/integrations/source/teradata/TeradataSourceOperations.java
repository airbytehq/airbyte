...
public class TeradataSourceOperations extends JdbcSourceOperations {
    ...
    @Override
    protected void putTimestamp(ObjectNode node, String columnName, ResultSet resultSet,
    ...
    @Override
    protected void putTimestampWithTimezone(ObjectNode node, String columnName, ResultSet resultSet,
                                            int index) throws SQLException {
        Timestamp timestamp = (Timestamp) resultSet.getObject(index);
