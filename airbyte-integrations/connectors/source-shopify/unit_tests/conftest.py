...
{"__typename":"FulfillmentLineItem","fulfillment_line_items":{},"id":"gid://shopify/FulfillmentLineItem/4","quantity":2,"line_item":{"id":"gid://shopify/LineItem/5","name":"Widget","quantity":2,"sku":"SKU-1","taxable":true,"title":"Widget","unfulfilledQuantity":0,"vendor":"Vendor","price_set":{"shop_money":{"amount":"10.50","currency_code":"USD"},"presentment_money":{"amount":"10.50","currency_code":"USD"}},"variant":{"id":"gid://shopify/ProductVariant/6","inventoryManagement":"SHOPIFY","title":"Blue"},"product":{"id":"gid://shopify/Product/7"}},"__parentId":"gid://shopify/Fulfillment/2"}
