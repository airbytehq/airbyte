...
import pytest
from source_lever.source import LeverStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(LeverStream, "path", "v0/example_endpoint")
    mocker.patch.object(LeverStream, "primary_key", "test_primary_key")
    mocker.patch.object(LeverStream, "__abstractmethods__", set())
