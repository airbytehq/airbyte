...
```
./gradlew :airbyte-integrations:connectors:source-convertkit:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-convertkit:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-convertkit:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-convertkit:integrationTest
```
