...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-convertkit:dev`.
...
```Dockerfile
FROM airbyte/source-convertkit:latest
...
docker run airbyte/source-convertkit:dev spec
```
#### Run
