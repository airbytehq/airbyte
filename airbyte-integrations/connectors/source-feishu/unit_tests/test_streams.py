...
import pytest
from source_feishu.source import FeishuStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(FeishuStream, "path", "v0/example_endpoint")
    mocker.patch.object(FeishuStream, "primary_key", "test_primary_key")
    mocker.patch.object(FeishuStream, "__abstractmethods__", set())
