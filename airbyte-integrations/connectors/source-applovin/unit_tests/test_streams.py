...
def patch_base_class(mocker):
    ...
    mocker.patch.object(Campaigns, "path", "v0/example_endpoint")
    mocker.patch.object(Campaigns, "primary_key", "test_primary_key")
    mocker.patch.object(Campaigns, "__abstractmethods__", set())
