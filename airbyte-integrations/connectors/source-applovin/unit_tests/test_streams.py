...
def patch_base_class(mocker):
    ...
    mocker.patch.object(CampaignsStream, "path", "v0/example_endpoint")
    mocker.patch.object(CampaignsStream, "primary_key", "test_primary_key")
    mocker.patch.object(CampaignsStream, "__abstractmethods__", set())
