...
import pytest
from source_applovin.source import Applovin2Stream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(Applovin2Stream, "path", "v0/example_endpoint")
    mocker.patch.object(Applovin2Stream, "primary_key", "test_primary_key")
    mocker.patch.object(Applovin2Stream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = Applovin2Stream()
