...
import pytest
from source_applovin.source import ApplovinStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ApplovinStream, "path", "v0/example_endpoint")
    mocker.patch.object(ApplovinStream, "primary_key", "test_primary_key")
    mocker.patch.object(ApplovinStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ApplovinStream()
