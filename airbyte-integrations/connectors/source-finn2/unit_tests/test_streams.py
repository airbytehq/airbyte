...
import pytest
from source_finn2.source import Finn2Stream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(Finn2Stream, "path", "v0/example_endpoint")
    mocker.patch.object(Finn2Stream, "primary_key", "test_primary_key")
    mocker.patch.object(Finn2Stream, "__abstractmethods__", set())
