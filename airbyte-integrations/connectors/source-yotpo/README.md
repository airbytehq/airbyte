...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-yotpo:dev`.
...
```Dockerfile
FROM airbyte/source-yotpo:latest
...
docker run airbyte/source-yotpo:dev spec
```
#### Run
