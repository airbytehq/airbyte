...
public class TestSchema {
  ...
  void testSchema() {
    ...
    final JsonNode spec = Jsons.deserialize(NEW_SPEC).get("connectionSpecification");
    final JsonNode config = Jsons.deserialize(CONFIG);
    assertTrue(validator.validate(spec, config).isEmpty());
  }

  private static final String CONFIG = """
      {"seed": 0, "type": "CONTINUOUS_FEED", "max_messages": 100, "mock_catalog": {"type": "SINGLE_STREAM", "stream_name": "data_stream", "stream_schema": "{ \\"type\\": \\"object\\", \\"properties\\": { \\"column1\\": { \\"type\\": \\"string\\" } } }", "stream_duplication": 1}, "message_interval_ms": 0}
      """;
