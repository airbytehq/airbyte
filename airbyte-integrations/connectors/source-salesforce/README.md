...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-salesforce:dev`.
...
```Dockerfile
FROM airbyte/source-salesforce:latest
...
docker run airbyte/source-salesforce:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/salesforce.md`).
