...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-newsdata:dev`.
...
```Dockerfile
FROM airbyte/source-newsdata:latest
...
docker run airbyte/source-newsdata:dev spec
```
#### Run
