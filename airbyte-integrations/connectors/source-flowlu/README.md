# Flowlu
This directory contains the manifest-only connector for `source-flowlu`.
...
### Build
This will create a dev image (`source-flowlu:dev`) that you can use to test the connector locally.
```bash
