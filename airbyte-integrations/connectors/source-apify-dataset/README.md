...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-apify-dataset:dev`.
...
```Dockerfile
FROM airbyte/source-apify-dataset:latest
...
docker run airbyte/source-apify-dataset:dev spec
```
#### Run
