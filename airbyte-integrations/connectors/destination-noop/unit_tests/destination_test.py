...
from destination_noop.config import ConfigModel
from destination_noop.destination import DestinationPGVector
...
class TestDestinationPGVector(unittest.TestCase):
    ...
    @patch("destination_noop.pgvector_processor.PGVectorProcessor")
