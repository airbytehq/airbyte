...
from destination_noop.common.destinations.record_processor import RecordProcessorBase
from destination_noop.common.state.state_writers import StdOutStateWriter
...
if TYPE_CHECKING:
    ...
    from destination_noop.common.catalog.catalog_providers import CatalogProvider
    from destination_noop.common.state.state_writers import StateWriterBase
