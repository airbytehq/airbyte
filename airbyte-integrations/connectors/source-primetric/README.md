...
```
./gradlew :airbyte-integrations:connectors:source-primetric:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-primetric:buildDockerImage
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-primetric:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-primetric:integrationTest
```
