...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-primetric:dev`.
...
```Dockerfile
FROM airbyte/source-primetric:latest
...
docker run airbyte/source-primetric:dev spec
```
#### Run
