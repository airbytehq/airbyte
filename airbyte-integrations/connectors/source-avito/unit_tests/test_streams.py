...
import pytest
from source_avito.source import AvitoStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AvitoStream, "path", "v0/example_endpoint")
    mocker.patch.object(AvitoStream, "primary_key", "test_primary_key")
    mocker.patch.object(AvitoStream, "__abstractmethods__", set())
