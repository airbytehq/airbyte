...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-rd-station-marketing:dev`.
...
```Dockerfile
FROM airbyte/source-rd-station-marketing:latest
...
docker run airbyte/source-rd-station-marketing:dev spec
```
#### Run
