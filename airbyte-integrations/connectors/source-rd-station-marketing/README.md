...
This is the repository for the RD Station Marketing configuration based source connector.
...
```
./gradlew :airbyte-integrations:connectors:source-rd-station-marketing:build
```
