...
class JsonToAvroConverterTest {
  ...
  // final JsonNode input2 = Jsons.deserialize("{ \"anyOf\": [{ \"type\": \"string\" }, { \"type\":
  // \"integer\" }] }");
  ...
  //
  // @Override
  // public Stream<? extends Arguments> provideArguments(final ExtensionContext context) throws
  // Exception {
  ...
  // public void testFieldTypeConversion(final String fieldName, final JsonNode jsonFieldSchema, final
  // JsonNode avroFieldType) {
  // assertEquals(
  // avroFieldType,
