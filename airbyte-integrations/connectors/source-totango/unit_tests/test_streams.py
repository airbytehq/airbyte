...
import pytest
from source_totango.source import TotangoStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TotangoStream, "path", "v0/example_endpoint")
    mocker.patch.object(TotangoStream, "primary_key", "test_primary_key")
    mocker.patch.object(TotangoStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = TotangoStream()
