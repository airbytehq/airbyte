...
class DatascopeIncrementalStream(DatascopeStream, ABC):
    ...
    def request_params(
        self, next_page_token: Mapping[str, Any] = None, stream_state: Mapping[str, Any] = None, **kwargs
...
class SourceDatascope(AbstractSource):
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        ...
        return [
            Forms(authenticator=auth, token=config["api_key"], form_id=config["form_id"], start_date=start_date, schema_type=schema_type)
        ]
