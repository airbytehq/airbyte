...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-tempo:dev`.
...
```Dockerfile
FROM airbyte/source-tempo:latest
...
docker run airbyte/source-tempo:dev spec
```
#### Run
