...
import pytest
from source_shein.source import SheinStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SheinStream, "path", "v0/example_endpoint")
    mocker.patch.object(SheinStream, "primary_key", "test_primary_key")
    mocker.patch.object(SheinStream, "__abstractmethods__", set())
