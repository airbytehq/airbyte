...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-zendesk-sell:dev`.
...
```Dockerfile
FROM airbyte/source-zendesk-sell:latest
...
docker run airbyte/source-zendesk-sell:dev spec
```
#### Run
