...
import pytest
from source_rapidap.source import RapidapStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(RapidapStream, "path", "v0/example_endpoint")
    mocker.patch.object(RapidapStream, "primary_key", "test_primary_key")
    mocker.patch.object(RapidapStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = RapidapStream()
