...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/destination-rabbitmq:dev`.
...
```Dockerfile
FROM airbyte/destination-rabbitmq:latest
...
docker run airbyte/destination-rabbitmq:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/destinations/rabbitmq.md`).
