...
```
./gradlew :airbyte-integrations:connectors:destination-rabbitmq:build
```
...
```
./gradlew :airbyte-integrations:connectors:destination-rabbitmq:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:destination-rabbitmq:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:destination-rabbitmq:integrationTest
```
