...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-aha:dev`.
...
```Dockerfile
FROM airbyte/source-aha:latest
...
docker run airbyte/source-aha:dev spec
```
#### Run
