...
This is the repository for the Aha source connector, written in Python.
...
poetry run source-aha read --config secrets/config.json --catalog sample_files/configured_catalog.json
```
