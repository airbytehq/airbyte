...
import pytest
from source_kustomer.source import KustomerStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(KustomerStream, "path", "v0/example_endpoint")
    mocker.patch.object(KustomerStream, "primary_key", "test_primary_key")
    mocker.patch.object(KustomerStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = KustomerStream()
