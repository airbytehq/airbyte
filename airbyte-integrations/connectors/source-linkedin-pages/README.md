...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-linkedin-pages:dev`.
...
```Dockerfile
FROM airbyte/source-linkedin-pages:latest
...
docker run airbyte/source-linkedin-pages:dev spec
```
#### Run
