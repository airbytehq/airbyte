...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-braintree:dev`.
...
```Dockerfile
FROM airbyte/source-braintree:latest
...
docker run airbyte/source-braintree:dev spec
```
#### Run
