...
import pytest
from source_jagajam_new.source import JagajamNewStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(JagajamNewStream, "path", "v0/example_endpoint")
    mocker.patch.object(JagajamNewStream, "primary_key", "test_primary_key")
    mocker.patch.object(JagajamNewStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = JagajamNewStream()
