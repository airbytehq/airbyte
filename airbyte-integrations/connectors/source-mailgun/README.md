...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-mailgun:dev`.
...
```Dockerfile
FROM airbyte/source-mailgun:latest
...
docker run airbyte/source-mailgun:dev spec
```
#### Run
