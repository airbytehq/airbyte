...
import pytest
from source_yabbi.source import YabbiStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(YabbiStream, "path", "v0/example_endpoint")
    mocker.patch.object(YabbiStream, "primary_key", "test_primary_key")
    mocker.patch.object(YabbiStream, "__abstractmethods__", set())
