...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-ringcentral:dev`.
...
```Dockerfile
FROM airbyte/source-ringcentral:latest
...
docker run airbyte/source-ringcentral:dev spec
```
#### Run
