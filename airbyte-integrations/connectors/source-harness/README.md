...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-harness:dev`.
...
```Dockerfile
FROM airbyte/source-harness:latest
...
docker run airbyte/source-harness:dev spec
```
#### Run
