...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-opsgenie:dev`.
...
```Dockerfile
FROM airbyte/source-opsgenie:latest
...
docker run airbyte/source-opsgenie:dev spec
```
#### Run
