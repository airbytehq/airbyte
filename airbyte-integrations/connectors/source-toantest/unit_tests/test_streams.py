...
import pytest
from source_toantest.source import ToantestStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ToantestStream, "path", "v0/example_endpoint")
    mocker.patch.object(ToantestStream, "primary_key", "test_primary_key")
    mocker.patch.object(ToantestStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ToantestStream()
