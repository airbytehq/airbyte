...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-survey-sparrow:dev`.
...
```Dockerfile
FROM airbyte/source-survey-sparrow:latest
...
docker run airbyte/source-survey-sparrow:dev spec
```
#### Run
