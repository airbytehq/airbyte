...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-mailjet-mail:dev`.
...
```Dockerfile
FROM airbyte/source-mailjet-mail:latest
...
docker run airbyte/source-mailjet-mail:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/mailjet-mail.md`).
