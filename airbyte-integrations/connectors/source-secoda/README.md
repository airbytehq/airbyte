...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-secoda:dev`.
...
```Dockerfile
FROM airbyte/source-secoda:latest
...
docker run airbyte/source-secoda:dev spec
```
#### Run
