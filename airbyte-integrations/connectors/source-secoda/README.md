...
```
./gradlew :airbyte-integrations:connectors:source-secoda:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-secoda:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-secoda:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-secoda:integrationTest
```
