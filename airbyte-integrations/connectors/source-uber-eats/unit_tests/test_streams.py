...
import pytest
from source_uber_eats.source import UberEatsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(UberEatsStream, "path", "v0/example_endpoint")
    mocker.patch.object(UberEatsStream, "primary_key", "test_primary_key")
    mocker.patch.object(UberEatsStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = UberEatsStream()
