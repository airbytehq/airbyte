...
import pytest
from source_abwe.source import SourceAbwe


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SourceAbwe, "path", "v0/example_endpoint")
    mocker.patch.object(SourceAbwe, "primary_key", "test_primary_key")
    mocker.patch.object(SourceAbwe, "__abstractmethods__", set())
