...
This directory contains the manifest-only connector for `source-pabbly-subscriptions-billing`.
...
### Build
This will create a dev image (`source-pabbly-subscriptions-billing:dev`) that you can use to test the connector locally.
```bash
