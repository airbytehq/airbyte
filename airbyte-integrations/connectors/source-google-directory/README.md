...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-google-directory:dev`.
...
```Dockerfile
FROM airbyte/source-google-directory:latest
...
docker run airbyte/source-google-directory:dev spec
```
#### Run
