...
class DatabricksDataCoercionTest(
    ...
    @ParameterizedTest
    @MethodSource(
        "io.airbyte.integrations.destination.databricksv2.component.DatabricksDataCoercionTest#numbers"
    )
    ...
    @ParameterizedTest
    @MethodSource(
        "io.airbyte.integrations.destination.databricksv2.component.DatabricksDataCoercionTest#timestampTz"
    )
    ...
    @ParameterizedTest
    @MethodSource(
        "io.airbyte.integrations.destination.databricksv2.component.DatabricksDataCoercionTest#timestampNtz"
    )
    ...
    @ParameterizedTest
    @MethodSource(
        "io.airbyte.integrations.destination.databricksv2.component.DatabricksDataCoercionTest#date"
    )
    ...
    @ParameterizedTest
    @MethodSource(
        "io.airbyte.integrations.destination.databricksv2.component.DatabricksDataCoercionTest#strings"
    )
