# Invoiceninja
This directory contains the manifest-only connector for `source-invoiceninja`.
...
### Build
This will create a dev image (`source-invoiceninja:dev`) that you can use to test the connector locally.
```bash
