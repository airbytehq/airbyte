...
@dataclass
class UnnestingDpathExtractor(RecordExtractor):
    """
    ...
    def extract_records(self, response: requests.Response) -> List[Mapping[str, Any]]:
        ...
        return self.extract_from_json(response_body)

    def extract_from_json(self, response_body: Mapping[str, Any]) -> List[Mapping[str, Any]]:
        ...
        if self.unnest_extractor:
            return self.unnest_fields(extracted)
