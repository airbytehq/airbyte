...
from source_netsuite.streams import CustomIncrementalNetsuiteStream, IncrementalNetsuiteStream, NetsuiteStream, CustomInventory, CustomSalesOrder, CustomProduction, CustomWholesale, CustomItem, CustomFulfillmentItem
...
class SourceNetsuite(AbstractSource):
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        ...
        streams.append(CustomFulfillmentItem(**input_args))
