...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-chartmogul:dev`.
...
```Dockerfile
FROM airbyte/source-chartmogul:latest
...
docker run airbyte/source-chartmogul:dev spec
```
#### Run
