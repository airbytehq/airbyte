...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-copper:dev`.
...
```Dockerfile
FROM airbyte/source-copper:latest
...
docker run airbyte/source-copper:dev spec
```
#### Run
