...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-open-exchange-rates:dev`.
...
```Dockerfile
FROM airbyte/source-open-exchange-rates:latest
...
docker run airbyte/source-open-exchange-rates:dev spec
```
#### Run
