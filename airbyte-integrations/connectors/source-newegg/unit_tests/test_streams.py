...
import pytest
from source_newegg.source import NeweggStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(NeweggStream, "path", "v0/example_endpoint")
    mocker.patch.object(NeweggStream, "primary_key", "test_primary_key")
    mocker.patch.object(NeweggStream, "__abstractmethods__", set())
