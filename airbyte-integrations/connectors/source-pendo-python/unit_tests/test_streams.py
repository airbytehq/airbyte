...
import pytest
from source_pendo_python.source import PendoPythonStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(PendoPythonStream, "path", "v0/example_endpoint")
    mocker.patch.object(PendoPythonStream, "primary_key", "test_primary_key")
