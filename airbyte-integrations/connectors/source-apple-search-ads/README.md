...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-apple-search-ads:dev`.
...
```Dockerfile
FROM airbyte/source-apple-search-ads:latest
...
docker run airbyte/source-apple-search-ads:dev spec
```
#### Run
