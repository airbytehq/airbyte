...
- [Campaign-Level Report](https://developer.apple.com/documentation/apple_ads/get-campaign-level-reports)
- [Ad Group-Level Report](https://developer.apple.com/documentation/apple_ads/get-ad-group-level-reports)
- [Keyword-Level Report](https://developer.apple.com/documentation/apple_ads/get-keyword-level-reports)
- [Ad-Level Report](https://developer.apple.com/documentation/apple_ads/get-ad-level-reports)
...
At the moment, report streams are only set to the `DAILY` granularity (e.g: `campaigns_report_daily`, `adgroups_report_daily`, `keywords_report_daily`, `ads_report_daily`).
