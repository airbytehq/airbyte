...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-gutendex:dev`.
...
```Dockerfile
FROM airbyte/source-gutendex:latest
...
docker run airbyte/source-gutendex:dev spec
```
#### Run
