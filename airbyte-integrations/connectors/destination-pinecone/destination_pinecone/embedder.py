...
from destination_pinecone.config import FakeEmbeddingConfigModel, OpenAIEmbeddingConfigModel, CohereEmbeddingConfigModel, HuggingFaceEmbeddingConfigModel
...
class HuggingFaceEmbedder(Embedder):
    def __init__(self, config: HuggingFaceEmbeddingConfigModel):
        super().__init__()
        self.embeddings = HuggingFaceEmbeddings(model_name="sentence-transformers/all-mpnet-base-v2", model_kwargs={"device": "cpu"}, encode_kwargs={ "normalize_embeddings": False })
