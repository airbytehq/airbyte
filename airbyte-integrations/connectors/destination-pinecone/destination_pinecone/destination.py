...
from destination_pinecone.embedder import Embedder, FakeEmbedder, OpenAIEmbedder, CohereEmbedder, HuggingFaceEmbedder
...
embedder_map = {"openai": OpenAIEmbedder, "cohere": CohereEmbedder, "huggingface": HuggingFaceEmbedder, "fake": FakeEmbedder}
