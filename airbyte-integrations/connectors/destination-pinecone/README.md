...
```
./gradlew :airbyte-integrations:connectors:destination-pinecone:build
```
...
```
./gradlew :airbyte-integrations:connectors:destination-pinecone:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:destination-pinecone:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:destination-pinecone:integrationTest
```
