...
import pytest
from source_stripe_alex.stream import StripeAlexStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(StripeAlexStream, "path", "v0/example_endpoint")
    mocker.patch.object(StripeAlexStream, "primary_key", "test_primary_key")
    mocker.patch.object(StripeAlexStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = StripeAlexStream()
