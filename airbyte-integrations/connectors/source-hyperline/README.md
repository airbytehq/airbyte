# Hyperline
This directory contains the manifest-only connector for `source-hyperline`.
...
### Build
This will create a dev image (`source-hyperline:dev`) that you can use to test the connector locally.
```bash
airbyte-ci connectors --name=source-hyperline build
```

### Test
This will run the acceptance tests for the connector.
```bash
airbyte-ci connectors --name=source-hyperline test
```
