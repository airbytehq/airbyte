...
This is the repository for the Sftp source connector in Java. For information about how to use this
connector within Airbyte, see
[the User Documentation](https://docs.airbyte.com/integrations/sources/sftp/).
...
Once built, the docker image name and tag on your host will be `airbyte/source-sftp:dev`. the
Dockerfile.
