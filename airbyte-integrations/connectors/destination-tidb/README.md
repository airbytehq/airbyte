...
For information about how to use this connector within Airbyte, see [the User Documentation](https://docs.airbyte.com/integrations/destinations/tidb).
...
```
./gradlew :airbyte-integrations:connectors:destination-tidb:airbyteDocker
```
