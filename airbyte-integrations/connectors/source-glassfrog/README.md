...
```
./gradlew :airbyte-integrations:connectors:source-glassfrog:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-glassfrog:buildDockerImage
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-glassfrog:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-glassfrog:integrationTest
```
