...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-glassfrog:dev`.
...
```Dockerfile
FROM airbyte/source-glassfrog:latest
...
docker run airbyte/source-glassfrog:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/glassfrog.md`).
