...
def _get_source(args: List[str]):
    ...
    try:
        return SourceAmplitude(
            SourceAmplitude.read_catalog(catalog_path) if catalog_path else None,
            SourceAmplitude.read_config(config_path) if config_path else None,
            SourceAmplitude.read_state(state_path) if state_path else None,
        )
