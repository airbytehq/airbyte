...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-ashby:dev`.
...
```Dockerfile
FROM airbyte/source-ashby:latest
...
docker run airbyte/source-ashby:dev spec
```
#### Run
