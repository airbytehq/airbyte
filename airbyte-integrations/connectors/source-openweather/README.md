...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-openweather:dev`.
...
```Dockerfile
FROM airbyte/source-openweather:latest
...
docker run airbyte/source-openweather:dev spec
```
#### Run
