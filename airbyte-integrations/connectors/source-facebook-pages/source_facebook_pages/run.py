...
def _get_source(args):
    ...
    try:
        return SourceFacebookPages(
            SourceFacebookPages.read_catalog(catalog_path) if catalog_path else None,
            SourceFacebookPages.read_config(config_path) if config_path else None,
            SourceFacebookPages.read_state(state_path) if state_path else None,
        )
