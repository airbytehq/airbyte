...
def test_field_transformation():
    with open(os.path.dirname(__file__)+"initial_record.json", "r") as initial_record, \
            open(os.path.dirname(__file__)+"transformed_record.json", "r") as transformed_record:
