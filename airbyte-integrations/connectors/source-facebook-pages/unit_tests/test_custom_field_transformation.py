...
def test_field_transformation():
    with open(f"{os.path.dirname(__file__)}/initial_record.json") as initial_record, \
            open(f"{os.path.dirname(__file__)}/transformed_record.json") as transformed_record:
