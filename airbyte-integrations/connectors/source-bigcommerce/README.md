...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-bigcommerce:dev`.
...
```Dockerfile
FROM airbyte/source-bigcommerce:latest
...
docker run airbyte/source-bigcommerce:dev spec
```
#### Run
