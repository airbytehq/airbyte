...
import pytest
from source_rippling.source import RipplingStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(RipplingStream, "path", "v0/example_endpoint")
    mocker.patch.object(RipplingStream, "primary_key", "test_primary_key")
    mocker.patch.object(RipplingStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = RipplingStream()
