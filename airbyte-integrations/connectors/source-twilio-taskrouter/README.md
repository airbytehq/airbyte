...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-twilio-taskrouter:dev`.
...
```Dockerfile
FROM airbyte/source-twilio-taskrouter:latest
...
docker run airbyte/source-twilio-taskrouter:dev spec
```
#### Run
