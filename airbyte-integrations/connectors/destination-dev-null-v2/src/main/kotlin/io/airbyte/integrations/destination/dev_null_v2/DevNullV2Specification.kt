...
sealed class DevNullV2Specification : ConfigurationSpecification() {
...
class DevNullV2SpecificationOss : DevNullV2Specification() {
...
class DevNullV2SpecificationCloud : DevNullV2Specification() {
    @JsonProperty("test_destination")
    @JsonSchemaTitle("Test Destination")
    @JsonPropertyDescription("The type of destination to be used")
