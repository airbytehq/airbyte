...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-sap-fieldglass:dev`.
...
```Dockerfile
FROM airbyte/source-sap-fieldglass:latest
...
docker run airbyte/source-sap-fieldglass:dev spec
```
#### Run
