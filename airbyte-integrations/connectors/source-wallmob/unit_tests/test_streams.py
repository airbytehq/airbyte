...
import pytest
from source_wallmob.source import WallmobStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(WallmobStream, "path", "v0/example_endpoint")
    mocker.patch.object(WallmobStream, "primary_key", "test_primary_key")
    mocker.patch.object(WallmobStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = WallmobStream()
