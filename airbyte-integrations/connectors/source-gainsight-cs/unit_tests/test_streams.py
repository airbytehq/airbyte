...
import pytest
from source_gainsight_cs.source import GainsightCsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GainsightCsStream, "path", "v0/example_endpoint")
    mocker.patch.object(GainsightCsStream, "primary_key", "test_primary_key")
    mocker.patch.object(GainsightCsStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = GainsightCsStream()
