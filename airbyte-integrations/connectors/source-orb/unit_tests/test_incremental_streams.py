...
@pytest.mark.parametrize(
    ...
    [
        (
            {"created_at": "2022-01-25T12:00:00+00:00"},
            {"created_at": "2022-01-26T12:00:00+00:00"},
            {"created_at": "2022-01-26T12:00:00+00:00"},
        ),
        (
            {"created_at": "2022-01-26T12:00:00+00:00"},
        ...
        ({}, {"created_at": "2022-01-25T12:00:00+00:00"}, {"created_at": "2022-01-25T12:00:00+00:00"}),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({}, {"created_at": "2022-01-25T12:00:00+00:00"}, None, {"created_at[gte]": "2022-01-25T12:00:00+00:00"}),
        ...
        ({}, {}, None, None),
        ({"start_date": pendulum.parse("2022-01-25T12:00:00+00:00")}, {}, None, {"created_at[gte]": "2022-01-25T12:00:00+00:00"}),
        (
            {"start_date": pendulum.parse("2022-01-25T12:00:00+00:00")},
            {"created_at": "2022-01-26T12:00:00+00:00"},
            None,
        ...
        # Honors lookback_window_days
        (
            {"start_date": pendulum.parse("2022-01-25T12:00:00+00:00"), "lookback_window_days": 2},
            {"created_at": "2022-01-26T12:00:00+00:00"},
            None,
...
@pytest.mark.parametrize(
    ...
    [
        (
            {},
            {"invoice_date": "2022-01-25T12:00:00+00:00"},
            {"cursor": "f96594d0-8220-11ec-a8a3-0242ac120002"},
            {"invoice_date[gte]": "2022-01-25T12:00:00+00:00", "cursor": "f96594d0-8220-11ec-a8a3-0242ac120002"},
        ),
        ({}, {"invoice_date": "2022-01-25T12:00:00+00:00"}, None, {"invoice_date[gte]": "2022-01-25T12:00:00+00:00"}),
        # Honors lookback_window_days
        (
            {"lookback_window_days": 3},
            {"invoice_date": "2022-01-25T12:00:00+00:00"},
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"customer_id_foo": {"created_at": "2022-01-25T12:00:00+00:00"}},
            {"created_at": "2022-01-26T12:00:00+00:00", "customer_id": "customer_id_foo"},
            {"customer_id_foo": {"created_at": "2022-01-26T12:00:00+00:00"}},
        ),
        ...
        (
            {"customer_id_foo": {"created_at": "2022-01-25T12:00:00+00:00"}},
            {"created_at": "2022-01-26T12:00:00+00:00", "customer_id": "customer_id_bar"},
            {
                "customer_id_foo": {"created_at": "2022-01-25T12:00:00+00:00"},
                "customer_id_bar": {"created_at": "2022-01-26T12:00:00+00:00"},
            },
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {},
            {"invoice_date": "2022-01-26T12:00:00+00:00"},
            {"invoice_date": "2022-01-26T12:00:00+00:00"},
        ),
        # Existing state
        (
            {"invoice_date": "2022-01-26T12:00:00+00:00"},
            {"invoice_date": "2023-01-26T12:00:00+00:00"},
            {"invoice_date": "2023-01-26T12:00:00+00:00"},
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"customer_id_foo": {"created_at": "2022-01-25T12:00:00+00:00"}},
            {"customer_id": "customer_id_foo"},
            {"cursor": "f96594d0-8220-11ec-a8a3-0242ac120002"},
        ),
        # Slice matches customer in state, non-paginated request
        ({"customer_id_foo": {"created_at": "2022-01-25T12:00:00+00:00"}}, {"customer_id": "customer_id_foo"}, None),
        # Slice does not match customer in state, paginated request
        (
            {"customer_id_foo": {"created_at": "2022-01-25T12:00:00+00:00"}},
            {"customer_id": "customer_id_bar"},
            {"cursor": "f96594d0-8220-11ec-a8a3-0242ac120002"},
        ),
        # Slice does not match customer in state, non-paginated request
        ({"customer_id_foo": {"created_at": "2022-01-25T12:00:00+00:00"}}, {"customer_id": "customer_id_bar"}, None),
        ({}, {"customer_id": "customer_id_baz"}, None),
    ],
)
def test_credits_ledger_entries_request_params(mocker, current_stream_state, current_stream_slice, next_page_token):
    ...
    expected_params = {"limit": CreditsLedgerEntries.page_size, "entry_status": "committed"}
...
@pytest.mark.parametrize(
    ...
    [
        # Updates for matching customer already in state
        (
            {"subscription_id_foo": {"timeframe_start": "2022-01-25T12:00:00+00:00"}},
            {"timeframe_start": "2022-01-26T12:00:00+00:00", "subscription_id": "subscription_id_foo"},
            {"subscription_id_foo": {"timeframe_start": "2022-01-26T12:00:00+00:00"}},
        ),
        ...
        (
            {"subscription_id_foo": {"timeframe_start": "2022-01-25T12:00:00+00:00"}},
            {"timeframe_start": "2022-01-26T12:00:00+00:00", "subscription_id": "subscription_id_bar"},
            {
                "subscription_id_foo": {"timeframe_start": "2022-01-25T12:00:00+00:00"},
                "subscription_id_bar": {"timeframe_start": "2022-01-26T12:00:00+00:00"},
            },
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"subscription_id_foo": {"timeframe_start": "2022-01-25T12:00:00+00:00"}},
            {"subscription_id": "subscription_id_foo", "timeframe_start": "2022-01-25T12:00:00+00:00", "timeframe_end": "2022-01-26T12:00:00+00:00"},
            None,
        ),
        # Slice does not match subscription in state, no grouping
        (
            {"subscription_id_foo": {"timeframe_start": "2022-01-25T12:00:00+00:00"}},
            {"subscription_id": "subscription_id_bar", "timeframe_start": "2022-01-25T12:00:00+00:00", "timeframe_end": "2022-01-26T12:00:00+00:00"},
            None,
        ),
        # No existing state, no grouping
        (
            {},
            {"subscription_id": "subscription_id_baz", "timeframe_start": "2022-01-25T12:00:00+00:00", "timeframe_end": "2022-01-26T12:00:00+00:00"},
            None,
        ),
        # Slice matches subscription in state, with grouping
        (
            {"subscription_id_foo": {"timeframe_start": "2022-01-25T12:00:00+00:00"}},
            {"subscription_id": "subscription_id_foo", "billable_metric_id": "billableMetricA", "timeframe_start": "2022-01-25T12:00:00+00:00", "timeframe_end": "2022-01-26T12:00:00+00:00"},
            "group_key_foo",
        ),
        # Slice does not match subscription in state, with grouping
        (
            {"subscription_id_foo": {"timeframe_start": "2022-01-25T12:00:00+00:00"}},
            {"subscription_id": "subscription_id_bar", "billable_metric_id": "billableMetricA", "timeframe_start": "2022-01-25T12:00:00+00:00", "timeframe_end": "2022-01-26T12:00:00+00:00"},
            "group_key_foo",
        ),
        # No existing state, with grouping
        (
            {},
            {"subscription_id": "subscription_id_baz", "billable_metric_id": "billableMetricA", "timeframe_start": "2022-01-25T12:00:00+00:00", "timeframe_end": "2022-01-26T12:00:00+00:00"},
            "group_key_foo",
        ),
    ],
)
def test_subscription_usage_request_params(mocker, current_stream_state, current_stream_slice, grouping_key):
    ...
    expected_params = {"granularity": "day"}
