...
def test_query_shopping_performance_view_stream(customers, config, requests_mock):
    ...
    requests_mock.register_uri(
        "GET", "https://googleads.googleapis.com/v19/customers:listAccessibleCustomers", accessible_customers_response
    )
    requests_mock.register_uri(
        "POST", "https://googleads.googleapis.com/v19/customers/1234567890/googleAds:searchStream", customers_response
    )

    request_history = requests_mock.register_uri(
        "POST",
        "https://googleads.googleapis.com/v19/customers/123/googleAds:searchStream",
        shopping_performance_view_response,
    )
