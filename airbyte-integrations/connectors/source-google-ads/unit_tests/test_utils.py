...
def test_parse_GAQL_fail(config):
    ...
    expected_message = "The custom GAQL query test_table failed. Validate your GAQL query with the Google Ads query validator. https://developers.google.com/google-ads/api/fields/v20/query_validator"
