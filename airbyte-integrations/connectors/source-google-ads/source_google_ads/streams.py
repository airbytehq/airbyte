...
from google.ads.googleads.v21.services.types.google_ads_service import SearchGoogleAdsResponse
...
class CustomerClient(GoogleAdsStream):
    """
    Customer Client stream: https://developers.google.com/google-ads/api/fields/v21/customer_client
    """
