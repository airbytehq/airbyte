...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-unleash:dev`.
...
```Dockerfile
FROM airbyte/source-unleash:latest
...
docker run airbyte/source-unleash:dev spec
```
#### Run
