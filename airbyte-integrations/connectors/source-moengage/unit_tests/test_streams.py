...
import pytest
from source_moengage.source import MoengageStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MoengageStream, "path", "v0/example_endpoint")
    mocker.patch.object(MoengageStream, "primary_key", "test_primary_key")
    mocker.patch.object(MoengageStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = MoengageStream()
