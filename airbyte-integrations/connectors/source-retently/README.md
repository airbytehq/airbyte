...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-retently:dev`.
...
```Dockerfile
FROM airbyte/source-retently:latest
...
docker run airbyte/source-retently:dev spec
```
#### Run
