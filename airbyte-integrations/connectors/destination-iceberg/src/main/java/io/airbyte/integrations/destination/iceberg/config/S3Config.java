...
public class S3Config implements StorageConfig {
    ...
    public void check() {
        ...
        final var prefix = this.warehouseUri + (this.warehouseUri.endsWith("/") ? "" : "/");
        final String tempObjectName =
            prefix + "_airbyte_connection_test_" + UUID.randomUUID().toString().replaceAll("-", "");
        final var bucket = this.warehouseUri;
    ...
    @Override
    public void appendSparkConfig(Map<String, String> sparkConfig, String catalogName) {
    ...
    @Override
    public void appendCatalogInitializeProperties(Map<String, String> properties) {
