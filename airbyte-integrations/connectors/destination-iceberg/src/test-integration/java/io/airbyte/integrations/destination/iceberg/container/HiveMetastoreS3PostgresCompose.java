 ...
 */
public class HiveMetastoreS3PostgresCompose
    extends DockerComposeContainer<HiveMetastoreS3PostgresCompose> {
  ...
  private static final String METASTORE_COMPOSE_PATH =
      LOCAL_RELATIVE_PATH + "hive-metastore-compose.yml";
  ...
  public void start() {
    ...
    LOGGER.info(
        "PostgreSQL port: {}",
        getServicePort(POSTGRES_SERVICE_NAME, PostgreSQLContainer.POSTGRESQL_PORT));
    ...
    LOGGER.info(
        "Hive Metastore docker-compose startup cost: {} ms",
