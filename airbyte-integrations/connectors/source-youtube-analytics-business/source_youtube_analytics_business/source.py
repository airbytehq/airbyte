...
class SourceYoutubeAnalyticsBusiness(AbstractSource):
    @staticmethod
    ...
    def check_connection(self, logger, config) -> Tuple[bool, any]:
        ...
        if not jobs:
            ...
            report_streams = ReportResources(name="channel_basic_a2", jobs_resource=jobs_resource, job_id=None, authenticator=authenticator)
