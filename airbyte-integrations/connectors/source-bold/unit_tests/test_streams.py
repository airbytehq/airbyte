...
import pytest
from source_bold.source import BoldStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(BoldStream, "path", "v0/example_endpoint")
    mocker.patch.object(BoldStream, "primary_key", "test_primary_key")
    mocker.patch.object(BoldStream, "__abstractmethods__", set())
