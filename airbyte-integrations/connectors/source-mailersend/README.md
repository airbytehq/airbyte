...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-mailersend:dev`.
...
```Dockerfile
FROM airbyte/source-mailersend:latest
...
docker run airbyte/source-mailersend:dev spec
```
#### Run
