...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-yandex-metrica:dev`.
...
```Dockerfile
FROM airbyte/source-yandex-metrica:latest
...
docker run airbyte/source-yandex-metrica:dev spec
```
#### Run
