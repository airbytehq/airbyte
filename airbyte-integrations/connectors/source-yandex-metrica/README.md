...
```
./gradlew :airbyte-integrations:connectors:source-yandex-metrica:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-yandex-metrica:buildDockerImage
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-yandex-metrica:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-yandex-metrica:integrationTest
```
