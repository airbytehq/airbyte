...
import pytest
from source_yandex_metrica.streams import YandexMetricaStream, Views, Sessions, Create, Check, Download
...
def patch_base_class():
    ...
    return {
        ...
        'sessions_stream': Sessions(counter_id=00000000, params={'start_date': '2022-07-01',  'end_date': '2022-07-02', 'fields': ['ym:s:visitID', 'ym:s:dateTime']}, **kwargs),
        'yandex_metrica_stream': YandexMetricaStream(counter_id=00000000, params={'start_date': '2022-07-01',  'end_date': '2022-07-02', 'source': 'hits', 'fields': 'ym:pv:watchID,ym:pv:dateTime'}, **kwargs),        
        'create_substream': Create(counter_id=00000000, params={'start_date': '2022-07-01',  'end_date': '2022-07-02', 'source': 'hits' , 'fields': 'ym:pv:watchID,ym:pv:dateTime'}, **kwargs),
        'check_substream': Check(counter_id=00000000, params={'start_date': '2022-07-01',  'end_date': '2022-07-02', 'source': 'hits' , 'fields': 'ym:pv:watchID,ym:pv:dateTime'}, logrequest_id=00000000, **kwargs),
        'download_substream_1_page': Download(counter_id=00000000,params={'start_date': '2022-07-01',  'end_date': '2022-07-02', 'source': 'hits' , 'fields': 'ym:pv:watchID,ym:pv:dateTime'}, logrequest_id=00000000, last_page=0, **kwargs),
        'download_substream_2_pages': Download(counter_id=00000000, params={'start_date': '2022-07-01',  'end_date': '2022-07-02', 'source': 'hits' , 'fields': 'ym:pv:watchID,ym:pv:dateTime'}, logrequest_id=00000000, last_page=1, **kwargs),
    }
