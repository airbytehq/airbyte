...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-pipedrive:dev`.
...
```Dockerfile
FROM airbyte/source-pipedrive:latest
...
docker run airbyte/source-pipedrive:dev spec
```
#### Run
