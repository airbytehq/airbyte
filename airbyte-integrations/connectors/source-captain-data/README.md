...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-captain-data:dev`.
...
```Dockerfile
FROM airbyte/source-captain-data:latest
...
docker run airbyte/source-captain-data:dev spec
```
#### Run
