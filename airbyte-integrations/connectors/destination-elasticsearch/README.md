...
This is the repository for the Elasticsearch destination connector in Java. For information about
how to use this connector within Airbyte, see
[the User Documentation](https://docs.airbyte.io/integrations/destinations/elasticsearch).
...
Once built, the docker image name and tag on your host will be
`airbyte/destination-elasticsearch:dev`. the Dockerfile.
