...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-postmarkapp:dev`.
...
```Dockerfile
FROM airbyte/source-postmarkapp:latest
...
docker run airbyte/source-postmarkapp:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/postmarkapp.md`).
