# Humanitix
This directory contains the manifest-only connector for `source-humanitix`.
...
### Build
This will create a dev image (`source-humanitix:dev`) that you can use to test the connector locally.
```bash
