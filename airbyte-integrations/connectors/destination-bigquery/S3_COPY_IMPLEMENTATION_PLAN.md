...
acknowledges state; consumers must tolerate retries. This legacy preview retains its existing
schema/generation-cutoff layout and does not add the newer stream-complete marker.
