...
public class GcsAvroBigQueryUploader extends AbstractGscBigQueryUploader<GcsAvroWriter> {
    ...
    public GcsAvroBigQueryUploader(TableId table, TableId tmpTable, GcsAvroWriter writer, JobInfo.WriteDisposition syncMode, Schema schema, GcsDestinationConfig gcsDestinationConfig, BigQuery bigQuery) {
