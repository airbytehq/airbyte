...
class BigQueryGcsStorageOperation(
    ...
    override fun writeToStage(
        ...
        val stagedFileName: String = uploadRecordsToStage(streamConfig.id, suffix, data, streamConfig.generationId)
    ...
    private fun uploadRecordsToStage(
        ...
        return gcsStorageOperations.uploadRecordsToBucket(buffer, streamId.rawNamespace, objectPath, generationId)
    }
