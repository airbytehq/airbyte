...
This directory contains the manifest-only connector for `source-keepa-api`.
...
### Build
This will create a dev image (`source-keepa-api:dev`) that you can use to test the connector locally.
```bash
airbyte-ci connectors --name=source-keepa-api build
```

### Test
This will run the acceptance tests for the connector.
```bash
airbyte-ci connectors --name=source-keepa-api test
```
