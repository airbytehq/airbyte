...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-pypi:dev`.
...
```Dockerfile
FROM airbyte/source-pypi:latest
...
docker run airbyte/source-pypi:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/pypi.md`).
