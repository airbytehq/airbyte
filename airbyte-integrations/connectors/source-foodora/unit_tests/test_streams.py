...
import pytest
from source_foodora.source import FoodoraStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(FoodoraStream, "path", "v0/example_endpoint")
    mocker.patch.object(FoodoraStream, "primary_key", "test_primary_key")
    mocker.patch.object(FoodoraStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = FoodoraStream()
