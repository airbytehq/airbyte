...
```
./gradlew :airbyte-integrations:connectors:source-xkcd:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-xkcd:buildDockerImage
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-xkcd:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-xkcd:integrationTest
```
