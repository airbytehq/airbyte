...
This is the repository for the Xkcd source connector, written in Python. For information about how
to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.io/integrations/sources/xkcd).
...
[documentation](https://docs.airbyte.io/integrations/sources/xkcd) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_xkcd/spec.yaml`
...
`source xkcd test creds` and place them into `secrets/config.json`.
