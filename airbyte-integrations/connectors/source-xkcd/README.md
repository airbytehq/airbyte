...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-xkcd:dev`.
...
```Dockerfile
FROM airbyte/source-xkcd:latest
...
docker run airbyte/source-xkcd:dev spec
```
#### Run
