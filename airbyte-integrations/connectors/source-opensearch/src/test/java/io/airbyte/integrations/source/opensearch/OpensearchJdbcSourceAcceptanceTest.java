...
class OpensearchJdbcSourceAcceptanceTest extends JdbcSourceAcceptanceTest {

  private static final Logger LOGGER = LoggerFactory.getLogger(OpensearchJdbcSourceAcceptanceTest.class);
  ...
  public String getDriverClass() {
    return OpensearchSource.DRIVER_CLASS;
  }
