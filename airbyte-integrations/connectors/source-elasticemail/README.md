# Elasticemail
This directory contains the manifest-only connector for `source-elasticemail`.
...
### Build
This will create a dev image (`source-elasticemail:dev`) that you can use to test the connector locally.
```bash
