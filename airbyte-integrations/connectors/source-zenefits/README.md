...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-zenefits:dev`.
...
```Dockerfile
FROM airbyte/source-zenefits:latest
...
docker run airbyte/source-zenefits:dev spec
```
#### Run
