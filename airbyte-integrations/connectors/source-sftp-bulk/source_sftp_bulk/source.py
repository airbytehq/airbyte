...
class SourceFtp(AbstractSource):
    ...
    def _infer_json_schema(
        ...
        autogenerate_column_names = config.get("autogenerate_column_names", False)
        autogenerated_column_names_prefix = config.get("autogenerated_column_names_prefix", "col_")
        ...
        if column_names and column_names_separator:
            ...
            header_names = [f"{autogenerated_column_names_prefix}{i}" for i in range(len(column_names.split(column_names_separator)))]
