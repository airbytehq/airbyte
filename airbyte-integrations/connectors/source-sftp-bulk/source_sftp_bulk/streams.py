...
class FTPStream(Stream, IncrementalMixin):
    ...
    def read_records(
        ...
        for cursor, records in self.connection.fetch_files(
            ...
            autogenerate_column_names=self.config.get("autogenerate_column_names"),
            autogenerated_column_names_prefix=self.config.get(
                "autogenerated_column_names_prefix"
            ),
            column_names_separator=self.config.get("column_names_separator"),
        ):
