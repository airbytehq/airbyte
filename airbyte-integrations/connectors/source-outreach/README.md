...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-outreach:dev`.
...
```Dockerfile
FROM airbyte/source-outreach:latest
...
docker run airbyte/source-outreach:dev spec
```
#### Run
