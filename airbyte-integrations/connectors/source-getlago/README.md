...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-getlago:dev`.
...
```Dockerfile
FROM airbyte/source-getlago:latest
...
docker run airbyte/source-getlago:dev spec
```
#### Run
