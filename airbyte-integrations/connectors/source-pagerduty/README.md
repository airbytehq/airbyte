...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-pagerduty:dev`.
...
```Dockerfile
FROM airbyte/source-pagerduty:latest
...
docker run airbyte/source-pagerduty:dev spec
```
#### Run
