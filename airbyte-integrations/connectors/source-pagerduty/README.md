...
```
./gradlew :airbyte-integrations:connectors:source-pagerduty:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-pagerduty:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-pagerduty:check
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-pagerduty:integrationTest
```
