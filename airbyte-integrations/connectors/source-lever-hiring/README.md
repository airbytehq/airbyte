...
**If you are a community contributor**, get the necessary credentials. Then create a file
`secrets/config.json` conforming to the `source_lever_hiring/spec.json` file. Note that any
...
`source lever-hiring test creds` and place them into `secrets/config.json`.
...
4. Make the connector documentation and its changelog is up to date
   (`docs/integrations/sources/lever-hiring.md`).
