...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-everhour:dev`.
...
```Dockerfile
FROM airbyte/source-everhour:latest
...
docker run airbyte/source-everhour:dev spec
```
#### Run
