...
This is the repository for the Activecampaign source connector, written in Python.
...
poetry run source-activecampaign read --config secrets/config.json --catalog sample_files/configured_catalog.json
```
