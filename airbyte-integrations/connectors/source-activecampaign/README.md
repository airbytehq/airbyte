...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-activecampaign:dev`.
...
```Dockerfile
FROM airbyte/source-activecampaign:latest
...
docker run airbyte/source-activecampaign:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/activecampaign.md`).
