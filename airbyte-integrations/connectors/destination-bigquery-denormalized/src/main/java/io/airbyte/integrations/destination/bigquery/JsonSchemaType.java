 ...
 *
 * <p>The order field of the enum provides us the ability to sort union types (array of
 * JsonSchemaType from narrow to wider scopes of types. For example, STRING takes precedence over
 * NUMBER if both are included in the same type array.
 */
