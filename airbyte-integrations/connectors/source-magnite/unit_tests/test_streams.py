...
import pytest
from source_magnite.source import MagniteStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MagniteStream, "path", "v0/example_endpoint")
    mocker.patch.object(MagniteStream, "primary_key", "test_primary_key")
    mocker.patch.object(MagniteStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = MagniteStream()
