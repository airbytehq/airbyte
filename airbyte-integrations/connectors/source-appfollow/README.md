...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-appfollow:dev`.
...
```Dockerfile
FROM airbyte/source-appfollow:latest
...
docker run airbyte/source-appfollow:dev spec
```
#### Run
