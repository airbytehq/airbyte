...
class TestMockAPIClient:
    ...
    def sample_user_data(self):
        return {"name": "John Doe", "avatar": "https://example.com/avatar.jpg"}
    ...
    def test_create_user_success(self, client, sample_user_data):
        ...
        created_user = {**sample_user_data, "id": "123", "createdAt": "2025-09-18T12:00:00.000Z"}
    ...
    def test_create_deal_success(self, client):
        ...
        deal_data = {"name": "Big Deal", "avatar": "https://example.com/deal.jpg"}
        created_deal = {**deal_data, "id": "456", "createdAt": "2025-09-18T12:00:00.000Z"}
