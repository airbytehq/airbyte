        ...
        streams=[
            ConfiguredAirbyteStream(
                stream=AirbyteStream(
                    ...
                    json_schema={
                        "type": "object",
                        "properties": {"name": {"type": "string"}, "email": {"type": "string"}, "avatar": {"type": "string"}},
                    },
            ...
            ConfiguredAirbyteStream(
                stream=AirbyteStream(
                    name="deals",
                    json_schema={"type": "object", "properties": {"name": {"type": "string"}, "avatar": {"type": "string"}}},
                    supported_sync_modes=[SyncMode.full_refresh, SyncMode.incremental],
                ),
                sync_mode=SyncMode.full_refresh,
                destination_sync_mode=DestinationSyncMode.overwrite,
    ...
    return [
        AirbyteMessage(
            ...
            record=AirbyteRecordMessage(
                stream="users",
                data={"name": "John Doe from Test", "email": "john.test@example.com", "avatar": "https://example.com/john.jpg"},
        ...
        AirbyteMessage(
            ...
            record=AirbyteRecordMessage(
                stream="users",
                data={"name": "Jane Smith from Test", "email": "jane.test@example.com", "avatar": "https://example.com/jane.jpg"},
                emitted_at=int(datetime.now().timestamp() * 1000),
            ),
        ),
        AirbyteMessage(
            ...
            record=AirbyteRecordMessage(
                stream="deals",
                data={"name": "Big Test Deal", "avatar": "https://example.com/deal.jpg"},
                emitted_at=int(datetime.now().timestamp() * 1000),
            ),
        ),
    ]
