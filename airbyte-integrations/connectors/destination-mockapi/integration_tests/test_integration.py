...
class TestMockAPIIntegration:
    ...
    def config_from_secrets(self):
        ...
        if config_path.exists():
            ...
            return {"api_url": os.getenv("MOCKAPI_URL", "https://68cc13e1716562cf50764f2b.mockapi.io/api/v1")}
    ...
    def client(self, parsed_config):
        return MockAPIClient(api_url=parsed_config.api_url, timeout=parsed_config.timeout)
    ...
    def test_create_real_user_with_config(self, client):
        ...
        test_user = {"name": "Test User from Config", "email": "testconfig@example.com", "age": 25}
