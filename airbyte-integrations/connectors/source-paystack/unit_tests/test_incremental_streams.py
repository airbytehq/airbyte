...
from source_paystack.source import IncrementalPaystackStream
...
def test_cursor_field(patch_incremental_base_class):
    stream = IncrementalPaystackStream()
...
def test_supports_incremental(patch_incremental_base_class, mocker):
    mocker.patch.object(IncrementalPaystackStream, "cursor_field", "dummy_field")
    stream = IncrementalPaystackStream()
