...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-paystack:dev`.
...
```Dockerfile
FROM airbyte/source-paystack:latest
...
docker run airbyte/source-paystack:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/paystack.md`).
