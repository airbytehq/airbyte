...
import pytest
from source_soloway.source import SolowayStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SolowayStream, "path", "v0/example_endpoint")
    mocker.patch.object(SolowayStream, "primary_key", "test_primary_key")
    mocker.patch.object(SolowayStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = SolowayStream()
