...
from source_facebook_marketing.streams.base_streams import FBMarketingStream, FBMarketingIncrementalStream
...
def incremental_class_instance(api):
    # Adjust the parameters as necessary for your class
...
class TestFBMarketingIncrementalStreamSliceAndState():
    ...
    def test_get_updated_state(self, incremental_class_instance):
        current_stream_state = {
            '123': {'date': '2021-01-15T00:00:00+00:00'},
        ...
        expected_state = {
            '123': {'date': '2021-01-20T00:00:00+00:00', 'include_deleted': False},
            'include_deleted': False
        }
