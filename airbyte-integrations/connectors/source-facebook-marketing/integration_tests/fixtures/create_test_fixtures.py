...
def main():
    ...
    #
    #
    start_date = pendulum.parse("2021-02-01T00:00:00Z")
    ...
    params = {
        ...
        "time_ranges": [{"since": start_date.to_date_string(), "until": start_date.add(days=30).to_date_string()}],
    }
    print(params)
    print(ad_account.get_insights(params=params))
