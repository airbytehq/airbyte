...
import pytest
from source_weatherstack.source import WeatherstackStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(WeatherstackStream, "path", "v0/example_endpoint")
    mocker.patch.object(WeatherstackStream, "primary_key", "test_primary_key")
    mocker.patch.object(WeatherstackStream, "__abstractmethods__", set())
