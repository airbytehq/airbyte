...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-weatherstack:dev`.
...
```Dockerfile
FROM airbyte/source-weatherstack:latest
...
docker run airbyte/source-weatherstack:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/weatherstack.md`).
