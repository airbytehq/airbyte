...
import pytest
from source_couchbase.source import CouchbaseStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(CouchbaseStream, "path", "v0/example_endpoint")
    mocker.patch.object(CouchbaseStream, "primary_key", "test_primary_key")
    mocker.patch.object(CouchbaseStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = CouchbaseStream()
