...
#
# import pytest
# from source_zoho_crm.source import ZohoCrmStream
#
#
# @pytest.fixture
# def patch_base_class(mocker):
#     # Mock abstract methods to enable instantiating abstract class
#     mocker.patch.object(ZohoCrmStream, "path", "v0/example_endpoint")
#     mocker.patch.object(ZohoCrmStream, "primary_key", "test_primary_key")
#     mocker.patch.object(ZohoCrmStream, "__abstractmethods__", set())
#
#
# def test_request_params(patch_base_class):
#     stream = ZohoCrmStream()
