...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-oura:dev`.
...
```Dockerfile
FROM airbyte/source-oura:latest
...
docker run airbyte/source-oura:dev spec
```
#### Run
