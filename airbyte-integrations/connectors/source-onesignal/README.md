...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-onesignal:dev`.
...
```Dockerfile
FROM airbyte/source-onesignal:latest
...
docker run airbyte/source-onesignal:dev spec
```
#### Run
