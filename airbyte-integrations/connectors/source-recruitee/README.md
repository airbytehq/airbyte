...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-recruitee:dev`.
...
```Dockerfile
FROM airbyte/source-recruitee:latest
...
docker run airbyte/source-recruitee:dev spec
```
#### Run
