...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-stripe:dev`.
...
```Dockerfile
FROM airbyte/source-stripe:latest
...
docker run airbyte/source-stripe:dev spec
```
#### Run
