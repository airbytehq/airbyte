...
class FullRefreshTest(TestCase):
    ...
    def test_given_one_page_when_read_then_return_records(
        ...
        http_mocker.get(
            ...
            .with_record(_an_external_bank_account())
            .with_record(_an_external_bank_account())
            .build(),
        )
    ...
    def test_given_many_pages_when_read_then_return_records(
        ...
        http_mocker.get(
            ...
            .with_pagination()
            .with_record(
                _an_external_bank_account().with_id("last_record_id_from_first_page")
            )
            .build(),
        )
        http_mocker.get(
    ...
    def test_given_state_when_read_then_query_events_using_types_and_state_value_plus_1(
        ...
        http_mocker.get(
            ...
            .with_record(
                ...
                .with_field(_DATA_FIELD, _an_external_bank_account().build())
            )
            .build(),
        )
