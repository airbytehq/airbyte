...
_ENDPOINT_TEMPLATE_NAME = "issuing_authorizations"
...
def _authorizations_request() -> StripeRequestBuilder:
    return StripeRequestBuilder.issuing_authorizations_endpoint(
...
def _given_authorizations_availability_check(http_mocker: HttpMocker) -> None:
    http_mocker.get(
        StripeRequestBuilder.issuing_authorizations_endpoint(
            _ACCOUNT_ID, _CLIENT_SECRET
        )
...
class FullRefreshTest(TestCase):
    ...
    def test_given_one_page_when_read_then_return_records(
        ...
        http_mocker.get(
            ...
            .with_limit(100)
            .build(),
            _authorizations_response()
            .with_record(_an_authorization())
            .with_record(_an_authorization())
            .build(),
        )
    ...
    def test_given_many_pages_when_read_then_return_records(
        ...
        http_mocker.get(
            ...
            _authorizations_response()
            .with_pagination()
            .with_record(_an_authorization().with_id("last_record_id_from_first_page"))
            .build(),
        )
        http_mocker.get(
            _authorizations_request()
...
class IncrementalTest(TestCase):
    ...
    def test_given_no_state_when_read_then_use_authorizations_endpoint(
        ...
        http_mocker.get(
            ...
            .build(),
            _authorizations_response()
            .with_record(_an_authorization().with_cursor(cursor_value))
            .build(),
        )
    ...
    def test_given_state_when_read_then_query_events_using_types_and_state_value_plus_1(
        ...
        http_mocker.get(
            ...
            .with_record(
                ...
                .with_field(_DATA_FIELD, _an_authorization().build())
            )
            .build(),
        )
    ...
    def test_given_state_and_small_slice_range_when_read_then_perform_multiple_queries(
        ...
        http_mocker.get(
            ...
            .build(),
            _events_response()
            .with_record(self._an_authorization_event())
            .with_record(self._an_authorization_event())
            .build(),
        )
