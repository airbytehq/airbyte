...
def _authorizations_request() -> StripeRequestBuilder:
    return StripeRequestBuilder.issuing_authorizations_endpoint(_ACCOUNT_ID, _CLIENT_SECRET)
...
class FullRefreshTest(TestCase):
    ...
    def test_given_slice_range_when_read_then_perform_multiple_requests(self, http_mocker: HttpMocker) -> None:
        ...
        http_mocker.get(
            _authorizations_request().with_created_gte(start_date).with_created_lte(slice_datetime - _AVOIDING_INCLUSIVE_BOUNDARIES).with_limit(100).build(),
