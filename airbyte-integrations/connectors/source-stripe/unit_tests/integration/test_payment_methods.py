...
def _given_payment_methods_availability_check(http_mocker: HttpMocker) -> None:
    http_mocker.get(
        StripeRequestBuilder.payment_methods_endpoint(_ACCOUNT_ID, _CLIENT_SECRET)
...
class IncrementalTest(TestCase):
    ...
    @HttpMocker()
    def test_given_no_state_when_read_then_use_payment_methods_endpoint(
        self, http_mocker: HttpMocker
    ) -> None:
        _given_events_availability_check(http_mocker)
        ...
        http_mocker.get(
            _payment_methods_request().with_limit(100).build(),
            _payment_methods_response()
            .with_record(_a_payment_method().with_cursor(cursor_value))
            .build(),
        )
    ...
    def test_given_state_when_read_then_query_events_using_types_and_state_value_plus_1(
        ...
        http_mocker.get(
            ...
            .with_record(
                ...
                .with_field(_DATA_FIELD, _a_payment_method().build())
            )
            .build(),
        )
    ...
    def test_given_state_and_small_slice_range_when_read_then_perform_multiple_queries(
        ...
        http_mocker.get(
            ...
            .build(),
            _events_response()
            .with_record(self._a_payment_method_event())
            .with_record(self._a_payment_method_event())
            .build(),
        )
