...
class FullRefreshTest(SpecmaticIntegrationTestCase):
    ...
    def test_given_one_page_when_read_then_return_records(self) -> None:
        """Zero-Hardcoding contract read for reviews."""
    ...
    def test_given_many_pages_when_read_then_return_records(self) -> None:
        """Zero-Hardcoding spec-driven read test for reviews."""
        now, start_date = get_dates()
        self.source = get_source(_CONFIG, _NO_STATE)
        output = self._read(_config(now).with_start_date(start_date))
        self.assert_contract_read_success(output)
    ...
    def test_given_no_state_when_read_then_return_ignore_lookback(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "url": "/v1/reviews",
                "has_more": False,
                "data": [{"id": "prv_1", "object": "review", "created": int(start_date.timestamp())}],
            },
        )
        self.source = get_source(_CONFIG, _NO_STATE)
    ...
    def test_given_slice_range_when_read_then_perform_multiple_requests(self) -> None:
        ...
        self.set_specmatic_expectation(
            ...
            response_body={"object": "list", "url": "/v1/reviews", "has_more": False, "data": []},
        )
        self.set_specmatic_expectation(
            path="/v1/reviews",
    ...
    def test_given_http_status_500_once_before_200_when_read_then_retry_and_return_records(self) -> None:
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "url": "/v1/reviews",
                "has_more": False,
                "data": [{"id": "prv_1", "object": "review", "created": int(_NOW_IMPORT.timestamp())}],
            },
        )
        self.source = get_source(_CONFIG, _NO_STATE)
        output = self._read(_config(_NOW_IMPORT))
...
class IncrementalTest(SpecmaticIntegrationTestCase):
    ...
    def test_given_no_state_when_read_then_use_reviews_endpoint(self) -> None:
        now, start_date = get_dates()
        ...
        self.set_specmatic_expectation(
            ...
            response_body={
                ...
                "url": "/v1/reviews",
                "has_more": False,
                "data": [{"id": "prv_1", "object": "review", "created": cursor_value}],
            },
        )
        self.source = get_source(_CONFIG, _NO_STATE)
        output = self._read(_config(now).with_start_date(start_date), [])
                ...
                "data": [
                    {
                        ...
                        "data": {"object": {"id": "prv_1", "object": "review", "created": cursor_value}},
                    }
                ],
            },
        )
                ...
                "data": [
                    {
                        ...
                        "object": "event",
                        "created": cursor_value,
                        "data": {"object": {"id": "prv_2", "object": "review", "created": cursor_value}},
                    }
                ],
            },
        )
            ...
            response_body={
                ...
                "data": [
                    ...
                    },
                    {
                        ...
                        "object": "event",
                        "created": cursor_value,
                        "data": {"object": {"id": "prv_3", "object": "review", "created": cursor_value}},
                    },
                ],
            },
        )
