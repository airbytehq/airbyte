...
from airbyte_protocol.models import (AirbyteStateBlob, AirbyteStateMessage,
                                     AirbyteStreamState,
...
class FullRefreshTest(TestCase):
    ...
    def test_given_many_pages_when_read_then_return_records(
        ...
        http_mocker.get(
            ...
            .with_pagination()
            .with_record(
                _an_application_fee().with_id("last_record_id_from_first_page")
            )
            .build(),
        )
        http_mocker.get(
...
class IncrementalTest(TestCase):
    ...
    def test_given_no_state_when_read_then_use_application_fees_endpoint(
        ...
        http_mocker.get(
            ...
            .build(),
            _application_fees_response()
            .with_record(_an_application_fee().with_cursor(cursor_value))
            .build(),
        )
    ...
    def test_given_state_when_read_then_query_events_using_types_and_state_value_plus_1(
        ...
        http_mocker.get(
            ...
            .with_record(
                ...
                .with_field(_DATA_FIELD, _an_application_fee().build())
            )
            .build(),
        )
    ...
    def test_given_state_and_small_slice_range_when_read_then_perform_multiple_queries(
        ...
        http_mocker.get(
            ...
            .build(),
            _events_response()
            .with_record(self._an_application_fee_event())
            .with_record(self._an_application_fee_event())
            .build(),
        )
