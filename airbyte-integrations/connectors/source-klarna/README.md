...
This is the repository for the Klarna configuration based source connector.
...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-klarna:dev`.
...
```Dockerfile
FROM airbyte/source-klarna:latest
...
docker run airbyte/source-klarna:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/klarna.md`).
