...
```
./gradlew :airbyte-integrations:connectors:source-outbrain-amplify:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-outbrain-amplify:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-outbrain-amplify:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-outbrain-amplify:integrationTest
```
