...
import pytest
from source_memcare.source import MemcareStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MemcareStream, "path", "v0/example_endpoint")
    mocker.patch.object(MemcareStream, "primary_key", "test_primary_key")
    mocker.patch.object(MemcareStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = MemcareStream()
