# Concord
This directory contains the manifest-only connector for `source-concord-2`.
...
### Build
This will create a dev image (`source-concord-2:dev`) that you can use to test the connector locally.
```bash
airbyte-ci connectors --name=source-concord-2 build
```

### Test
This will run the acceptance tests for the connector.
```bash
airbyte-ci connectors --name=source-concord-2 test
```
