...
import pytest
from source_hybrid_ads.source import HybridAdsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(HybridAdsStream, "path", "v0/example_endpoint")
    mocker.patch.object(HybridAdsStream, "primary_key", "test_primary_key")
    mocker.patch.object(HybridAdsStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = HybridAdsStream()
