...
class WaidsOscarproStream(HttpStream, ABC):
    """
...
class Customers(WaidsOscarproStream):
    """
...
class IncrementalWaidsOscarproStream(WaidsOscarproStream, ABC):
    """
...
class Employees(IncrementalWaidsOscarproStream):
    """
    TODO: Change class name to match the table/data source this stream corresponds to.
    """
