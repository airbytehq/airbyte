...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-firebase-realtime-database:dev`.
...
```Dockerfile
FROM airbyte/source-firebase-realtime-database:latest
...
docker run airbyte/source-firebase-realtime-database:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/firebase-realtime-database.md`).
