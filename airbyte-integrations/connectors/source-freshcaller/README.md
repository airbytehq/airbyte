...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-freshcaller:dev`.
...
```Dockerfile
FROM airbyte/source-freshcaller:latest
...
docker run airbyte/source-freshcaller:dev spec
```
#### Run
