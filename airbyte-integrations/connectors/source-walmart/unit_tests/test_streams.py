...
import pytest
from source_walmart.source import WalmartStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(WalmartStream, "path", "v0/example_endpoint")
    mocker.patch.object(WalmartStream, "primary_key", "test_primary_key")
    mocker.patch.object(WalmartStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = WalmartStream()
