...
class SourceNapta(AbstractSource):
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        ...
        return [
            ...
            RexTemplate(authenticator=authenticator, config=config),
            ResumeTemplate(authenticator=authenticator, config=config),
            User(authenticator=authenticator, config=config),
            MinimalUser(authenticator=authenticator, config=config),
            # UserCalendar and ProjectCalendar need to be incremental streams, not implemented yet
            # UserCalendar(authenticator=authenticator, config=config),
            # ProjectCalendar(authenticator=authenticator, config=config),
            ...
            Log(authenticator=authenticator, config=config),
            ...
            UserProjectEvaluationUserProjectUserSkillGrade(authenticator=authenticator, config=config),
            UserProjectEvaluationUserProjectUserSkill(authenticator=authenticator, config=config),
            UserskillUsergrade(authenticator=authenticator, config=config),
            ...
            MetadataFieldRight(authenticator=authenticator, config=config),
            BusinessUnit(authenticator=authenticator, config=config),
            UserskillInterest(authenticator=authenticator, config=config),
            EvaluationCampaign(authenticator=authenticator, config=config),
            EvaluationCampaignEvaluation(authenticator=authenticator, config=config),
            EvaluationCampaignEvaluationAuthor(authenticator=authenticator, config=config),
            EvaluationCampaignEvaluationUserSkill(authenticator=authenticator, config=config),
            EvaluationCampaignEvaluationUserSkillGrade(authenticator=authenticator, config=config),
            UserPositionToUserProjectEvaluationTemplate(authenticator=authenticator, config=config),
            UserProjectEvaluation(authenticator=authenticator, config=config),
            UserProjectEvaluationAuthor(authenticator=authenticator, config=config),
            UserProjectEvaluationTemplate(authenticator=authenticator, config=config),
            UserGroupToUserGroupRight(authenticator=authenticator, config=config),
            EvaluationCampaignEvaluationTemplate(authenticator=authenticator, config=config),
            UserProjectUserPreference(authenticator=authenticator, config=config),
            ...
            EvaluationCampaignEvaluationApproval(authenticator=authenticator, config=config),
            UserProjectEvaluationApproval(authenticator=authenticator, config=config),
            ProjectContributor(authenticator=authenticator, config=config),
            ProjectLike(authenticator=authenticator, config=config),
            ...
            JobSheet(authenticator=authenticator, config=config),
            JobSheetSkill(authenticator=authenticator, config=config),
            UserJobSheet(authenticator=authenticator, config=config),
            CareerTrack(authenticator=authenticator, config=config),
            CareerTrackJobSheet(authenticator=authenticator, config=config),
