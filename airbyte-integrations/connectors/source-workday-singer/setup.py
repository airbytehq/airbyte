...
def check_singer():
    ...
    if not os.path.exists(tmp_dir):
        check_call(f"git clone -b v5.9.0 https://github.com/singer-io/singer-python.git {tmp_dir}".split())
...
setup(
    name="source_workday_singer",
    description="Source implementation for Workday, built on the Singer tap implementation.",
    author="Airbyte",
