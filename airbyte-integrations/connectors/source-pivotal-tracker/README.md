...
```
./gradlew :airbyte-integrations:connectors:source-pivotal-tracker:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-pivotal-tracker:airbyteDocker
```
...
To run your integration tests with Docker, run:, run
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-pivotal-tracker:unitTest
```
