...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-pivotal-tracker:dev`.
...
```Dockerfile
FROM airbyte/source-pivotal-tracker:latest
...
docker run airbyte/source-pivotal-tracker:dev spec
```
#### Run
