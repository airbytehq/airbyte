...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-zenloop:dev`.
...
```Dockerfile
FROM airbyte/source-zenloop:latest
...
docker run airbyte/source-zenloop:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/zenloop.md`).
