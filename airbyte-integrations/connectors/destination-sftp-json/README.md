...
```
./gradlew :airbyte-integrations:connectors:destination-sftp-json:build
```
...
```
./gradlew :airbyte-integrations:connectors:destination-sftp-json:buildDockerImage
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:destination-sftp-json:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:destination-sftp-json:integrationTest
```
