...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/destination-sftp-json:dev`.
...
```Dockerfile
FROM airbyte/destination-sftp-json:latest
...
docker run airbyte/destination-sftp-json:dev spec
```
#### Run
