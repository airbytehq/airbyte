...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-timely:dev`.
...
```Dockerfile
FROM airbyte/source-timely:latest
...
docker run airbyte/source-timely:dev spec
```
#### Run
