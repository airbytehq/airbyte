...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-rss:dev`.
...
```Dockerfile
FROM airbyte/source-rss:latest
...
docker run airbyte/source-rss:dev spec
```
#### Run
