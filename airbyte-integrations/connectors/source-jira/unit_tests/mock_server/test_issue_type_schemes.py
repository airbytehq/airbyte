...
_STREAM_NAME = "issue_type_schemes"
_DOMAIN = "airbyteio.atlassian.net"


@freezegun.freeze_time(_NOW.isoformat())
class TestIssueTypeSchemesStream(TestCase):
    """
    Tests for the Jira 'issue_type_schemes' stream.
    ...
    def test_full_refresh_single_page(self, http_mocker: HttpMocker):
        ...
        scheme_records = [
            {
                ...
                "description": "Default issue type scheme for the project.",
                "defaultIssueTypeId": "10001",
                "isDefault": True,
            },
            {
                "id": "10001",
                "name": "Custom Issue Type Scheme",
                "description": "Custom issue type scheme.",
        ...
        http_mocker.get(
            JiraRequestBuilder.issue_type_schemes_endpoint(_DOMAIN).with_any_query_params().build(),
    ...
    def test_pagination_multiple_pages(self, http_mocker: HttpMocker):
        ...
        # Page 1
        page1_schemes = [
            {"id": "10000", "name": "Scheme 1", "isDefault": True},
            {"id": "10001", "name": "Scheme 2", "isDefault": False},
        ]

        # Page 2
        page2_schemes = [
            {"id": "10002", "name": "Scheme 3", "isDefault": False},
        ]
