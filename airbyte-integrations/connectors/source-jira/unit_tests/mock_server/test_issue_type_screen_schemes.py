...
_STREAM_NAME = "issue_type_screen_schemes"
_DOMAIN = "airbyteio.atlassian.net"


@freezegun.freeze_time(_NOW.isoformat())
class TestIssueTypeScreenSchemesStream(TestCase):
    """
    Tests for the Jira 'issue_type_screen_schemes' stream.
        ...
        scheme_records = [
            {
                ...
                "description": "Default issue type screen scheme for the project.",
            },
            {
                "id": "10001",
                "name": "Custom Issue Type Screen Scheme",
                "description": "Custom issue type screen scheme.",
            },
        ]

        http_mocker.get(
            JiraRequestBuilder.issue_type_screen_schemes_endpoint(_DOMAIN).with_any_query_params().build(),
