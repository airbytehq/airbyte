...
_STREAM_NAME = "issue_notification_schemes"
_DOMAIN = "airbyteio.atlassian.net"


@freezegun.freeze_time(_NOW.isoformat())
class TestIssueNotificationSchemesStream(TestCase):
    """
    Tests for the Jira 'issue_notification_schemes' stream.
        ...
        scheme_records = [
            {
                ...
                "description": "Default notification scheme for all projects",
                "self": f"https://{_DOMAIN}/rest/api/3/notificationscheme/10000",
            },
            {
                "id": 10001,
                "name": "Custom Notification Scheme",
                "description": "Custom notification scheme",
                "self": f"https://{_DOMAIN}/rest/api/3/notificationscheme/10001",
            },
        ]

        http_mocker.get(
            JiraRequestBuilder.issue_notification_schemes_endpoint(_DOMAIN).with_any_query_params().build(),
            JiraPaginatedResponseBuilder("values")
            .with_records(scheme_records)
    ...
    def test_pagination_multiple_pages(self, http_mocker: HttpMocker):
        ...
        # Page 1
        page1_schemes = [
            {"id": 10000, "name": "Scheme 1", "self": f"https://{_DOMAIN}/rest/api/3/notificationscheme/10000"},
            {"id": 10001, "name": "Scheme 2", "self": f"https://{_DOMAIN}/rest/api/3/notificationscheme/10001"},
        ]

        # Page 2
        page2_schemes = [
            {"id": 10002, "name": "Scheme 3", "self": f"https://{_DOMAIN}/rest/api/3/notificationscheme/10002"},
        ]
