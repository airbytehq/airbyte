...
public interface MySqlInitialLoadStateManager {
  ...
  AirbyteStateMessage createFinalStateMessage(final AirbyteStreamNameNamespacePair pair, final JsonNode streamStateForIncrementalRun, final double messageCount);
