    ...
    override fun initializeErrorDictionary() {
        ...
        add(
            ConnectorErrorProfile(
                ...
                sampleInternalMessage = "java.io.EOFException: Can not read response from server. Expected to read X bytes, read Y bytes before connection was unexpectedly lost."
            )
        )
    }
}
