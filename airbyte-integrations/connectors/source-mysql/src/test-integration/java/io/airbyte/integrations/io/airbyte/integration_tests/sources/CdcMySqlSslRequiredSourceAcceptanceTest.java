...
public class CdcMySqlSslRequiredSourceAcceptanceTest extends MySqlSourceAcceptanceTest {

  public Path getConfigFilePath() {
    return Path.of("secrets/cdc-mysql-ssl-required-source-acceptance-test-config.json");
  }
  ...
  protected void setupEnvironment(final TestDestinationEnv environment) throws Exception {
    ...
    mysqlSeeding.setUserRequireSsl();
  }
