...
public class MySqlDatatypeAccuracyTest extends AbstractMySqlSourceDatatypeTest {
  ...
  protected Path getConfigFilePath() {
    return Path.of("secrets/mysql-datatype-accuracy-test-config.json");
  }

  @Override
  protected Database setupDatabase() throws Exception {
    mySqlSeeding = new MySqlSeeding(getConfigFilePath(), Map.of("zeroDateTimeBehavior", "convertToNull"));
