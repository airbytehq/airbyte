...
class RecordMungerTest {
    ...
    fun `transforms record into map of munged keys and values`() {
        ...
        val coerced = mockk<EnrichedDestinationRecordAirbyteValue> {
        ...
        verify { input.asEnrichedDestinationRecordAirbyteValue(extractedAtAsTimestampWithTimezone = true) }
