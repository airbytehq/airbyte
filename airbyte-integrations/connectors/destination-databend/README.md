...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/destination-databend:dev`.
...
```Dockerfile
FROM airbyte/destination-databend:latest
...
docker run airbyte/destination-databend:dev spec
```
#### Run
