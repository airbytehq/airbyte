...
For information about how to use this connector within Airbyte, see [the documentation](https://docs.airbyte.com/integrations/sources/metabase).
...
1. Make sure your changes are passing our test suite: `airbyte-ci connectors --name=source-metabase test`
