...
```
./gradlew :airbyte-integrations:connectors:source-todoist:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-todoist:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-todoist:unitTest
```
