...
This is the repository for the Clickup-Api source connector, written in Python.
...
poetry run source-clickup-api read --config secrets/config.json --catalog sample_files/configured_catalog.json
```
