...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-clickup-api:dev`.
...
```Dockerfile
FROM airbyte/source-clickup-api:latest
...
docker run airbyte/source-clickup-api:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/clickup-api.md`).
