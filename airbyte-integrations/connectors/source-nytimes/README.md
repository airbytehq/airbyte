...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-nytimes:dev`.
...
```Dockerfile
FROM airbyte/source-nytimes:latest
...
docker run airbyte/source-nytimes:dev spec
```
#### Run
