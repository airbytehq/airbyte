...
public class TeradataSqlOperationsTest {
    ...
    void testCreateTableQuery() {
        ...
        assertEquals("CREATE SET TABLE schema.table, FALLBACK ( _airbyte_ab_id VARCHAR(256), _airbyte_data JSON, _airbyte_emitted_at TIMESTAMP(6))  UNIQUE PRIMARY INDEX (_airbyte_ab_id) ", query);
    }
