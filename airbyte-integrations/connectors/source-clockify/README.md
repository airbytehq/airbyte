...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-clockify:dev`.
...
```Dockerfile
FROM airbyte/source-clockify:latest
...
docker run airbyte/source-clockify:dev spec
```
#### Run
