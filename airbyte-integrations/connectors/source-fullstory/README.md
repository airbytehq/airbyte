...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-fullstory:dev`.
...
```Dockerfile
FROM airbyte/source-fullstory:latest
...
docker run airbyte/source-fullstory:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/fullstory.md`).
