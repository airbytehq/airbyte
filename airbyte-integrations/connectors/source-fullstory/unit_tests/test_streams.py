...
import pytest
from source_fullstory.source import FullstoryStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(FullstoryStream, "path", "v0/example_endpoint")
    mocker.patch.object(FullstoryStream, "primary_key", "test_primary_key")
    mocker.patch.object(FullstoryStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = FullstoryStream()
