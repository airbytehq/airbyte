...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-omnisend:dev`.
...
```Dockerfile
FROM airbyte/source-omnisend:latest
...
docker run airbyte/source-omnisend:dev spec
```
#### Run
