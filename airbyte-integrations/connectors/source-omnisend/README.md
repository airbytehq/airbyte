...
```
./gradlew :airbyte-integrations:connectors:source-omnisend:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-omnisend:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-omnisend:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-omnisend:integrationTest
```
