...
```
./gradlew :airbyte-integrations:connectors:source-rocket-chat:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-rocket-chat:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-rocket-chat:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-rocket-chat:integrationTest
```
