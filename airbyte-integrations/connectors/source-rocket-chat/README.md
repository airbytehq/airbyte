...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-rocket-chat:dev`.
...
```Dockerfile
FROM airbyte/source-rocket-chat:latest
...
docker run airbyte/source-rocket-chat:dev spec
```
#### Run
