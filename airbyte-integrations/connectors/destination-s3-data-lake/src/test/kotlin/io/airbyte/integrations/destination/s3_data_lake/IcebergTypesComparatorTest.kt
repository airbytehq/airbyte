...
class IcebergTypesComparatorTest {
    ...
    fun testNewColumns() {
        ...
        val incomingSchema = buildSchema(
            field("id", Types.IntegerType.get(), false),
    ...
    fun testUnsupportedTypeBinary() {
        ...
        assertThat(exception.message).contains("Unsupported or unmapped Iceberg type: BINARY. Please implement handling if needed.")
    }
    ...
    fun testUnsupportedTypeDecimal() {
        ...
        assertThat(exception.message).contains("Unsupported or unmapped Iceberg type: DECIMAL. Please implement handling if needed.")
    }
}
