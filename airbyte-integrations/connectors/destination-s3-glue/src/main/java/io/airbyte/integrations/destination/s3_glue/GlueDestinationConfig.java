...
import static io.airbyte.cdk.integrations.destination.s3_glue.MetastoreConstants.GLUE_DATABASE;
import static io.airbyte.cdk.integrations.destination.s3_glue.MetastoreConstants.SERIALIZATION_LIBRARY;
