...
import pytest
from source_telegram.source import TelegramStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TelegramStream, "path", "v0/example_endpoint")
    mocker.patch.object(TelegramStream, "primary_key", "test_primary_key")
    mocker.patch.object(TelegramStream, "__abstractmethods__", set())
