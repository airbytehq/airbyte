...
import pytest
from source_minnesider.source import MinnesiderStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MinnesiderStream, "path", "v0/example_endpoint")
    mocker.patch.object(MinnesiderStream, "primary_key", "test_primary_key")
    mocker.patch.object(MinnesiderStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = MinnesiderStream()
