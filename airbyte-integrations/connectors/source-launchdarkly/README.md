...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-launchdarkly:dev`.
...
```Dockerfile
FROM airbyte/source-launchdarkly:latest
...
docker run airbyte/source-launchdarkly:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/launchdarkly.md`).
