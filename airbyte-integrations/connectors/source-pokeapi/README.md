...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-pokeapi:dev`.
...
```Dockerfile
FROM airbyte/source-pokeapi:latest
...
docker run airbyte/source-pokeapi:dev spec
```
#### Run
