...
import pytest
from source_tidsbanken.source import TidsbankenStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TidsbankenStream, "path", "v0/example_endpoint")
    mocker.patch.object(TidsbankenStream, "primary_key", "test_primary_key")
    mocker.patch.object(TidsbankenStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = TidsbankenStream()
