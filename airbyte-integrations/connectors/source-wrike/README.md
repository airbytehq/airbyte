...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-wrike:dev`.
...
```Dockerfile
FROM airbyte/source-wrike:latest
...
docker run airbyte/source-wrike:dev spec
```
#### Run
