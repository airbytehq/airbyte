...
public class ClickHouseSource extends AbstractJdbcSource<JDBCType> implements Source {
  ...
  public static Source getWrappedSource() {
    return new SshWrappedSource(
        new ClickHouseSource(), JdbcUtils.HOST_LIST_KEY, JdbcUtils.PORT_LIST_KEY);
  }
  ...
  public JsonNode toDatabaseConfig(final JsonNode config) {
    ...
    final boolean isAdditionalParamsExists = config.get(JdbcUtils.JDBC_URL_PARAMS_KEY) != null
