...
class S3V2Specification :
    ...
    @get:JsonProperty("part_size_b") val partSizeBytes: Long? = null

    @get:JsonProperty("num_concurrent_uploads") val numConcurrentUploads: Int? = null

    @get:JsonProperty("memory_overhead_ratio") val memoryOverheadRatio: Double? = null
}
