...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-smaily:dev`.
...
```Dockerfile
FROM airbyte/source-smaily:latest
...
docker run airbyte/source-smaily:dev spec
```
#### Run
