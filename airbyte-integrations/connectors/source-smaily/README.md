...
```
./gradlew :airbyte-integrations:connectors:source-smaily:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-smaily:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-smaily:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-smaily:integrationTest
```
