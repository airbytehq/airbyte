...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-customer-io:dev`.
...
```Dockerfile
FROM airbyte/source-customer-io:latest
...
docker run airbyte/source-customer-io:dev spec
```
#### Run
