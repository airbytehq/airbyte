...
```
./gradlew :airbyte-integrations:connectors:source-customer-io:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-customer-io:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-customer-io:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-customer-io:integrationTest
```
