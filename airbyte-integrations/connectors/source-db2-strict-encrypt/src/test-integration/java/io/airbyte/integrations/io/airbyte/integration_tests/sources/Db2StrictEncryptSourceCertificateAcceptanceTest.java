...
public class Db2StrictEncryptSourceCertificateAcceptanceTest extends SourceAcceptanceTest {
  ...
  private static final String SSL_CONFIG = ":sslConnection=true;sslTrustStoreLocation="
      + KEY_STORE_FILE_PATH + ";sslTrustStorePassword=" + TEST_KEY_STORE_PASS + ";";
  ...
  protected void setupEnvironment(final TestDestinationEnv environment) throws Exception {
    db = new Db2Container("ibmcom/db2:11.5.5.0")
        .withCommand()
        .acceptLicense()
  ...
  private String getCertificate() throws IOException, InterruptedException {
    ...
    // Then you need to enable SSL connection and specify on which port it will work. These changes
    // will
