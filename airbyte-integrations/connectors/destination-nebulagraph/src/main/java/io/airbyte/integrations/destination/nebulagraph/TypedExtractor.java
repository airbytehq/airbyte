...
/**
 * Extract top-level primitive fields into typed map.
 * Only STRING/INT/DOUBLE/BOOL like primitives, others -> NULL (or omitted; here we omit and let writer map absent to NULL).
 */
public final class TypedExtractor {
  ...
  public static boolean isPrimitive(Object v) {
    if (v == null) return true; // treat null as acceptable -> becomes NULL
