...
public final class EndpointBuilder {
  ...
  public long buildRank(Map<String, Object> record, String rankField) {
    if (rankField == null || rankField.isEmpty()) return 0L;
  ...
  private String build(Map<String, Object> record, List<String> fields, String sep, int maxLen, String kind) {
    if (record == null) throw new IllegalArgumentException(kind + " record is null");
    if (fields == null || fields.isEmpty()) throw new IllegalArgumentException(kind + " fields empty");
    StringBuilder sb = new StringBuilder();
    for (int i = 0; i < fields.size(); i++) {
      String f = fields.get(i);
      Object v = record.get(f);
      if (v == null) throw new IllegalArgumentException(kind + " field is null: " + f);
