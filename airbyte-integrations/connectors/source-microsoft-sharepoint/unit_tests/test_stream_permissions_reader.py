...
def test_get_site_group_members_success(setup_permissions_reader_class):
    ...
    with (
        ...
        patch("source_microsoft_sharepoint.stream_permissions_reader.execute_query_with_retry") as mock_execute,
...
def test_get_site_users(setup_permissions_reader_class):
    ...
    with (
        ...
        patch("source_microsoft_sharepoint.stream_permissions_reader.execute_query_with_retry") as mock_execute_with_retry,
    ):
