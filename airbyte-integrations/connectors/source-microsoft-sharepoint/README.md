...
**If you are an Airbyte core member**, copy the credentials in Lastpass under the secret name `source microsoft-sharepoint test creds`
...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-microsoft-sharepoint:dev`.
...
```Dockerfile
FROM airbyte/source-microsoft-sharepoint:latest
...
2. Build your image:
```bash
docker build -t airbyte/source-microsoft-sharepoint:dev .
# Running the spec command against your patched connector
docker run airbyte/source-microsoft-sharepoint:dev spec
````
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/microsoft-sharepoint.md`).
