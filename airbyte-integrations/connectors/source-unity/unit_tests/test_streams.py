...
import pytest
from source_unity.source import UnityStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(UnityStream, "path", "v0/example_endpoint")
    mocker.patch.object(UnityStream, "primary_key", "test_primary_key")
    mocker.patch.object(UnityStream, "__abstractmethods__", set())
