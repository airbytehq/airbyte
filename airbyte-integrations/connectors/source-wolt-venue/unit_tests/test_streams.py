...
import pytest
from source_wolt_venue.source import WoltVenueStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(WoltVenueStream, "path", "v0/example_endpoint")
    mocker.patch.object(WoltVenueStream, "primary_key", "test_primary_key")
    mocker.patch.object(WoltVenueStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = WoltVenueStream()
