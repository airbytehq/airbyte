...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-intruder:dev`.
...
```Dockerfile
FROM airbyte/source-intruder:latest
...
docker run airbyte/source-intruder:dev spec
```
#### Run
