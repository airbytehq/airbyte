...
class SourceElasticsearch(Source):
    ...
    def read(
        ...
        """
        Reads through each stream in the configured catalog.
        """
    ...
    def _scroll_through_index(
        ...
        """
        Scrolls through the index.

        For each page in the index, yields each document in that page as an AirbyteRecordMessage.
        """
