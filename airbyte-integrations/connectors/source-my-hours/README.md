...
This is the repository for the My Hours source connector, written in Python. For information about
how to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.io/integrations/sources/my-hours).
...
[documentation](https://docs.airbyte.io/integrations/sources/my-hours) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_my_hours/spec.json`
...
`source my-hours test creds` and place them into `secrets/config.json`.
