...
import pytest
from source_mytarget.source import MyTargetStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MyTargetStream, "path", "v0/example_endpoint")
    mocker.patch.object(MyTargetStream, "primary_key", "test_primary_key")
    mocker.patch.object(MyTargetStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = MyTargetStream()
