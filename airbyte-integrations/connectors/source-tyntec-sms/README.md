...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-tyntec-sms:dev`.
...
```Dockerfile
FROM airbyte/source-tyntec-sms:latest
...
docker run airbyte/source-tyntec-sms:dev spec
```
#### Run
