...
import pytest
from source_test.source import TestStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TestStream, "path", "v0/example_endpoint")
    mocker.patch.object(TestStream, "primary_key", "test_primary_key")
    mocker.patch.object(TestStream, "__abstractmethods__", set())
