...
import pytest
from source_hotmart.source import HotmartStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(HotmartStream, "path", "v0/example_endpoint")
    mocker.patch.object(HotmartStream, "primary_key", "test_primary_key")
    mocker.patch.object(HotmartStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = HotmartStream()
