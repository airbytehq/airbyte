...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-k6-cloud:dev`.
...
```Dockerfile
FROM airbyte/source-k6-cloud:latest
...
docker run airbyte/source-k6-cloud:dev spec
```
#### Run
