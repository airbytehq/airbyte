...
import pytest
from source_dentclinic.source import DentclinicStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(DentclinicStream, "path", "v0/example_endpoint")
    mocker.patch.object(DentclinicStream, "primary_key", "test_primary_key")
    mocker.patch.object(DentclinicStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = DentclinicStream()
