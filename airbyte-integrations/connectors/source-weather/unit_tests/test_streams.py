...
import pytest
from source_weather.source import WeatherStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(WeatherStream, "path", "v0/example_endpoint")
    mocker.patch.object(WeatherStream, "primary_key", "test_primary_key")
    mocker.patch.object(WeatherStream, "__abstractmethods__", set())
