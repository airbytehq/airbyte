...
class StateManagerTest {
  ...
  private static final AirbyteStreamNameNamespacePair NAME_NAMESPACE_PAIR1 =
      new AirbyteStreamNameNamespacePair(STREAM_NAME1, NAMESPACE);
  private static final String STREAM_NAME2 = "bicycles";
  private static final AirbyteStreamNameNamespacePair NAME_NAMESPACE_PAIR2 =
  ...
  void testCreateCursorInfoCatalogAndStateSameCursorField() {
    final CursorInfo actual =
        StateManager.createCursorInfoForStream(
            NAME_NAMESPACE_PAIR1, getState(CURSOR_FIELD1, CURSOR), getCatalog(CURSOR_FIELD1));
  ...
  void testCreateCursorInfoCatalogAndStateSameCursorFieldButNoCursor() {
    final CursorInfo actual =
        StateManager.createCursorInfoForStream(
            NAME_NAMESPACE_PAIR1, getState(CURSOR_FIELD1, null), getCatalog(CURSOR_FIELD1));
  ...
  void testCreateCursorInfoCatalogAndStateChangeInCursorFieldName() {
    final CursorInfo actual =
        StateManager.createCursorInfoForStream(
            NAME_NAMESPACE_PAIR1, getState(CURSOR_FIELD1, CURSOR), getCatalog(CURSOR_FIELD2));
  ...
  void testCreateCursorInfoCatalogAndNoState() {
    final CursorInfo actual =
        StateManager.createCursorInfoForStream(
            NAME_NAMESPACE_PAIR1, Optional.empty(), getCatalog(CURSOR_FIELD1));
  ...
  void testCreateCursorInfoStateAndNoCatalog() {
    final CursorInfo actual =
        StateManager.createCursorInfoForStream(
            NAME_NAMESPACE_PAIR1, getState(CURSOR_FIELD1, CURSOR), Optional.empty());
  ...
  void testCreateCursorInfoNoCatalogAndNoState() {
    final CursorInfo actual =
        StateManager.createCursorInfoForStream(
            NAME_NAMESPACE_PAIR1, Optional.empty(), Optional.empty());
  ...
  void testCreateCursorInfoStateAndCatalogButNoCursorField() {
    final CursorInfo actual =
        StateManager.createCursorInfoForStream(
            NAME_NAMESPACE_PAIR1, getState(CURSOR_FIELD1, CURSOR), getCatalog(null));
    assertEquals(new CursorInfo(CURSOR_FIELD1, CURSOR, null, null), actual);
  }
        ...
        new ConfiguredAirbyteCatalog()
            .withStreams(
                Lists.newArrayList(
                    new ConfiguredAirbyteStream()
                        .withStream(
                            new AirbyteStream().withName(STREAM_NAME1).withNamespace(NAMESPACE))
                        .withCursorField(Lists.newArrayList(CURSOR_FIELD1)),
                    new ConfiguredAirbyteStream()
                        .withStream(
                            new AirbyteStream().withName(STREAM_NAME2).withNamespace(NAMESPACE))));
        ...
        new ConfiguredAirbyteCatalog()
            .withStreams(
                Lists.newArrayList(
                    ...
                    new ConfiguredAirbyteStream()
                        .withStream(
                            new AirbyteStream().withName(STREAM_NAME3).withNamespace(NAMESPACE))));
