...
public class LegacyStateManagerTest {
  ...
  void testGetters() {
    ...
    assertEquals(
        Optional.of(CURSOR_FIELD1), stateManager.getOriginalCursorField(NAME_NAMESPACE_PAIR1));
  ...
  void testToState() {
    ...
    final AirbyteStateMessage actualFirstEmission =
        stateManager.updateAndEmit(NAME_NAMESPACE_PAIR1, "a");
    ...
    final AirbyteStateMessage expectedSecondEmission = new AirbyteStateMessage()
        ...
        .withData(Jsons.jsonNode(new DbState()
            .withStreams(List.of(
                ...
                .collect(Collectors.toList()))
            .withCdc(false)));
    final AirbyteStateMessage actualSecondEmission =
        stateManager.updateAndEmit(NAME_NAMESPACE_PAIR2, "b");
