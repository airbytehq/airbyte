...
/**
 * Test suite for the {@link PerStreamStateManager} class.
 */
public class PerStreamStateManagerTest {
    ...
    final AirbyteStateMessage airbyteStateMessage = new AirbyteStateMessage()
        .withStreams(List.of(
            new AirbyteStreamState()
                ...
                .withState(Jsons.jsonNode("Not a state object"))));
    final ConfiguredAirbyteCatalog catalog = mock(ConfiguredAirbyteCatalog.class);

    Assertions.assertDoesNotThrow(() -> {
      final StateManager stateManager = new PerStreamStateManager(airbyteStateMessage, catalog);
  ...
  void testGetters() {
    ...
    final StateManager stateManager = new PerStreamStateManager(state, catalog);
                ...
                .withState(
                    Jsons.jsonNode(
                        new DbStreamState()
                            ...
                            .withStreamNamespace(NAMESPACE))))
            .stream().sorted(Comparator.comparing(AirbyteStreamState::getName)).collect(Collectors.toList()));
