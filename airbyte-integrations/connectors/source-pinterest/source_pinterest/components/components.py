...
class PinterestReportRetriever(Retriever):
    ...
    def __init__(self, config: Config, report_level: str, **kwargs):
        super().__init__(config, **kwargs)
        self.report_level = report_level
        self.base_url = "https://api.pinterest.com/v5/"
        
    def read_records(self, sync_mode, cursor_field, stream_slice, stream_state) -> Iterable[Record]:
    ...
    def _poll_for_completion(self, ad_account_id: str, token: str, max_attempts: int = 30) -> str:
    ...
    def _download_and_extract_records(self, download_url: str, stream_slice: StreamSlice) -> Iterable[Record]:
