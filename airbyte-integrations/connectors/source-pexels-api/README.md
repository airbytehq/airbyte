...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-pexels-api:dev`.
...
```Dockerfile
FROM airbyte/source-pexels-api:latest
...
docker run airbyte/source-pexels-api:dev spec
```
#### Run
