...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-mailerlite:dev`.
...
```Dockerfile
FROM airbyte/source-mailerlite:latest
...
docker run airbyte/source-mailerlite:dev spec
```
#### Run
