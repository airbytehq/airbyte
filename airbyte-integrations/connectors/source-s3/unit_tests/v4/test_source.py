...
class SourceTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self._source = SourceS3(self._stream_reader, Config, "../sample_files/catalog.json")
    ...
    def test_given_config_is_v3_when_read_config_then_emit_new_config(self, emit_config_mock) -> None:
        self._source.read_config("../sample_files/v3_config.json")
    ...
    def test_given_config_is_v4_when_read_config_then_do_not_emit_new_config(self, emit_config_mock) -> None:
        self._source.read_config("../sample_files/v4_config.json")
