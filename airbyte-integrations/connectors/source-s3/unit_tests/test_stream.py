...
from .abstract_test_parser import memory_limit, create_by_local_file
...
class TestFileStream:
    ...
    @pytest.mark.parametrize(  # set expected_return_record to None for an expected fail
        ...
        [
            ...
            (  # additional columns
                    ["id", "first_name", "last_name"],
                    {"id": "1", "first_name": "Frodo", "last_name": "Baggins", "location": "The Shire",
                     "items": ["The One Ring", "Sting"]},
                    {
                        "id": "1",
                        "first_name": "Frodo",
                        "last_name": "Baggins",
    ...
    @pytest.mark.parametrize(  #
        ...
        [
            ...
            (  # 'everything' at least 1 level deep
                    ...
                    ["folder/file.csv", "folder/file.parquet", "folder/nested/file.csv", "folder/nested/file.parquet",
                     "a/b/c/d/e/f/file"],
            ),
