        ...
        "breakdowns": [
            {
                "dimension_keys": ["city"],
                "results": [
                    {"dimension_values": ["London, England"], "value": 263},
                    {"dimension_values": ["Sydney, New South Wales"], "value": 467},
                    {"dimension_values": ["Algiers, Algiers Province"], "value": 58},
                    {"dimension_values": ["Casablanca, Grand Casablanca"], "value": 71},
                    {"dimension_values": ["São Paulo, São Paulo (state)"], "value": 139},
                    {"dimension_values": ["Rio de Janeiro, Rio de Janeiro (state)"], "value": 44},
                    {"dimension_values": ["Perth, Western Australia"], "value": 180},
                    {"dimension_values": ["Berlin, Berlin"], "value": 47},
                    {"dimension_values": ["Kolkata, West Bengal"], "value": 85},
                    {"dimension_values": ["Phoenix, Arizona"], "value": 39},
                    {"dimension_values": ["Lagos, Lagos State"], "value": 40},
                    {"dimension_values": ["Dublin, Dublin"], "value": 65},
                    {"dimension_values": ["Pune, Maharashtra"], "value": 72},
                    {"dimension_values": ["Wollongong, New South Wales"], "value": 43},
                    {"dimension_values": ["Christchurch, Canterbury"], "value": 42},
                    {"dimension_values": ["Jakarta, Jakarta"], "value": 46},
                    {"dimension_values": ["Pretoria, Gauteng"], "value": 54},
                    {"dimension_values": ["Buenos Aires, Ciudad Autónoma de Buenos Aires"], "value": 41},
                    {"dimension_values": ["Gold Coast, Queensland"], "value": 98},
                    {"dimension_values": ["Sunshine Coast, Queensland"], "value": 37},
                    {"dimension_values": ["Melbourne, Victoria"], "value": 338},
                    {"dimension_values": ["Gurugram, Haryana"], "value": 52},
                    {"dimension_values": ["Delhi, Delhi"], "value": 194},
                    {"dimension_values": ["Los Angeles, California"], "value": 66},
                    {"dimension_values": ["Madrid, Comunidad de Madrid"], "value": 65},
                    {"dimension_values": ["Lahore, Punjab"], "value": 41},
                    {"dimension_values": ["Brisbane, Queensland"], "value": 160},
                    {"dimension_values": ["Adelaide, South Australia"], "value": 93},
                    {"dimension_values": ["Canberra, Australian Capital Territory"], "value": 45},
                    {"dimension_values": ["Lima, Lima Region"], "value": 43},
                    {"dimension_values": ["Istanbul, Istanbul Province"], "value": 57},
                    {"dimension_values": ["Toronto, Ontario"], "value": 40},
                    {"dimension_values": ["Chennai, Tamil Nadu"], "value": 82},
                    {"dimension_values": ["Mexico City, Distrito Federal"], "value": 66},
                    {"dimension_values": ["Auckland, Auckland Region"], "value": 98},
                    {"dimension_values": ["Cape Town, Western Cape"], "value": 172},
                    {"dimension_values": ["New York, New York"], "value": 139},
                    {"dimension_values": ["Cairo, Cairo Governorate"], "value": 45},
                    {"dimension_values": ["Dubai, Dubai"], "value": 57},
                    {"dimension_values": ["Santiago, Santiago Metropolitan Region"], "value": 73},
                    {"dimension_values": ["Mumbai, Maharashtra"], "value": 195},
                    {"dimension_values": ["Bangalore, Karnataka"], "value": 195},
                    {"dimension_values": ["Nairobi, Nairobi"], "value": 50},
                    {"dimension_values": ["Johannesburg, Gauteng"], "value": 50},
                    {"dimension_values": ["Hyderabad, Telangana"], "value": 49},
                ],
            }
        ]
    },
