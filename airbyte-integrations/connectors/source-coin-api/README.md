...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-coin-api:dev`.
...
```Dockerfile
FROM airbyte/source-coin-api:latest
...
docker run airbyte/source-coin-api:dev spec
```
#### Run
