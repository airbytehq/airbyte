# Finnworlds
This directory contains the manifest-only connector for `source-finnworlds`.
...
### Build
This will create a dev image (`source-finnworlds:dev`) that you can use to test the connector locally.
```bash
