  ...
  protected void initTests() {
    ...
    addDataTypeTestData(
        TestDataHolder.builder()
            ...
            .build());//This is very brittle. A change of parameters on the customer's account could change the values returned by snowflake
    addDataTypeTestData(
        TestDataHolder.builder()
            ...
            .build());//This is extremely brittle. A change of parameters on the customer's account,
                     // or a change of timezone where this code is executed (!!) could change the values returned by snowflake
    addDataTypeTestData(
        TestDataHolder.builder()
