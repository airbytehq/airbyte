...
public class SnowflakeSourceDatatypeTest extends AbstractSourceDatabaseTypeTest {
  ...
  private static final String SCHEMA_NAME =
      "SOURCE_DATA_TYPE_TEST_" + RandomStringUtils.randomAlphanumeric(4).toUpperCase();
  ...
  protected void initTests() {
    ...
    addDataTypeTestData(TestDataHolder.builder()
        ...
        .addExpectedValues(
            null, "0001-01-01T00:00:00.000000", "9999-12-31T23:59:59", "9999-12-31T23:59:59.123456")
        .build());
    addDataTypeTestData(TestDataHolder.builder()
        .sourceType("TIME")
        .airbyteType(JsonSchemaType.STRING_TIME_WITHOUT_TIMEZONE)
        .addInsertValues("null", "'00:00:00'", "'1:59 PM'", "'23:59:59.123456'")
        .addExpectedValues(null, "00:00:00.000000", "13:59:00.000000", "23:59:59.123456")
        .build());
    addDataTypeTestData(TestDataHolder.builder()
    ...
    addDataTypeTestData(TestDataHolder.builder()
        ...
        .addInsertValues(
            "null", "'2018-03-22 12:00:00.123 +05:00'", "'2018-03-22 12:00:00.123456 +05:00'")
