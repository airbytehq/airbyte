    ...
    return json.dumps([
        {
            ...
            "accountInfo": {
                ...
                "id": "A3LUQZ2NBMFGO4",
                "type": "seller",
                "name": "The Airbyte Store",
                "validPaymentMethod": True
            }
        },
        {
            "profileId": 2935840597082037,
            "countryCode": "CA",
            "currencyCode": "CAD",
            "timezone": "America/Los_Angeles",
            "accountInfo": {
                "marketplaceStringId": "A2EUQ1WTGCTBG2",
                "id": "ENTITY1T4PQ8E0Y1LVJ",
                "type": "vendor",
                "name": "test",
        ...
        [
            {
                ...
                "inBudget": True,
                "state": "enabled",
                "creationDate": 1687510907465,
                "lastUpdatedDate": 1687510907465,
                "servingStatus": "PORTFOLIO_STATUS_ENABLED"
            },
            {
                "portfolioId": 270076898441727,
                "name": "Test Portfolio",
                "budget": {
                    "amount": 1,
                    "currencyCode": "USD",
                ...
                "inBudget": True,
                "state": "enabled",
                "creationDate": 1687510616329,
                "lastUpdatedDate": 1687514774484,
                "servingStatus": "PORTFOLIO_STATUS_ENABLED"
            }
        ]
    )
                ...
                "reports": [
                    {
                        ...
                        "productAsin": "some-asin",
                        "productCategory": "Chemicals",
                        "productConversionType": "some-conversion-type",
                        "productGroup": "some-group",
                        "productName": "some-product-name",
                        "productSubcategory": "some-subcategory",
