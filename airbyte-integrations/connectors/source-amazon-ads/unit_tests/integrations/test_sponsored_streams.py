...
class TestSponsoredBrandsStreamsFullRefresh(TestCase):
    ...
    def test_given_many_pages_when_read_ad_groups_then_return_records(self, http_mocker):
        ...
        http_mocker.get(
            ...
            SponsoredBrandsResponseBuilder.ad_groups_response(CountBasedPaginationStrategy())
            .with_record(SponsoredBrandsRecordBuilder.ad_groups_record())
            .with_pagination()
            .build(),
        )
        http_mocker.get(
    ...
    def test_given_many_pages_when_read_campaigns_then_return_records(self, http_mocker):
        ...
        http_mocker.get(
            ...
            SponsoredBrandsResponseBuilder.campaigns_response(CountBasedPaginationStrategy())
            .with_record(SponsoredBrandsRecordBuilder.campaigns_record())
            .with_pagination()
            .build(),
        )
        http_mocker.get(
