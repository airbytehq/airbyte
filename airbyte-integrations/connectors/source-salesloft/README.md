...
```
./gradlew :airbyte-integrations:connectors:source-salesloft:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-salesloft:buildDockerImage
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-salesloft:unitTest
```
