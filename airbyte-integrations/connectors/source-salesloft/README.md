...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-salesloft:dev`.
...
```Dockerfile
FROM airbyte/source-salesloft:latest
...
docker run airbyte/source-salesloft:dev spec
```
#### Run
