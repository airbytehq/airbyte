...
from airbyte_cdk.sources.configurable.YamlConfigurableSource import YamlConfigurableSource
...
class SendgridSource(YamlConfigurableSource):
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        ...
        configurable_stream = create_partial.create(
            ConfigurableStream,
            schema_loader=create_partial.create(JsonSchema, config=config, file_path="./source_sendgrid/schemas/{{kwargs['name']}}.json"),
            cursor_field=[],
        )
