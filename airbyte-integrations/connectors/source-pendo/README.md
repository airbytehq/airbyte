...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-pendo:dev`.
...
```Dockerfile
FROM airbyte/source-pendo:latest
...
docker run airbyte/source-pendo:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/pendo.md`).
