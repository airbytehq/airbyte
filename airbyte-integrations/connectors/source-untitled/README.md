# Untitled
This directory contains the manifest-only connector for `source-untitled`.
...
### Build
This will create a dev image (`source-untitled:dev`) that you can use to test the connector locally.
```bash
airbyte-ci connectors --name=source-untitled build
```

### Test
This will run the acceptance tests for the connector.
```bash
airbyte-ci connectors --name=source-untitled test
```
