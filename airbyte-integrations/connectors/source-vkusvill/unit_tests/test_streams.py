...
import pytest
from source_vkusvill.source import VkusvillStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(VkusvillStream, "path", "v0/example_endpoint")
    mocker.patch.object(VkusvillStream, "primary_key", "test_primary_key")
    mocker.patch.object(VkusvillStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = VkusvillStream()
