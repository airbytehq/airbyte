...
import pytest
from source_wordstat.source import WordstatStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(WordstatStream, "path", "v0/example_endpoint")
    mocker.patch.object(WordstatStream, "primary_key", "test_primary_key")
    mocker.patch.object(WordstatStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = WordstatStream()
