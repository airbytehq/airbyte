...
public abstract class AzureBlobStorageGcsStagingDestinationAcceptanceTest extends DestinationAcceptanceTest {
  ...
  protected static final Logger LOGGER = LoggerFactory
      .getLogger(AzureBlobStorageGcsStagingDestinationAcceptanceTest.class);

  protected final String secretFilePath = "secrets/config_gcs_staging.json";
  ...
  protected AzureBlobStorageGcsStagingDestinationAcceptanceTest(final AzureBlobStorageFormat outputFormat) {
