...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-slack:dev`.
...
```Dockerfile
FROM airbyte/source-slack:latest
...
docker run airbyte/source-slack:dev spec
```
#### Run
