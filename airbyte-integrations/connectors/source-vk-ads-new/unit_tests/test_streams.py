...
import pytest
from source_vk_ads_new.source import VkAdsNewStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(VkAdsNewStream, "path", "v0/example_endpoint")
    mocker.patch.object(VkAdsNewStream, "primary_key", "test_primary_key")
    mocker.patch.object(VkAdsNewStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = VkAdsNewStream()
