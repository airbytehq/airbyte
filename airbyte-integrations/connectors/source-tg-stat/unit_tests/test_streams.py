...
import pytest
from source_tg_stat.source import TgStatStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TgStatStream, "path", "v0/example_endpoint")
    mocker.patch.object(TgStatStream, "primary_key", "test_primary_key")
    mocker.patch.object(TgStatStream, "__abstractmethods__", set())
