...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-serpstat:dev`.
...
```Dockerfile
FROM airbyte/source-serpstat:latest
...
docker run airbyte/source-serpstat:dev spec
```
#### Run
