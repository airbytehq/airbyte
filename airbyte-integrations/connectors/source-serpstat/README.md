...
This is the repository for the Serpstat source connector, written in Python.
...
poetry run source-serpstat read --config secrets/config.json --catalog sample_files/configured_catalog.json
```
