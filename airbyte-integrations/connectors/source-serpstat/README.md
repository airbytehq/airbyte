...
```
./gradlew :airbyte-integrations:connectors:source-serpstat:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-serpstat:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-serpstat:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-serpstat:integrationTest
```
