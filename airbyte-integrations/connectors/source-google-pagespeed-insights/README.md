...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-google-pagespeed-insights:dev`.
...
```Dockerfile
FROM airbyte/source-google-pagespeed-insights:latest
...
docker run airbyte/source-google-pagespeed-insights:dev spec
```
#### Run
