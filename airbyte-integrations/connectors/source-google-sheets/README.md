...
This is the repository for the Google-Sheets source connector, written in Python. For information
about how to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.com/integrations/sources/google-sheets).
...
[documentation](https://docs.airbyte.com/integrations/sources/google-sheets) to generate the
necessary credentials. Then create a file `secrets/config.json` conforming to the
`source_google_sheets/spec.yaml` file. Note that any directory named `secrets` is gitignored across
