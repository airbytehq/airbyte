...
```
#### Acceptance Tests
Customize `acceptance-test-config.yml` file to configure tests. See [Source Acceptance Tests](../../../docs/contributing-to-airbyte/building-new-connector/source-acceptance-tests.md) for more information.
