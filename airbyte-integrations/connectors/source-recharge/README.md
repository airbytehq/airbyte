# Recharge source connector

This is the repository for the Recharge source connector, written in Python. For information about
how to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.com/integrations/sources/recharge).
...
[documentation](https://docs.airbyte.com/integrations/sources/recharge) to generate the necessary
credentials. Then create a file `secrets/config.json` conforming to the `source_recharge/spec.yaml`
...
An image will be available on your host with the tag `airbyte/source-recharge:dev`.
