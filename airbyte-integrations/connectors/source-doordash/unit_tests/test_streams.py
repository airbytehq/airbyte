...
import pytest
from source_doordash.source import DoordashStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(DoordashStream, "path", "v0/example_endpoint")
    mocker.patch.object(DoordashStream, "primary_key", "test_primary_key")
    mocker.patch.object(DoordashStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = DoordashStream()
