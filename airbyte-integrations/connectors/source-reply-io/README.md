...
```
./gradlew :airbyte-integrations:connectors:source-reply-io:build
```
...
```
./gradlew :airbyte-integrations:connectors:source-reply-io:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-reply-io:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-reply-io:integrationTest
```
