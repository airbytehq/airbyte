...
sealed class Db2SourceJdbcPartition(
    val selectQueryGenerator: SelectQueryGenerator,
    final override val streamState: Db2JdbcStreamState,
) : JdbcPartition<Db2JdbcStreamState> {
    val stream: Stream = streamState.stream
    val from = From(stream.name, stream.namespace)
}

/** Base class for default implementations of [JdbcPartition] for unsplittable partitions. */
sealed class Db2JdbcUnsplittablePartition(
    selectQueryGenerator: SelectQueryGenerator,
    streamState: Db2JdbcStreamState,
) : Db2SourceJdbcPartition(selectQueryGenerator, streamState) {
...
class Db2JdbcUnsplittableSnapshotPartition(
    selectQueryGenerator: SelectQueryGenerator,
    streamState: Db2JdbcStreamState,
 ...
 */
class Db2JdbcUnsplittableSnapshotWithCursorPartition(
    selectQueryGenerator: SelectQueryGenerator,
    streamState: Db2JdbcStreamState,
    val cursor: Field,
) :
    Db2JdbcUnsplittablePartition(selectQueryGenerator, streamState),
    JdbcCursorPartition<Db2JdbcStreamState> {
...
sealed class Db2JdbcSplittablePartition(
    selectQueryGenerator: SelectQueryGenerator,
    streamState: Db2JdbcStreamState,
    ...
    Db2SourceJdbcPartition(selectQueryGenerator, streamState),
    JdbcSplittablePartition<Db2JdbcStreamState> {
...
class Db2JdbcSplittableSnapshotPartition(
    selectQueryGenerator: SelectQueryGenerator,
    streamState: Db2JdbcStreamState,
 ...
 */
sealed class Db2JdbcCursorPartition(
    selectQueryGenerator: SelectQueryGenerator,
    streamState: Db2JdbcStreamState,
 ...
 * cursor-based incremental sync.
 */
class Db2JdbcSplittableSnapshotWithCursorPartition(
    selectQueryGenerator: SelectQueryGenerator,
    streamState: Db2JdbcStreamState,
    primaryKey: List<Field>,
    triggerCdcPartitionState: TriggerCdcPartitionState? = null,
 ...
 * splittable.
 */
class Db2JdbcCursorIncrementalPartition(
    selectQueryGenerator: SelectQueryGenerator,
    streamState: Db2JdbcStreamState,
    cursor: Field,
    triggerCdcPartitionState: TriggerCdcPartitionState? = null,
