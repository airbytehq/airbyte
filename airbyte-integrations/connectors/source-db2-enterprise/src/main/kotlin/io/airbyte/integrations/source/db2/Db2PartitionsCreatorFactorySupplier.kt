...
class Db2PartitionsCreatorFactorySupplier<
    A : JdbcSharedState,
    S : JdbcStreamState<A>,
    P : JdbcPartition<S>,
>(private val factory: Db2PartitionsCreatorFactory<A, S, P>) :
    PartitionsCreatorFactorySupplier<Db2PartitionsCreatorFactory<A, S, P>> {

    override fun get(): Db2PartitionsCreatorFactory<A, S, P> {
        return factory
    }
}
