...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-strava:dev`.
...
```Dockerfile
FROM airbyte/source-strava:latest
...
docker run airbyte/source-strava:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/strava.md`).
