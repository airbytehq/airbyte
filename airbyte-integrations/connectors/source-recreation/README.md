...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-recreation:dev`.
...
```Dockerfile
FROM airbyte/source-recreation:latest
...
docker run airbyte/source-recreation:dev spec
```
#### Run
