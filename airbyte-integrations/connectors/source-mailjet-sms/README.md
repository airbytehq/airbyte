...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-mailjet-sms:dev`.
...
```Dockerfile
FROM airbyte/source-mailjet-sms:latest
...
docker run airbyte/source-mailjet-sms:dev spec
```
#### Run
