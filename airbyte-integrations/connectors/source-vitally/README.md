...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-vitally:dev`.
...
```Dockerfile
FROM airbyte/source-vitally:latest
...
docker run airbyte/source-vitally:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/vitally.md`).
