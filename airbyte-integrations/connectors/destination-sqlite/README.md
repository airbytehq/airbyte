...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/destination-sqlite:dev`.
...
```Dockerfile
FROM airbyte/destination-sqlite:latest
...
docker run airbyte/destination-sqlite:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/destinations/sqlite.md`).
