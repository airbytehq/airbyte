...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-exchange-rates:dev`.
...
```Dockerfile
FROM airbyte/source-exchange-rates:latest
...
docker run airbyte/source-exchange-rates:dev spec
```
#### Run
