...
This is the repository for the Linkedin-Ads source connector, written in Python. For information
about how to use this connector within Airbyte, see
[the documentation](https://docs.airbyte.com/integrations/sources/linkedin-ads).
...
[documentation](https://docs.airbyte.com/integrations/sources/linkedin-ads) to generate the
necessary credentials. Then create a file `secrets/config.json` conforming to the
`source_linkedin_ads/spec.yaml` file. Note that any directory named `secrets` is gitignored across
