...
_STREAM_NAME = "ad_member_company_analytics"
_PIVOT_VALUE = "MEMBER_COMPANY"
...
def _create_analytics_record(
    ...
    return {
        ...
        "pivotValues": [f"urn:li:sponsoredCampaign:{campaign_id}", "urn:li:organization:12345"],
        "impressions": impressions,
        "clicks": clicks,
        "costInLocalCurrency": "10.00",
        "costInUsd": "10.00",
        "end_date": end_date,
        "string_of_pivot_values": "urn:li:organization:12345",
    }


@freezegun.freeze_time("2024-06-15T00:00:00Z")
class TestAdMemberCompanyAnalyticsStream(TestCase):
    """
    Tests for the LinkedIn Ads 'ad_member_company_analytics' stream.
