...
_STREAM_NAME = "ad_member_job_function_analytics"
_PIVOT_VALUE = "MEMBER_JOB_FUNCTION"
...
def _create_analytics_record(
    ...
    return {
        ...
        "pivotValues": [f"urn:li:sponsoredCampaign:{campaign_id}", "urn:li:function:8"],
        "impressions": impressions,
        "clicks": clicks,
        "costInLocalCurrency": "10.00",
        "costInUsd": "10.00",
        "end_date": end_date,
        "string_of_pivot_values": "urn:li:function:8",
    }


@freezegun.freeze_time("2024-06-15T00:00:00Z")
class TestAdMemberJobFunctionAnalyticsStream(TestCase):
    """
    Tests for the LinkedIn Ads 'ad_member_job_function_analytics' stream.
    ...
    pivot value MEMBER_JOB_FUNCTION instead of CAMPAIGN.
    """
