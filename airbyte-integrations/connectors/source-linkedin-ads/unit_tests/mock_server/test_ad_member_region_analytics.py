...
_STREAM_NAME = "ad_member_region_analytics"
_PIVOT_VALUE = "MEMBER_REGION_V2"
...
def _create_analytics_record(
    ...
    return {
        ...
        "pivotValues": [f"urn:li:sponsoredCampaign:{campaign_id}", "urn:li:geo:103644278"],
...
class TestAdMemberRegionAnalyticsStream(TestCase):
    """
    Tests for the LinkedIn Ads 'ad_member_region_analytics' stream.
