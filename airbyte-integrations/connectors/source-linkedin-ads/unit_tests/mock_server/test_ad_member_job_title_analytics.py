...
_STREAM_NAME = "ad_member_job_title_analytics"
_PIVOT_VALUE = "MEMBER_JOB_TITLE"
...
class TestAdMemberJobTitleAnalyticsStream(TestCase):
    """
    Tests for the LinkedIn Ads 'ad_member_job_title_analytics' stream.
