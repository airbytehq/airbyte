...
_STREAM_NAME = "ad_member_company_size_analytics"
_PIVOT_VALUE = "MEMBER_COMPANY_SIZE"
...
def _create_analytics_record(
    ...
    return {
        ...
        "pivotValues": [f"urn:li:sponsoredCampaign:{campaign_id}", "urn:li:companySize:D"],
        "impressions": impressions,
        "clicks": clicks,
        "costInLocalCurrency": "10.00",
        "costInUsd": "10.00",
        "end_date": end_date,
        "string_of_pivot_values": "urn:li:companySize:D",
    }


@freezegun.freeze_time("2024-06-15T00:00:00Z")
class TestAdMemberCompanySizeAnalyticsStream(TestCase):
    """
    Tests for the LinkedIn Ads 'ad_member_company_size_analytics' stream.
    ...
    pivot value MEMBER_COMPANY_SIZE instead of CAMPAIGN.
    """
