...
_STREAM_NAME = "ad_impression_device_analytics"
_PIVOT_VALUE = "IMPRESSION_DEVICE_TYPE"
...
class TestAdImpressionDeviceAnalyticsStream(TestCase):
    """
    Tests for the LinkedIn Ads 'ad_impression_device_analytics' stream.
    ...
    pivot value IMPRESSION_DEVICE_TYPE instead of CAMPAIGN.
    """
