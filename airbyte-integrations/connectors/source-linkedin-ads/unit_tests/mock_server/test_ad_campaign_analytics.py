...
class TestAdCampaignAnalyticsStream(TestCase):
    ...
    def test_full_refresh_with_single_parent_campaign(self, http_mocker: HttpMocker):
        ...
        http_mocker.get(
            LinkedInAdsRequestBuilder.ad_analytics_endpoint()
            .with_any_query_params()
            .build(),
            LinkedInAdsAnalyticsResponseBuilder()
            .with_records([_create_analytics_record(1001, "2024-06-01", 1000, 50)])
            .build(),
        )
    ...
    def test_analytics_data_fields(self, http_mocker: HttpMocker):
        ...
        http_mocker.get(
            ...
            .build(),
            LinkedInAdsAnalyticsResponseBuilder()
            .with_records([_create_analytics_record(1001, "2024-06-01", 5000, 250)])
            .build(),
        )
