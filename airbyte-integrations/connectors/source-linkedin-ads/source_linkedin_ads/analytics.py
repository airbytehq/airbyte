...
def chunk_analytics_fields(
    ...
    # Make chunks
    chunks = ([fields[f : f + fields_chunk_size] for f in range(0, len(fields), fields_chunk_size)])
...
def make_date_slices(start_date: str, end_date: Optional[str] = None, window_in_days: int = WINDOW_IN_DAYS) -> Iterable[List]:
...
def make_analytics_slices(
    record: Mapping[str, Any], key_value_map: Mapping[str, Any], start_date: str, end_date: Optional[str] = None,
