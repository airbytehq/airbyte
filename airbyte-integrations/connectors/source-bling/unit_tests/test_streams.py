...
import pytest
from source_bling.source import BlingStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(BlingStream, "path", "v0/example_endpoint")
    mocker.patch.object(BlingStream, "primary_key", "test_primary_key")
    mocker.patch.object(BlingStream, "__abstractmethods__", set())
