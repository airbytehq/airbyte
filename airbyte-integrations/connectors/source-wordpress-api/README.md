# Wordpress API
This directory contains the manifest-only connector for `source-wordpress-api`.
...
### Build
This will create a dev image (`source-wordpress-api:dev`) that you can use to test the connector locally.
```bash
airbyte-ci connectors --name=source-wordpress-api build
```

### Test
This will run the acceptance tests for the connector.
```bash
airbyte-ci connectors --name=source-wordpress-api test
```
