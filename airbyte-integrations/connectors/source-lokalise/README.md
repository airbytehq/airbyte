...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-lokalise:dev`.
...
```Dockerfile
FROM airbyte/source-lokalise:latest
...
docker run airbyte/source-lokalise:dev spec
```
#### Run
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/lokalise.md`).
