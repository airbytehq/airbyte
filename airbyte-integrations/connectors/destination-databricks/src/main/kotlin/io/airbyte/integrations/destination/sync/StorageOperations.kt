...
interface StorageOperations {
     ...
     */
    fun prepareStage(streamId: StreamId)
     ...
     * This could be destination specific, INSERT INTO..SELECT * and DROP TABLE
     * OR CREATE OR REPLACE ... SELECT *, DROP TABLE
     */
     ...
     *
     */
    fun typeAndDedupe(streamConfig: StreamConfig, maxProcessedTimestamp: Optional<Instant>, finalTableSuffix: String)
