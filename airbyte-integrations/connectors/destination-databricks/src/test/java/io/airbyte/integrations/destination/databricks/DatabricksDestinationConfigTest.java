...
class DatabricksDestinationConfigTest {
  ...
  public void testConfigCreationFromJsonS3() {
    ...
    final ObjectNode databricksConfig = OBJECT_MAPPER
        .createObjectNode()
    ...
    assertThrows(
        IllegalArgumentException.class, () -> DatabricksDestinationConfig.get(databricksConfig));
    ...
    databricksConfig
        .put("databricks_port", "1000")
        .put("schema", "testing_schema")
        .put("enable_schema_evolution", true);
    ...
    assertEquals(
        DatabricksS3StorageConfigProvider.class, config2.storageConfig().getClass());
  }
  ...
  public void testConfigCreationFromJsonAzure() {
    ...
    assertEquals(
        DatabricksAzureBlobStorageConfigProvider.class, config2.storageConfig().getClass());
  }

  @Test
  public void testDefaultCatalog() {
    final DatabricksDestinationConfig databricksDestinationConfig = DatabricksDestinationConfig.get(
        Jsons.deserialize(
            """
        {
          "accept_terms": true,
