...
import io.airbyte.integrations.destination.databricks.schema.DatabricksTableSchemaMapper
...
class DatabricksDataDumper(
    private val configProvider: (ConfigurationSpecification) -> DatabricksConfiguration,
