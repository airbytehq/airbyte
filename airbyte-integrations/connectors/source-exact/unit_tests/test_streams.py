...
import pytest
from source_exact.source import ExactStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ExactStream, "path", "v0/example_endpoint")
    mocker.patch.object(ExactStream, "primary_key", "test_primary_key")
    mocker.patch.object(ExactStream, "__abstractmethods__", set())
