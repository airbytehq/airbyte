...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-okta:dev`.
...
```Dockerfile
FROM airbyte/source-okta:latest
...
docker run airbyte/source-okta:dev spec
```
#### Run
