...
This is the repository for the Qonto configuration based source connector.
...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-qonto:dev`.
...
```Dockerfile
FROM airbyte/source-qonto:latest
...
docker run airbyte/source-qonto:dev spec
