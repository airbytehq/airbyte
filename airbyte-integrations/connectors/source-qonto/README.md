...
[the documentation](https://docs.airbyte.io/integrations/sources/metabase).
...
[documentation](https://docs.airbyte.io/integrations/sources/metabase) to generate the necessary
...
`source metabase test creds` and place them into `secrets/config.json`.
...
[Connector Acceptance Tests](https://docs.airbyte.io/connector-development/testing-connectors/connector-acceptance-tests-reference)
