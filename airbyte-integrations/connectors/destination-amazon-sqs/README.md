...
```
./gradlew :airbyte-integrations:connectors:destination-amazon-sqs:build
```
...
```
./gradlew :airbyte-integrations:connectors:destination-amazon-sqs:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:destination-amazon-sqs:unitTest
```
