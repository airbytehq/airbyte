...
import pytest
from source_getintent.source import GetintentStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GetintentStream, "path", "v0/example_endpoint")
    mocker.patch.object(GetintentStream, "primary_key", "test_primary_key")
    mocker.patch.object(GetintentStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = GetintentStream()
