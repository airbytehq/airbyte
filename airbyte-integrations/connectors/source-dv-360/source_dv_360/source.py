...
class SourceDV360(AbstractSource):
    ...
    def check_connection(self, logger: AirbyteLogger, config: Mapping[str, Any]) -> Tuple[bool, any]:
        ...
        try:
            ...
            return False, f"Unable to connect to Google Ads API with the provided credentials - {err!r}"
    ...
    def read(
        ...
        for configured_stream in catalog.streams:
            ...
            if not stream_instance:
                msg = f"The requested stream {stream_name} was not found in the source. Available streams: {stream_instances.keys()}"
                raise KeyError(
                    msg,
                )
