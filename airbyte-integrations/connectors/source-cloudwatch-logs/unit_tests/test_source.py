...
@patch(
    "source_cloudwatch_logs.source.boto3.Session",
)
def test_check_connection_success(mock_session, source, sample_config):
...
def test_check_connection_failure(mock_session, source, sample_config):
