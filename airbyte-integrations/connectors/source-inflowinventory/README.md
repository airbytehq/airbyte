# Inflowinventory
This directory contains the manifest-only connector for `source-inflowinventory`.
...
### Build
This will create a dev image (`source-inflowinventory:dev`) that you can use to test the connector locally.
```bash
