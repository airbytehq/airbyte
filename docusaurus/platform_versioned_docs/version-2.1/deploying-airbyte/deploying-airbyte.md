...
airbyte/airbyte	2.0.7        	1.8.0      	Helm chart to deploy airbyte 
```

### 2. Create a Namespace for Airbyte

While it's not strictly necessary to isolate the Airbyte installation into its own namespace, it's good practice and recommended as a part of the installation. This documentation assumes that you chose the name `airbyte` for the namespace, but you may choose a different name if required.
...
1. Identify the Helm chart version that corresponds to the platform version you want to run. Most Helm chart versions are designed to work with one Airbyte version, and they don't necessarily have the same version number.
    ...
    ```text
    NAME                            CHART VERSION   APP VERSION     DESCRIPTION
    airbyte/airbyte              2.0.18          2.0.0           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.17          1.8.5           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.16          1.8.4           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.15          1.8.4           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.14          1.8.4           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.13          1.8.3           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.12          1.8.2           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.11          1.8.2           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.10          1.8.1           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.9           1.8.0           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.8           1.8.0           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.7           1.7.1           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.6           1.7.1           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.5           1.7.0           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.4           1.6.3           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.3           1.6.2           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.2           1.6.2           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.1           1.6.1           Helm chart to deploy airbyte
    airbyte/airbyte              2.0.0           1.6.0           Helm chart to deploy airbyte
