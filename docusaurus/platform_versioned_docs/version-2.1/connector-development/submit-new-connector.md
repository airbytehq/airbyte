...
![Select Tokens Classic](../../../../docs/community/contributing-to-airbyte/assets/token-classic.png)

4. Select Generate new token, then click `Generate new token (classic)`.

![Generate Tokens Classic](../../../../docs/community/contributing-to-airbyte/assets/token-classic-select.png)

5. Add the `workflow` scope. Click `Generate Token`.

![Generate Tokens Classic](../../../../docs/community/contributing-to-airbyte/assets/token-classic-scope.png)
