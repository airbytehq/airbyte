...
// Path to the cached Agent API OpenAPI specification
const SPEC_CACHE_PATH = path.join(PROJECT_ROOT, "src", "data", "agent_engine_api_spec.json");

// URL for fetching the latest Agent API specification
...
const API_DOCS_OUTPUT_DIR = "../docs/ai-agents/reference/api/api-reference";
