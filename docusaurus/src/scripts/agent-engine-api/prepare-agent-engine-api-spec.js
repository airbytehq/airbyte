/**
 * This script fetches the Agent API OpenAPI spec and processes it before
...
function fetchAgentEngineApiSpec() {
  return new Promise((resolve, reject) => {
    console.log("Fetching Agent API spec...");
...
async function main() {
  ...
  try {
    console.log("🔄 Attempting to fetch latest Agent API spec...");
    ...
    console.log(
      `✅ Agent API spec processed and saved to ${SPEC_CACHE_PATH}`,
    );
    ...
    if (previousSpec) {
      ...
      const fallbackSpec = {
        ...
        info: {
          ...
          version: "0.0.0",
          description: "The Agent API specification could not be fetched. Please check your network connection and try again."
        },
        paths: {},
        tags: [],
        components: {}
      ...
      console.log("✅ Build will continue with empty Agent API documentation");
    }
  }
}
