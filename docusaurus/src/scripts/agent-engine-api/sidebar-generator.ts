...
export const loadAgentEngineApiSidebar = (): any[] => {
...
export const replaceApiReferenceCategory = (
  ...
  return items.map((item) => {
    ...
    if (item.items) {
      return {
        ...item,
        items: replaceApiReferenceCategory(item.items, agentEngineApiItems),
      };
    }
