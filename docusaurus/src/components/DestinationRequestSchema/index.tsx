...
import { ApiEndpointsData, RequestBodyProperty } from "../DestinationConfiguration/types";

const apiEndpointsData = apiEndpointsDataRaw as ApiEndpointsData;

interface DestinationRequestSchemaProps {
  pageId: string;
}

export const DestinationRequestSchema = ({ pageId }: DestinationRequestSchemaProps) => {
...
export default DestinationRequestSchema;
