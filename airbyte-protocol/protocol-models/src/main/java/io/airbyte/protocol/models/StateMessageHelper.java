...
public class StateMessageHelper {
  ...
  /**
   * This a takes a json blob state and tries return either a legacy state in the format of a json object or a state message with the new format
   * which is a list of airbyte state message.
   * @param state
