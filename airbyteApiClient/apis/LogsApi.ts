...
export class LogsApi extends runtime.BaseAPI {
     ...
     * Get logs
     */
    async getLogsRaw(requestParameters: GetLogsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Blob>> {
        ...
        const response = await this.request({
            ...
            body: LogsRequestBodyToJSON(requestParameters.logsRequestBody),
        }, initOverrides);
     ...
     * Get logs
     */
    async getLogs(requestParameters: GetLogsRequest, initOverrides?: RequestInit): Promise<Blob> {
