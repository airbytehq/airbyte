...
export function PrivateSourceDefinitionReadFromJSON(json: any): PrivateSourceDefinitionRead {
    return PrivateSourceDefinitionReadFromJSONTyped(json, false);
}

export function PrivateSourceDefinitionReadFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrivateSourceDefinitionRead {
...
export function PrivateSourceDefinitionReadToJSON(value?: PrivateSourceDefinitionRead | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
