...
export function DestinationDefinitionCreateFromJSON(json: any): DestinationDefinitionCreate {
    return DestinationDefinitionCreateFromJSONTyped(json, false);
}

export function DestinationDefinitionCreateFromJSONTyped(json: any, ignoreDiscriminator: boolean): DestinationDefinitionCreate {
...
export function DestinationDefinitionCreateToJSON(value?: DestinationDefinitionCreate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
