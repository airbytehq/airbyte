...
export function PrivateDestinationDefinitionReadFromJSON(json: any): PrivateDestinationDefinitionRead {
    return PrivateDestinationDefinitionReadFromJSONTyped(json, false);
}

export function PrivateDestinationDefinitionReadFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrivateDestinationDefinitionRead {
...
export function PrivateDestinationDefinitionReadToJSON(value?: PrivateDestinationDefinitionRead | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
