...
export function JobWithAttemptsReadFromJSON(json: any): JobWithAttemptsRead {
    return JobWithAttemptsReadFromJSONTyped(json, false);
}

export function JobWithAttemptsReadFromJSONTyped(json: any, ignoreDiscriminator: boolean): JobWithAttemptsRead {
...
export function JobWithAttemptsReadToJSON(value?: JobWithAttemptsRead | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
