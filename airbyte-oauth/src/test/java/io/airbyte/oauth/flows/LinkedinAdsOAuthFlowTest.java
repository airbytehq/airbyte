...
public class LinkedinAdsOAuthFlowTest {

  private UUID workspaceId;
  private UUID definitionId;
  private LinkedinAdsOAuthFlow linkedinAdsOAuthFlow;
  ...
  public void setup() throws IOException, JsonValidationException {
    ...
    when(configRepository.listSourceOAuthParam()).thenReturn(List.of(new SourceOAuthParameter()
        ...
        .withConfiguration(Jsons.jsonNode(Map.of("credentials", ImmutableMap.builder()
            ...
            .build())))));
    linkedinAdsOAuthFlow = new LinkedinAdsOAuthFlow(configRepository, httpClient, LinkedinAdsOAuthFlowTest::getConstantState);
  ...
  public void testGetSourceConcentUrl() throws IOException, ConfigNotFoundException {
    final String concentUrl =
        linkedinAdsOAuthFlow.getSourceConsentUrl(workspaceId, definitionId, REDIRECT_URL);
    assertEquals(concentUrl,
        "https://www.linkedin.com/oauth/v2/authorization?client_id=test_client_id&redirect_uri=https%3A%2F%2Fairbyte.io&response_type=code&scope=r_ads_reporting+r_ads+r_basicprofile&state=state");
  }
  ...
  public void testCompleteSourceOAuth() throws IOException, InterruptedException, ConfigNotFoundException {
    ...
    final Map<String, Object> actualQueryParams =
        linkedinAdsOAuthFlow.completeSourceOAuth(workspaceId, definitionId, queryParams, REDIRECT_URL);
