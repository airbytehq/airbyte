...
public class KubeAcceptanceTests {
...
//    } catch (Exception e) {}
    ...
    @RetryingTest(3)
    @Order(18)
    @EnabledIfEnvironmentVariable(named = "CONTAINER_ORCHESTRATOR", matches = "true")
    ...
    private JsonNode getDbConfig(final PostgreSQLContainer psql, final boolean hiddenPassword, final boolean withSchema, final AcceptanceTests.Type connectorType) {
        try {
