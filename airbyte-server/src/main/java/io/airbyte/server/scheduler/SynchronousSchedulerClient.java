...
public interface SynchronousSchedulerClient {
  ...
  SynchronousResponse<StandardCheckConnectionOutput> createSourceCheckConnectionJob(SourceConnection source,
                                                                                    String dockerImage,
                                                                                    Version protocolVersion,boolean isCustomConnector)
      throws IOException;
  ...
  SynchronousResponse<UUID> createDiscoverSchemaJob(SourceConnection source, String dockerImage, String connectorVersion, Version protocolVersion, boolean isCustomConnector)
      throws IOException;
