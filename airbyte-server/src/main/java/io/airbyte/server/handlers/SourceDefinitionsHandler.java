...
public class SourceDefinitionsHandler {
  ...
  @VisibleForTesting
  static SourceDefinitionRead buildSourceDefinitionRead(
    ...
    try {
      ...
      throw new InternalServerKnownException(
          "Unable to process retrieved latest source definitions list", e);
    }
  }
  ...
  private static SourceDefinitionReadList toSourceDefinitionReadList(
      final List<StandardSourceDefinition> defs) {
    final List<SourceDefinitionRead> reads =
        defs.stream()
  ...
  public SourceDefinitionRead getSourceDefinition(
    ...
    return buildSourceDefinitionRead(
  ...
  public SourceDefinitionRead createSourceDefinition(
    ...
    imageValidator.assertValidIntegrationImage(
        sourceDefinitionCreate.getDockerRepository(), sourceDefinitionCreate.getDockerImageTag());
  ...
  public SourceDefinitionRead updateSourceDefinition(
    ...
    final StandardSourceDefinition currentSourceDefinition =
        configRepository.getStandardSourceDefinition(
            sourceDefinitionUpdate.getSourceDefinitionId());
    imageValidator.assertValidIntegrationImage(
        currentSourceDefinition.getDockerRepository(), sourceDefinitionUpdate.getDockerImageTag());
