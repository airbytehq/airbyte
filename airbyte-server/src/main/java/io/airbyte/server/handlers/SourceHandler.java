...
public class SourceHandler {
  ...
  public SourceRead createSource(final SourceCreate sourceCreate)
    ...
    final ConnectorSpecification spec =
        getSpecFromSourceDefinitionId(sourceCreate.getSourceDefinitionId());
  ...
  public void deleteSource(final SourceRead source)
    ...
    final WorkspaceIdRequestBody workspaceIdRequestBody =
        new WorkspaceIdRequestBody().workspaceId(source.getWorkspaceId());
    ...
    final var fullConfig =
        configRepository.getSourceConnectionWithSecrets(source.getSourceId()).getConfiguration();
  ...
  public static ConnectorSpecification getSpecFromSourceDefinitionId(
      final SpecFetcher specFetcher, final StandardSourceDefinition sourceDefinition)
  ...
  private void persistSourceConnection(
      final String name,
  ...
  protected static SourceRead toSourceRead(
      final SourceConnection sourceConnection,
      final StandardSourceDefinition standardSourceDefinition) {
