...
import io.airbyte.protocol.models.v1.transform_models.FieldTransformType;
import io.airbyte.protocol.models.v1.transform_models.StreamTransformType;
...
public class CatalogDiffConverters {
  ...
  public static StreamTransform streamTransformToApi(final io.airbyte.protocol.models.v1.transform_models.StreamTransform transform) {
  ...
  public static Optional<List<FieldTransform>> updateStreamToApi(final io.airbyte.protocol.models.v1.transform_models.StreamTransform transform) {
  ...
  public static FieldTransform fieldTransformToApi(final io.airbyte.protocol.models.v1.transform_models.FieldTransform transform) {
  ...
  private static Optional<FieldAdd> addFieldToApi(final io.airbyte.protocol.models.v1.transform_models.FieldTransform transform) {
  ...
  private static Optional<FieldRemove> removeFieldToApi(final io.airbyte.protocol.models.v1.transform_models.FieldTransform transform) {
  ...
  private static Optional<FieldSchemaUpdate> updateFieldToApi(final io.airbyte.protocol.models.v1.transform_models.FieldTransform transform) {
