...
public class OauthModelConverter {
  ...
  public static Optional<AuthSpecification> getAuthSpec(final ConnectorSpecification spec) {
    ...
    final io.airbyte.protocol.models.v1.AuthSpecification incomingAuthSpec = spec.getAuthSpecification();

    final AuthSpecification authSpecification = new AuthSpecification();
    if (incomingAuthSpec.getAuthType() == io.airbyte.protocol.models.v1.AuthSpecification.AuthType.OAUTH_2_0) {
  ...
  public static Optional<AdvancedAuth> getAdvancedAuth(final ConnectorSpecification spec) {
    ...
    final io.airbyte.protocol.models.v1.AdvancedAuth incomingAdvancedAuth = spec.getAdvancedAuth();
    final AdvancedAuth advancedAuth = new AdvancedAuth();
    if (List.of(io.airbyte.protocol.models.v1.AdvancedAuth.AuthFlowType.OAUTH_1_0, io.airbyte.protocol.models.v1.AdvancedAuth.AuthFlowType.OAUTH_2_0)
        .contains(incomingAdvancedAuth.getAuthFlowType())) {
      final AuthFlowTypeEnum oauthFlowType;
      if (io.airbyte.protocol.models.v1.AdvancedAuth.AuthFlowType.OAUTH_1_0.equals(incomingAdvancedAuth.getAuthFlowType())) {
        oauthFlowType = AuthFlowTypeEnum.OAUTH1_0;
      } else {
        oauthFlowType = AuthFlowTypeEnum.OAUTH2_0;
      }
      final io.airbyte.protocol.models.v1.OAuthConfigSpecification incomingOAuthConfigSpecification =
