...
public class WebBackendApiFactory implements Factory<WebBackendApiController> {
  ...
  public static void setValues(final WebBackendConnectionsHandler webBackendConnectionsHandler, final WebBackendGeographiesHandler webBackendGeographiesHandler) {
  ...
  @Override public WebBackendApiController provide() {
  ...
  @Override public void dispose(final WebBackendApiController instance) {
    /* no op */
  }
}
