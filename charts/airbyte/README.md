...
![Version: 0.39.36](https://img.shields.io/badge/Version-0.39.36-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.40.4](https://img.shields.io/badge/AppVersion-0.39.41--alpha-informational?style=flat-square)
...
| airbyte-bootloader.image.tag                       | string | `"0.40.4"`                  |             |
...
| server.image.tag                                   | string | `"0.40.4"`                  |             |
...
| webapp.image.tag                                   | string | `"0.40.4"`                  |             |
...
| worker.image.tag                                   | string | `"0.40.4"`                  |             |
