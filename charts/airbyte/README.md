...
| `webapp.image.tag`           | The airbyte webapp image tag. Defaults to the chart's AppVersion | `0.32.0-alpha-patch-0`   |
...
| `scheduler.image.tag`          | The airbyte scheduler image tag. Defaults to the chart's AppVersion | `0.32.0-alpha-patch-0`      |
...
| `server.image.tag`                          | The airbyte server image tag. Defaults to the chart's AppVersion | `0.32.0-alpha-patch-0`   |
...
| `worker.image.tag`                          | The airbyte worker image tag. Defaults to the chart's AppVersion | `0.32.0-alpha-patch-0`   |
