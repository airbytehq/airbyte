...
| `server.image.tag`                          | The airbyte server image tag. Defaults to the chart's AppVersion | `0.36.6-alpha`   |
...
| `worker.image.tag`                          | The airbyte worker image tag. Defaults to the chart's AppVersion | `0.36.6-alpha`   |
