...
| `webapp.image.tag`           | The airbyte webapp image tag. Defaults to the chart's AppVersion | `0.32.0-alpha-patch-1`   |
...
| `scheduler.image.tag`          | The airbyte scheduler image tag. Defaults to the chart's AppVersion | `0.32.0-alpha-patch-1`      |
...
| `server.image.tag`                          | The airbyte server image tag. Defaults to the chart's AppVersion | `0.32.0-alpha-patch-1`   |
...
| `worker.image.tag`                          | The airbyte worker image tag. Defaults to the chart's AppVersion | `0.32.0-alpha-patch-1`   |
