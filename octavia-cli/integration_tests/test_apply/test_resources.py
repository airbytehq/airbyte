...
#     connection_with_normalization.state = connection_with_normalization._get_state_from_file(connection_with_normalization.configuration_path)
#     assert connection_with_normalization.was_created
#     assert connection_with_normalization.remote_resource["configuration"]["operations"] == "tolo"
