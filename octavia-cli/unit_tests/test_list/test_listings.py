...
class TestSourceConnectorsDefinitions:
    def test_init(self, mock_api_client):
        ...
        assert source_connectors_definition.list_function_name == "list_source_definitions_for_workspace"
...
class TestDestinationConnectorsDefinitions:
    def test_init(self, mock_api_client):
        ...
        assert destination_connectors_definition.list_function_name == "list_destination_definitions_for_workspace"
