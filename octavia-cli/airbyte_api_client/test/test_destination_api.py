...
from airbyte_api_client.api.destination_api import DestinationApi  # noqa: E501
...
class TestDestinationApi(unittest.TestCase):
    ...
    def test_check_connection_to_destination(self):
    ...
    def test_check_connection_to_destination_for_update(self):
    ...
    def test_list_destinations_for_workspace(self):
