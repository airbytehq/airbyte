...
class WebBackendConnectionRead(ModelNormal):
    ...
    def _from_openapi_data(
        cls, connection_id, name, source_id, destination_id, sync_catalog, status, source, destination, is_syncing, *args, **kwargs
    ):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, connection_id, name, source_id, destination_id, sync_catalog, status, source, destination, is_syncing, *args, **kwargs
    ):  # noqa: E501
        """WebBackendConnectionRead - a model defined in OpenAPI
