...
class SourceDefinitionReadList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'source_definitions': ([SourceDefinitionRead],),  # noqa: E501
        }
    ...
    attribute_map = {
        'source_definitions': 'sourceDefinitions',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, source_definitions, *args, **kwargs):  # noqa: E501
        """SourceDefinitionReadList - a model defined in OpenAPI

        Args:
            source_definitions ([SourceDefinitionRead]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, source_definitions, *args, **kwargs):  # noqa: E501
        """SourceDefinitionReadList - a model defined in OpenAPI
