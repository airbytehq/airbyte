...
class SourceRead(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'connection_configuration': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, source_definition_id, source_id, workspace_id, connection_configuration, name, source_name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, source_definition_id, source_id, workspace_id, connection_configuration, name, source_name, *args, **kwargs):  # noqa: E501
        """SourceRead - a model defined in OpenAPI
