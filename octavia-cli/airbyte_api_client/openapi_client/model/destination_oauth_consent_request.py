...
class DestinationOauthConsentRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, destination_definition_id, workspace_id, redirect_url, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, destination_definition_id, workspace_id, redirect_url, *args, **kwargs):  # noqa: E501
        """DestinationOauthConsentRequest - a model defined in OpenAPI
