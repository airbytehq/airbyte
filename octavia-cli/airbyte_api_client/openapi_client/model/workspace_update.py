...
class WorkspaceUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, workspace_id, initial_setup_complete, anonymous_data_collection, news, security_updates, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, workspace_id, initial_setup_complete, anonymous_data_collection, news, security_updates, *args, **kwargs):  # noqa: E501
        """WorkspaceUpdate - a model defined in OpenAPI
