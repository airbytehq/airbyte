...
class SourceCoreConfig(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, source_definition_id, connection_configuration, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, source_definition_id, connection_configuration, *args, **kwargs):  # noqa: E501
        """SourceCoreConfig - a model defined in OpenAPI
