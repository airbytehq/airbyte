...
class ConnectionState(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "state": ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, connection_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            state ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
        """
