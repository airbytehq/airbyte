...
class SourceDefinitionSpecificationRead(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "connection_specification": ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, source_definition_id, job_info, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            connection_specification ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The specification for what values are required to configure the sourceDefinition.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, source_definition_id, job_info, *args, **kwargs):  # noqa: E501
        """SourceDefinitionSpecificationRead - a model defined in OpenAPI
