...
class SourceUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, source_id, connection_configuration, name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, source_id, connection_configuration, name, *args, **kwargs):  # noqa: E501
        """SourceUpdate - a model defined in OpenAPI
