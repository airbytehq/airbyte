...
class DestinationAuthSpecification(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """DestinationAuthSpecification - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (AuthSpecification):  # noqa: E501

        Keyword Args:
            value (AuthSpecification):  # noqa: E501
