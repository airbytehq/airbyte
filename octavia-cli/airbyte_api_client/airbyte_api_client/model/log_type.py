...
class LogType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): type/source of logs produced., must be one of ["server", "scheduler", ]  # noqa: E501

        Keyword Args:
            value (str): type/source of logs produced., must be one of ["server", "scheduler", ]  # noqa: E501
