...
class CheckConnectionRead(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, job_info, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, job_info, *args, **kwargs):  # noqa: E501
        """CheckConnectionRead - a model defined in OpenAPI
