...
class DestinationRead(ModelNormal):
    ...
    def _from_openapi_data(
        cls, destination_definition_id, destination_id, workspace_id, connection_configuration, name, destination_name, *args, **kwargs
    ):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, destination_definition_id, destination_id, workspace_id, connection_configuration, name, destination_name, *args, **kwargs
    ):  # noqa: E501
        """DestinationRead - a model defined in OpenAPI
