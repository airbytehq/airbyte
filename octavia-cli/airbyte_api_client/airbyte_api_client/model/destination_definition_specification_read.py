...
class DestinationDefinitionSpecificationRead(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, destination_definition_id, job_info, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            connection_specification (bool, date, datetime, dict, float, int, list, str, none_type): The specification for what values are required to configure the destinationDefinition.. [optional]  # noqa: E501
            auth_specification (AuthSpecification): [optional]  # noqa: E501
            advanced_auth (AdvancedAuth): [optional]  # noqa: E501
            supported_destination_sync_modes ([DestinationSyncMode]): [optional]  # noqa: E501
            supports_dbt (bool): [optional]  # noqa: E501
