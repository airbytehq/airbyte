...
class OperationUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, operation_id, name, operator_configuration, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, operation_id, name, operator_configuration, *args, **kwargs):  # noqa: E501
        """OperationUpdate - a model defined in OpenAPI
