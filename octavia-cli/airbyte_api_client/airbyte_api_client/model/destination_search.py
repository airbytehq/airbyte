...
class DestinationSearch(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            destination_definition_id (str): [optional]  # noqa: E501
            destination_id (str): [optional]  # noqa: E501
            workspace_id (str): [optional]  # noqa: E501
            connection_configuration (bool, date, datetime, dict, float, int, list, str, none_type): The values required to configure the destination. The schema for this must match the schema return by destination_definition_specifications/get for the destinationDefinition.. [optional]  # noqa: E501
