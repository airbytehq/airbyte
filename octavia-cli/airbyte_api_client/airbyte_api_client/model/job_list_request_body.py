...
class JobListRequestBody(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "config_types": ([JobConfigType],),  # noqa: E501
    ...
    attribute_map = {
        "config_types": "configTypes",  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, config_types, config_id, *args, **kwargs):  # noqa: E501
        """JobListRequestBody - a model defined in OpenAPI

        Args:
            config_types ([JobConfigType]):
            config_id (str):
    ...
    @convert_js_args_to_python_args
    def __init__(self, config_types, config_id, *args, **kwargs):  # noqa: E501
        """JobListRequestBody - a model defined in OpenAPI
