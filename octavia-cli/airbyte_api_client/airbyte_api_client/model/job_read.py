...
class JobRead(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, config_type, config_id, created_at, updated_at, status, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, config_type, config_id, created_at, updated_at, status, *args, **kwargs):  # noqa: E501
        """JobRead - a model defined in OpenAPI
