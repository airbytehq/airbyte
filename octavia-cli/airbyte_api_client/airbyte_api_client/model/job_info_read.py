...
class JobInfoRead(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "job": (JobRead,),  # noqa: E501
            "attempts": ([AttemptInfoRead],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, job, attempts, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, job, attempts, *args, **kwargs):  # noqa: E501
        """JobInfoRead - a model defined in OpenAPI
