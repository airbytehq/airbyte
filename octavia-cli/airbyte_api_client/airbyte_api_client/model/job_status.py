...
class JobStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["pending", "running", "incomplete", "failed", "succeeded", "cancelled", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["pending", "running", "incomplete", "failed", "succeeded", "cancelled", ]  # noqa: E501
