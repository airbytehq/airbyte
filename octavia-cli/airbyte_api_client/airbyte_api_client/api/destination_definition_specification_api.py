...
class DestinationDefinitionSpecificationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_destination_definition_specification_endpoint = _Endpoint(
            settings={
                "response_type": (DestinationDefinitionSpecificationRead,),
                "auth": [],
                "endpoint_path": "/v1/destination_definition_specifications/get",
                "operation_id": "get_destination_definition_specification",
                "http_method": "POST",
                "servers": None,
            },
            params_map={
    ...
    def get_destination_definition_specification(self, destination_definition_id_request_body, **kwargs):
        """Get specification for a destinationDefinition  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_destination_definition_specification(destination_definition_id_request_body, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_destination_definition_specification_endpoint.call_with_http_info(**kwargs)
