...
from airbyte_api_client.configuration import Configuration

# import exceptions
from airbyte_api_client.exceptions import ApiAttributeError, ApiException, ApiKeyError, ApiTypeError, ApiValueError, OpenApiException
