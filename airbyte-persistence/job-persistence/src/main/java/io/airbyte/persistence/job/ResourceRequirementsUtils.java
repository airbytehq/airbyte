...
public class ResourceRequirementsUtils {
  ...
  /**
   * Given connection-level resource requirements, actor-definition-level resource requirements, worker-default resource requirements, and a job type,
   * returns the final resource requirements generated by merging the provided requirements in hierarchy order.
   *
   * Connection-level resource requirements take precendence over actor-definition level resource requirements. Within the actor-definition level
   * requirements, job-type-specific requirements take precedence over default definition requirements. Actor-definition level resource requirements
   ...
   * @param workerDefaultResourceReqs - the default worker resource requirements set in the env variables
  ...
  /**
   * Given connection-level and worker-default resource requirements, returns the final resource requirements generated by merging the provided
   * requirements in hierarchy order.
   *
   * Connection-level resource requirements take precendence over worker-default resource requirements.
   *
   * @param connectionResourceReqs - the resource requirements set on the connection
   * @param workerDefaultResourceReqs - the default worker resource requirements set in the env variables
   * @return resource requirements, if present, otherwise an empty ResourceRequirements object.
