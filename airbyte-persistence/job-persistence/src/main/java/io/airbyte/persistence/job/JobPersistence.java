...
public interface JobPersistence {
   ...
   */
  List<Job> listJobs(Set<ConfigType> configTypes, String configId, int limit, int offset) throws IOException;
  ...
  List<Job> listJobs(ConfigType configType, String configId, int limit, int offset) throws IOException;
   ...
   * @throws IOException
   */
  List<Job> listJobsIncludingId(Set<ConfigType> configTypes, String connectionId, long includingJobId, int pagesize) throws IOException;

  List<Job> listJobsWithStatus(JobStatus status) throws IOException;

  List<Job> listJobsWithStatus(Set<ConfigType> configTypes, JobStatus status) throws IOException;

  List<Job> listJobsWithStatus(ConfigType configType, JobStatus status) throws IOException;

  List<Job> listJobsForConnectionWithStatuses(UUID connectionId, Set<ConfigType> configTypes, Set<JobStatus> statuses) throws IOException;
