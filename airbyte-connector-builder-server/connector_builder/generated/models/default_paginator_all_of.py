...
class DefaultPaginatorAllOf(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    DefaultPaginatorAllOf - a model defined in OpenAPI

        pagination_strategy: The pagination_strategy of this DefaultPaginatorAllOf.
        config: The config of this DefaultPaginatorAllOf.
        url_base: The url_base of this DefaultPaginatorAllOf.
        decoder: The decoder of this DefaultPaginatorAllOf [Optional].
        token: The token of this DefaultPaginatorAllOf [Optional].
        page_size_option: The page_size_option of this DefaultPaginatorAllOf [Optional].
