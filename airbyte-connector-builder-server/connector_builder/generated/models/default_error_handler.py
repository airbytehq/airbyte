...
class DefaultErrorHandler(BaseModel):
    ...
    DefaultErrorHandler - a model defined in OpenAPI

        config: The config of this DefaultErrorHandler.
        response_filters: The response_filters of this DefaultErrorHandler [Optional].
        max_retries: The max_retries of this DefaultErrorHandler [Optional].
        max_retries: The max_retries of this DefaultErrorHandler [Optional].
