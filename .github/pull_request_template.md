...
- [ ] Add new connector to Airbyte cloud like as described [here](https://github.com/airbytehq/airbyte-cloud/blob/master/docs/runbooks/releasing-connectors-to-cloud.md#adding-a-new-connector-to-airbyte-cloud)
