...
public class JdbcSourceOperations implements SourceOperations<ResultSet, JDBCType> {
  ...
  protected void setJsonField(final ResultSet r, final int i, final ObjectNode o) throws SQLException {
  ...
  protected void putReal(final ObjectNode node, final String columnName, final ResultSet resultSet, final int index) throws SQLException {
  ...
  public JsonSchemaPrimitive getType(final JDBCType bigQueryType) {
    return switch (bigQueryType) {
      ...
      case TIMESTAMP -> JsonSchemaPrimitive.STRING_TIMESTAMP;
