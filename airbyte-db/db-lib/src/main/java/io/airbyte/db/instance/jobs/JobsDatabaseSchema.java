...
/**
 * Whenever a new table is created in the Job Airbyte Database, we should also add a corresponding yaml file to validate the content of the table when
 * it is exported/imported in files.
 *
