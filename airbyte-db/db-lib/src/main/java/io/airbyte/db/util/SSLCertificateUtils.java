...
/**
 * General SSL utilities used for certificate and keystore operations
 * related to secured db connections.
 */
public class SSLCertificateUtils {
  ...
  private static URI saveKeyStoreToFile(final KeyStore keyStore, final String keyStorePassword, final FileSystem filesystem, final String directory)
    ...
    final Path pathToFile = pathToStore.resolve(KEYSTORE_FILE_NAME + new Random().nextLong() +  KEYSTORE_FILE_TYPE);
  ...
  public static URI keyStoreFromCertificate(final Certificate cert, final String keyStorePassword, final FileSystem filesystem, final String directory)
  ...
  public static URI keyStoreFromCertificate(final String certString, final String keyStorePassword, final FileSystem filesystem, final String directory)
