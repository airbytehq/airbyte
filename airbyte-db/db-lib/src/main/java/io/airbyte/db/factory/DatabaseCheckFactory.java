...
/**
 * Temporary factory class that provides convenience methods for creating a {@link io.airbyte.db.check.DatabaseCheck} and {@link DatabaseInitializer}
 * instances. This class will be removed once the project has been converted to leverage an application framework to manage the creation and injection
 * of various check objects.
 */
public class DatabaseCheckFactory {

  /**
   * Constructs a new {@link DatabaseAvailabilityCheck} that verifies the availability of the {@code Configurations} database.
   *
  ...
  /**
   * Constructs a new {@link DatabaseAvailabilityCheck} that verifies the availability of the {@code Jobs} database.
   *
   * @param dslContext The {@link DSLContext} instance used to communicate with the {@code Jobs} database.
   * @param timeoutMs The amount of time to wait for the database to become available, in milliseconds.
  ...
  /**
   * Constructs a new {@link DatabaseMigrationCheck} that verifies that the {@code Configurations} database has been migrated to the requested minimum
   * schema version.
   *
   * @param dslContext The {@link DSLContext} instance used to communicate with the {@code Configurations} database.
  ...
  /**
   * Constructs a new {@link DatabaseMigrationCheck} that verifies that the {@code Jobs} database has been migrated to the requested minimum schema
   * version.
   *
   * @param dslContext The {@link DSLContext} instance used to communicate with the {@code Configurations} database.
   * @param flyway The {@link Flyway} instance used to determine the current migration status.
  ...
  /**
   * Constructs a new {@link DatabaseInitializer} that ensures that the {@code Configurations} database schema has been initialized.
   *
   * @param dslContext The {@link DSLContext} instance used to communicate with the {@code Configurations} database.
   * @param timeoutMs The amount of time to wait for the database to become available, in milliseconds.
  ...
  /**
   * Constructs a new {@link DatabaseInitializer} that ensures that the {@code Jobs} database schema has been initialized.
   *
   * @param dslContext The {@link DSLContext} instance used to communicate with the {@code Jobs} database.
   * @param timeoutMs The amount of time to wait for the database to become available, in milliseconds.
   * @param initialSchema The initial schema creation script to be executed if the database is not already populated.
