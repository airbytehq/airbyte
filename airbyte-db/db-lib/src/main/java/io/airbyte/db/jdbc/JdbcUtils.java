...
public class JdbcUtils {
  ...
  // An estimate for how much additional data in sent over the wire due to conversion of source data into {@link AirbyteMessage}. This is due to
  // the fact that records are in JSON format and all database fields are converted to Strings. Currently, this is used in the logic for emitting
