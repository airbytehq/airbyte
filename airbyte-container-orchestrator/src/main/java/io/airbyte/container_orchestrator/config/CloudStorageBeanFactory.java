...
/**
 * Micronaut bean factory for cloud storage-related singletons. TODO: this class currently exists in
 * at least two different places; here and in the workers, consolidate them!
 */
@Factory
...
public class CloudStorageBeanFactory {
  ...
  public CloudStorageConfigs minioLogStorageConfigs(
    ...
    return CloudStorageConfigs.minio(
        new MinioConfig(s3LogBucket, awsAccessKeyId, awsSecretAccessKey, s3MinioEndpoint));
  }
  ...
  public CloudStorageConfigs s3LogStorageConfigs(
    ...
    return CloudStorageConfigs.s3(
        new S3Config(s3LogBucket, awsAccessKeyId, awsSecretAccessKey, s3LogBucketRegion));
  }
  ...
  public CloudStorageConfigs minioStateStorageConfiguration(
    ...
    return CloudStorageConfigs.minio(
        new MinioConfig(bucketName, awsAccessKey, secretAccessKey, endpoint));
  }
