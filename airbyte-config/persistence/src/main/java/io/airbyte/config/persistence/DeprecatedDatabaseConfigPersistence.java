...
/**
 * Use {@link DatabaseConfigPersistence}
 */
@Deprecated
public class DeprecatedDatabaseConfigPersistence implements ConfigPersistence {

  private static final Logger LOGGER = LoggerFactory.getLogger(DeprecatedDatabaseConfigPersistence.class);

  private final ExceptionWrappingDatabase database;

  public DeprecatedDatabaseConfigPersistence(final Database database) {
   ...
   */
  public DeprecatedDatabaseConfigPersistence migrateFileConfigs(final Configs serverConfigs) throws IOException {
