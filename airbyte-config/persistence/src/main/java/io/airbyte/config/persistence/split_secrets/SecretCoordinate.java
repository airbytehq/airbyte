...
/**
 * A secret coordinate represents a specific secret at a specific version stored within a {@link
 * SecretPersistence}.
 *
 * <p>We use "coordinate base" to refer to a string reference to a secret without versioning
...
public class SecretCoordinate {
  ...
  /**
   * Used to turn a full string coordinate into a coordinate object using a full coordinate
   * generated by {@link SecretsHelpers#getCoordinate}.
   *
   * <p>This will likely need refactoring if we end up using a secret store that doesn't allow the
   * same format of full coordinate.
   *
