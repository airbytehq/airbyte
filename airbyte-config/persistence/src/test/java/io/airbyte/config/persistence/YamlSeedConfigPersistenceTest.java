...
public class YamlSeedConfigPersistenceTest {
  ...
  public void testGetConfig() throws Exception {
    ...
    final StandardSourceDefinition mysqlSource =
        PERSISTENCE.getConfig(
            ConfigSchema.STANDARD_SOURCE_DEFINITION, mySqlSourceId, StandardSourceDefinition.class);
    ...
    assertEquals(
        "https://docs.airbyte.io/integrations/sources/mysql", mysqlSource.getDocumentationUrl());
    assertEquals("mysql.svg", mysqlSource.getIcon());

    // destination
    final String s3DestinationId = "4816b78f-1489-44c1-9060-4b19d5fa9362";
    final StandardDestinationDefinition s3Destination =
        PERSISTENCE.getConfig(
    ...
    assertEquals(
        "https://docs.airbyte.io/integrations/destinations/s3",
        s3Destination.getDocumentationUrl());
  }
  ...
  public void testGetInvalidConfig() {
    ...
    assertThrows(
        ...
        () ->
            PERSISTENCE.getConfig(
                ConfigSchema.STANDARD_SOURCE_DEFINITION, "invalid_id", StandardWorkspace.class));
  }
  ...
  public void testDumpConfigs() {
    ...
    assertTrue(
        allSeedConfigs.get(ConfigSchema.STANDARD_SOURCE_DEFINITION.name()).findAny().isPresent());
    assertTrue(
        allSeedConfigs
            .get(ConfigSchema.STANDARD_DESTINATION_DEFINITION.name())
            .findAny()
            .isPresent());
  }
  ...
  public void testWriteMethods() {
    assertThrows(
        UnsupportedOperationException.class,
        () -> PERSISTENCE.writeConfig(ConfigSchema.STANDARD_SOURCE_DEFINITION, "id", new Object()));
    assertThrows(
        UnsupportedOperationException.class,
        () -> PERSISTENCE.replaceAllConfigs(Collections.emptyMap(), false));
  }
}
