...
public class DatabaseConfigPersistenceLoadDataTest extends BaseDatabaseConfigPersistenceTest {
  ...
  public void testUpdateConfigsInNonEmptyDatabase() throws Exception {
    when(seedPersistence.listConfigs(
  ...
  public void testNoUpdateForUsedConnector() throws Exception {
    ...
    final StandardDestinationDefinition destinationS3V2 =
    ...
    final StandardSourceDefinition sourceGithubV2 =
        YamlSeedConfigPersistence.getDefault()
            .getConfig(
    ...
    configPersistence.writeConfig(
        ...
        s3Connection.getDestinationId().toString(),
        s3Connection);
    final SourceConnection githubConnection =
        new SourceConnection()
            .withSourceId(UUID.randomUUID())
            .withSourceDefinitionId(sourceGithubV2.getSourceDefinitionId());
    configPersistence.writeConfig(
        ConfigSchema.SOURCE_CONNECTION,
        githubConnection.getSourceId().toString(),
        githubConnection);
  ...
  public void testUpdateForUnusedConnector() throws Exception {
    ...
    final StandardDestinationDefinition snowflakeV2 =
        YamlSeedConfigPersistence.getDefault()
            .getConfig(
                ConfigSchema.STANDARD_DESTINATION_DEFINITION,
