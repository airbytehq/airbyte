...
- In this flavor of incremental, records in the warehouse destination will never be deleted in the story tables \(named with a `_scd` suffix\), but might not exist in the final table.
