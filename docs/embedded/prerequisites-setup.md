...
Clone the [sample app via Github]([https://github.com/quintonwall/airbyte-embedded-sampleapp](https://github.com/airbytehq/embedded-sampleweb-reactjs)), and navigate to embedded-sampleweb-reactjs/server.
