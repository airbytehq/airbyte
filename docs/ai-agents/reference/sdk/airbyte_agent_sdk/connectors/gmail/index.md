...
Sub-modules
-----------
* airbyte_agent_sdk.connectors.gmail.connector
* airbyte_agent_sdk.connectors.gmail.connector_model
* airbyte_agent_sdk.connectors.gmail.models
* airbyte_agent_sdk.connectors.gmail.types
...
:   Type-safe Gmail API connector.
    ...
    `execute(self, entity: str, action: "Literal['get', 'list', 'create', 'update', 'delete', 'context_store_search']", params: Mapping[str, Any] | None = None) ‑> Any`
