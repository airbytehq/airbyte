...
<CardWithIcon title="Interfaces" description="Choose how to work with your data: the web app, Airbyte Agent MCP, Python SDK, or HTTP API." ctaText="Interfaces" ctaLink="/ai-agents/interfaces/" icon="fa-plug" />
