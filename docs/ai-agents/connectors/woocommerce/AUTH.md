...
agent = Agent(name="Woocommerce Assistant", tools=openai_tools)
```
...
The Woocommerce connector also needs these configuration values to construct the base API URL.
