...
- **[Automations](../interfaces/ui/automations)**: Agent tasks that run on a schedule or on demand. Use Automations when you need the same work to happen repeatedly without a person in the loop.
