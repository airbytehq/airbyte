...
- **Multiple interfaces.** Use connectors through the [web app](../interfaces/ui), the [Python SDK](../interfaces/sdk), the [HTTP API](../interfaces/api), or the [MCP server](../interfaces/mcp), whichever fits your stack. <Also Airbyte Agents!>
...
<Let's point to the benchmarks CC AJ>
...
<This is the first time Airbyte Agents are introduced I think. This came as surprise>
