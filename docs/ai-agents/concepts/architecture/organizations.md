...
- **Context Store** — The [Context Store](../context-store) is enabled by default and operates at the organization level. Airbyte automatically populates it for each connector you add.
