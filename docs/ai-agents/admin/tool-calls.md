...
Tool calls are the billable unit that most directly reflects the work your agents do. Airbyte combines tool calls with token usage to calculate agentic operations (AOs). For more information, see [Billing and pricing](./billing.md).
