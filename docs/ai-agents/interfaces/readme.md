...
- [**CLI**](/ai-agents/interfaces/cli): A shell-first interface for installing `airbyte-agent`, authenticating, adding connectors, and executing connector actions from scripts or AI-agent harnesses.
