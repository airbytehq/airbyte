...
- Airbyte creates that connector in that workspace. If a workspace with the given `workspace_name` already exists, Airbyte adds the connector to the others in that workspace.
