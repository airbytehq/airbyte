...
Please follow our [Code of conduct](01-code-of-conduct.md) in the context of any contributions made to Airbyte.

## Airbyte specification

Before you can start contributing, you need to understand [Airbyte's data protocol specification](../10-understanding-airbyte/02-airbyte-protocol.md).
...
The contributing guide for docs can be found [here](10-updating-documentation/README.md).
