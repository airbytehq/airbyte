# How to Save and Search Through Your Slack History on a Free Slack Plan
...
{% hint style="info" %} MeiliSearch stores data in $(pwd)/data.ms, so if you prefer to store it somewhere else, just adjust this path. {% endhint %}
...
![](../../.gitbook/assets/slack-history-catalog.png)
