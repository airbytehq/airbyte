...
* `supported_sync_modes` - This field lists the type of data replication that this source supports. The possible values in this array include `FULL_REFRESH` \([docs](../architecture/full-refresh.md)\) and `INCREMENTAL` \([docs](../architecture/incremental.md)\).
