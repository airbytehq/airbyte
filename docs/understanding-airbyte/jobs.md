...
This section will depict the lifecycle of a worker. It will only show the 2 connector versions. The single connector version is the same with one side removed.
