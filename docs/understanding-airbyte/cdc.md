...
We add some metadata columns for CDC sources which all begin with the `_ap_cdc_` prefix.  The actual columns syced will vary per srouce, but might look like:
