...
* For REST API streams:
	* Access token - An OAuth 2.0 access token for API client integrations. More information and instructions can be found in the Workday community documentation for your environment.
...
![REST Setup](./assets/workday-rest.png)
...
![RaaS Setup](./assets/workday-raas.png)
