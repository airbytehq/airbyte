...
|:--------| :--------- | :--------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.3.0 | 2026-04-11 | [#PR](https://github.com/airbytehq/airbyte/pull/76252) | Upgrade to Weaviate Python client v4; migrate to Collections API; add optional grpc_port config; replace text2vec-palm with text2vec-google |
