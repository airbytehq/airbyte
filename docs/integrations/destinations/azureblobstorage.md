...
| Azure Blob Storage output buffer size | integer | Azure Blob Storage output buffer size, in bytes. Exmaple: 104857600 |
...
| 0.1.1 | 2021-12-29 | | Added BufferedOutputStream wrapper to blob output stream to improve performance and fix issues with 50,000 block limit. Also disabled autoflush on PrintWriter. |
