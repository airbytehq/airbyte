...
|:--------|:-----------|:-------------------------------------------------------------|:--------------------------------------------------------------------------------------|
| 1.0.11  | 2026-06-22 | [80340](https://github.com/airbytehq/airbyte/pull/80340)     | Fix `IllegalArgumentException` when setting identifier fields on tables with optional PK columns |
