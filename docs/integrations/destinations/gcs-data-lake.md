...
|:--------|:-----------|:-------------------------------------------------------------|:--------------------------------------------------------------------------------------|
| 1.0.11  | 2026-07-07 | [*PR_NUMBER_PLACEHOLDER*](https://github.com/airbytehq/airbyte/pull/*PR_NUMBER_PLACEHOLDER*)     | Normalize table location with a trailing slash before deleting prefixes, fixing 403 AccessDenied errors with STS-scoped REST catalog credentials. |
