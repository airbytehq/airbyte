...
|:--------|:-----------|:-------------------------------------------------------------|:--------------------------------------------------------------------------------------|
| 1.0.11  | 2026-06-22 | [](https://github.com/airbytehq/airbyte/pull/)     | Fix `IllegalArgumentException` when setting identifier fields on tables with optional PK columns |
