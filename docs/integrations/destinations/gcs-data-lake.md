...
|:--------|:-----------|:-------------------------------------------------------------|:--------------------------------------------------------------------------------------|
| 1.0.11  | 2026-07-07 | [81445](https://github.com/airbytehq/airbyte/pull/81445)     | Pick up Load CDK 1.0.16: normalize table location with a trailing slash before deleting prefixes, fixing 403 AccessDenied errors with STS-scoped REST catalog credentials. |
