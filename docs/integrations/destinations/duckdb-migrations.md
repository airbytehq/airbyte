...
This version updates the DuckDB libraries from `v0.9.1` to `v0.10.2`. Note that DuckDB `0.10.2` is only partially backwards compatible with prior versions of DuckDB. Please see the [DuckDB 0.10.2 release notes](https://github.com/duckdb/duckdb/releases/tag/v0.10.2) for more information and for upgrade instructions.
