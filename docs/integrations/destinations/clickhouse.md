...
2. Configure the destination with the following information.
    ...
    - **Record Window Size** (advanced): The maximum number of records to write in a single batch. The default is 100,000 records. Tuning this parameter can impact performance. The batch size is also limited to 70 MB regardless of this setting.
