...
For authentication, you can provide your [MotherDuck Service Credential](https://motherduck.c../authenticating-to-motherduck/#syntax) as the `motherduck_api_key` configuration option.
