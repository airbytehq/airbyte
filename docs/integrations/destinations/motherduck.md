...
| :------ | :--- | :----------- | :------ |
| 0.2.4 | 2026-07-08 | [PLACEHOLDER_PR](https://github.com/airbytehq/airbyte/pull/PLACEHOLDER_PR) | Fix silent data loss on multi-stream syncs by no longer discarding other streams' buffered records when one stream is flushed |
