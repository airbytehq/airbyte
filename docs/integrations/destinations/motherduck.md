...
| :------ | :--- | :----------- | :------ |
| 0.2.5-rc.1 | 2026-07-16 | [82236](https://github.com/airbytehq/airbyte/pull/82236) | Fix sync failures on array fields containing empty objects by serializing JSON array columns before load |
