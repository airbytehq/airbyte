...
|:---------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.1.8 | 2026-05-29 | [78500](https://github.com/airbytehq/airbyte/pull/78500) | Fix overwrite/truncate cleanup failure for SAS-authenticated destinations by falling back to per-blob delete when batch delete is not supported |
