...
|:---------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.1.8 | 2026-05-29 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Fix overwrite/truncate cleanup failure for SAS-authenticated destinations by falling back to per-blob delete when batch delete is not supported |
