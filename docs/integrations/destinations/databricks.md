...
| :------ | :--------- | :------------------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------- |
| 1.1.2   | 2024-02-11 | [#35130](https://github.com/airbytehq/airbyte/pull/33924)                                                           | Update the S3 table location to use `schema` from the configured schema instead of the default                                                    |
