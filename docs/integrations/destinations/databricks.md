...
- `Use VARIANT data type` - Whether to use the new [VARIANT](https://docs.databricks.com/en/sql/language-manual/data-types/variant-type.html) data type for semi-structured data.
