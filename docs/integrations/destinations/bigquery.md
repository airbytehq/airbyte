...
|:--------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.8.5   | 2024-07-24 | [42511](https://github.com/airbytehq/airbyte/pull/42511)   | BigQueryDestination: Added a copy operation to validate copy permissions in the check function                                                                                   | Add a copy step in the check function to check copy operation is working                                                                                                         |
