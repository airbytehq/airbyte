...
|:------------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.1.1 | 2026-09-09 | [76904](https://github.com/airbytehq/airbyte/pull/76904) | Fix schema-change `INSERT ... SELECT` when a stream's name collides with one of its own column names. |
