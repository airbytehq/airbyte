...
|:------------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.1.3 | 2026-09-15 | [86197](https://github.com/airbytehq/airbyte/pull/86197) | Handle a table that disappears between setup and start in direct-load mode by recreating it instead of failing with a NullPointerException. |
