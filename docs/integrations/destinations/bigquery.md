...
|:------------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.19 | 2026-04-22 | [76929](https://github.com/airbytehq/airbyte/pull/76929) | Fix schema-change `INSERT ... SELECT` when a stream's name collides with one of its own column names. |
