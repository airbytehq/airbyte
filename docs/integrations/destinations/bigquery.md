...
|:------------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.19 | 2026-05-13 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Allow append load jobs to add missing nullable Airbyte metadata columns in legacy raw tables. |
