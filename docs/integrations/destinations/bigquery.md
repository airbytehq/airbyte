...
| :------ | :--------- | :--------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------- |
| 2.0.0   | 2023-01-12 | [\#21306](https://github.com/airbytehq/airbyte/pull/21306) | Remove `supportsDbt` and `supportsNormalization` from spec. This requires Airbyte >= 0.43.18                             |
