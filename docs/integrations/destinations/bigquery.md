...
10. For **CDC deletion mode (Optional)**, select **Hard delete** or **Soft delete**. Hard delete
    propagates source deletions to the destination by removing the row. Soft delete retains the row
    and marks it as deleted using metadata. Defaults to hard delete.
