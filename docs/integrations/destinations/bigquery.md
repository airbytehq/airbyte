...
|:------------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.25-rc.1 | 2026-08-12 | [00000](https://github.com/airbytehq/airbyte/pull/00000) | Retry transient BigQuery backend errors when opening the standard-inserts write channel and surface exhausted retries as a transient error |
