...
|:------------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.24 | 2026-08-21 | [84930](https://github.com/airbytehq/airbyte/pull/84930) | Fail with a clear config error when a stream is set to deduplicate without a primary key instead of a BigQuery SQL syntax error |
