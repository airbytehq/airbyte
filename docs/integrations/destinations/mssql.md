...
- `_airbyte_generation_id`: Incremented each time a [refresh](https://docs.airbyte.com/platform/operator-guides/refreshes) is executed.  The column type in SQL Server is `TEXT`.
