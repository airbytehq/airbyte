...
|:-----------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------|
| 2.2.18 | 2026-06-17 | [80165](https://github.com/airbytehq/airbyte/pull/80165) | Add defensive null-handling for date/time columns to prevent SQL Server error 241 on NULL values |
