...
|:-----------|:-----------|:-----------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------|
| 2.2.22 | 2026-09-09 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Report SQL Server permission-denied and string-truncation errors as configuration errors instead of system errors. |
