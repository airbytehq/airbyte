...
|:-----------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------|
| 2.2.16 | 2026-04-23 | [77018](https://github.com/airbytehq/airbyte/pull/77018) | Fix `_ab_cdc_deleted_at` column type so the secondary index on CDC streams can be created. |
