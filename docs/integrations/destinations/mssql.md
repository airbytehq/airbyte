...
|:-----------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------|
| 2.2.18 | 2026-06-09 | [79602](https://github.com/airbytehq/airbyte/pull/79602) | fix(destination-mssql): make Azure SQL DB bulk load work — schema-qualified staging tables and always serialize booleans as 0/1 |
