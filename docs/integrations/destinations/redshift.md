...
| :------ | :--------- | :--------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 4.0.8   | 2026-09-01 | [85152](https://github.com/airbytehq/airbyte/pull/85152)   | Detect existing schemas via `svv_all_schemas` so pre-created schemas with USAGE/CREATE grants are found and CREATE SCHEMA is skipped                                                                              |
