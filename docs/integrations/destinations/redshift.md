...
|:--------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.8   | 2026-08-24 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)       | fix: preserve empty strings on load instead of converting them to NULL; replace EMPTYASNULL with NULL AS sentinel for VARCHAR/SUPER columns                                                                      |
