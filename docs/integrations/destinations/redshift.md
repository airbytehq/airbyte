...
|:--------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.2 | 2026-06-05 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Guard SUPER→VARCHAR schema migration with JSON_SIZE check to prevent "SUPER value exceeds export size" error on oversized values |
