...
|:--------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.10  | 2026-09-01 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX)   | Use `svv_all_schemas` instead of `information_schema.schemata` for schema existence check to support users with USAGE/CREATE-only grants                                                                         |
