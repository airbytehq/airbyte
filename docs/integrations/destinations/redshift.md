...
| :------ | :--------  | :-----       | :------ |
| 0.3.17  | 2021-10-15 | [6949](https://github.com/airbytehq/airbyte/pull/6949) | Each stream was split into files of 10,000,000 records each for copying using S3 or GCS  |
