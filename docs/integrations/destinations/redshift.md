...
| :------ | :--------- | :--------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.5.5 | 2026-04-22 | [76902](https://github.com/airbytehq/airbyte/pull/76902) | Ignore blank cursor fields and primary key columns that are not present in the stream schema to prevent invalid dedup SQL |
