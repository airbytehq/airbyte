...
|:--------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.1   | 2026-06-04 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)      | Fix SSL connection failure caused by `sslmode`/`sslfactory` conflict in Redshift JDBC 2.2.7 driver |
