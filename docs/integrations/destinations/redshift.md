...
|:--------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.1   | 2026-06-04 | [79126](https://github.com/airbytehq/airbyte/pull/79126)   | Fix SSL connection failure caused by `sslmode`/`sslfactory` conflict in Redshift JDBC 2.2.7 driver |
