...
|:--------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.2 | 2026-06-05 | [79155](https://github.com/airbytehq/airbyte/pull/79155) | Guard SUPER→VARCHAR schema migration with JSON_SIZE check to prevent "SUPER value exceeds export size" error on oversized values |
