...
|:--------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.4 | 2026-07-24 | [PLACEHOLDER_PR](https://github.com/airbytehq/airbyte/pull/PLACEHOLDER_PR) | fix: preserve empty strings on load instead of converting them to NULL |
