...
|:--------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.3 | 2026-06-18 | [](https://github.com/airbytehq/airbyte/pull/) | fix(destination-redshift): guard against non-SUPER `_airbyte_meta` column during schema evolution |
