...
|:--------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.11  | 2026-09-06 | [80245](https://github.com/airbytehq/airbyte/pull/80245)   | fix: skip `_airbyte_meta` change tracking during schema evolution when the column is not SUPER |
