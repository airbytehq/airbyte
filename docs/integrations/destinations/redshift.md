...
| :------ | :--------  | :-----       | :------ |
| 0.3.15   | 2021-10-11 | [5924](https://github.com/airbytehq/airbyte/pull/5924) | Each stream was split into files of 10,000 records each for copying using S3 or GCS  |
