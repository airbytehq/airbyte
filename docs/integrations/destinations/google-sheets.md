...
|---------| ---------- | -------------------------------------------------------- | ---------------------------------------------------------- |
| 0.3.2 | 2025-04-02 | [56968](https://github.com/airbytehq/airbyte/pull/56968) | Update airbyte-cdk from 0.51.21 to 6.44.0 to fix 'str' object has no attribute 'json' error |
