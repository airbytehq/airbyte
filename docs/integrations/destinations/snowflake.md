...
|:----------------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.40          | 2026-04-14 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX)  | Classify "Insufficient privileges" Snowflake errors as config errors instead of system errors                                                                                          |
