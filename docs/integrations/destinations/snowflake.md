...
|:----------------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------|
|                 | 2023-08-09 | [\#29637](https://github.com/airbytehq/airbyte/pull/29637) | Destinations v2: Add support for incremental/dedup on streams with no explicit cursor (e.g. source-postgres xmin)                                   |
