...
| :------ | :-------- | :-----       | :------ |
| 0.3.14  | 2021-09-01 | [#5783](https://github.com/airbytehq/airbyte/pull/5783) | Added `batch size` to spec.json and split the snowflake insert query into multiple queries with a specific batch size  |
