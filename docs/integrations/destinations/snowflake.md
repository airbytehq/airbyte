...
|:----------------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.1.3           | 2026-08-31 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)       | Report Snowflake insufficient-privilege and ownership-required errors as configuration errors instead of system errors                                                                 |
