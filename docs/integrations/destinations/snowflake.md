...
|:----------------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.40          | 2026-04-24 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX)   | Fix trailing whitespace being trimmed from string fields during CSV loading into Snowflake                                                                                             |
