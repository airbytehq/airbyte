...
|:----------------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.1.2           | 2026-08-19 | [84953](https://github.com/airbytehq/airbyte/pull/84953)   | Automatically add missing Airbyte meta columns (`_airbyte_meta`, `_airbyte_generation_id`) to tables created by connector versions prior to 3.10.0, fixing "invalid identifier" sync failures after upgrading to 4.x. Upgrade CDK to 1.0.25. |
