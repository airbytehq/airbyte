...
|:----------------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.50-rc.1     | 2026-08-12 | [84303](https://github.com/airbytehq/airbyte/pull/84303)   | Overwrite syncs no longer fail when the internal/staging schema is transient, while preserving the final table's permanent or transient kind.                                  |
