...
|:----------------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.50-rc.1     | 2026-08-12 | [next PR](https://github.com/airbytehq/airbyte/pulls)       | Overwrite syncs no longer fail when the internal/staging schema is transient, while preserving the final table's permanent or transient kind.                                  |
