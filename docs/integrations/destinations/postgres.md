...
|:--------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.14  | 2026-06-08 | [](https://github.com/airbytehq/airbyte/pull/)   | Surface FK violations, permission denied, and type cast errors as config errors instead of system errors. |
