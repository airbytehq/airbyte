...
|:--------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.17 | 2026-08-18 | [84400](https://github.com/airbytehq/airbyte/pull/84400) | Strip null bytes nested inside object and array values, which PostgreSQL rejects in `jsonb` columns |
