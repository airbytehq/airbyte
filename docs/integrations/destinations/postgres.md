...
|:--------|:-----------|:-----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.19 | 2026-09-11 | [PRNUMBER](https://github.com/airbytehq/airbyte/pull/PRNUMBER) | Upgrade to Bulk CDK 1.1.0 and replace the startup `COUNT(*)` with an existence check, so syncs no longer scan large tables before replicating. |
