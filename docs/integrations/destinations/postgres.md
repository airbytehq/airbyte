...
|:--------|:-----------|:-----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.18  | 2026-08-19 | [84953](https://github.com/airbytehq/airbyte/pull/84953)   | Automatically add missing Airbyte meta columns (`_airbyte_meta`, `_airbyte_generation_id`) to tables created by pre-direct-load connector versions, and tolerate a missing `_airbyte_generation_id` column when reading the generation id. Upgrade CDK to 1.0.25.                                     |
