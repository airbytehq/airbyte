...
|:--------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.14  | 2026-07-09 | [81533](https://github.com/airbytehq/airbyte/pull/81533)   | Fix schema-evolution sync failures by using safe casts for incompatible column type changes (e.g. jsonb→numeric, boolean→integer).                                                                                                                                                                  |
