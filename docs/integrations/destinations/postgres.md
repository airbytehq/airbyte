...
|:--------|:-----------|:-----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.19  | 2026-09-11 | [85835](https://github.com/airbytehq/airbyte/pull/85835)   | Upgrade to Bulk CDK 1.1.0 and replace the startup `COUNT(*)` with an existence check, so syncs no longer scan large tables before replicating.                                                                                                                                                        |
