...
|:--------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.14  | 2026-07-29 | TBD                                                         | Fail the sync on transient database connection errors instead of treating tables as missing, which could cause final tables to be dropped and recreated. Upgrade CDK to 1.0.20.        |
