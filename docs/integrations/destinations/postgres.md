...
|:--------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.14  | 2026-07-29 | [83235](https://github.com/airbytehq/airbyte/pull/83235)   | Fail the sync on transient database connection errors instead of treating tables as missing, which could cause final tables to be dropped and recreated. Upgrade CDK to 1.0.20.        |
