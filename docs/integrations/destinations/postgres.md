...
|:--------|:-----------|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.14  | 2026-07-17 | [82250](https://github.com/airbytehq/airbyte/pull/82250)   | Disable server-side statement timeout for the destination session to prevent `canceling statement due to statement timeout` errors during upserts (e.g. behind managed poolers).       |
