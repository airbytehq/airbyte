...
To mitigate this, generate a flag to detect outdated records. Airbyte generates a `_airbyte_extracted_at` [metadata field](../../platform/understanding-airbyte/airbyte-metadata-fields) that assists with this.
