...
|:------------|:-----------|:-----------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0.3.54 | 2026-08-29 | [85189](https://github.com/airbytehq/airbyte/pull/85189) | Nested `_airbyte_meta` fields are now written as optional rather than required for compatibility with external catalog consumers; existing tables migrate in place on the next sync and cannot be written to by earlier connector versions afterwards. |
