...
Iceberg supports [Git-like semantics](https://iceberg.apache.o../latest/branching/) over your data. This connector leverages those semantics to provide resilient syncs.
