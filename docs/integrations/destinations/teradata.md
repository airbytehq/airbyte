...
The Teradata destination connector supports [ sync modes](https://docs.airbyte.com/cloud/core-concepts#connection-sync-modes): [DBT custom transformation] (https://docs.airbyte.com/operator-guides/transformation-and-normalization/transformations-with-airbyte/) type.
