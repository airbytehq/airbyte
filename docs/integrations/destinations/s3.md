...
|:--------| :--- | :--- |:---------------------------------------------------------------------------------------------------------------------------|
| 0.3.10  | 2022-06-30 | [\#](https://github.com/airbytehq/airbyte/pull/) | Change INSTANCE_PROFILE to use `AWSDefaultProfileCredential`, which supports more authentications on AWS |
