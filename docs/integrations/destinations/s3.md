...
It will become this JSON line:

```json
{
  "_airbyte_ab_id": "26d73cde-7eb1-4e1e-b7db-a4c03b4cf206",
  "_airbyte_emitted_at": "1622135805000",
  "_airbyte_data": {
    "user_id": 123,
    "name": {
      "first": "John",
...
| :--- | :---  | :--- | :--- |
| 0.1.7 | 2021-06-20 | [#4227](https://github.com/airbytehq/airbyte/pull/4227) | Added JSONL output. |
