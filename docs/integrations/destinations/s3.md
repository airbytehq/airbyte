...
- `${WORKSPACE_ID}`: The unique identifier (UUID) of the Airbyte workspace running the sync.
- `${CONNECTION_ID}`: The unique identifier (UUID) of the Airbyte connection running the sync.
