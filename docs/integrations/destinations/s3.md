...
:::note
Currently, this feature is available only for the users in a Sales Assist workflow. Please [contact the Sales team](https://airbyte.com/company/talk-to-sales) if you are interested in using this.
:::
