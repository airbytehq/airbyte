...
4. Configure fields:
   ...
   - **S3 Filename pattern**
     - The pattern allows you to set the file-name format for the S3 staging file(s), next
       ...
       `{part_number}`, `{sync_id}`, `{format_extension}`. Please, don't use empty space and not
       won't be recognized.
...
|:------------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.9.8       | 2026-05-22 | [78332](https://github.com/airbytehq/airbyte/pull/78332) | Promote release candidate 1.9.8-rc.1 to a main version. |
| 1.9.8-rc.1  | 2026-05-20 | [78240](https://github.com/airbytehq/airbyte/pull/78240) | Upgrade CDK to 1.0.13 and enable progressive rollout. |
