...
[binary encoding](http://avro.apache.o../current/spec.html#binary_encoding), and assumes that
...
[here](https://docs.airbyte.com/platform/understanding-airbyte/json-avro-conversion).
...
[Parquet documentation](https://parquet.apache.o../file-format/configurations/) for their
...
current limitations [here](https://docs.airbyte.com/platform/understanding-airbyte/json-avro-conversion).
