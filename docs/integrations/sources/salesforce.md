...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.8.1 | 2026-07-23 | [82719](https://github.com/airbytehq/airbyte/pull/82719) | Fix rotated refresh token being dropped when rotation occurs during check or discover (emit the connector-config control message directly to stdout) |
