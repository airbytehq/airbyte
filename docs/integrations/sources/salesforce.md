...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.7.24 | 2026-06-26 | [](https://github.com/airbytehq/airbyte/pull/) | Fix LIMIT_EXCEEDED error misclassified as BulkNotSupportedException; add REST fallback for BulkSalesforceSubStream |
