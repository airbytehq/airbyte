...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.0 | 2026-06-09 | [*PR_NUMBER_PLACEHOLDER*](https://github.com/airbytehq/airbyte/pull/*PR_NUMBER_PLACEHOLDER*) | Restructure auth spec to use oneOf credentials with OAuth and Manual variants, preventing platform credential injection when users provide their own Salesforce Connected App credentials |
