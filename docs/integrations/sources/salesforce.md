...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.8.2 | 2026-08-12 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Restart the REST query instead of retrying an expired `nextRecordsUrl` when the session is invalidated mid-pagination |
