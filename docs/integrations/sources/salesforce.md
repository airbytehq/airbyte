...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.8.0 | 2026-06-10 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Add oneOf credentials selector to separate OAuth from Manual auth, preventing platform credential injection for BYO-app users |
