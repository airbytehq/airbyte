...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.7.23 | 2026-05-01 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Fix data loss on schema-change refresh by replacing sliding-window default start_date with a fixed date |
