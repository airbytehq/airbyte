...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.8.1 | 2026-07-27 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Fail fast when the refresh token is rejected instead of retrying the token endpoint from every stream |
