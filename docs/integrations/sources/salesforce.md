...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.8.0 | 2026-06-24 | [80784](https://github.com/airbytehq/airbyte/pull/80784) | Add OAuth 2.0 JWT Bearer Token authentication for headless/server-to-server use cases |
