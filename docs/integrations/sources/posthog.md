...
| :------ | :--------- | :------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------- |
| 1.1.26 | 2026-09-22 | [86898](https://github.com/airbytehq/airbyte/pull/86898) | Fix `events` stream truncation by following the API's `next` URL (keyset pagination) instead of offset pagination |
