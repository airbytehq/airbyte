...
| :------ | :--------- | :------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------- |
| 1.1.26 | 2025-06-03 | [79115](https://github.com/airbytehq/airbyte/pull/79115) | Add events stream to connection check to validate query:read scope; classify HTTP 401/403 as config errors |
