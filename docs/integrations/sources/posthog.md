...
| :------ | :--------- | :------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------- |
| 1.1.26 | 2026-04-17 | [76441](https://github.com/airbytehq/airbyte/pull/76441) | Classify HTTP 403 "missing required scope" responses as `config_error` with a clearer message |
