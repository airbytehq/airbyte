...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------|
| 1.4.7-rc.1 | 2026-03-10 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Add HTTPAPIBudget (2 req/s rate limiting), concurrency_level, and num_workers configuration |
