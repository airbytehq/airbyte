...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.0.1       | 2026-09-01 | [85286](https://github.com/airbytehq/airbyte/pull/85286)                                                          | Restart the initial snapshot when a stream's saved CDC state is `{}` (never checkpointed) instead of skipping it; fixes incomplete data being promoted on retry after a failed snapshot. |
