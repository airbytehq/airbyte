...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.4.3       | 2026-05-01 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)                                                              | Fix CDC offset validation including unauthorized capture instances; improve error messages for offset and permission failures.     |
