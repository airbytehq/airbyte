...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.3.6       | 2026-03-25 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)                                                              | Fix discovery of user-defined alias types by resolving them to their base SQL Server types.                                                     |
