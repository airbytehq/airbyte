...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.3.5 | 2026-02-21 | [73710](https://github.com/airbytehq/airbyte/pull/73710) | Fix LSN validation to use CDC data (cdc.lsn_time_mapping) instead of transaction log, resolving sync failures on Azure SQL geo-replicas and environments with aggressive log recycling. |
