...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.0.1       | 2026-09-04 | [13444](https://github.com/airbytehq/oncall/issues/13444)                                                         | Treat an empty `{}` stream state as no state so a CDC initial snapshot interrupted before its first checkpoint is re-read instead of being skipped. |
