...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.4.3       | 2026-05-01 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)                                                              | Fix CDC LSN validation failing when unauthorized capture instances cause MIN() to return zero.                                                  |
