...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.3.3       | 2025-12-17 | [70945](https://github.com/airbytehq/airbyte/issues/70945) | Fix cursor-based incremental syncs to use exclusive comparison (>) instead of inclusive (>=) to prevent duplicate record reads                |
