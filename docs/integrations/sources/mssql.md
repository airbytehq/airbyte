...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.0.1       | 2026-08-28 | [85175](https://github.com/airbytehq/airbyte/pull/85175)                                                          | Test-harness only: mirror Maven Central for the e2e build and fix the CDC catalog fixtures' cursor field. No functional change.                 |
