...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.4.9       | 2026-06-01 | [78529](https://github.com/airbytehq/airbyte/issues/78529)                                                        | Fall back to primary key when SQL Server clustered-index discovery is rejected (e.g. CData Connect Server) instead of failing the sync.                                               |
