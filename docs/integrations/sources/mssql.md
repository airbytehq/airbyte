...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.3.6       | 2026-04-08 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)                                                              | Fix checkPrivileges bypass in MSSQL discovery — columns with DENY SELECT are now correctly filtered out.                                        |
