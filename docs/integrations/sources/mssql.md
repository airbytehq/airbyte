...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.0.2       | 2026-09-17 | [PR_NUMBER_PLACEHOLDER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER_PLACEHOLDER)                         | Preserve columns added via ALTER TABLE in CDC syncs that resume from a heartbeat offset (fixes newly added columns being emitted as NULL).                  |
| 5.0.1       | 2026-09-09 | [84356](https://github.com/airbytehq/airbyte/pull/84356)                                                         | Change Debezium data.query.mode from `direct` to `function` to prevent syncs from hanging on large tables.                                                  |
