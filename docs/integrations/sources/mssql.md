...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.0.1       | 2026-09-08 | [PLACEHOLDER](https://github.com/airbytehq/airbyte/pull/PLACEHOLDER)                                                | Fix the local DB harness CDC comparison example: derive an incremental `_ab_cdc_cursor` catalog and guard against full-refresh catalogs under CDC config. |
