...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.0.1       | 2026-09-01 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)                                                              | Restart the initial snapshot when a stream's saved CDC state is `{}` (never checkpointed) instead of skipping it; fixes incomplete data being promoted on retry after a failed snapshot. |
