...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.0.2       | 2026-09-17 | [86413](https://github.com/airbytehq/airbyte/pull/86413)                                                         | Preserve columns added via ALTER TABLE in CDC syncs that resume from a heartbeat offset (fixes newly added columns being emitted as NULL).                  |
