...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.4.0       | 2026-04-08 | [76143](https://github.com/airbytehq/airbyte/pull/76143)                                                          | Add Microsoft Entra ID authentication support (Service Principal, Managed Identity, Default credential chain) for both JDBC and CDC paths.     |
