...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.3.6       | 2026-03-01 | [74105](https://github.com/airbytehq/airbyte/pull/74105)                                                          | Fix CDC LSN validation failing on databases where user lacks db_owner role by excluding unauthorized capture instances from MIN() aggregation.   |
