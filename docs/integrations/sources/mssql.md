...
| :---------- | :--------- | :---------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------- |
| 4.4.5       | 2026-05-05 | [77775](https://github.com/airbytehq/airbyte/pull/77775)                                                          | Restructure CDC repro harness into co-located agent skills (`source-mssql-e2e-tests`, `source-mssql-e2e-cdc-tests`); add oncall#11451 worked example. |
| 4.4.4       | 2026-05-05 | [77775](https://github.com/airbytehq/airbyte/pull/77775)                                                          | Fix CDC repro harness in `dev/cdc-repro/`: drop user-defined network, populate v4.3.x-required catalog fields.                                        |
| 4.4.3       | 2026-05-05 | [77775](https://github.com/airbytehq/airbyte/pull/77775)                                                          | Add `CONTRIBUTING.md` and `dev/cdc-repro/` fixtures documenting a local CDC repro harness for the connector.                                          |
