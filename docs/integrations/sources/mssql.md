...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.3.6       | 2026-03-01 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX)                                                          | Fix CDC LSN validation failing on databases where user lacks db_owner role by excluding unauthorized capture instances from MIN() aggregation.   |
