...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.4.3       | 2026-05-04 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX)                                                          | Fix CDC startup failure when stream names or namespaces contain whitespace or `:` (skip those streams from the `message.key.columns` override and rely on Debezium's native primary key detection). |
