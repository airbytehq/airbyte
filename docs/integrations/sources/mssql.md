...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.4.3       | 2026-05-01 | [77668](https://github.com/airbytehq/airbyte/pull/77668)                                                          | Fix CDC LSN validation failing when unauthorized capture instances cause MIN() to return zero.                                                  |
