...
| :------ | :--------- | :------------------------------------------------------- | :------------------------------------------------------------------------------ |
| 1.0.22 | 2026-05-05 | [00000](https://github.com/airbytehq/airbyte/pull/00000) | Bump base image to `source-declarative-manifest:7.18.1` so streams without cursors no longer advertise incremental sync |
