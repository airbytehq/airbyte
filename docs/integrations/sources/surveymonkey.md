...
| :------ | :--------- | :------------------------------------------------------- | :------------------------------------------------------------------------------- |
| 0.3.48 | 2026-02-23 | [73720](https://github.com/airbytehq/airbyte/pull/73720) | fix(source-surveymonkey): use lowercase sort_order parameter to match SurveyMonkey API validation |
