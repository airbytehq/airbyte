...
This source syncs advertiser-side reporting data from AppLovin. It covers app campaign
reporting, web campaign reporting, and asset (creative) level reporting.
