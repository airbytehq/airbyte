...
|:-----------|:-----------|:----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.0 | 2026-06-29 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Add landing page event metrics (`total_landing_page_view`, `cost_per_landing_page_view`, `landing_page_view_rate`) to all basic report streams |
