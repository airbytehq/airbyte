...
|:-----------|:-----------|:----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.0.11 | 2026-06-16 | [80061](https://github.com/airbytehq/airbyte/pull/80061) | Reduce date step from P30D to P1D for `ads_reports_daily` and `ads_reports_by_country_daily` to avoid TikTok API error 40067 ("query too large") |
