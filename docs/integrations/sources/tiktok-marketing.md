...
|:-----------|:-----------|:----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.0 | 2026-07-03 | [76231](https://github.com/airbytehq/airbyte/pull/76231) | Include `advertiser_id` in the source-defined primary keys of report streams so Incremental + Deduped syncs distinguish records across advertiser partitions |
