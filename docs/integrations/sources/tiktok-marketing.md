...
|:--------|:-----------| :------------------------------------------------------- |:------------------------------------------------------------------------------------------------------------|
| 3.9.3   | 2023-11-16 | [32092](https://github.com/airbytehq/airbyte/pull/32596) | Fix `include_deleted` argument not having affect on `ads`, `ad_groups`, and `campaigns` streams.            |
