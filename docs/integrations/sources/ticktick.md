...
|------------------|-------------------|--------------|----------------|
| 0.0.15 | 2025-12-16 | [70787](https://github.com/airbytehq/airbyte/pull/70787) | Update dependencies |
...
| 0.0.5 | 2025-09-03 | [64947](https://github.com/airbytehq/airbyte/pull/64947) | Add oauth2 method. Ignore archived projects on stream `projects`. Added API budget to proactively not hit rate limits. |
