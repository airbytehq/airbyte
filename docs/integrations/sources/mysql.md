...
| `timestamp`                               | string                 | ISO-8601 timestamp string. In CDC mode, zero-date values will be converted to Unix epoch (`1970-01-01T00:00:00`). In non-CDC syncs, zero-dates will be NULL. If using a zero-date column as a cursor, convert to EPOCH.                                                  |
