...
|:------------|:-----------|:-----------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.53.6      | 2026-09-24 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)         | Promote to Bulk CDK 1.1.12: emit zero-date `DATE`/`DATETIME` values as `null` instead of logging a retrieval failure (`zeroDateTimeBehavior=convertToNull`). |
