...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.51.6      | 2026-03-27 | [75531](https://github.com/airbytehq/airbyte/pull/75531)                                              | Replace deprecated Jackson `ObjectNode.fields()` usage and bump the pinned Bulk CDK version to `0.2.8` so `source-mysql` builds against the current published CDK APIs. |
