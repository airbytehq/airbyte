...
|:------------|:-----------|:-----------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.53.5      | 2026-09-04 | [80332](https://github.com/airbytehq/airbyte/pull/80332)   | Widen random CDC `server_id` range from 5400-6400 to 5400-2147483647 to prevent collisions when multiple CDC connections target the same MySQL server. |
