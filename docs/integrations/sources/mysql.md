...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.52.3      | 2026-05-18 | [76345](https://github.com/airbytehq/airbyte/pull/76345)                                              | Drop `RELOAD` privilege requirement for CDC; document OCI HeatWave `binlog_row_value_options=PARTIAL_JSON` UPDATE-drop regression.              |
