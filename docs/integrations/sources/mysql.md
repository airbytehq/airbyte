...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.51.6      | 2026-03-27 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)                                                  | Fix NullPointerException in CDC GTID validation during warm start when saved state has null GTIDs or server UUID changes                        |
