...
|:------------|:-----------|:-----------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.53.2      | 2026-07-14 | [82101](https://github.com/airbytehq/airbyte/pull/82101)   | Fix `Illegal mix of collations` (error 1267) when partitioning string primary keys by keeping synthetic partition boundaries within the column's character set. |
