...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.52.4      | 2026-06-01 | [77899](https://github.com/airbytehq/airbyte/pull/77899)                                                  | Raise CDC payload limit to support rows whose serialized JSON exceeds 100 MiB, and emit an actionable error when one does.                  |
