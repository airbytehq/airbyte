...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.52.4      | 2026-06-22 | [80377](https://github.com/airbytehq/airbyte/pull/80377)                                                  | Widen random CDC `server_id` range from 5400-6400 to 5400-2147483647 to prevent collisions when multiple CDC connections target the same MySQL server.                                                                                             |
