...
|:------------|:-----------|:-----------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.53.5      | 2026-09-12 | [PRNUMBER](https://github.com/airbytehq/airbyte/pull/PRNUMBER) | Fix NullPointerException in CDC state validation when the server has GTIDs from a server UUID unknown to the saved state.                        |
