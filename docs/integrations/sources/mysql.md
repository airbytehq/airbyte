...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.51.7      | 2026-05-05 | [77793](https://github.com/airbytehq/airbyte/pull/77793)                                              | Honor `tinyInt1isBit=false` JDBC URL param during CDC so TINYINT(1) columns sync as integers instead of booleans.                               |
