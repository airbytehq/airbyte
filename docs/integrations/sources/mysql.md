...
|:------------|:-----------|:-----------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.53.5      | 2026-09-04 | [85349](https://github.com/airbytehq/airbyte/pull/85349)   | Fix concurrent initial snapshot dropping every row sharing the minimum first primary-key column value on tables with composite primary keys.   |
