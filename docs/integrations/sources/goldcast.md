...
|:---------|:-----------|:---------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------|
| 0.3.0 | 2026-07-27 | [82770](https://github.com/airbytehq/airbyte/pull/82770) | Declare `event_members` `props.cs_webinar_follow_up`, returned by the API but missing from the schema |
