...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.1   | 2026-09-25 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Treat `_` and `%` in the configured schema as literal characters during discovery instead of SQL LIKE wildcards, fixing over-matched schemas and duplicate-column discovery failures. |
