...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.1   | 2026-09-25 | [87000](https://github.com/airbytehq/airbyte/pull/87000) | Treat `_` and `%` in the configured schema as literals during discovery instead of SQL LIKE wildcards, fixing duplicate-column failures.  |
