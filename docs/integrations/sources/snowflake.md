...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.1   | 2026-09-25 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Treat the configured schema as a literal name during discovery (escape `_`/`%` LIKE wildcards) and de-duplicate discovered columns, fixing `Duplicate key` discovery failures. |
