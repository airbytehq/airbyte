...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.1   | 2026-09-25 | [86999](https://github.com/airbytehq/airbyte/pull/86999) | Treat the configured schema as a literal name during discovery (escape `_`/`%` LIKE wildcards) and de-duplicate discovered columns, fixing `Duplicate key` discovery failures. |
