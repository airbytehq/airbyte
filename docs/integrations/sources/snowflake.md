...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.1   | 2026-09-25 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Fix duplicate-column discovery failure when a schema name contains `_` or `%`, and report the affected stream and column when duplicates are found. |
