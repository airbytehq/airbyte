...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.1   | 2026-09-25 | [87000](https://github.com/airbytehq/airbyte/pull/87000) | Treat `_` and `%` in the configured schema as literal characters during discovery instead of SQL LIKE wildcards, fixing over-matched schemas and duplicate-column discovery failures. |
