...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------|
| 1.0.9 | 2026-02-26 | [74066](https://github.com/airbytehq/airbyte/pull/74066) | Fix silent sync failure (0 records emitted) caused by Snowflake JDBC driver returning inconsistent type names for NUMBER(38,0) columns |
