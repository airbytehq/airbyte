...
|:-----------|:-----------|:---------------------------------------------------------|:-------------------------------------------------------------------------------|
| 1.5.35 | 2026-04-30 | [](https://github.com/airbytehq/airbyte/pull/) | Remove client-side incremental filtering from parent streams to fix missing child stream data |
