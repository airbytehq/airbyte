...
|:-----------|:-----------|:---------------------------------------------------------|:-------------------------------------------------------------------------------|
| 1.5.35 | 2026-05-07 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Allow legacy `%Y-%m-%dT%H:%M:%S` cursor format in daily stats stream state to fix state parsing regression from 1.5.16 |
