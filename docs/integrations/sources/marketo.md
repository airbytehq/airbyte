...
|:---------|:-----------|:---------------------------------------------------------|:-------------------------------------------------------------------------------------------------|
| 1.6.3 | 2026-04-21 | [76484](https://github.com/airbytehq/airbyte/pull/76484) | Surface Marketo error code 607 (daily API call quota reached) as a config error instead of a generic backoff exception |
