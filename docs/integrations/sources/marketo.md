...
|:---------|:-----------|:---------------------------------------------------------|:-------------------------------------------------------------------------------------------------|
| 2.1.2 | 2026-08-27 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Handle numeric and other non-string values for boolean-typed fields in activity streams instead of failing the sync. |
