...
|:---------|:-----------|:---------------------------------------------------------|:-------------------------------------------------------------------------------------------------|
| 2.0.2 | 2026-06-26 | [80925](https://github.com/airbytehq/airbyte/pull/80925) | Add read timeout to bulk export downloads to prevent indefinite hangs when Marketo stops sending data. |
