...
|:---------|:-----------|:---------------------------------------------------------|:-------------------------------------------------------------------------------------------------|
| 1.4.39 | 2026-01-26 | [71848](https://github.com/airbytehq/airbyte/pull/71848) | Fix type conversion errors in leads stream when API returns unexpected data types |
