...
|:---------|:-----------|:---------------------------------------------------------|:-------------------------------------------------------------------------------------------------|
| 2.0.2 | 2026-06-10 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Raise structured `AirbyteTracedException` with context when Marketo bulk export jobs fail or are cancelled. |
