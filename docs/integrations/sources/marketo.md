...
|:---------|:-----------|:---------------------------------------------------------|:-------------------------------------------------------------------------------------------------|
| 2.0.1 | 2026-05-22 | [78370](https://github.com/airbytehq/airbyte/pull/78370) | Expose Bulk Export Window in Days so large incremental Marketo syncs can use smaller Bulk Extract jobs. |
