...
|:---------|:-----------|:---------------------------------------------------------|:-------------------------------------------------------------------------------------------------|
| 2.1.3 | 2026-09-01 | [79644](https://github.com/airbytehq/airbyte/pull/79644) | Raise structured `AirbyteTracedException` with context when Marketo bulk export jobs fail or are cancelled. |
