...
| ------- | ---- | ------------ | ------- |
| 1.0.1 | 2026-09-03 | [85338](https://github.com/airbytehq/airbyte/pull/85338) | Bump SDM base image to CDK prerelease `7.28.3.post5.dev33815635514` (single `CONNECTOR_CONFIG` emission per refresh token rotation) |
