...
|---------|------|--------------|---------|
| 0.1.0 | 2026-04-17 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Add incremental sync support for 12 streams using the `updatedAt` cursor field |
