...
| ------- | ---- | ------------ | ------- |
| 1.0.1 | 2026-09-09 | [85789](https://github.com/airbytehq/airbyte/pull/85789) | Stop the config migration from writing an empty `credentials.api_key` into OAuth configs, which prevented rotated refresh tokens from being persisted |
