...
| ------- | ---- | ------------ | ------- |
| 1.0.0 | 2026-08-27 | [PR_PLACEHOLDER] | Type all date and datetime fields and remove deprecated Linear fields from the `users`, `teams` and `customer_statuses` queries. |
