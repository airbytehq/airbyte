...
| ------- | ---- | ------------ | ------- |
| 0.2.15 | 2026-08-21 | [0](https://github.com/airbytehq/airbyte/pull/0) | Classify Linear GraphQL errors: surface actionable config errors for invalid credentials and fail fast on invalid queries |
