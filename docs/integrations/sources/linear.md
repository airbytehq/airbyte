...
| ------- | ---- | ------------ | ------- |
| 0.2.15 | 2026-08-21 | [84949](https://github.com/airbytehq/airbyte/pull/84949) | Classify Linear GraphQL errors: surface actionable config errors for invalid credentials and fail fast on invalid queries |
