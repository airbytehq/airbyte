...
| ------- | ---- | ------------ | ------- |
| 0.2.15 | 2026-08-21 | [84947](https://github.com/airbytehq/airbyte/pull/84947) | Add suggested streams so new connections pre-select core streams and exclude Customer Requests streams |
