...
| ------- | ---- | ------------ | ------- |
| 1.0.4 | 2026-09-23 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Retry when Linear returns an incomplete or unparsable response instead of failing the stream |
