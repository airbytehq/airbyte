...
|:--------|:-----------|:---------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------|
| 5.3.4 | 2025-04-18 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fix to properly retrieve `approximateMemberReach` for `adAnalytics` streams following `v5.3.3`.                   |
