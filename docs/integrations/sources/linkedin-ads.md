...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.6.11 | 2026-07-21 | [74334](https://github.com/airbytehq/airbyte/pull/74334) | Batch supported analytics streams in groups of 50, preserve member-demographic finder and state compatibility, prevent response truncation and property-chunk collisions, and harden data-volume rate-limit handling. |
