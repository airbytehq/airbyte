...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.8.0 | 2026-07-30 | [TBD](https://github.com/airbytehq/airbyte/pulls) | Fix invalid `error_handlers` manifest key so the custom error handler and exponential backoff are actually applied |
