...
|:--------|:-----------|:---------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------|
| 4.0.7   | 2024-08-08 | [42847](https://github.com/airbytehq/airbyte/pull/42847) | Update fields: `approximateUniqueImpressions` field has been deprecated and is replaced by the new API field `approximateMemberReach` |
