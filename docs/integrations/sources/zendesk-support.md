...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.7-rc.1 | 2026-04-23 | [76953](https://github.com/airbytehq/airbyte/pull/76953) | Add `subscription_tier` config field, comment out the existing HTTP API budget for concurrency tuning, raise default concurrency from 3 to 10, and enable progressive rollout |
