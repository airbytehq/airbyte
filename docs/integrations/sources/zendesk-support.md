...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.5.0-rc.2 | 2026-08-07 | [83777](https://github.com/airbytehq/airbyte/pull/83777) | Raise `maxSecondsBetweenMessages` to 4 hours so a long `tickets` backfill on the 10 req/min Incremental Ticket Export endpoint is not killed by the source heartbeat timeout |
