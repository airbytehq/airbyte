...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.5.0-rc.2 | 2026-08-05 | [83708](https://github.com/airbytehq/airbyte/pull/83708) | Fail the sync when Zendesk denies access to a data stream instead of skipping it and reporting a successful empty sync; permission denials are still skipped for optional plan- and admin-gated streams |
