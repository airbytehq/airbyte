...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.0 | 2026-07-09 | [81531](https://github.com/airbytehq/airbyte/pull/81531) | Revert `tickets` stream cursor from `updated_at` back to `generated_timestamp` (Incremental Ticket Export API) so automation/macro/system-driven ticket updates are no longer silently missed. Existing state is migrated automatically; a one-time refresh of `tickets` and `ticket_metrics` is recommended. |
