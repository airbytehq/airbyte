...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.1.7-rc.1 | 2026-03-10 | [](https://github.com/airbytehq/airbyte/pull/) | Add comprehensive HTTPAPIBudget with 200 req/min catch-all policy for all non-incremental endpoints (Team tier default), add 429 status code handling, and enable progressive rollout |
