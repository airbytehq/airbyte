...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.0 | 2026-07-09 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Revert `tickets` stream cursor from `updated_at` back to `generated_timestamp` (Incremental Ticket Export API) so automation/macro/system-driven ticket updates are no longer silently missed. Existing state is migrated automatically; a one-time refresh of `tickets` and `ticket_metrics` is recommended. |
