...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.6.1 | 2026-09-23 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Request the Incremental Ticket Export in pages of 100 tickets (`per_page`) and disable response caching on `tickets`, to prevent source OOMs on accounts with large tickets |
