...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.5.2 | 2026-08-13 | [84360](https://github.com/airbytehq/airbyte/pull/84360) | Render incremental epoch boundaries with `.timestamp()` instead of `strftime('%s')`, which resolved against the host timezone rather than UTC |
