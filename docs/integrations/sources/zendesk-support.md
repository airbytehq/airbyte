...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.7 | 2026-04-24 | [](https://github.com/airbytehq/airbyte/pull/) | Split HTTP 403 and 404 error handling into distinct messages instead of a single misleading permissions error |
