...
| :------ | :--------- | :------------------------------------------------------- | :------------------------------------------------------------------------------------ |
| 3.3.4 | 2026-09-22 | [86643](https://github.com/airbytehq/airbyte/pull/86643) | Fix the `ticket_activities` stream reading zero records when the Freshdesk export endpoint returns a list of exports |
