...
| :------ | :--------- | :------------------------------------------------------- | :------------------------------------------------------------------------------------ |
| 3.3.3 | 2026-09-22 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Fix the `ticket_activities` stream reading zero records when the Freshdesk export endpoint returns a list of exports |
