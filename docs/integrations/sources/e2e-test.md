...
|---------|------------| ----------------------------------------------------------------------------------------------------------------- |---------------------------------------------------------------------------------------------------------|
| 2.2.0   | 2023-06-27 | [26701](https://github.com/airbytehq/airbyte/pull/26701)                                                          | Add support for continuous feed to emit state. Add support for not logging every record in legacy mode. |
