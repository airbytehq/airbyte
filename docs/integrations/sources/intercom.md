...
|:-----------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------|
| 0.10.1     | 2025-01-29 | [51619](https://github.com/airbytehq/airbyte/pull/51619) | upgrade API version to 2.11, update metadata, add new fields to conversation_parts |
