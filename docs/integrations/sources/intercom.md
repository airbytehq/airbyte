...
|:------------|:-----------|:---------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------|
| 0.13.16-rc.4 | 2026-03-02 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | fix(source-intercom): fix UnboundLocalError in rate limiter when response is not available |
