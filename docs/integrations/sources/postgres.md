...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.2  | 2026-06-11 | [79678](https://github.com/airbytehq/airbyte/pull/79678) | Surface a config error when the database does not support the replication protocol (e.g. connection pooler). |
