...
|-------------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.0-rc.12 | 2026-05-28 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fix ClassCastException in CDC deserialization when array-typed columns arrive as text instead of JSON arrays.                                                               |
