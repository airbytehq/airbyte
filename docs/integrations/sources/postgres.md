...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.2  | 2026-06-15 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Classify 'the database system is shutting down' (SQLSTATE 57P03) as transient error to enable retries.                      |
