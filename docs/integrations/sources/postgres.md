...
|------------|------------|-----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.0-rc.9 | 2026-05-05 | [PR_NUM_PLACEHOLDER](https://github.com/airbytehq/airbyte/pull/PR_NUM_PLACEHOLDER) | Make the hidden additional properties fields in spec optional. No functional change.                                                                                      |
