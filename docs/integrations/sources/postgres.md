...
|---------|------------|------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.7.2 | 2026-02-02 | [72535](https://github.com/airbytehq/airbyte/pull/72535) | Fix ClassCastException with interval columns having DEFAULT values on PostgreSQL 16.x |
