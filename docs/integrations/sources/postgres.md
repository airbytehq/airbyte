...
ALTER TABLE tbl1 REPLICA IDENTITY FULL;`.  Ensure that TOAST-able tables use non-toastable primary keys (integers, varchars, etc), and there will only be a [modest increase in resource utlization](https://xata.io/blog/replica-identity-full-performance).
