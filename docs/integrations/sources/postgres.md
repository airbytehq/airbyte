...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.2  | 2026-06-17 | [80172](https://github.com/airbytehq/airbyte/pull/80172) | Fix cursor-based incremental sync skipping records from in-flight transactions by applying a 2-minute lookback window to the cursor lower bound for timestamp cursors.     |
