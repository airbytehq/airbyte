...
|---------|------------|------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.7.1   | 2025-12-03 | [70297](https://github.com/airbytehq/airbyte/pull/70297)   | Fix ClassCastException with interval columns having DEFAULT values on PostgreSQL 16.x                                                                                      |
