...
|------------|------------|-----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.0-rc.8 | 2026-04-22 | [76475](https://github.com/airbytehq/airbyte/pull/76475) | CDC: skip redundant replication-slot acknowledgement when the slot is already at or beyond the saved LSN                                                                  |
