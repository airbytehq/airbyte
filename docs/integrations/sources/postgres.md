...
For CDC, cascading replication (from a read-replica), is possible only for Postgres 16 or later versions.
...
|---------|------------|----------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.6.20  | 2024-09-17 | - | Adopt latest CDK to allow cascading replication (Postgres > 16)                 |
