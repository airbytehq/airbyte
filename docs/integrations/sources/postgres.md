...
|---------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.6   | 2026-09-02 | [85301](https://github.com/airbytehq/airbyte/pull/85301) | Fail fast with an actionable error when the database contains an enum type with no labels, which crashes Debezium at CDC startup.                                             |
