...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.2  | 2026-06-11 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Fix CDC replication slot LSN not advancing: add server-side flush confirmation poll and fall back to `lsn` offset field when `lsn_proc`/`lsn_commit` are absent after snapshot. |
