...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.2  | 2026-07-01 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fix DateTimeParseException when cursor value is date-only format in timestamp columns.                                                                                     |
