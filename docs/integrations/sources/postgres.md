...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.2  | 2026-06-28 | [80938](https://github.com/airbytehq/airbyte/pull/80938) | Classify connection pool checkout timeout as a transient error to enable automatic retries.                                                                                 |
