...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.1  | 2026-06-03 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)    | Handle unsupported pg_relation_filenode query on non-standard PostgreSQL-compatible databases                                                                               |
