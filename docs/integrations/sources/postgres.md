...
|------------|------------|-----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.0-rc.9 | 2026-05-04 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)     | Restore CDC metadata fields (`_ab_cdc_lsn`, `_ab_cdc_updated_at`, `_ab_cdc_deleted_at`) on CDC streams without a primary key                                              |
