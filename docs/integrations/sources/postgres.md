...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.2  | 2026-06-28 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Classify connection pool checkout timeout as a transient error to enable automatic retries.                                                                                 |
