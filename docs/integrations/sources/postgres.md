...
|---------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.6   | 2026-09-22 | [86921](https://github.com/airbytehq/airbyte/pull/86921) | Fix ClassCastException in CDC when Debezium emits a non-array value for an array column (e.g. unchanged TOASTed enum arrays). |
