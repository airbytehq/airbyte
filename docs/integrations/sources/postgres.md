...
|------------|------------|-----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.0-rc.8 | 2026-04-22 | [PLACEHOLDER_PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PLACEHOLDER_PR_NUMBER) | Improve error message for Postgres replication conflicts on hot standby replicas                                                                                          |
