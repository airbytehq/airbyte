...
|---------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.6   | 2026-09-22 | [PR_PLACEHOLDER](https://github.com/airbytehq/airbyte/pull/PR_PLACEHOLDER) | Fix ClassCastException in CDC when Debezium emits a non-array value for an array column (e.g. unchanged TOASTed enum arrays). |
