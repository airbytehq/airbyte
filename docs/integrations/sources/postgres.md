...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.2  | 2026-06-11 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Surface a config error when the database does not support the replication protocol (e.g. connection pooler). |
