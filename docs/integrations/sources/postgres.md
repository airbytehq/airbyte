...
|-------------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.0-rc.12 | 2026-06-01 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)     | Prevent JVM heap OOM during initial backfill of large catalogs with wide-row tables by capping the JDBC `fetchSize` per-query buffer.                                      |
