...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.2  | 2026-07-01 | [81353](https://github.com/airbytehq/airbyte/pull/81353) | Fix DateTimeParseException when cursor value is date-only format in timestamp columns.                                                                                     |
