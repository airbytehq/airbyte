...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.1-rc.1 | 2026-06-03 | [00000](https://github.com/airbytehq/airbyte/pull/00000) | Restore non-null PostGIS geometry/geography on the CDC path, standardizing both paths on canonical EWKT                                                                |
