...
|---------|------------|------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.7.2   | 2026-02-02 | [70297](https://github.com/airbytehq/airbyte/pull/70297)   | Fix ClassCastException with interval columns having DEFAULT values on PostgreSQL 16.x                                                                                      |
