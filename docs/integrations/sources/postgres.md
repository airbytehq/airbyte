...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.9.0  | 2026-07-27 | [82782](https://github.com/airbytehq/airbyte/pull/82782) | Remove the non-functional `invalid_cdc_cursor_position_behavior` option; invalidated replication slots always fail the sync.                                              |
