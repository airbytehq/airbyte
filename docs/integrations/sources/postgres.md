...
|------------|------------|-----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.0-rc.9 | 2026-05-04 | [77727](https://github.com/airbytehq/airbyte/pull/77727) | Classify "terminating connection due to administrator command" as a transient error so the sync retries instead of failing.                                               |
