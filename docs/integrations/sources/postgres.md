...
|-------------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.0-rc.12 | 2026-05-28 | [78477](https://github.com/airbytehq/airbyte/pull/78477) | Fix ClassCastException in CDC deserialization when array-typed columns arrive as text instead of JSON arrays.                                                               |
