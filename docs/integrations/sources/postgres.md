...
|---------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.6   | 2026-09-04 | [79671](https://github.com/airbytehq/airbyte/pull/79671) | Fix CDC replication slot LSN not advancing: add server-side flush confirmation poll and fall back to `lsn` offset field when `lsn_proc`/`lsn_commit` are absent after snapshot. |
