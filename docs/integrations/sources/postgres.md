...
|--------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.2  | 2026-06-08 | [](https://github.com/airbytehq/airbyte/pull/) | Classify SocketTimeoutException and connection attempt failures as transient errors for automatic retries. |
