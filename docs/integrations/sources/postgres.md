...
2. You may optionally opt to list each of the schemas you want to sync. These are case-sensitive, and multiple schemas may be entered. When not provided, all available schemas are discovered.
</FieldAnchor>
