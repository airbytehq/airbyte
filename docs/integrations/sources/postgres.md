...
|------------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.0-rc.9 | 2026-05-11 | [77706](https://github.com/airbytehq/airbyte/pull/77805) | Prevent table filenode query from running outside max db connections control.                                                                                              |
