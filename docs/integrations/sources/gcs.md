...
5. Paste the service account JSON key to the `Service Account Information` field .
...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------|
| 0.8.0   | 2024-10-25 | [45414](https://github.com/airbytehq/airbyte/pull/45414) | Add support for OAuth authentication                                    |
