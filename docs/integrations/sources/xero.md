...
|:--------|:-----------|:---------------------------------------------------------|:----------------------------------------------------------|
| 2.1.7 | 2026-09-14 | [86352](https://github.com/airbytehq/airbyte/pull/86352) | Use lightweight `organisations` stream for connection check instead of `bank_transactions` (fixes `HighVolumeException` on large tenants) |
