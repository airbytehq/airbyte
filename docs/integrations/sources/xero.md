...
|:--------|:-----------|:---------------------------------------------------------|:----------------------------------------------------------|
| 2.1.7 | 2026-09-14 | [PR_PLACEHOLDER](https://github.com/airbytehq/airbyte/pull/PR_PLACEHOLDER) | Use lightweight `organisations` stream for connection check instead of `bank_transactions` (fixes `HighVolumeException` on large tenants) |
