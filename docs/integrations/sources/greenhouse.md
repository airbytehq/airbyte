...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.3.0 | 2026-09-18 | [PRNUM](https://github.com/airbytehq/airbyte/pull/PRNUM) | Add the `candidate_attribute_types` and `job_notes` streams, completing Harvest v3 parity. Requests two new Harvest v3 scopes during consent |
