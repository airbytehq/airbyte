...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0.8.0 | 2026-08-10 | 0 | Send pagination and incremental filter parameters only on first-page requests, and use fully-qualified per-stream URLs, in preparation for the Harvest v3 migration. |
