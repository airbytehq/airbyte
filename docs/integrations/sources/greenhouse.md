...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.2.0 | 2026-09-17 | [86426](https://github.com/airbytehq/airbyte/pull/86426) | Add the `attachments`, `interviewers`, and `job_hiring_managers` streams, and request the three matching Harvest v3 scopes during consent. Existing connections keep syncing unchanged; enabling a new stream requires re-running the consent flow so the new scopes are granted |
