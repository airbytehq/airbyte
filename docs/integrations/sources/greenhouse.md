...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.1.1 | 2026-09-17 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Clarify the HTTP 403 error message to name Greenhouse, the missing Harvest permission or Site Admin requirement, and the re-authentication remedy |
