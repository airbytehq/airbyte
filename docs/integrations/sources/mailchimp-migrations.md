...
Version 2.0.0 introduces changes in the primary key for the `Segment Members` and `List Members` streams. You must refresh affected schemas and reset data after upgrading.
...
4. Select **Save changes** at the bottom of the page. Ensure the **Reset affected streams** option is checked.

   :::note
   Depending on destination type, you may not be prompted to reset your data.
   :::

5. Select **Save connection**. This will reset the data in your destination and initiate a fresh sync.
