...
|---------|------|--------------|---------|
| 0.0.64 | 2026-09-10 | [85104](https://github.com/airbytehq/airbyte/pull/85104) | Stop pagination when `has_more_items` is false (Eventbrite still returns `continuation` on the last page, which infinite-looped check) |
