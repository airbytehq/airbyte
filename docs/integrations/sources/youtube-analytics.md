...
|:-----------|:-----------|:---------------------------------------------------------|:----------------------------------------------------|
| 1.3.4 | 2026-09-03 | [85335](https://github.com/airbytehq/airbyte/pull/85335) | Restore incremental syncs for report streams: only new daily report files are requested and downloaded instead of re-downloading every retained report on each sync |
