...
|:-----------|:-----------|:---------------------------------------------------------|:----------------------------------------------------|
| 1.3.0 | 2026-07-31 | [83286](https://github.com/airbytehq/airbyte/pull/83286) | Fix setup check failure by validating credentials against the `reportTypes` endpoint instead of a report stream that depends on generated report data |
