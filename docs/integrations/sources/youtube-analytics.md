...
|:-----------|:-----------|:---------------------------------------------------------|:----------------------------------------------------|
| 1.3.4 | 2026-09-01 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Restore incremental filtering on the report parent stream (send startTimeAtOrAfter, apply the record filter, advance the report cursor) so already-synced daily reports are not re-downloaded every sync |
