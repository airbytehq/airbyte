...
|:-----------|:-----------|:---------------------------------------------------------|:----------------------------------------------------|
| 1.3.5 | 2026-09-08 | [85335](https://github.com/airbytehq/airbyte/pull/85335) | Restore incremental syncs for report streams: only new daily report files are requested and downloaded instead of re-downloading every retained report on each sync |
