...
|:-----------|:-----------|:---------------------------------------------------------|:----------------------------------------------------|
| 1.3.3 | 2026-08-21 | [Pending](https://github.com/airbytehq/airbyte/pulls) | Honor `Retry-After`, use exponential backoff for 429s, and report a clearer daily-quota error |
