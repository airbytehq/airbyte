...
|:-----------|:-----------|:---------------------------------------------------------|:----------------------------------------------------|
| 1.2.13 | 2026-07-31 | [PR_NUMBER_PLACEHOLDER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER_PLACEHOLDER) | Fix setup check failure by validating credentials against the `reportTypes` endpoint instead of a report stream that depends on generated report data |
