...
|:-----------|:-----------|:---------------------------------------------------------|:----------------------------------------------------|
| 1.3.4 | 2026-09-01 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Restore incremental filtering of the `report` parent stream: send `startTimeAtOrAfter` and apply the record filter so already-synced daily reports are not re-downloaded every sync |
