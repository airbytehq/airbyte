...
|:-----------|:-----------|:---------------------------------------------------------|:----------------------------------------------------|
| 1.2.12 | 2026-07-28 | [82712](https://github.com/airbytehq/airbyte/pull/82712) | Fix setup check failure by pointing the connection check at the supported `channel_basic_a3` report, and update the `channel_annotations_a1`, `channel_end_screens_a1`, and `channel_sharing_service_a1` streams to request the current `channel_annotations_a2`, `channel_end_screens_a2`, and `channel_sharing_service_a2` reports. Stream names and schemas are unchanged |
