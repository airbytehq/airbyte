...
|:-----------|:-----------|:---------------------------------------------------------|:----------------------------------------------------|
| 1.3.4 | 2026-09-03 | [00000](https://github.com/airbytehq/airbyte/pull/00000) | Restore incremental syncs for report streams: only new daily report files are requested and downloaded instead of re-downloading every retained report on each sync |
