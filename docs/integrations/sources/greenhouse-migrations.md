...
Version 1.0.0 introduces an optional `start_date` configuration value for incremental streams. When it is unset, the connector starts two years before the current date instead of reading all history.
