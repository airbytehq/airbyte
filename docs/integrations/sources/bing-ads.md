...
|:------------|:-----------|:---------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.23.10 | 2026-01-18 | [71845](https://github.com/airbytehq/airbyte/pull/71845) | Fix 400 Bad Request error when using Manual OAuth credentials by removing invalid OAuth parameters from token refresh request |
