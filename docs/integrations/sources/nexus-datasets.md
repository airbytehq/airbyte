...
|---------|------|--------------|---------|
| 0.1.14 | 2026-07-28 | [__PR__](https://github.com/airbytehq/airbyte/pull/__PR__) | Update to CDK 7.23.8 (fixes AirbyteCustomCodeNotPermittedError for bundled custom components) and remove the temporary Cloud version override |
