...
|:-----------|:-----------|:----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.5.2 | 2026-02-19 | [](https://github.com/airbytehq/airbyte/pull/) | Add `linked_item_ids` to `BoardRelationValue` and `DependencyValue` column types to restore linked item data lost after API version 2025-04+ |
