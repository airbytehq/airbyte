...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.3 | 2026-05-22 | [78368](https://github.com/airbytehq/airbyte/pull/78368) | Add per-worker random jitter (`60s ± 15s`) to the `search_analytics_*` rate-limit backoff strategy to de-synchronize concurrent worker wake-ups and reduce peak memory during rate-limit storms. See airbytehq/oncall#12246 for context. |
