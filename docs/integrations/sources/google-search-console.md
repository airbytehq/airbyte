...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.2-rc.1 | 2026-05-18 | [*PR_NUMBER_PLACEHOLDER*](https://github.com/airbytehq/airbyte/pull/*PR_NUMBER_PLACEHOLDER*) | Improve Search Analytics load quota handling. |
| 2.0.1-rc.1 | 2026-05-07 | [78007](https://github.com/airbytehq/airbyte/pull/78007) | Concurrency tuning Phase 1: raise `default_concurrency` from `num_workers`-driven (40/3) to fixed 60 and `max_concurrency` 50 → 100; keep existing 1200 RPM API budget |
