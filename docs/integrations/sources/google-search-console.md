...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.3 | 2026-06-01 | [78545](https://github.com/airbytehq/airbyte/pull/78545) | Adopt CDK `jitter_range_in_seconds` on `ConstantBackoffStrategy` to de-synchronize concurrent worker retries on rate-limit backoff; behavior unchanged (uniform backoff in [45, 75] seconds). |
