...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.3 | 2026-06-01 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Adopt CDK `jitter_range_in_seconds` on `ConstantBackoffStrategy` to de-synchronize concurrent worker retries on rate-limit backoff; behavior unchanged (uniform backoff in [45, 75] seconds). |
