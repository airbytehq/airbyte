...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.3 | 2026-06-01 | [78545](https://github.com/airbytehq/airbyte/pull/78545) | Adopt CDK `jitter_range_in_seconds` on `ConstantBackoffStrategy`; keeps the existing 60 s minimum backoff and adds CDK-native jitter to spread retries across [60, 90] s. |
