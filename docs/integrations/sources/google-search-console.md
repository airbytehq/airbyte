...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.1 | 2026-04-16 | [76409](https://github.com/airbytehq/airbyte/pull/76409) | Drop duplicate unfiltered keyword rows caused by empty/null `searchAppearance` partitions; wrap `dimensionFilterGroups.filters` in an array to match the Google Search Console API spec |
