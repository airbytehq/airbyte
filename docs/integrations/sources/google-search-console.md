...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.10.30 | 2026-04-09 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Remove stale `access_token` from `complete_oauth_output_specification` to fix OAuth source creation via API |
