...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.3 | 2026-05-22 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Add per-worker random jitter (`60s ± 15s`) to the `search_analytics_*` rate-limit backoff strategy to de-synchronize concurrent worker wake-ups and reduce peak memory during rate-limit storms. See airbytehq/oncall#12246 for context. |
