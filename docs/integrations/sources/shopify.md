...
- [Collects](https://shopify.dev/api/admin-rest/2024-04/resources/collect#top) - Returns manually associated products in custom collections only
- [Collection Products (GraphQL)](https://shopify.dev/docs/api/admin-graphql/latest/objects/Collection#field-Collection.fields.products) - Returns all products in each collection, including products matched by smart collection rules
