...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.8 | 2025-07-07 | [62499](https://github.com/airbytehq/airbyte/pull/62499) | Fixed missing data for BULK-supported streams by waiting for `partialDataUrl` and continuing pagination with requests that fail for errorCode=INTERNAL_SERVER_ERROR|
