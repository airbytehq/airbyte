...
|:-----------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.4.0 | 2026-04-16 | [](https://github.com/airbytehq/airbyte/pull/) | Add optional `lookback_window_in_days` config to re-fetch recent records during incremental syncs, preventing missed nested records |
