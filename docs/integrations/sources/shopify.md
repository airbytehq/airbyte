...
|:-----------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.3.1 | 2026-04-21 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Fix OOM in bulk metafield streams by replacing in-memory `sorted()` with an on-disk external merge sort in `sort_output_asc` |
