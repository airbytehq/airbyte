...
|:-----------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.4.0 | 2026-04-16 | [70986](https://github.com/airbytehq/airbyte/pull/70986) | Add optional `lookback_window_in_days` configuration (0-30 days) to re-fetch recent records during incremental syncs, helping capture records missed due to race conditions or late-arriving data |
