...
|:-----------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.5.1 | 2026-06-24 | [80815](https://github.com/airbytehq/airbyte/pull/80815) | Fix shop name validation: restore `http://` spec regex lookahead and harden `get_shop_name()` to strip schemes, paths, and trailing slashes |
