...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.6 | 2025-04-28 | [58677](https://github.com/airbytehq/airbyte/pull/58677) | Fix Shopify app store review. Note existing Shopify OAuth applications will need to append `?redirect_to_index` to their allowed list of redirect urls |
