...
| :------ | :--------- | :------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------ |
| 1.2.0   | 2023-11-09 | [32345](https://github.com/airbytehq/airbyte/pull/32345) | Fixed the issue with `state` causing the `substreams` to skip the records, made `metafield_`: collections, customers, draft_orders, locations, orders, product_images, product_variants, products streams to use `BULK Operations` instead of `REST`|
