...
| :------ | :--------  | :-----       | :------ |
| 0.1.8   | 2021-06-29 | [4416](https://github.com/airbytehq/airbyte/pull/4416) | Changed the cursor_field from `since_id` to `updated_at` for streams using Inremental Refresh |
