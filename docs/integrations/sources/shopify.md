...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.8 | 2025-07-07 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fixed missing data for BULK-supported streams by waiting for `partialDataUrl` and continuing pagination with requests that fail for errorCode=INTERNAL_SERVER_ERROR|
