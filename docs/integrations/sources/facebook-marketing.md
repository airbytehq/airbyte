...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.0.0      | 2026-02-05 | [72779](https://github.com/airbytehq/airbyte/pull/72779) | Custom Insights streams now use level-based primary keys. Users syncing Custom Insights with `level=adset`, `level=campaign`, or `level=account` should refresh schema and reset affected streams.                                                                                                |
