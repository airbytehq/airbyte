...
2. (Optional) For **Start Date**, use the provided datepicker, or enter the date programmatically in the `YYYY-MM-DDTHH:mm:ssZ` format. If the start date is not set, then all data will be replicated except for Insight streams, which default to the last 2 years of data.
...
| 3.4.0      | 2025-03-11 | [50418](https://github.com/airbytehq/airbyte/pull/50418) | Add `learning_stage_info` field to `ad_sets` stream                                                                                                                                                                                                                                               |
