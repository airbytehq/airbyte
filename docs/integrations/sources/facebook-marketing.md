...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.2.0 | 2026-08-20 | [84929](https://github.com/airbytehq/airbyte/pull/84929) | Add hidden `verbatim_custom_insight_stream_names` option that names Custom Insights streams exactly as configured instead of prepending `Custom` and snake-casing the result |
