...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.5 | 2026-04-03 | [74890](https://github.com/airbytehq/airbyte/pull/74890) | Handle FacebookBadObjectError across all streams: insight streams restart the async job (new AdReportRun), non-insight streams retry with exponential backoff. Falls back to transient_error for platform retry. |
