...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.3 | 2026-03-24 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fix `_collect_child_ids`: clamp `since <= until` after retention validation and add retry logic for transient `Job Failed` status |
