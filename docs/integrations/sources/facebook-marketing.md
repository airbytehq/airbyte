...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.7-rc.2 | 2026-04-22 | [*PR_NUMBER_PLACEHOLDER*](https://github.com/airbytehq/airbyte/pull/*PR_NUMBER_PLACEHOLDER*) | Treat empty `_collect_child_ids` results as "no data for this slice" instead of raising `system_error`, so syncs advance past historical intervals with no campaign activity |
