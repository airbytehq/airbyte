...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.1 | 2026-06-24 | [80748](https://github.com/airbytehq/airbyte/pull/80748) | Tolerate transient malformed (non-JSON) batch responses from the Facebook API during async job status polling instead of crashing with `AttributeError`. |
