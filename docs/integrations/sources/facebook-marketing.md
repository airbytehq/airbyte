...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.14 | 2026-06-10 | [<PR#>](https://github.com/airbytehq/airbyte/pull/<PR#>) | Replace the cryptic `system_error` on un-generatable Ads Insights reports with a clear, actionable `config_error` that names the offending field/breakdown and how to resolve it (unselect the field, or disable the incrementality attribution window for geographic breakdowns like dma/region) (oncall #12088). |
