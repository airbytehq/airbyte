...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.1 | 2026-06-24 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Tolerate transient malformed (non-JSON) batch responses from the Facebook API during async job status polling instead of crashing with `AttributeError`. |
