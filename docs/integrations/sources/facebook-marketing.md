...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.15 | 2026-06-11 | [79675](https://github.com/airbytehq/airbyte/pull/79675) | Fixed JSON serialization failures caused by circular references in Facebook SDK export data for ad_sets and other streams. |
