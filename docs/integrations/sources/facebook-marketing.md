...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.1 | 2026-06-23 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Add type guard in `CursorPatch.load_next_page()` to raise a clear transient error when Facebook API returns a non-JSON response instead of crashing with `TypeError`. |
