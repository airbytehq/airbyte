...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.1 | 2026-06-23 | [80747](https://github.com/airbytehq/airbyte/pull/80747) | Add type guard in `CursorPatch.load_next_page()` to raise a clear transient error when Facebook API returns a non-JSON response instead of crashing with `TypeError`. |
