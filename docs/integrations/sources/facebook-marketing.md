...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.15 | 2026-06-15 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Handle TypeError from Facebook SDK v25 when API returns malformed non-dict responses during Insights report splitting |
