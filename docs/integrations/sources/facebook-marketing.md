...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.3 | 2026-03-30 | [74890](https://github.com/airbytehq/airbyte/pull/74890) | Handle FacebookBadObjectError across all streams with in-process retry (exponential backoff, 5 attempts) before falling back to transient_error for platform retry. Note: duplicate records may be emitted within a slice when retry occurs. |
