...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.1 | 2026-06-24 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Fix TypeError crash when Meta Graph API returns malformed string items in response data array |
