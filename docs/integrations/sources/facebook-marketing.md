...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.3.0 | 2026-08-18 | [78542](https://github.com/airbytehq/airbyte/pull/78542) | Add `attribution_spec` field to the `ad_sets` stream (existing connections pick it up after a source schema refresh) |
