...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.1 | 2026-06-24 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Handle `TypeError` from SDK v25 `ObjectParser.parse_single()` when Facebook API returns malformed non-dict responses; retry automatically instead of crashing the sync. |
