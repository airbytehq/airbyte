...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.5 | 2026-04-08 | [*PR_NUMBER_PLACEHOLDER*](https://github.com/airbytehq/airbyte/pull/*PR_NUMBER_PLACEHOLDER*) | Reduce default async job concurrency from 100 to 10 to prevent ad-account-level rate limit exhaustion; add backoff in throttle refresh; improve rate-limit error message |
