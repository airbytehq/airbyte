...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.1 | 2026-06-24 | [80749](https://github.com/airbytehq/airbyte/pull/80749) | Handle `TypeError` from SDK v25 `ObjectParser.parse_single()` when Facebook API returns malformed non-dict responses; retry automatically instead of crashing the sync. |
| 6.0.0 | 2026-06-22 | [80324](https://github.com/airbytehq/airbyte/pull/80324) | Replace deprecated `ads_insights_dma` and `ads_insights_demographics_dma_region` streams with `ads_insights_comscore_market` and `ads_insights_demographics_comscore_market_region` following Meta's DMA → Comscore Market transition. Remove `dma` from Custom Insights breakdowns. |
