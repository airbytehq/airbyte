...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.2.0 | 2026-08-17 | [74292](https://github.com/airbytehq/airbyte/pull/74292) | Add `video_thruplay_watched_actions` field to the base Ads Insights schema - available in all Ads Insights streams (existing connections pick it up after a source schema refresh) |
