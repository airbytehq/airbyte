...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.12 | 2026-04-30 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Fix breakdown fields being incorrectly included in API fields parameter during job field-splitting, causing errors on breakdown streams like AdsInsightsDma |
