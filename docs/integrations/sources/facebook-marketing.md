...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.3 | 2026-03-30 | [74890](https://github.com/airbytehq/airbyte/pull/74890) | Handle FacebookBadObjectError in base stream read_records with in-process retry to prevent transient crashes from inconsistent API responses |
