...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.13 | 2026-05-28 | [78490](https://github.com/airbytehq/airbyte/pull/78490) | Fix `_split_by_fields_parent` propagating breakdown columns into `fields` (causing Meta API v23+ to reject the request with error 100). See #78488. |
