...
| :------ | :--------- | :------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------- |
| 0.3.1 | 2026-09-21 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Map bundle editions (e.g. Zoho One, CRM Plus) to the contained CRM edition when detecting the concurrency limit |
