...
| :------ | :--------- | :------------------------------------------------------- | :-------------------------------- |
| 0.3.59 | 2026-08-28 | [85110](https://github.com/airbytehq/airbyte/pull/85110) | Sync folderless lists via `GET /space/{id}/list` and include them as task parents (stock `list` only walked folder-parented lists) |
