...
|:--------|:-----------|:---------------------------------------------------------|:--------------------------------------------|
| 0.3.12 | 2026-02-27 | [74086](https://github.com/airbytehq/airbyte/pull/74086) | Add missing fields (test, metadata, archived, company) to Transactions stream schema; fix product_key type from object to string |
