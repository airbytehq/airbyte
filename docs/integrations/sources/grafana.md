...
|------------------|-------------------|--------------|----------------|
| 0.0.11 | 2026-06-12 | [79694](https://github.com/airbytehq/airbyte/pull/79694) | Add missing `withCredentials`, `secureJsonFields`, and `version` fields to datasources stream schema |
