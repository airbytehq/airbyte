...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------|
| 1.7.0 | 2026-04-21 | [76838](https://github.com/airbytehq/airbyte/pull/76838) | Add incremental sync support for `tasks` stream using `modified_at` cursor; enable `incremental_dependency` on child streams (`stories_compact`, `stories`, `attachments_compact`, `attachments`) |
