...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------|
| 1.5.2 | 2026-04-06 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Extract actual Asana API error message for HTTP 400 responses instead of generic CDK message |
