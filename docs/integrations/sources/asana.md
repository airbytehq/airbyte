...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------|
| 1.6.0 | 2026-04-21 | [76838](https://github.com/airbytehq/airbyte/pull/76838) | Add incremental sync support for `tasks` stream using `modified_at` cursor; bump `airbyte-cdk` from `^6` to `^7.13.0` (promotes 1.6.0-rc.1 from [76390](https://github.com/airbytehq/airbyte/pull/76390)) |
