...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------|
| 1.5.0 | 2025-05-02 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Adds `portfolio_items` stream to sync items (such as projects and portfolios) in each portfolio ([API reference](https://developers.asana.com/reference/getitemsforportfolio)) |
