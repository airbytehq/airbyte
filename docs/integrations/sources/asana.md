...
- If you encounter access errors while using OAuth, make sure your Asana OAuth app is available in the authorizing workspace and is configured with **Full permissions**. For more information, see Asana's [OAuth documentation](https://developers.asana.com/docs/oauth).
...
| :--- | :--- | :--- | :--- |
| 1.7.2 | 2026-05-19 | [*PR_NUMBER_PLACEHOLDER*](https://github.com/airbytehq/airbyte/pull/*PR_NUMBER_PLACEHOLDER*) | Improve Asana task query limit error messages. |
