...
| :--- | :--- | :--- | :--- |
| 1.7.3 | 2026-06-10 | [79641](https://github.com/airbytehq/airbyte/pull/79641) | Fetch tasks by section instead of by project to avoid Asana API result-set limit on large projects |
