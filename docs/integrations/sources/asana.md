...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------------------------------|
| 1.6.0 | 2026-04-21 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Add incremental sync support for `tasks` stream using `modified_at` cursor; enable `incremental_dependency` on child streams (`stories_compact`, `stories`, `attachments_compact`, `attachments`) |
