...
| :--- | :--- | :--- | :--- |
| 1.7.3 | 2026-06-10 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Fetch tasks by section instead of by project to avoid Asana API result-set limit on large projects |
