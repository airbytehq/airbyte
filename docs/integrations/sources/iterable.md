...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.0.1 | 2026-09-14 | [85908](https://github.com/airbytehq/airbyte/pull/85908) | Paginate the `campaigns` stream using the Iterable API's page and pageSize parameters. |
