...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.0.1 | 2026-09-14 | devin/1789356307-source-iterable-campaigns-pagination | Paginate the `campaigns` stream using the Iterable API's page and pageSize parameters. |
