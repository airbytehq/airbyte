...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0.6.55 | 2026-03-09 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Add configurable end-time buffer to prevent silent data loss from Iterable Export API eventual consistency |
