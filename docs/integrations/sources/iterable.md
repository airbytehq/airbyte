...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.0.0 | 2026-06-10 | [](https://github.com/airbytehq/airbyte/pull/) | 🚨 Breaking: Restructure `users` stream schema — custom fields moved to `data` object, `itblInternal` flattened to dotted keys, removed `format: date-time` from non-RFC3339 date fields, added `itblUserId` |
