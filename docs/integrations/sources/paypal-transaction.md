...
| :------ | :--------- | :------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------- |
| 2.6.46 | 2026-08-26 | [76626](https://github.com/airbytehq/airbyte/pull/76626) | Clamp `list_disputes` incremental start to PayPal's 180-day window to avoid `INVALID_DATE_RANGE` |
