...
|:--------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------|
| 0.10.0 | 2025-04-30 | [57507](https://github.com/airbytehq/airbyte/pull/57507) | Adapt file-transfer records to latest protocol, requires platform >= 1.7.0, destination-s3 >= X.X.X |
