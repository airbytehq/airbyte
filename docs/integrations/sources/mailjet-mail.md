...
This source can sync data from the [Mailjet Mail API](https://dev.mailjet.com/email/guides/). At
...
[here](https://dev.mailjet.com/email/reference/overview/rate-limits/)
