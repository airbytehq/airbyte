...
|------------------|-------------------|--------------|----------------|
| 0.0.63 | 2026-08-28 | [85103](https://github.com/airbytehq/airbyte/pull/85103) | Update retired 2026-05-01 list routes to current v3/v4 APIs, extract `data`, stop empty paging, fix work_times dates, ignore 410 on surcharges |
