...
|:--------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.3 | 2026-09-01 | [85217](https://github.com/airbytehq/airbyte/pull/85217) | Add a one-hour lookback window to the `global_exclusions` cursor so profiles updated at the exact stored cursor value or re-ordered mid-pagination are not skipped by the strict `greater-than` filter. |
| 3.0.2 | 2026-08-31 | [85217](https://github.com/airbytehq/airbyte/pull/85217) | Send the `global_exclusions` cursor filter to Klaviyo so incremental syncs no longer re-page all profiles; a first/stateless sync still returns the full suppression list. |
