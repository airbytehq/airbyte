...
|:---------|:-----------| :--------------------------------------------------------- |:------------------------------------------------------------------------------------------------------------------------|
| `2.0.0`  | 2023-10-25 | [31815](https://github.com/airbytehq/airbyte/pull/31815)   | Make streams `email_templates`, `lists`, `campaigns`, and `metrics` incremental. Change cursor field for stream `flows` |
