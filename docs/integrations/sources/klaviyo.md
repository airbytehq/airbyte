...
|:--------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.17.7 | 2026-04-24 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Fix sync failure when conversion metrics do not support values data queries in flow_series_reports and campaign_values_reports streams |
