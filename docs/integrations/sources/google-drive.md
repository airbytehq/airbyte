...
|---------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------|
| 0.5.28 | 2026-08-06 | [83755](https://github.com/airbytehq/airbyte/pull/83755) | Bump CDK to throttle per-slice state emission, bounding state volume on large syncs |
