...
|---------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------|
| 0.5.13 | 2026-03-26 | [](https://github.com/airbytehq/airbyte/pull/) | Added native Google Docs Markdown export support via new `google_doc_export_format` config option |
