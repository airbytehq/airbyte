...
|---------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------|
| 0.5.12 | 2026-03-09 | [74388](https://github.com/airbytehq/airbyte/pull/74388) | Fix OOM during CHECK by using disk-backed temp files instead of in-memory BytesIO |
