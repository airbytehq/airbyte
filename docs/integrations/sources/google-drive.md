...
|---------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------|
| 0.4.0 | 2025-04-30 | [57496](https://github.com/airbytehq/airbyte/pull/57496) | Adapt file-transfer records to latest protocol, requires platform >= 1.7.0, destination-s3 >= X.X.X |
