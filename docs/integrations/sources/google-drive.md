...
Google documents, spreadsheets, presentations and drawings are supported as well - Google documents are exported as Docx files while spreadsheets, presentations and drawings are exported as PDF files.
