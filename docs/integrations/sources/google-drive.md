...
|---------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------|
| 0.5.21 | 2026-06-12 | [79696](https://github.com/airbytehq/airbyte/pull/79696) | Deduplicate files by URI to prevent 'No such file or directory' errors in file transfer mode when multiple files share the same name |
