...
|---------|------------|----------------------------------------------------------|----------------------------------------------------------------------------------------------|
| 0.5.29 | 2026-08-11 | [79696](https://github.com/airbytehq/airbyte/pull/79696) | Deduplicate files by URI to prevent 'No such file or directory' errors in file transfer mode when multiple files share the same name |
