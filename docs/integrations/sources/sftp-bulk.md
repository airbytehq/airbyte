...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------|
| 1.9.3 | 2026-06-22 | [](https://github.com/airbytehq/airbyte/pull/) | Enable SSH keepalive on SFTP transport to prevent connection drops during large file transfers |
