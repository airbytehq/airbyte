...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------|
| 1.9.3 | 2026-08-06 | [83753](https://github.com/airbytehq/airbyte/pull/83753) | Bump CDK to throttle per-slice state emission, bounding state volume on large syncs |
