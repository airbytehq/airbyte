...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------|
| 1.9.3 | 2026-08-06 | [PRNUM](https://github.com/airbytehq/airbyte/pull/PRNUM) | Bump CDK to throttle per-slice state emission, bounding state volume on large syncs |
