...
|:--------|:-----------|:---------------------------------------------------------|:------------------------------------------------------------|
| 1.9.3 | 2026-06-22 | [80339](https://github.com/airbytehq/airbyte/pull/80339) | Enable SSH keepalive on SFTP transport to prevent connection drops during large file transfers |
