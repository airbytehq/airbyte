...
|:------------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.3.3 | 2026-09-16 | [79652](https://github.com/airbytehq/airbyte/pull/79652) | Validate and normalize `account_id` config: add `pattern` constraint (digits only) and `.strip()` whitespace in all path templates to prevent malformed URLs |
