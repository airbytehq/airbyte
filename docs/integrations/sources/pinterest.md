...
|:------------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.28-rc.1 | 2026-04-23 | [*PR_NUMBER_PLACEHOLDER*](https://github.com/airbytehq/airbyte/pull/*PR_NUMBER_PLACEHOLDER*) | Concurrency tuning (Path A): bump `default_concurrency` default to 4 (via `num_threads` fallback) and comment out HTTPAPIBudget to enable empirical tuning. No user-visible spec changes. |
