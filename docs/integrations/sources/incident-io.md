...
|---------|------|--------------|---------|
| 0.1.39 | 2026-09-14 | [85915](https://github.com/airbytehq/airbyte/pull/85915) | Migrate `actions` and `follow-ups` streams from deprecated `/v2` to paginated `/v3` endpoints |
