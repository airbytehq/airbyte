...
|---------|------|--------------|---------|
| 0.1.39 | 2026-09-14 | [PR_PLACEHOLDER](https://github.com/airbytehq/airbyte/pull/PR_PLACEHOLDER) | Migrate `actions` and `follow-ups` streams from deprecated `/v2` to paginated `/v3` endpoints |
