...
|---------|------|--------------|---------|
| 0.1.40 | 2026-09-14 | [85916](https://github.com/airbytehq/airbyte/pull/85916) | Migrate `actions` and `follow-ups` streams to the paginated `/v3` endpoints ahead of the `/v2` deprecation |
