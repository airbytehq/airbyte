...
The New York Times connector should not run into limitations under normal usage. Please
...
1. Create a new App [here](https://developer.nytimes.com/my-apps/new-app) (You need to have an
   account to create a new App).
