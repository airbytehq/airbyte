...
|------------------|-------------------|--------------|----------------|
| 0.0.48 | 2026-02-15 | [73350](https://github.com/airbytehq/airbyte/pull/73350) | Use profile stream for connection check to avoid rate limiting on messages endpoint |
