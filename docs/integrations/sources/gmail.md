...
|------------------|-------------------|--------------|----------------|
| 0.1.15 | 2026-09-09 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Fix config migration copying empty or incomplete legacy OAuth fields into nested `credentials` |
