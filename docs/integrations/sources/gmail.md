...
|------------------|-------------------|--------------|----------------|
| 0.1.15 | 2026-09-09 | [85800](https://github.com/airbytehq/airbyte/pull/85800) | Fix config migration copying empty or incomplete legacy OAuth fields into nested `credentials` |
