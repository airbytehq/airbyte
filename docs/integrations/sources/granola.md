...
| :------ | :--- | :----------- | :------ |
| 0.2.12 | 2026-08-12 | [PR-pending](https://github.com/airbytehq/airbyte/pull/PR-pending) | Retry rate-limited and server-error responses with backoff honoring Retry-After |
