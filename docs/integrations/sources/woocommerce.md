...
|:--------| :--------- |:---------------------------------------------------------|:-----------------------------------------------------------------------|
| 0.5.49 | 2026-08-25 | [84999](https://github.com/airbytehq/airbyte/pull/84999) | Skip product attributes whose WooCommerce taxonomy no longer exists instead of failing the sync |
