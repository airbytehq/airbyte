...
1. Go to https://airtable.com/create/tokens to create new token.
   ![Generate new Token](/platform/.gitbook/assets/source/airtable/generate_new_token.png)
2. Add following scopes:
   ...
   ![Add Scopes](/platform/.gitbook/assets/source/airtable/add_scopes.png)

3. Select required bases or allow access to all available and press the `Create Token` button.
   ![Add Bases](/platform/.gitbook/assets/source/airtable/add_bases.png)
