...
|:-----------|:-----------|:---------------------------------------------------------|:----------------------------------------------------------------------------------------|
| 4.6.29 | 2026-06-17 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fix ValueError for multipleLookupValues, lookup, and rollup fields with uncovered result types |
