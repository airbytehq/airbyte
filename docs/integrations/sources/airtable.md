...
|:-----------|:-----------|:---------------------------------------------------------|:----------------------------------------------------------------------------------------|
| 4.6.39 | 2026-09-09 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Exclude bases with a missing, null, or empty `permissionLevel` from the `bases` stream |
