...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.2.6 | 2026-04-30 | [](https://github.com/airbytehq/airbyte/pull/) | Improve error handling for Slack API ok=false responses: add catch-all for unrecognized errors, expand error code coverage, and filter channel_join/channel_leave from threads parent stream |
