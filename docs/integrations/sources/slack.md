...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.2.4 | 2026-04-28 | [77078](https://github.com/airbytehq/airbyte/pull/77078) | Fix rate-limit response filters to use RATE_LIMITED action and reorder HTTP status code filters above ok=false catch-all |
