...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.1.15 | 2026-03-30 | [75572](https://github.com/airbytehq/airbyte/pull/75572) | Fix rate limiting: map HTTP 429 to RATE_LIMITED instead of RETRY, remove broken MessagesAndThreadsApiBudget throttle |
