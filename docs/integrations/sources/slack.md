...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.2.23 | 2026-09-09 | [85798](https://github.com/airbytehq/airbyte/pull/85798) | Stop syncing messages and threads from channels the bot has not joined when `join_channels` is not set |
