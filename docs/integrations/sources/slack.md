...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.2.22 | 2026-09-03 | [85051](https://github.com/airbytehq/airbyte/pull/85051) | Fix `threads` stream re-syncing from `start_date` when the global cursor state format is active |
