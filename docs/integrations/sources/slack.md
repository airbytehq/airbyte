...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.1.22 | 2026-04-24 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Allow OAuth API budget to recover after transient 429 rate limits instead of permanently throttling the sync |
