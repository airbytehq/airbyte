...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.1.22 | 2026-04-24 | [](https://github.com/airbytehq/airbyte/pull/) | Remove unused OAuth scopes (`im:history`, `mpim:history`, `im:read`, `mpim:read`) that are not exercised by any stream |
