...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.1.15 | 2026-03-31 | [](https://github.com/airbytehq/airbyte/pull/) | Skip conversations.replies API calls for messages with no replies, reducing unnecessary API usage |
