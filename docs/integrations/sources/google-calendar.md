...
|------------------|-------------------|--------------|----------------|
| 0.3.0 | 2026-09-18 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Add `acl` and `freebusy` streams, partition `events`/`acl`/`freebusy` over all calendars, make `calendarid` optional |
