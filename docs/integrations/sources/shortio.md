...
| :------ | :--------- | :------------------------------------------------------- | :------------------------------------------------ |
| 0.3.59 | 2026-07-22 | [PRNUM](https://github.com/airbytehq/airbyte/pull/PRNUM) | Migrate `clicks` stream to the `statistics.short.io` `last_clicks` endpoint (old `api-v2.short.cm` host decommissioned) and fix its pagination |
