...
|------------------|-------------------|--------------|----------------|
| 0.0.5 | 2026-04-29 | [77519](https://github.com/airbytehq/airbyte/pull/77519) | Expand `ad_spend_daily` with 13 new metrics, 5 new dimensions, ad-level primary key (`AdsetId`, `AdId`); fix `AdvertiserCost` type to number |
