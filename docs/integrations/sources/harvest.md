...
|:--------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.2.15 | 2025-05-05 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fix missing Schema for: `time_team`, `users`, `time_entries`, `company`, & `project_assignments` streams. |
