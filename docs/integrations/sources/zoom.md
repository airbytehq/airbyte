...
| :------ | :--------- | :------------------------------------------------------- | :--------------------------------------------------- |
| 1.2.65 | 2026-09-25 | [PR](https://github.com/airbytehq/airbyte/pull/PR) | Skip Zoom per-resource errors (code 3161 unlicensed users, code 3001 deleted meetings/webinars) instead of failing the sync, and double URL-encode webinar UUIDs in report and past-webinar paths |
