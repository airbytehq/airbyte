...
| :------ | :--------- | :------------------------------------------------------- | :--------------------------------------------------- |
| 1.4.0 | 2026-07-26 | [PRNUMBER](https://github.com/airbytehq/airbyte/pull/PRNUMBER) | Add incremental sync support to meetings, meeting_registrants, meeting_polls, meeting_poll_results, meeting_registration_questions, report_meetings, and report_meeting_participants (creation-time cursors with a 30-day lookback) |
