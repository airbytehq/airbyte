...
| :------ | :--------- | :------------------------------------------------------- | :--------------------------------------------------- |
| 1.2.60 | 2026-07-30 | [83XXX](https://github.com/airbytehq/airbyte/pull/83XXX) | Parallelize per-meeting and substream requests with a configurable worker count and request-rate budget |
