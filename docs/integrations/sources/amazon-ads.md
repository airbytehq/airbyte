...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 7.3.16 | 2026-03-26 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fix reportDate deduplication in daily report streams by using the actual date from API response |
