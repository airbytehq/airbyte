...
9. (Optional) For **State Filter**, you may enter one or more "states" to filter the data for the Sponsored Display, Product, and Brand Campaign streams. The options are:
