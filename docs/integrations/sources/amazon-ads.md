...
|:-----------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 8.0.2 | 2026-05-01 | [](https://github.com/airbytehq/airbyte/pull/) | Handle HTTP 403 "not authorized to use Amazon Attribution" errors on attribution report performance streams by ignoring unauthorized profiles instead of failing the sync |
