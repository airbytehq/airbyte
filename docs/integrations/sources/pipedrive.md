...
For more information, access [enabling API for company users](https://pipedrive.readme.../enabling-api-for-company-users).
...
See [How to find the API Token](https://pipedrive.readme.../how-to-find-the-api-token) for detailed information.

### Via OAuth

Step 1 - Register a Pipedrive app:

Pipedrive allows integrations with its API through **registered apps**. So, to authenticate Airbyte, first you need to create a Pipedrive private app in the marketplace. Follow these [instructions](https://pipedrive.readme.../marketplace-registering-the-app) to register your integration.

Step 2 - Follow the Oauth Authorization flow:

With the registered app, you can follow the authorization flow to obtain the `client_id`, `client_secret`, and `refresh_token` secrets. Pipedrive has documentation about it: https://pipedrive.readme.../marketplace-oauth-authorization.
...
- [Activities](https://developers.pipedrive.c../api/v1/Activities#getActivities)

- [ActivityFields](https://developers.pipedrive.c../api/v1/ActivityFields#getActivityFields)

- [ActivityTypes](https://developers.pipedrive.c../api/v1/ActivityTypes#getActivityTypes)

- [Currencies](https://developers.pipedrive.c../api/v1/Currencies#getCurrencies)

- [DealFields](https://developers.pipedrive.c../api/v1/DealFields#getDealFields)

- [DealProducts](https://developers.pipedrive.c../api/v1/Deals#getDealProducts)

- [Deals](https://developers.pipedrive.c../api/v1/Deals#getDeals)

- [Files](https://developers.pipedrive.c../api/v1/Files#getFiles)

- [Filters](https://developers.pipedrive.c../api/v1/Filters#getFilters)

- [Goals](https://developers.pipedrive.c../api/v1/Goals#getGoals)

- [LeadLabels](https://developers.pipedrive.c../api/v1/LeadLabels#getLeadLabels)

- [Leads](https://developers.pipedrive.c../api/v1/Leads#getLeads)

- [Notes](https://developers.pipedrive.c../api/v1/Notes#getNotes)

- [OrganizationFields](https://developers.pipedrive.c../api/v1/OrganizationFields#getOrganizationFields)

- [Organizations](https://developers.pipedrive.c../api/v1/Organizations#getOrganizations)

- [PermissionSets](https://developers.pipedrive.c../api/v1/PermissionSets#getPermissionSets)

- [PersonFields](https://developers.pipedrive.c../api/v1/PersonFields#getPersonFields)

- [Persons](https://developers.pipedrive.c../api/v1/Persons#getPersons)

- [Pipelines](https://developers.pipedrive.c../api/v1/Pipelines#getPipelines)

- [ProductFields](https://developers.pipedrive.c../api/v1/ProductFields#getProductFields)

- [Products](https://developers.pipedrive.c../api/v1/Products#getProducts)

- [Roles](https://developers.pipedrive.c../api/v1/Roles#getRoles)

- [Stages](https://developers.pipedrive.c../api/v1/Stages#getStages)

- [Users](https://developers.pipedrive.c../api/v1/Users#getUsers)

## Performance considerations

The Pipedrive connector will gracefully handle rate limits. For more information, see [the Pipedrive docs for rate limitations](https://pipedrive.readme.../core-api-concepts-rate-limiting).
