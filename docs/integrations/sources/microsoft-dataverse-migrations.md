...
Starting with version 0.2.0, DateOnly fields are correctly mapped to `format: "date"`. This is a schema type change that requires affected streams to be reset.

### Steps to upgrade

1. Upgrade the connector to version 0.2.0.
