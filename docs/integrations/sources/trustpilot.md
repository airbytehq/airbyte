...
| :------ | :--------- | :------------------------------------------------------- | :-------------- |
| 0.4.13 | 2026-04-22 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Surface Trustpilot 400/401/403/404 responses as `config_error` instead of silently returning zero records |
