...
|:--------|:-----------|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.1 | 2026-05-21 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Avoid requesting the `live_videos` Page field by default and improve the Facebook app approval error. |
