...
|:--------|:-----------|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.1 | 2026-05-13 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Improved handling of Facebook API HTTP 400 errors so the upstream error message is shown without retries |
