...
|:--------|:-----------|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.2.0 | 2026-09-18 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | `post_insights` now retries a page Facebook rejected as too large at a smaller page size instead of failing the sync |
