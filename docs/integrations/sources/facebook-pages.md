...
|:--------|:-----------|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.2 | 2026-06-23 | [PRNUM](https://github.com/airbytehq/airbyte/pull/PRNUM) | Replace Page/Post Insights metrics deprecated by Meta (Nov 2025 & Jun 2026) with their `media_view` / `follows` replacements so the insights streams stop returning `(#100) The value must be a valid insights metric`. |
