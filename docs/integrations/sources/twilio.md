...
| :------ | :--- | :----------- | :------ |
| 1.0.6 | 2026-06-23 | [80330](https://github.com/airbytehq/airbyte/pull/80330) | Add `Status` filter to `conferences` and `conference_participants` streams to retrieve both completed and in-progress conferences after Twilio's July 2026 API default change |
