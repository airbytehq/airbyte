...
| :------ | :--- | :----------- | :------ |
| 1.0.7 | 2026-07-02 | [80330](https://github.com/airbytehq/airbyte/pull/80330) | Add `Status` filter to `conferences` and `conference_participants` streams to retrieve both completed and in-progress conferences after Twilio's July 2026 API default change |
