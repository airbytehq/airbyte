...
| :--- | :--- | :--- | :--- |
| 0.1.5 | 2022-05-17 | [12555](https://github.com/airbytehq/airbyte/pull/12555) | Add page size and lookback window parameters to fetch messages with a rolling window and catch status updates |
