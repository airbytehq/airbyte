...
|------------------|-------------------|--------------|----------------|
| 0.0.60 | 2026-08-28 | [85109](https://github.com/airbytehq/airbyte/pull/85109) | Point `attribute_classes` and `identified_peoples` at current Cloud paths (`/management/contact-attribute-keys`, `/management/contacts`); old `/attribute-classes` and `/people` 404 |
...
| 0.0.53 | 2026-06-30 | [80993](https://github.com/airbytehq/airbyte/pull/80993) | Update dependencies |
