...
|------------------|-------------------|--------------|----------------|
| 0.0.61 | 2026-09-10 | [85109](https://github.com/airbytehq/airbyte/pull/85109) | Point `attribute_classes` and `identified_peoples` at current Cloud paths (`/management/contact-attribute-keys`, `/management/contacts`); old `/attribute-classes` and `/people` 404 |
