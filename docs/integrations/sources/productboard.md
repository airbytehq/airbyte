...
|---------|------------|----------------------------------------------------------|-------------------------------------------------------------------------------------------|
| 0.0.60 | 2026-06-19 | [80288](https://github.com/airbytehq/airbyte/pull/80288) | Fix notes stream cursor not advancing due to cursor_granularity/datetime_format precision mismatch |
