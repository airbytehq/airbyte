...
|---------|------------|----------------------------------------------------------|-------------------------------------------------------------------------------------------|
| 0.0.60 | 2026-06-19 | [](https://github.com/airbytehq/airbyte/pull/) | Fix stuck incremental cursor on `notes` stream by aligning cursor_granularity (P1D) with day-precision datetime_format |
