...
|---------|------------|----------------------------------------------------------|-------------------------------------------------------------------------------------------|
| 0.0.60 | 2026-06-19 | [](https://github.com/airbytehq/airbyte/pull/) | Fix notes stream cursor not advancing due to cursor_granularity/datetime_format precision mismatch |
