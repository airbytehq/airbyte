...
This source can sync data for the [Lever API](https://hire.lever.co/developer/documentation#introduction).
...
The Lever connector should not run into Lever API limitations under normal usage. Please [create an issue](https://github.com/airbytehq/airbyte/issues) if you see any rate limit issues that are not automatically retried successfully.
