...
* (Required for Airbyte Cloud; Optional for Airbyte Open Source) A Service Account Key to authenticate into your Service Account
...
* **Credentials JSON \[Optional\]**: the contents of your Service Account Key JSON file. Default credentials will be used if this field is left empty.
...
|:--------|:-----------| :--- |:------------------------------------------------------------------------------------------------------------------------------------------|
| 0.2.4   | 2023-02-10 | [22802](https://github.com/airbytehq/airbyte/pull/22802) | Support Application Default Credentials        |
