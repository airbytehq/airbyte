...
| :------ | :--------- | :------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------- |
| 0.4.6 | 2026-08-25 | [85025](https://github.com/airbytehq/airbyte/pull/85025) | Report BigQuery "Response too large to return" failures as a clear, non-retryable configuration error naming the affected table. |
