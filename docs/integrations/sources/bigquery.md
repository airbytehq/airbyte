...
| :------ | :--------- | :------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------- |
| 0.4.6 | 2026-08-25 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Paginate query results to avoid "Response too large to return" failures on large tables. |
