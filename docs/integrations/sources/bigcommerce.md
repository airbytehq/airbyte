...
- [ProductVariants](https://developer.bigcommerce.com/api-reference/02db3ddfc6be7-get-all-product-variants)
...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------|
| 0.1.10  | 2022-12-22 | [20540](https://github.com/airbytehq/airbyte/pull/20540) | Add order_shipping_addresses and product_variants stream             |
