...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.2.0 | 2026-05-01 | [77687](https://github.com/airbytehq/airbyte/pull/77687) | Classify GraphQL errors by type instead of blanket-retrying; NOT_FOUND skips the slice, FORBIDDEN/INSUFFICIENT_SCOPES/MAX_NODE_LIMIT_EXCEEDED fail fast with actionable messages |
