...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.25 | 2026-05-01 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Raise transient error instead of silently completing when GitHub API returns 502 Bad Gateway after retries are exhausted |
