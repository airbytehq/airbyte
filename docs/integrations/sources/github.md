...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.2.3 | 2026-08-28 | [82725](https://github.com/airbytehq/airbyte/pull/82725) | Actually apply the reduced GraphQL page size after an HTTP 502/504 by rebuilding the request body; the reduced page size now stays in effect for the rest of the sync instead of springing back to the default, and 502/504 logs name the owner and repository |
