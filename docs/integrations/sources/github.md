...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.0.0 | 2025-12-02 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | **Breaking Change**: Changes primary key for `workflow_runs` stream from `[id]` to `[id, run_attempt]` to preserve all workflow run attempts. |
