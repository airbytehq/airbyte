...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.2.0 | 2026-05-01 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Classify GraphQL errors by type instead of blanket-retrying; NOT_FOUND skips the slice, FORBIDDEN/INSUFFICIENT_SCOPES/MAX_NODE_LIMIT_EXCEEDED fail fast with actionable messages |
