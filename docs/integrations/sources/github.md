...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.26 | 2026-05-01 | [77688](https://github.com/airbytehq/airbyte/pull/77688) | Replace placeholder and raw-passthrough error messages with actionable text. Errors now include status code, affected resource, likely cause, and remediation steps. |
| 2.1.25 | 2026-05-01 | [77655](https://github.com/airbytehq/airbyte/pull/77655) | Fix error handling: correct copy-paste error messages for 401/404/409/410, add 422 handler, improve rate limit and gateway timeout messages |
