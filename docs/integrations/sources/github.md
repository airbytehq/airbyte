...
| 2.7.2 | 2026-09-23 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Replace the custom `NestedGraphQLRecordExtractor` and `DeepNestedGraphQLRecordExtractor` of `reviews`, `issue_reactions` and `pull_request_comment_reactions` with the CDK `CombinedExtractor`, `RecordExpander`, `AddFields` and `RemoveFields`. Records are unchanged |
