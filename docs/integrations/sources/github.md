...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.25 | 2026-05-01 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | 502 Bad Gateway after exhausting retries now raises a transient error instead of silently returning empty records |
