...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.26 | 2026-05-01 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Replace placeholder and raw-passthrough error messages with actionable text. Errors now include status code, affected resource, likely cause, and remediation steps. |
