...
| :--- | :--- | :--- | :--- |
| 0.2.11 | 2021-01-?? | [????](https://github.com/airbytehq/airbyte/pull/????) | Remove optional parameter `Accept` for reaction`s streams to fix error with 502 HTTP status code in response |
