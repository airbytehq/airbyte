...
| :----------- | :----------- | :------------------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.7.3 | 2026-09-23 | [86932](https://github.com/airbytehq/airbyte/pull/86932) | `reviews`, `issue_reactions` and `pull_request_comment_reactions` copy the one parent field they need with the CDK `RecordExpander` `parent_fields`, instead of deep-copying the whole parent onto every record and removing it again. Records are unchanged |
| 2.7.2 | 2026-09-23 | [86930](https://github.com/airbytehq/airbyte/pull/86930) | Replace the custom `NestedGraphQLRecordExtractor` and `DeepNestedGraphQLRecordExtractor` of `reviews`, `issue_reactions` and `pull_request_comment_reactions` with the CDK `CombinedExtractor`, `RecordExpander`, `AddFields` and `RemoveFields`. Records are unchanged |
