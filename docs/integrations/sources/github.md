...
| :----------- | :----------- | :------------------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.7.1 | 2026-09-21 | [86497](https://github.com/airbytehq/airbyte/pull/86497) | Finalize manifest-only migration: the connector is now manifest-only (`source-declarative-manifest` base image); `check` runs through `CheckStream` on `branches` and the legacy `repository`/`branch` config migrations run from the manifest spec. |
