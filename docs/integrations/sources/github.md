...
| :----------- | :----------- | :------------------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.4.1 | 2026-09-11 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Stop `issue_timeline_events` from emitting a cumulative state message per issue, which exhausted destination memory on large repositories |
