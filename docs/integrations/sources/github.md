...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.0.0      | 2025-10-14 | [68095](https://github.com/airbytehq/airbyte/pull/68095)                                                          | **Breaking Change**: Normalize reaction field names for Avro/Parquet compatibility. The `+1` and `-1` reaction fields have been renamed to `plus_one` and `minus_one` in streams containing reactions (comments, commit_comments, issue_events, issues, releases, review_comments). Users should refresh their source schema and reset affected streams after upgrading. |
