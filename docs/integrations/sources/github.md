...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.27 | 2026-05-03 | [77656](https://github.com/airbytehq/airbyte/pull/77656) | Fix empty repository handling: treat all HTTP 409 responses as empty repo conditions instead of only matching exact body text, preventing retry exhaustion on 8+ streams |
