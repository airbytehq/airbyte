...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.28 | 2026-05-03 | [77680](https://github.com/airbytehq/airbyte/pull/77680) | Raise transient error instead of silently completing when GitHub API returns 502 Bad Gateway after retries are exhausted |
