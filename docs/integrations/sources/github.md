...
| :----------- | :----------- | :------------------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.7.1 | 2026-09-21 | [86497](https://github.com/airbytehq/airbyte/pull/86497) | Finalize manifest-only migration: drop the hybrid `read`/`discover`/`streams` plumbing from `SourceGithub`; config normalization and validation move into the manifest spec. |
