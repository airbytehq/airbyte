...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.25 | 2026-05-01 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Validate branches config and raise config_error when all configured branches are invalid instead of producing a KeyError |
