...
| :----------- | :----------- | :------------------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.5.0 | 2026-09-11 | [TODO: fill in once this PR is opened](https://github.com/airbytehq/airbyte/pull/TODO) | Add GitHub App authentication support, with multiple installations rotating for extra rate-limit headroom |
