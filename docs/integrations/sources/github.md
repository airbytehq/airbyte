...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.28 | 2026-05-07 | [77756](https://github.com/airbytehq/airbyte/pull/77756) | Make GraphQL stream `parse_response` and `next_page_token` defensive against non-JSON / malformed responses (mirrors the REST `_safe_json_list` precedent) |
