...
|:-----------|:-----------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.1.25 | 2026-05-01 | [](https://github.com/airbytehq/airbyte/pull/) | Fix empty repository handling: treat all HTTP 409 responses as empty repo conditions instead of only matching exact body text, preventing retry exhaustion on 8+ streams |
