...
| :----------- | :----------- | :------------------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.7.1 | 2026-09-21 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Finalize manifest-only migration: drop the hybrid `read`/`discover`/`streams` plumbing from `SourceGithub`; config normalization and validation move into the manifest spec. |
