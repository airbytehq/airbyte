...
| :----------- | :----------- | :------------------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.6.1 | 2026-09-17 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Follow GitHub's `Link` next URL with its `after` cursor to fix HTTP 422 `Pagination with the page parameter is not supported for large datasets` on large `issues` and other REST streams |
