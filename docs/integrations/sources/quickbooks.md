...
|:------------|:-----------|:---------------------------------------------------------| :----------------------------------------------------------------- |
| 4.1.9 | 2026-08-30 | [85204](https://github.com/airbytehq/airbyte/pull/85204) | Migrate legacy nested `credentials` configurations automatically to the current root-level config shape. |
