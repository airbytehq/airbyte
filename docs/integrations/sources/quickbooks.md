...
|:------------|:-----------|:---------------------------------------------------------| :----------------------------------------------------------------- |
| 4.2.0 | 2026-08-31 | [85216](https://github.com/airbytehq/airbyte/pull/85216) | Add actionable error handling for Intuit fault codes and HTTP statuses, drop unnecessary required spec fields, refresh the SDM base image, and declare the Intuit rate-limit budget, stream concurrency, and heartbeat timeout |
