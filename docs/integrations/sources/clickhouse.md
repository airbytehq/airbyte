...
This connector uses the [ClickHouse JDBC driver](https://github.com/ClickHouse/clickhouse-jdbc) to communicate with your database over HTTP. For more information, see the [ClickHouse JDBC documentation](https://clickhouse.com/docs/integrations/language-clients/java/jdbc).
