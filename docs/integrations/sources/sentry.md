...
|:--------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.0.1 | 2026-07-13 | [PLACEHOLDER_PR](https://github.com/airbytehq/airbyte/pull/PLACEHOLDER_PR) | Scope the 1.0.0 breaking change to the `projects` stream and emphasize the risk of data loss in the migration guide |
