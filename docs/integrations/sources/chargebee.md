...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0.10.36-rc.4 | 2026-05-26 | [_PR_NUMBER_PLACEHOLDER_](https://github.com/airbytehq/airbyte/pull/*PR_NUMBER_PLACEHOLDER*) | Reduce default concurrent workers to 3 after rollout duration regressions at 5. |
| 0.10.36-rc.3 | 2026-05-22 | [_PR_NUMBER_PLACEHOLDER_](https://github.com/airbytehq/airbyte/pull/*PR_NUMBER_PLACEHOLDER*) | Revert `default_concurrency` to 5, activate tier-aware `HTTPAPIBudget`, and document `subscription_tier` for GA rollout |
