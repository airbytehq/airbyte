...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0.10.32 | 2026-03-25 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Handle 404 errors in `subscription` stream to prevent sync failures when referenced entities are deleted |
