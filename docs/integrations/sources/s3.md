...
- **Endpoint**: An optional parameter that enables the use of non-Amazon S3 compatible services. The scheme is required: `https://` on Cloud and `http://` or `https://` on OSS. If you are using the default Amazon service, leave this field blank.
...
|:------------|:-----------|:----------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| 4.15.20 | 2026-08-18 | N/A | Require a URL scheme in the S3-compatible endpoint |
