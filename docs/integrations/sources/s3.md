...
Zip files protected with a traditional ("ZipCrypto") password can be read by setting the **Zip Password** field in the connector configuration. AES-encrypted zip files (WinZip's "AES-256" option) are not yet supported.
