...
Please note, the S3 Source connector used to infer schemas from all the available files and then merge them to create a superset schema. Starting from version 0.1.33 the schema inference works based on the first file found only.
...
|:--------|:-----------|:----------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------|
| 0.1.33  | 2023-02-17 | [00000](https://github.com/airbytehq/airbyte/pull/00000)                                                        | Infer schema based on one file instead of all the files                                    |
