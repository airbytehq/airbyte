...
- **Allow newlines in values**: This option toggles whether newline characters are allowed in JSON values. Turning this on may affect performance. Disabled by default.
