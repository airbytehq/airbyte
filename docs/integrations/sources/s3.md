...
|:------------|:-----------|:----------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| 4.15.10 | 2026-06-16 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Log a warning instead of silently dropping the deprecated `newlines_in_values` CSV option during v3→v4 config migration, and document the change |
