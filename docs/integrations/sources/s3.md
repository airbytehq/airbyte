...
- **Endpoint**: An optional parameter that enables the use of non-Amazon S3 compatible services. The value must be a full URL including the scheme, such as `https://my-s3-endpoint.com`. Airbyte Cloud requires `https://`; Self-Managed deployments also accept `http://`. If you are using the default Amazon service, leave this field blank.
...
|:------------|:-----------|:----------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| 4.15.20 | 2026-08-18 | [84886](https://github.com/airbytehq/airbyte/pull/84886) | Require a URL scheme in the S3-compatible endpoint |
