...
|:--------|:-----------|:----------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| 2.0.1   | 2023-03-16 | [00000](https://github.com/airbytehq/airbyte/pull/00000)                                                        | Return empty schema if `discover` finds no files; Do not infer extra data types when user defined schema is applied. |
