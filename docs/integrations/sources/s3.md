...
JSON is essentialy an ubiquitous, lightweight, plain-text, key-value data-interchange file format. Only line-delimited JSON format is supported at the moment. The following settings are available:
