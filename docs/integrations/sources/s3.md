...
|:------------|:-----------|:----------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| 4.15.5 | 2026-05-23 | [78325](https://github.com/airbytehq/airbyte/pull/78325) | Migrate to `FileBasedConcurrentCursor`, bump airbyte-cdk to a prerelease that throttles file-based state emission to prevent orchestrator OOM on large file streams, and size the boto3 connection pool to the CDK default concurrency. |
