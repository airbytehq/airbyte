...
|:------------|:-----------|:----------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| 4.15.5 | 2026-05-22 | [78325](https://github.com/airbytehq/airbyte/pull/78325) | Migrate to `FileBasedConcurrentCursor`, bump airbyte-cdk to a prerelease that throttles file-based state emission to prevent orchestrator OOM on large file streams, size the boto3 connection pool to the CDK default concurrency, and cap source-s3 at 20 concurrent partition readers to keep peak memory under the connector pod limit. |
