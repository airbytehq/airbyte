...
|:------------|:-----------|:----------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| 4.15.5 | 2026-05-21 | [78325](https://github.com/airbytehq/airbyte/pull/78325) | Migrate to `FileBasedConcurrentCursor` and bump airbyte-cdk to a prerelease that throttles file-based state emission, preventing orchestrator OOM on large file streams. |
