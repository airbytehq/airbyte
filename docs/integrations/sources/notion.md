...
```Dockerfile
FROM airbyte/source-notion:latest
...
2. Build your image:
```bash
docker build -t airbyte/source-notion:dev .
# Running the spec command against your patched connector
docker run airbyte/source-notion:dev spec
```
...
| :------ | :--------- | :------------------------------------------------------- | :--------------------------------------------------------------------------- |
| 2.0.1 | 2023-10-16 | [TBDGUS](https://github.com/airbytehq/airbyte/pull/TBDGUS) | Use our base image and remove Dockerfile |
