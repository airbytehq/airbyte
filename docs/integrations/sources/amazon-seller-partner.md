...
|:-----------|:-----------|:----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.7.1 | 2026-04-01 | [](https://github.com/airbytehq/airbyte/pull/) | Increase max_retries for async report error handlers to properly handle HTTP 429 rate limits and deprecate unused `wait_to_avoid_fatal_errors` config option |
