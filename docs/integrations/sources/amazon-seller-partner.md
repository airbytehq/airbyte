...
|:-----------|:-----------|:----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.7.8 | 2026-06-09 | [79590](https://github.com/airbytehq/airbyte/pull/79590) | Allow null values for optional string config fields (app_id, replication_start_date, replication_end_date) to handle platform-injected nulls |
