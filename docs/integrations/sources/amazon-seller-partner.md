...
|:-----------|:-----------|:----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.7.9 | 2026-06-16 | [79669](https://github.com/airbytehq/airbyte/pull/79669) | Stream-decode all large JSON report streams (Brand Analytics, Sales and Traffic, Vendor) with `JsonItemsDecoder` on CDK 7.23.1 to prevent out-of-memory failures |
