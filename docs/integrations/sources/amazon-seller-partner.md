...
|:-----------|:-----------|:----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.7.5 | 2026-04-30 | [77621](https://github.com/airbytehq/airbyte/pull/77621) | Fix `report_options_list` config property not being passed to SP-API `createReport` endpoint |
