...
- [Flat File Settlement Report V2 (GET_V2_SETTLEMENT_REPORT_DATA_FLAT_FILE_V2)](https://developer-docs.amazon.com/sp-api/docs/report-type-values-settlement) \(incremental\)
...
| :------- | :--------- | :--------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `3.1.0`  | 2023-12-19 | [\#32977](https://github.com/airbytehq/airbyte/pull/33541) | Add `GET_V2_SETTLEMENT_REPORT_DATA_FLAT_FILE_V2` stream                                                                                                                             |
