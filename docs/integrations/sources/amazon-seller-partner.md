...
|:-----------|:-----------|:----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.7.5 | 2026-04-29 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Classify expired/invalid refresh token errors as config errors instead of raising raw HTTP exceptions |
