...
|:-----------|:-----------|:----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.11.0 | 2026-09-18 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | ListFinancialEvents now retries a page rejected with `InvalidInput` at a smaller page size instead of failing the sync |
