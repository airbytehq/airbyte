...
|:-----------|:-----------|:----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.7.4 | 2026-04-26 | [](https://github.com/airbytehq/airbyte/pull/) | Add HTTP 429 to async report error handlers and increase max retries to 20 for report creation, polling, and download |
