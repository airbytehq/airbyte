...
|:-----------|:-----------|:----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.11.0 | 2026-09-18 | [86462](https://github.com/airbytehq/airbyte/pull/86462) | ListFinancialEvents now retries a page rejected with `InvalidInput` at a smaller page size instead of failing the sync |
