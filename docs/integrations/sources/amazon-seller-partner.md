...
| 5.10.2 | 2026-09-02 | [#TBD] | Send Amazon-required `reportOptions` (`reportPeriod`, `distributorView`, `sellingProgram`) for vendor sales/inventory/traffic/net pure product margin reports, fixing FATAL report generation |
