...
|:-----------|:-----------|:----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.0 | 2026-09-10 | [85814](https://github.com/airbytehq/airbyte/pull/85814) | Remove the incorrect `amazon-order-id` primary key from `GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_GENERAL` and `GET_FLAT_FILE_ALL_ORDERS_DATA_BY_LAST_UPDATE_GENERAL` so multi-item orders are no longer collapsed to a single row in deduped syncs |
