...
|:-----------|:-----------|:----------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.7.8 | 2026-06-13 | [79669](https://github.com/airbytehq/airbyte/pull/79669) | Stream-decode all large JSON report streams (Brand Analytics, Sales and Traffic, Vendor) with `JsonItemsDecoder` on CDK 7.23.1 to prevent out-of-memory failures |
