...
6. For **API Token** authentication, enter the **Domain** for your Jira account, e.g. `airbyteio.atlassian.net`, the **Email** for the Jira account that generated the API token, and the **API Token**.
7. For **Service Account** authentication, enter the **Service Account Token** and the **Cloud ID** for your Jira site.
