...
|:-----------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.0 | 2026-06-17 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Migrate `board_issues` and `sprint_issues` streams from deprecated `/rest/agile/1.0/` endpoints to `/rest/software/1.0/` with cursor-based pagination per Atlassian RFC-127 |
