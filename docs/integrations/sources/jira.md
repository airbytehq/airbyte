...
|:-----------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.2 | 2026-09-09 | [85802](https://github.com/airbytehq/airbyte/pull/85802) | Stop config migration from adding empty `api_token`, `email`, and `domain` fields to OAuth or partially-migrated configs |
