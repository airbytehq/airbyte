...
|:-----------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.3 | 2026-09-16 | [86357](https://github.com/airbytehq/airbyte/pull/86357) | Fix `issues` stream failing with `UndefinedError` when an issue has no `fields.project` |
