...
1. To get access to the Jira API you need to create an API token. See this [documentation](https://support.atlassian.com/atlassian-account/docs/manage-api-tokens-for-your-atlassian-account/) for instructions on how to create an API token.

### Step 2: Set up the Jira connector in Airbyte

**For Airbyte Cloud:**

1. Enter the **API Token** that you have created. This is used for Authorization to your account by BasicAuth.
...
For more information on the Jira connector configuration options, please refer to the [Jira Connector Spec](https://docs.airbyte.com/integrations/sources/jira).## Supported sync modes
