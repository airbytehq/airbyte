...
|:-----------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.4.0 | 2026-04-21 | [76840](https://github.com/airbytehq/airbyte/pull/76840) | Propagate incremental state from `issues` parent to `issue_remote_links`, `issue_transitions`, `issue_votes`, and `issue_watchers` via `incremental_dependency` (verified parent `updated` advances on each child mutation) |
