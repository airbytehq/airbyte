...
* [All issue worklogs](https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issue-worklogs/#api-rest-api-3-worklog-list-post)
...
`Issue Worklogs` and `All issue worklogs` streams work depending on the config. 
If you do not have specified projects in the configuration, `All issue worklogs` stream will work, otherwise `Issue Worklogs`.
This was done in order to speed up work in the case of a large number of issues and extract updated worklogs 
for all projects at once, bypassing the reading of all issues.
...
|:--------|:-----------|:-----------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------|
| 0.3.9   | 2023-05-12 | [\#26023](https://github.com/airbytehq/airbyte/pull/26023) | Add undeclared columns. Improved working of IssueWorklogs stream to avoid syncing of all issues in case of empty projects in config. |
