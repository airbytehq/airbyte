...
|:-----------|:-----------|:-----------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.0-rc.1 | 2026-06-04 | [*PR_NUMBER_PLACEHOLDER*](https://github.com/airbytehq/airbyte/pull/*PR_NUMBER_PLACEHOLDER*) | Remove deprecated `issue_field_configurations` stream (Atlassian removing `GET /rest/api/3/fieldconfiguration` in July 2026) and add replacement `field_schemes` stream using the new `GET /rest/api/3/config/fieldschemes` endpoint |
