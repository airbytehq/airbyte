...
| :------ | :--------- | :------------------------------------------------------- | :------------------------------------------------------------------------------ |
| 1.3.0 | 2026-07-17 | [82000](https://github.com/airbytehq/airbyte/pull/82000) | Source Gong: batch `callTranscripts` call IDs via `GroupingPartitionRouter` to avoid one request per call and the resulting rate-limit (429) / daily-quota exhaustion |
