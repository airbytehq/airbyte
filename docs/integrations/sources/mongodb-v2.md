...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [77796](https://github.com/airbytehq/airbyte/pull/77796) | Translate MongoDB "Unauthorized" (error 13) on change-stream open into a `config_error` with a clean, deterministic message (instead of surfacing the raw driver exception). |
