...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8   | 2026-05-06 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)     | Surface MongoDB Unauthorized (code 13) errors during CDC reads as `config_error` with a remediation hint. |
