...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Surface MongoDB `changeStream` privilege failures (errorCode 13) as a config error in `check` and during sync |
