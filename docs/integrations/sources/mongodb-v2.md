...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [71XXX](https://github.com/airbytehq/airbyte/pull/71XXX) | Surface change stream authorization failures as a `config_error` with a clean user-facing message instead of the raw `MongoCommandException`. |
