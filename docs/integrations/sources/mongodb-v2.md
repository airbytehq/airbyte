...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-09-09 | [81456](https://github.com/airbytehq/airbyte/pull/81456) | Bound the Debezium CDC event queue by byte size (CDK 0.48.19) to prevent OOM on large change events and cap Debezium `max.batch.size` at 256 |
