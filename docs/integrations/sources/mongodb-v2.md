...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-06-17 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fix spurious sync failures caused by Debezium's replicator-fetcher thread triggering orphaned thread force-exit |
