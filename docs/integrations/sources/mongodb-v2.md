...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8   | 2026-05-10 | [](https://github.com/airbytehq/airbyte/pull/) | Show an actionable configuration error when CDC syncs cannot open MongoDB change streams due to missing permissions. |
