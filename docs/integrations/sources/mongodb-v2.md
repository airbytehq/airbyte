...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8   | 2026-05-01 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fix discovery to exclude views by correctly filtering listCollections to type `collection` only |
