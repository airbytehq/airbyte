...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-04 | [77745](https://github.com/airbytehq/airbyte/pull/77745) | Classify MongoDB Unauthorized (error 13) failures as `config_error` with an actionable message. |
