...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-07-31 | [PRNUM](https://github.com/airbytehq/airbyte/pull/PRNUM) | Explain why a saved CDC resume token became invalid and how to resolve it in the resulting error message |
