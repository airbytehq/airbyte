...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8   | 2026-05-04 | [16296](https://github.com/airbytehq/airbyte-internal-issues/issues/16296) | Surface MongoDB `Unauthorized` (error code 13) failures from CDC change-stream initialization as a config error with a deterministic message. |
