...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [77792](https://github.com/airbytehq/airbyte/pull/77792) | Translate `MongoCommandException` (Unauthorized, code 13) raised when opening a CDC change stream into a clean `config_error` instead of surfacing the raw driver exception. |
