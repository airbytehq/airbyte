...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-10 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Classify unauthorized CDC change-stream access as a configuration error with a deterministic message. |
