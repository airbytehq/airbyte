...
| Database Name                              | The name of the database that contains the source collection(s) to sync. For backward compatibility. If both 'Database Name' and 'Database Names' are provided, 'Database Names' will take precedence.                                                                                                                                                                                                                                      |
