...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-09-18 | [86467](https://github.com/airbytehq/airbyte/pull/86467) | Ignore credentials embedded in the connection string so CDC syncs authenticate with the configured username and password, and report CDC authentication failures as a configuration error. |
