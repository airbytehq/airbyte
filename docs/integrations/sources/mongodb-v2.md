...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-05 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Surface MongoDB change-stream `Unauthorized` (error 13) as a `config_error` with an actionable message instead of the raw driver string. |
