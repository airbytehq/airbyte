...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8   | 2026-05-06 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Reclassify "not authorized" change-stream errors as `config_error` with an actionable user-facing message. |
