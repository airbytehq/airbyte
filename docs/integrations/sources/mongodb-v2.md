...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.5   | 2025-11-03 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Fix DESTINATION_SERIALIZATION_ERROR by serializing arrays and objects to JSON strings.                              |
