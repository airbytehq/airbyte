...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8   | 2026-05-01 | [77676](https://github.com/airbytehq/airbyte/pull/77676) | Fix discovery to exclude views by correctly filtering listCollections to type `collection` only |
