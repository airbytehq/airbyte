...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8   | 2026-05-05 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Reclassify MongoDB CDC `Unauthorized` (error 13) on change-stream open as a `config_error` with a deterministic, user-facing message. |
