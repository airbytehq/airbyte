...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-10 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Classify unauthorized MongoDB change stream errors as configuration errors with a deterministic message. |
