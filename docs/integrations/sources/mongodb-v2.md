...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [77807](https://github.com/airbytehq/airbyte/pull/77807) | Surface a config error when the MongoDB user lacks `changeStream` privilege on the source database. |
