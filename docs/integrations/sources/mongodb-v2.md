...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-06-17 | [80161](https://github.com/airbytehq/airbyte/pull/80161) | Use `$sample`-based aggregation for `_id` type discovery to avoid expensive full collection scans on large collections |
