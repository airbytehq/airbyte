...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [77799](https://github.com/airbytehq/airbyte/pull/77799) | Surface a config error when the MongoDB user is not authorized to read change streams. |
