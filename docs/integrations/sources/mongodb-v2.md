...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-09-18 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Ignore credentials embedded in the connection string so CDC syncs authenticate with the configured username and password, and report CDC authentication failures as a configuration error. |
