...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-08-06 | [79702](https://github.com/airbytehq/airbyte/pull/79702) | Surface actionable error message when CDC resume token references a rotated oplog entry (ChangeStreamFatalError) instead of generic failure |
