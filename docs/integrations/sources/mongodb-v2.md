...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8   | 2026-05-10 | [77946](https://github.com/airbytehq/airbyte/pull/77946) | Show an actionable configuration error when CDC syncs cannot open MongoDB change streams due to missing permissions. |
