...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [77823](https://github.com/airbytehq/airbyte/pull/77823) | Translate MongoDB `Unauthorized` (code 13) errors raised when opening the CDC change stream into actionable `config_error`s instead of leaking the raw driver exception. |
