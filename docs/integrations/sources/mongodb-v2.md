...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [00000](https://github.com/airbytehq/airbyte/pull/00000) | Surface a config error when the MongoDB user is not authorized to read change streams. |
