...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-07 | [77828](https://github.com/airbytehq/airbyte/pull/77828) | Throw ConfigErrorException with actionable message when the configured MongoDB user lacks changeStream privileges. |
