...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [77790](https://github.com/airbytehq/airbyte/pull/77790) | Surface a config-error message when the MongoDB user is not authorized to open a change stream. |
