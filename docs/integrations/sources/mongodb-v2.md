...
```
The contents of `data` will vary according to whichever values exist on each document read from MongoDB.
...
* When Running with Schema Enforced set to `false` there is no attempt to discover any schema. See more in [No Schema Mode](#No-Schema-Mode).
...
| Schema Enforced                            | Controls whether schema is discovered and enforced. See more in [No Schema Mode](#No-Schema-Mode).                                                                                                                                                                                                                                                                                                                                           |
