...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8   | 2026-05-06 | [77808](https://github.com/airbytehq/airbyte/pull/77808) | Reclassify "not authorized" change-stream errors as `config_error` with an actionable user-facing message. |
