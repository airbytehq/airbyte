...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [77802](https://github.com/airbytehq/airbyte/pull/77802) | Surface change stream authorization failures as a `config_error` with a clean user-facing message instead of the raw `MongoCommandException`. |
