...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [77783](https://github.com/airbytehq/airbyte/pull/77783) | Surface MongoDB `Unauthorized` change-stream errors as actionable config errors instead of raw driver exceptions. |
