...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [77825](https://github.com/airbytehq/airbyte/pull/77825) | Surface MongoDB Unauthorized (error 13) on CDC change-stream open as a `config_error` and probe the `changeStream` privilege at check time. |
