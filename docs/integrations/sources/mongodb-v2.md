...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-05 | [TODO](https://github.com/airbytehq/airbyte/pull/TODO) | Re-classify MongoDB change-stream "not authorized" failures as config errors with an actionable message. |
