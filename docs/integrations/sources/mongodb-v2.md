...
previous major version, follow the [MongoDB migration guide](/integrations/sources/mongodb-v2-migrations) instead.
...
5. (Airbyte Cloud only) Allow inbound traffic from Airbyte IPs.
...
To sync more than one database with a single source, grant cluster-wide read access instead, for example
`roles: [{role: "readAnyDatabase", db: "admin"}]`. The connector watches the entire deployment in that case.
:::
...
| Authentication Source                      | Specifies the database that the supplied credentials should be validated against. Defaults to `admin`. See the [MongoDB documentation](https://www.mongodb.com/docs/manual/reference/connection-string/#mongodb-urioption-urioption.authSource) for more details.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| 2.0.0   | 2025-06-03 | [60252](https://github.com/airbytehq/airbyte/pull/60252) | Add support for multiple databases |
| 1.5.19  | 2025-05-27 | [60311](https://github.com/airbytehq/airbyte/pull/60311) | Migrate to new Gradle flow |
