...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-06-17 | [](https://github.com/airbytehq/airbyte/pull/) | Use `$sample`-based aggregation for `_id` type discovery to avoid expensive full collection scans on large collections |
