...
![Security Database Access](/platform/.gitbook/assets/source/mongodb/mongodb_atlas_database_user_step_2.png)

3. Click on the "+ ADD NEW DATABASE USER" button.

![Add New Database User](/platform/.gitbook/assets/source/mongodb/mongodb_atlas_database_user_step_3.png)

4. On the "Add new Database User" modal dialog, choose "Password" for the "Authentication Method".

![Authentication Method](/platform/.gitbook/assets/source/mongodb/mongodb_atlas_database_user_step_4.png)
...
![Username and Password](/platform/.gitbook/assets/source/mongodb/mongodb_atlas_database_user_step_5.png)
...
![Database User Privileges](/platform/.gitbook/assets/source/mongodb/mongodb_atlas_database_user_step_6.png)
...
![Restrict Access](/platform/.gitbook/assets/source/mongodb/mongodb_atlas_database_user_step_7.png)

8. Click on "Add User" at the bottom to save the user.

![Add User](/platform/.gitbook/assets/source/mongodb/mongodb_atlas_database_user_step_8.png)
...
![Connect to Source Cluster](/platform/.gitbook/assets/source/mongodb/mongodb_atlas_connection_string_step_2.png)

3. On the "Connect to &lt;cluster name&gt;" modal dialog, select "Shell" under the "Access your data through tools" section.

![Shell Connect](/platform/.gitbook/assets/source/mongodb/mongodb_atlas_connection_string_step_3.png)
...
![Copy Connection String](/platform/.gitbook/assets/source/mongodb/mongodb_atlas_connection_string_step_4.png)
...
To see connector limitations, or troubleshoot your MongoDB connector, see more [in our MongoDB troubleshooting guide](/platform/integrations/sources/mongodb-v2/mongodb-v2-troubleshooting).
