...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8   | 2026-05-07 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD)     | Surface a clear, actionable error when the configured MongoDB user is not authorized to open change streams (error code 13) and classify it as a config error. |
