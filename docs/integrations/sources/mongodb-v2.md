...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [77816](https://github.com/airbytehq/airbyte/pull/77816) | Classify MongoDB "Unauthorized" (error 13) on change stream as a config error with a clearer remediation hint. |
