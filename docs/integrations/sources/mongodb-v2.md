...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [77797](https://github.com/airbytehq/airbyte/pull/77797) | Surface a config error (instead of a system error) when the MongoDB user lacks the `changeStream` privilege; verify the privilege at `check` time. |
