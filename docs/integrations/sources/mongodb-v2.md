...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-06-17 | [80213](https://github.com/airbytehq/airbyte/pull/80213) | Fix spurious sync failures caused by Debezium's replicator-fetcher thread triggering orphaned thread force-exit |
