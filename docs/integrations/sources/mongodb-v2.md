...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [airbyte-internal-issues#16322](https://github.com/airbytehq/airbyte-internal-issues/issues/16322) | Surface a clean `config_error` when the configured user lacks the `changeStream` privilege. |
