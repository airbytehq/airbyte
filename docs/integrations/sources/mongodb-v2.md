...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-07 | [77832](https://github.com/airbytehq/airbyte/pull/77832) | Translate MongoDB `Unauthorized` (error code 13) on change-stream open to a `config_error` with an actionable message. |
