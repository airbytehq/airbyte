...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8   | 2026-05-07 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Surface a `config_error` with an actionable message when the MongoDB user is not authorized to open a change stream during CDC. |
