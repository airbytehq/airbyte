...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-06 | [77810](https://github.com/airbytehq/airbyte/pull/77810) | Surface "Unauthorized" change-stream errors as actionable config errors and detect missing `changeStream` privilege at check time. |
