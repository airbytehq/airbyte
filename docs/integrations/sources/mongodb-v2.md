...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-05 | [TBD](https://github.com/airbytehq/airbyte/pull/TBD) | Surface a clearer config error when the MongoDB user lacks the `changeStream` privilege. |
