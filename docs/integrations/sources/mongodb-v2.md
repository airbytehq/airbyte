...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8 | 2026-05-04 | [77727](https://github.com/airbytehq/airbyte/pull/77727) | Surface a clear, actionable error message when the MongoDB user lacks `find`/`changeStream` privileges, classified as a config error. |
