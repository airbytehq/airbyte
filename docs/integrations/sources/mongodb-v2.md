...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.7 | 2026-01-21 | [72232](https://github.com/airbytehq/airbyte/pull/72232) | Use Debezium's change stream pipeline for resume token validation to ensure consistency with actual CDC resumption (h/t @ed-kyu) |
