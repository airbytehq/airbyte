...
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------|
| 2.0.8   | 2026-05-06 | [77814](https://github.com/airbytehq/airbyte/pull/77814) | Surface MongoDB Unauthorized (code 13) errors during CDC reads as `config_error` with a remediation hint. |
