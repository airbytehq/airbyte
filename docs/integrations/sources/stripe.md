...
|:------------|:-----------|:-------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.1.0 | 2026-06-16 | [77625](https://github.com/airbytehq/airbyte/pull/77625) | Add configurable `event_based_incremental_sync_mode` with new `hydrated_events` behavior for event-based incremental streams. |
