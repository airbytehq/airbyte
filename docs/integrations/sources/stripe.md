...
|:------------|:-----------|:-------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.9 | 2026-06-24 | [PRNUM](https://github.com/airbytehq/airbyte/pull/PRNUM) | Prerelease: pin CDK heartbeat-keepalive fix ([airbyte-python-cdk #1068](https://github.com/airbytehq/airbyte-python-cdk/pull/1068) / OC-12977) via prerelease `source-declarative-manifest` base image |
