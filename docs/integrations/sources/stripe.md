...
|:------------|:-----------|:-------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.15 | 2026-08-17 | [84451](https://github.com/airbytehq/airbyte/pull/84451) | Treat Stripe restricted sandbox keys (`rk_test_`) as sandbox when choosing default rate limit and concurrency |
