...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.8.1 | 2026-08-03 | [73315](https://github.com/airbytehq/airbyte/pull/73315) | Migrate OAuth token requests from the deprecated `/oauth/v1/token` endpoint to HubSpot's date-based `/oauth/2026-03/token` endpoint ahead of the 2027-02-16 sunset |
