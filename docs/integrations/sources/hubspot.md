...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.6.1 | 2026-06-09 | [](https://github.com/airbytehq/airbyte/pull/) | Allow string values for dynamic properties declared as number or boolean to prevent destination sync failures |
