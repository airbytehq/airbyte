...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.6.2 | 2026-06-11 | [](https://github.com/airbytehq/airbyte/pull/) | Fix CRM Search pagination to preserve string IDs and use GT operator, preventing missing records when short and long HubSpot object IDs coexist |
