...
| 6.5.3 | 2026-04-21 | [76073](https://github.com/airbytehq/airbyte/pull/76073) | Upgrade CDK base image to fix a concurrent-sync deadlock that could cause syncs to hang indefinitely |
