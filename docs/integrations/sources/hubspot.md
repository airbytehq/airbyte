...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.5.1 | 2026-04-16 | [76387](https://github.com/airbytehq/airbyte/pull/76387) | Widen schema for dynamic `number` and `boolean` properties to accept `string` values, fixing schema-value mismatch for non-numeric HubSpot API responses |
