...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.4.3 | 2026-04-08 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Added missing OAuth scopes `crm.objects.users.read` and `settings.users.read` for the `users` stream |
