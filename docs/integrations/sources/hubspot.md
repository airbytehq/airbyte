...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.9.0 | 2026-08-24 | [82769](https://github.com/airbytehq/airbyte/pull/82769) | Declare `marketing_emails` `testing.isAbVariation` and `teams[].primary` on `owners` and `owners_archived`, returned by the API but missing from the schemas |
