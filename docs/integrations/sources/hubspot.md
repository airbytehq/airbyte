...
| :--- | :--- | :--- | :--- |
| 0.1.20 | 2021-10-26 | [????](https://github.com/airbytehq/airbyte/pull/????) | Hotfix for `split_properties` function, add the length of separator symbol `,`(`%2C` in HTTP format) to the checking of the summary URL length |
