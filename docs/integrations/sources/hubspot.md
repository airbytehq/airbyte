...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.8.0 | 2026-06-24 | [*PR_NUMBER_PLACEHOLDER*](https://github.com/airbytehq/airbyte/pull/*PR_NUMBER_PLACEHOLDER*) | Restore 12 Web Analytics streams (contacts, companies, deals, tickets, engagements_calls, engagements_emails, engagements_meetings, engagements_notes, engagements_tasks, goals, line_items, products) removed during the v5.8.0 manifest-only migration. Streams are gated behind `enable_experimental_streams` and use fresh state from `start_date`. |
