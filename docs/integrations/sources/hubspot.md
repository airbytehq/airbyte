...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.8.1 | 2026-07-31 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Temporary test build on a prerelease source-declarative-manifest image to validate CDK PR #1079. |
