...
|:--------|:-----------|:---------------------------------------------------------|:----------------------------------------------------------|
| 0.1.28 | 2026-06-10 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fix incremental sync losing records between sync time and account-local midnight |
