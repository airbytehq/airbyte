...
|:--------|:-----------|:---------------------------------------------------------|:----------------------------------------------------------|
| 0.1.28 | 2026-06-23 | [80614](https://github.com/airbytehq/airbyte/pull/80614) | Use metadata-catalog endpoint for connection check instead of hardcoded contact record; parse NetSuite error details for actionable error messages |
