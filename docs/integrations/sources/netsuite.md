...
|:--------|:-----------|:---------------------------------------------------------|:----------------------------------------------------------|
| 0.1.28 | 2026-06-08 | [](https://github.com/airbytehq/airbyte/pull/) | Emit warning and fail sync when >50% of records are silently skipped due to NetSuite workflow locks (USER_ERROR) |
