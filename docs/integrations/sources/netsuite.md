...
|:--------|:-----------|:---------------------------------------------------------|:----------------------------------------------------------|
| 0.1.28 | 2026-06-23 | [](https://github.com/airbytehq/airbyte/pull/) | Use metadata-catalog endpoint for connection check instead of hardcoded contact record; parse NetSuite error details for actionable error messages |
