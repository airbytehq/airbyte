...
|--------|------------|----------------------------------------------------------|---------------------------------------------------------------------------|
| 2.1.23 | 2026-04-16 | [76268](https://github.com/airbytehq/airbyte/pull/76268) | Promote concurrency=6 + HTTPAPIBudget to GA after successful progressive rollout across all tiers |
