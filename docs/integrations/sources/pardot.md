...
| :------ | :--------- | :------------------------------------------------------- | :-------------------- |
| 1.0.54 | 2026-08-28 | [PENDING](https://github.com/airbytehq/airbyte/pull/PENDING) | Send Account Engagement requests to `pi.demo.pardot.com` for sandboxes and allow an explicit `pardot_api_host` (stock always used `pi.pardot.com`) |
