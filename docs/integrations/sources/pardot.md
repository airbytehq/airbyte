...
| :------ | :--------- | :------------------------------------------------------- | :-------------------- |
| 1.0.54 | 2026-08-28 | [85107](https://github.com/airbytehq/airbyte/pull/85107) | Send Account Engagement requests to `pi.demo.pardot.com` for sandboxes and allow an explicit `pardot_api_host` (stock always used `pi.pardot.com`) |
