...
| :------ | :--------- | :------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 4.4.29 | 2026-06-11 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fix OAuth 401 errors causing fatal sync failures by retrying with refreshed token instead of failing immediately |
