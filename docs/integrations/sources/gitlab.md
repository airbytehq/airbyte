...
| :------ | :--------- | :------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 4.4.27 | 2026-05-03 | [77719](https://github.com/airbytehq/airbyte/pull/77719) | Reclassify HTTP 404 from FAIL/system_error to FAIL/config_error and rewrite the user-facing message to name the failing stream and configured group/project |
