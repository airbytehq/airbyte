...
| :------ | :--------- | :------------------------------------------------------- | :------------------------------------------------------------------------ |
| 2.0.0 | 2026-09-14 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Migrate the `shifts` stream to Square's Timecards API (Labor Shift endpoints retired); removes the deprecated `employee_id` field |
