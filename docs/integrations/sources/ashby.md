...
|:--------| :--------- | :------------------------------------------------------- |:--------------------------------------------|
| 0.3.9 | 2026-08-14 | [84405](https://github.com/airbytehq/airbyte/pull/84405) | Send the pagination page size as the documented `limit` field so streams request 100 records per page and make fewer API calls |
