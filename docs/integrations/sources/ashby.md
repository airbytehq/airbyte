...
|:--------| :--------- | :------------------------------------------------------- |:--------------------------------------------|
| 1.3.0 | 2026-09-08 | [85755](https://github.com/airbytehq/airbyte/pull/85755) | Add `application_feedback` stream; send the API key as the Basic auth username with a blank password per Ashby docs |
