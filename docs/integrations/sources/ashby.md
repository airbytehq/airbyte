...
|:--------| :--------- | :------------------------------------------------------- |:--------------------------------------------|
| 0.4.0 | 2026-08-12 | [84274](https://github.com/airbytehq/airbyte/pull/84274) | Declare additional documented API fields across 13 stream schemas, including typed interview event start/end times; refresh the source schema to pick up the new fields |
