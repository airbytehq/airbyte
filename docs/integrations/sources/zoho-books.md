...
|------------------|-------------------|--------------|----------------|
| 1.0.0 | 2026-05-19 | [78174](https://github.com/airbytehq/airbyte/pull/78174) | Updated incremental syncs for financial streams to use record modification time so edited records are captured. |
