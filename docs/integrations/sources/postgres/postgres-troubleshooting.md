...
- Log-based replication works for master instances of Postgres. CDC can also be run from a read-replica of your primary database starting from connector version 3.6.21, provided the replica is configured appropriately.
