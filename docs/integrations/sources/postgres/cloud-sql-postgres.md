...
2. Add a new network, and enter the Airbyte's IPs, which you can find in our [Airbyte Security documentation](../../platform/../platform/operating-airbyte/security#network-security-1).
