...
|:---------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.9.30 | 2026-04-09 | [76186](https://github.com/airbytehq/airbyte/pull/76186) | Remove stale `access_token` from `complete_oauth_output_specification` to fix OAuth source creation via API |
