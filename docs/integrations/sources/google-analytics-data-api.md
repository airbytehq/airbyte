...
|:---------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.9.33-rc.1 | 2026-04-23 | [76956](https://github.com/airbytehq/airbyte/pull/76956) | Add `concurrency_level` with `num_workers` spec field (default 12) and tier-aware `subscription_tier` config with Standard (10 req/s) and Analytics 360 (50 req/s) `api_budget` for concurrency tuning rollout (RC) |
