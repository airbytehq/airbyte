...
Before you can use the service account to access Google Analytics data, you need to enable the Google Analytics Data API:
...
| 2.9.34-rc.2 | 2026-05-05 | [77781](https://github.com/airbytehq/airbyte/pull/77781) | Phase 1 step 3: bump `default_concurrency` 5 to 6 (tier-aware `api_budget` stays live)                                                                                                                                       |
