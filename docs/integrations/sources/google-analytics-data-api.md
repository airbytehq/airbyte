...
|:---------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.9.31 | 2026-04-16 | [76349](https://github.com/airbytehq/airbyte/pull/76349) | Surface expired/revoked OAuth refresh tokens as a `config_error` with a re-authentication message instead of a generic "Something went wrong" error |
