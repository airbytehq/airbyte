...
| ------------------ | ------------ | --- | ---------------- |
| 0.0.34 | 2025-11-25 | [69238](https://github.com/airbytehq/airbyte/pull/69238) | Changed the rate-limit handler to use the Retry-After header instead of an exponential backoff |
