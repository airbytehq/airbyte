...
| ------------------ | ------------ | --- | ---------------- |
| 0.0.56 | 2026-09-14 | [PRNUM](https://github.com/airbytehq/airbyte/pull/PRNUM) | Migrate `contact_groups`, `teammates_contact_groups`, and `teams_contact_groups` streams to the `contact_lists` endpoints (Front deprecated `contact_groups` on 2025-09-01) |
