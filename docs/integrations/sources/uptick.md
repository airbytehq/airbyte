...
|------------------|-------------------|--------------|----------------|
| 0.4.2 | 2026-01-06 | [x](https://github.com/airbytehq/airbyte/pull/x) | Add invoice_id to invoicelineitems, and add 6 new streams: servicetasks, routineservices, routineservicelevels, routineservicetypes, routineserviceleveltypes, subtasks |
