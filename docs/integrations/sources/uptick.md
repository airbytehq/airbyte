...
|------------------|-------------------|--------------|----------------|
| 1.2.0 | 2026-09-15 | [PLACEHOLDER_PR](https://github.com/airbytehq/airbyte/pull/PLACEHOLDER_PR) | Add error classification, request budget, concurrency, config migrations, HTTPS normalization, and certification metadata |
