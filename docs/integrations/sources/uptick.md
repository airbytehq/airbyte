...
| ------------------ | ------------------- | -------------- | ---------------- |
| 1.2.0 | 2026-09-17 | [86356](https://github.com/airbytehq/airbyte/pull/86356) | Add error classification, request budget, concurrency, HTTPS normalization, and certification metadata, refresh token and retry on 401 |
