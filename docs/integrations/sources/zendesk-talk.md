...
|:--|:--|:--|:--|
| 2.0.23 | 2026-08-11 | [83814](https://github.com/airbytehq/airbyte/pull/83814) | Persist OAuth token expiry on initial authentication so the first sync no longer refreshes and rotates away the single-use refresh token |
