...
| :--- | :--- | :--- | :--- |
| 4.0.2 | 2026-09-02 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Skip saved funnels that Mixpanel rejects with "Invalid bookmark format" instead of failing the funnels stream, and stop reporting generic HTTP 400 responses as authentication failures |
