...
|:--------|:-----------| :------------------------------------------------------- |:--------------------------------------------------------------------------------------------------------------------------------|
| 3.0.0   | 2024-05-10 | [38066](https://github.com/airbytehq/airbyte/pull/38066) | for cohort_members stream: changed key to distinct_id, changed state to per-patition format; fixed pagination for engage stream |
