...
| :--- | :--- | :--- | :--- |
| 4.0.2 | 2026-09-02 | [85290](https://github.com/airbytehq/airbyte/pull/85290) | Skip saved funnels that Mixpanel rejects with "Invalid bookmark format" instead of failing the funnels stream, and stop reporting generic HTTP 400 responses as authentication failures |
