...
|:--------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------|
| 2.0.25 | 2026-06-19 | [80287](https://github.com/airbytehq/airbyte/pull/80287) | Fix `logs` incremental state getting stuck near start date by aligning `cursor_granularity` with second-precision `datetime_format` |
