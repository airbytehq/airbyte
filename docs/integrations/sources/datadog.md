...
|:--------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------|
| 2.0.25 | 2026-06-19 | [](https://github.com/airbytehq/airbyte/pull/) | Fix `logs` incremental state getting stuck near start date by aligning `cursor_granularity` with second-precision `datetime_format` |
