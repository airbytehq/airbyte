...
|:--------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------|
| 2.0.25 | 2026-06-19 | [80291](https://github.com/airbytehq/airbyte/pull/80291) | Fix stuck incremental cursor on logs stream by aligning cursor_granularity with datetime_format precision |
