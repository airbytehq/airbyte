...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.2.5 | 2026-04-21 | [76866](https://github.com/airbytehq/airbyte/pull/76866) | Surface specific Google Ads API error messages from the nested `details[0].errors[0].message` response field |
