...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.2.6-rc.1 | 2026-04-28 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Update CDK to pre-release with stderr heartbeat diagnostics and concurrent-source deadlock fix |
