...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.2.5 | 2026-04-21 | [TODO](https://github.com/airbytehq/airbyte/pull/TODO) | Surface specific Google Ads API error messages from the nested `details[0].errors[0].message` response field |
