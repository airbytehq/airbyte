...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6.0.2 | 2026-06-04 | [79092](https://github.com/airbytehq/airbyte/pull/79092) | Migrate all deprecated Google Ads API v23 field names in custom GAQL queries (`metrics.video_views`, `metrics.video_view_rate`, `metrics.average_cpv`, `campaign.start_date`, `campaign.end_date`). |
