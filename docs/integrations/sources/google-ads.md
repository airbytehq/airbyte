...
|:---------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------|
| `0.1.44` | 2022-07-27 | [00000](https://github.com/airbytehq/airbyte/pull/00000) | Fix data type `ad_group_criterion.topic.path` in `display_topics_performance_report`         |
