...
For incremental streams, data is synced up to the previous day using your Google Ads account time zone since Google Ads can filter data only by [date](https://developers.google.com/google-ads/api/fields/v23/ad_group_ad#segments.date) without time. For report slices outside Google Ads' 37-month retention window for daily or weekly segment data, Airbyte requests `segments.month` instead of `segments.date` and records the first day of the month in `segments.date` so historical data can continue syncing at monthly granularity. Also, some reports cannot load data real-time due to Google Ads [limitations](https://support.google.com/google-ads/answer/2544985?hl=en).
...
|:------------|:-----------|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.0.2 | 2026-05-28 | [78479](https://github.com/airbytehq/airbyte/pull/78479) | Handle Google Ads 37-month granular data retention by querying historical incremental report slices at monthly granularity. |
