...
|------------------|-------------------|--------------|----------------|
| 0.3.12 | 2025-08-08 | [64118](https://github.com/airbytehq/airbyte/pull/64118) | Fix product_availability primary key to support multi-location inventory tracking by using composite key [ID, Location] instead of just [ID] |
