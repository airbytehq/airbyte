...
- [Balance](https://plaid.c../api/products/#balance)
...
This guide will walk through how to create the credentials you need to run this source in the sandbox of a new plaid account. For production use, consider using the Link functionality that Plaid provides [here](https://plaid.c../api/tokens/#linktokencreate)
...
- **Create an Access Token** First you have to create a public token key and then you can create an access token.
  ...
  - **Create public key** Make this API call described in [plaid docs](https://plaid.c../api/sandbox/#sandboxpublic_tokencreate)
