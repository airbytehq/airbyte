...
| :------ | :--------- | :----------------------------------------------------------------------------- | :-------------------------- |
| 0.4.22 | 2026-09-14 | [PR_NUMBER](https://github.com/airbytehq/airbyte/pull/PR_NUMBER) | Migrate the `users` stream to the Aircall User V2 API ahead of the V1 sunset and add pagination |
