...
| :------ | :--------- | :----------------------------------------------------------------------------- | :-------------------------- |
| 0.4.22 | 2026-09-14 | [85909](https://github.com/airbytehq/airbyte/pull/85909) | Migrate the `users` stream to the Aircall User V2 API ahead of the V1 sunset and add pagination |
