...
This source can sync data for the [Railz API](https://docs.railz.ai/). This page guides you through
the process of setting up the Railz source connector.
...
Generate API key [on the dashboard](https://dashboard.railz.ai/developers/api-keys) and take it's
...
3. On the source setup page, select **Railz** from the Source type dropdown and enter a name for
   this connector;
...
- [Accounting Transactions](https://docs.railz.ai/reference/get-accountingtransactions)
  \(Incremental sync\)
...
- [Invoices Credit Notes](https://docs.railz.ai/reference/get-invoice-creditnotes) \(Incremental
  sync\)
...
The Railz connector should gracefully handle Railz API limitations under normal usage. Please
