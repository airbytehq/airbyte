...
| --- | --- | --- | --- |
| 1.0.2 | 2026-09-18 | [86466](https://github.com/airbytehq/airbyte/pull/86466) | Fix authentication failures (HTTP 401) on channels with many videos: refresh the access token and retry on 401, and shorten API budget windows so syncs no longer wait past the token lifetime |
