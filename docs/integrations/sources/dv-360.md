...
Available filters and metrics are provided in this [page](https://developers.google.com/bid-manager/v2/filters-metrics).
...
3. Fill out a start date, and optionally, an end date and filters (check the [Queries documentation](https://developers.google.com/bid-manager/v2/queries)) .
4. You're done.
...
| :------ | :--------- | :------------------------------------------------------- | :------------------------------------------- |
| 0.2.0   | 2023-10-28 | [31564](https://github.com/airbytehq/airbyte/pull/31564) | Migrate API to v2 |
