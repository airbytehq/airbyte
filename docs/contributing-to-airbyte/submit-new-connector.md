...
1. Verify if there is an existing [Discussion](https://github.com/airbytehq/airbyte/discussions/categories/new-connector-request) for a connector you have in mind
...
See [the Connector Development](../connector-development/README.md) guide for more details on how to build a connector. For most API source connectors, Connector Builder is the way to go.
...
4. Wait for a review from a community maintainer or our team. We generally look for:
  - Does this PR cover authentication, pagination, incremental syncs where applicable?
