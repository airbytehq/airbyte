...
_Note: If you are looking for reference documentation for the deprecated first version of test suites, see_ [_Standard Tests \(Legacy\)_](https://github.com/airbytehq/airbyte/tree/88b77aa9f3ae8ca0e0de8d246e3543a13d9e7d19/docs/contributing-to-airbyte/building-new-connector/legacy-standard-source-tests.md)_._
...
See all the test cases, their description, and inputs in [Source Acceptance Tests](https://github.com/airbytehq/airbyte/tree/88b77aa9f3ae8ca0e0de8d246e3543a13d9e7d19/docs/contributing-to-airbyte/building-new-connector/source-acceptance-tests.md).
