...
Our security and reliability commitments are only applicable to Airbyte Cloud. Airbyte Open Source
...
If you’re deploying Airbyte Open Source on GCP, you may use Google
