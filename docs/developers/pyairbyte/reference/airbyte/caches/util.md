...
### `get_colab_cache` {#airbyte.caches.util.get_colab_cache}
...
### `get_default_cache` {#airbyte.caches.util.get_default_cache}
...
### `new_local_cache` {#airbyte.caches.util.new_local_cache}
