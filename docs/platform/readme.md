...
<CardWithIcon title="Plus" description="A cloud solution with all the capabilities of Standard, but with predictable, capacity-based annual pricing." ctaText="Talk to Sales" ctaLink="https://airbyte.com/company/talk-to-sales" icon="fa-lock" />
