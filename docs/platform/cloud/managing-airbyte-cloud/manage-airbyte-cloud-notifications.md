...
| **Queued syncs**                        | &#10003; | &#10003;     | A sync from any of your connections is queued due to capacity limits. Off by default. See [Manage and monitor data workers](./manage-data-workers.md).      |
