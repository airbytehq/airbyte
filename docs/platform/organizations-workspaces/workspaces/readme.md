...
- Control data residency and sovereignty. Each workspace can run syncs in a separate region.
    ...
    - If you use [Enterprise Flex](../../enterprise-flex/readme.md) or [Self-Managed Enterprise](../../enterprise-setup/README.md), you can also self-manage your own regions and data planes on your own infrastructure.
