...
3. **Contribute back to Airbyte**. If you want to contribute what you’ve built to the connector Marketplace, follow the steps provided in the [contribution guide for submitting new connectors](../contributing-to-airbyte/submit-new-connector.md).
