...
:::info {{product_name_sm_enterprise}} customers
If you're a {{product_name_sm_enterprise}} customer, skip this guide. Instead, follow the steps outlined in [{{product_name_sm_enterprise}}](../enterprise-setup/README.md) and the associated [implementation guide](../enterprise-setup/implementation-guide.md).
:::
