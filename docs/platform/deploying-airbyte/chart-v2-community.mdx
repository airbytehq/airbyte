...
sidebar_label: Upgrade to Helm chart V2 (Core)
---
...
# Upgrade to Helm chart V2 ({{product_name_sm_oss}})
...
Follow the [{{product_name_sm_enterprise}} guide](../enterprise-setup/chart-v2-enterprise) instead.
:::
