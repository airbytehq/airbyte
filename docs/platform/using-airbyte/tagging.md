...
### On-demand tag (Cloud Pro and Enterprise Flex)

When you enable [on-demand capacity](/platform/cloud/managing-airbyte-cloud/manage-data-workers#on-demand-capacity) for a connection, Airbyte automatically applies an "On-demand" tag. This tag has an orange gradient background with a star icon and is visually distinct from user-created tags.

![On-demand tag](images/on-demand-tag.png)

- The On-demand tag appears automatically when you enable "Use on-demand capacity" in a connection's Settings.
- The On-demand tag is removed automatically when you disable on-demand capacity.
- You can filter the Connections page by the On-demand tag to see all on-demand connections.
- Hovering on the On-demand tag displays a tooltip: "This connection uses on-demand capacity for syncs".
