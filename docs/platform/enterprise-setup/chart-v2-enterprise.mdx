...
sidebar_label: Upgrade to Helm chart V2 (Self-Managed Enterprise)
---
...
# Upgrade to Helm chart V2 ({{product_name_sm_enterprise}})
...
Follow the [{{product_name_sm_oss}} guide](../deploying-airbyte/chart-v2-community) instead.
:::
