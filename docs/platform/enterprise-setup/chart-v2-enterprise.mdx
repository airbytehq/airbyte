...
- Airbyte installed and managed with abctl version 0.30.0 or later (abctl uses Helm chart V2 by default starting with version 0.30.0)
...
:::note abctl users
If you use abctl to manage Airbyte, you don't need to follow this migration guide. Simply upgrade abctl to version 0.30.0 or later, and it will automatically use Helm chart V2 for new installations. Run `abctl local install` to upgrade your existing installation.
:::
