...
Docker and Java with the versions listed in the [tech stack section](../10-understanding-airbyte/09-tech-stack.md).
...
In order to best propagate user-friendly error messages and log error information to the platform, the [Airbyte Protocol](../10-understanding-airbyte/02-airbyte-protocol.md#The Airbyte Protocol) implements AirbyteTraceMessage.
...
For more details on what the spec is, you can read about the Airbyte Protocol [here](../10-understanding-airbyte/02-airbyte-protocol.md).
...
For a brief overview on the Airbyte catalog check out [the Beginner's Guide to the Airbyte Catalog](../10-understanding-airbyte/01-beginners-guide-to-catalog.md).
