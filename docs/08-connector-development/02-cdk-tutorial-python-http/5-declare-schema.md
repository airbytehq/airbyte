...
You can also dynamically define schemas, but that's beyond the scope of this tutorial. See the [schema docs](../07-cdk-python/03-full-refresh-stream.md#defining-the-streams-schema) for more information.
