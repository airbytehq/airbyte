...
Docker and Python with the versions listed in the [tech stack section](../10-understanding-airbyte/09-tech-stack.md). You can use any Python version between 3.7 and 3.9, but this tutorial was tested with 3.7.
...
The destination interface is described in detail in the [Airbyte Specification](../10-understanding-airbyte/02-airbyte-protocol.md) reference.
