...
Docker, Python, and Java with the versions listed in the [tech stack section](../10-understanding-airbyte/09-tech-stack.md).
...
Note that for simple and quick testing use cases, you can also do this step [using the UI](../02-integrations/03-custom-connectors.md#adding-your-connectors-in-the-ui).
