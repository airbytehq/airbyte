...
The type declaration can be found [here](../dataline-config/src/main/resources/json/StandardConnectionStatus.json).
...
The type declaration can be found [here](../dataline-config/src/main/resources/json/StandardDiscoveryOutput.json).
...
The type declaration can be found [here](../dataline-config/src/main/resources/json/StandardSyncConfiguration.json).
...
The type declaration can be found [here](../dataline-config/src/main/resources/json/StandardSyncSummary.json).
...
The type declaration can be found [here](../dataline-config/src/main/resources/json/StandardSyncSchedule.json).
