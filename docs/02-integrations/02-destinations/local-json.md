...
Note: If you are running Airbyte on Windows with Docker backed by WSL2, you have to use similar step as above or refer to this [link](../../06-operator-guides/08-locating-files-local-destination.md) for an alternative approach.
