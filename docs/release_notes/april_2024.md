...
- A new OSS [Quickstart](/using-airbyte/getting-started/quickstart) that automatically manages all install steps for you. Mac users can also use Brew to install the `abctl` command.
