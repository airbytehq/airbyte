...
Before upgrading from version 1.5 or earlier to version 1.6 or later, you must upgrade your service account. If you don't, Airbyte doesn't permit you to begin the upgrade. [Learn more](../enterprise-setup/upgrade-service-account.md).
:::
