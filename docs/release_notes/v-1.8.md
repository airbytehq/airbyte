...
It's summer time and that means grilling, fresh air, Coldplay concerts, and a new version of Airbyte. Airbyte 1.8 was released on August 11, 2025. We're excited to share new improvements and changes to the Airbyte platform.
...
You may notice slight visual and content differences on some pages as a result of this change. For example, when upgrading a connector version, Airbyte no longer lists the connections affected by the upgrade. These messages were too unwieldy in large workspaces with many connections.
...
### abctl uses Helm chart V2 by default

Version 0.30 of abctl uses Helm chart V2 by default when installing new versions of Airbyte. [**Learn more >**](#)
