...
To support Airbyte's data activation capabilities, a new [Salesforce](../integrations/enterprise-connectors/destination-salesforce-enterprise) destination is available exclusively to enterprise customers for an additional charge.
