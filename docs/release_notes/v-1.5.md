...
Airbyte now instruments a number of crucial metrics about syncs and data movement. If you use OTel as your observability framework, you can configure Airbyte to send this data to an OTel collector endpoint so you can consume these metrics in your monitoring tool of choice. The following metrics are available:
