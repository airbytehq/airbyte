...
- As we prepare to deprecate Docker Compose, we published a [migration guide](/using-airbyte/getting-started/migration-guide#docker-compose) for those migrating from Docker Compose to abctl.
