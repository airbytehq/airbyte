...
We go fast so you don't get furious. Airbyte version 2.0 was released on October 9, 2025. This version marks a major achievement in Airbyte's platform architecture. We're excited to share new improvements and changes to the Airbyte platform.
...
- Ingress: Airbyte now ships ingress with the helm chart. If you already have ingress set up, you can continue using your existing configuration. However, you might find with a new deployment, it's easier to enable ingress through `values.yaml`. [**Learn&nbsp;more&nbsp;>**](/platform/deploying-airbyte/integrations/ingress)
