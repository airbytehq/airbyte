...
This page includes new features and improvements to the Airbyte products as of v1.0. We are excited to share the release of v1.0 with you, which contains many improvements and additions to enhance the reliability and transparency of Airbyte.
...
- Built Enterprise-specific connectors (Oracle and Workday)
