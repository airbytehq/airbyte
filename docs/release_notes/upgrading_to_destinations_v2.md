...
To see more details and examples on the contents of the Destinations V2 release, see this [guide](/docs/understanding-airbyte/typing-deduping.md). The remainder of this page will walk you through upgrading connectors from legacy normalization to Destinations V2.
