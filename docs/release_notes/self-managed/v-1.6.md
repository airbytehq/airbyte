...
- Self-Managed Enterprise customers can create, update, delete, and list data planes using the new `/dataplane` endpoint. Previously, data plane endpoints were under `/region`. For more information about creating data planes, see [Multiple region deployments](/platform/enterprise-setup/).
...
Airbyte 1.6.6 was released on August 25, 2025.

- 1.6.6 is a security patch release. The base images have been updated to address security vulnerabilities.
