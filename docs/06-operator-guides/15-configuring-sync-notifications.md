...
Assuming you have a [running instance of Airbyte](../05-deploying-airbyte/README.md), we can navigate to the UI. Click on Settings and then click on `Notifications`.
