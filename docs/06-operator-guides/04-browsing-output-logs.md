...
For example, it is often useful to inspect the content of the [catalog](../10-understanding-airbyte/01-beginners-guide-to-catalog.md) file. You could do so by running a `cat` command:
