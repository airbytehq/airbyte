...
When incremental syncs are enabled and "Split up interval" is set, the connector is not fetching all
...
- **Do not use incremental sync** and always sync the full set of records to always have a
