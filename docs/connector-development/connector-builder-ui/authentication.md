...
If the API uses other grant types like PKCE are required, it's not possible to use the connector
...
This can be done using the "Overwrite config with refresh token response" setting. If enabled, the
