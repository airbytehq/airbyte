...
Errors can also be defined by parsing the error message. For instance, this error handler will
...
The strategy accepts an optional regular expression to extract the time from the header value, and a
