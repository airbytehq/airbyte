...
For the technical JSON schema definition that low code manifests are validated against, see [here](https://github.com/airbytehq/airbyte/blob/main/airbyte-cdk/python/airbyte_cdk/sources/declarative/declarative_component_schema.yaml).
