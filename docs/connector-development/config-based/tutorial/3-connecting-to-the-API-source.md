...
- `source-exchange_rates-tutorial/integration_tests/configured_catalog.json`: This is the connector's [catalog](../../../understanding-airbyte/beginners-guide-to-catalog.md). It describes what data to read from the source.
...
More details on the connector definition file can be found in the [Understanding the YAML file](../understanding-the-yaml-file.md) and [Source schema](../source_schema.yaml) sections.
...
- [Understanding the YAML file](../understanding-the-yaml-file.md)
- [Authentication](../understanding-the-yaml-file.md#configuring-the-authentication)
- [Request options providers](../understanding-the-yaml-file.md#request-options-provider)
