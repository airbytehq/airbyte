...
More details on the connector manifest file can be found in the [overview](../low-code-cdk-overview.md) and [connection definition](../understanding-the-yaml-file/manifest-overview.md) sections.
