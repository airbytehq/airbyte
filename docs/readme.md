...
Next, check out the [Airbyte Open Source QuickStart](/deploying-airbyte/local-depolyment). Then learn how to [deploy](/deploying-airbyte/local-deployment) and [manage](/operator-guides/upgrading-airbyte) Airbyte Open Source in your cloud infrastructure. 
