...
/**
 * This interface provides a java interface over all interactions with a Source from the POV of the platform. It encapsulates the full lifecycle of
 * the Source as well as any outputs.
 */
public interface AirbyteSource extends AutoCloseable {
   ...
   *
   * @param sourceConfig - contains the arguments that must be passed to the read method of the Source.
  ...
  /**
   * Means no more data will be emitted by the Source. This may be because all data has already been emitted or because the Source container has
   * exited.
   *
  ...
  /**
   * Gets the exit value of the source process. This should only be called after the source process has finished.
   *
