...
public class RecordSchemaValidator {
   ...
   */
  public void validateSchema(final AirbyteRecordMessage message, final AirbyteStreamNameNamespacePair messageStream) throws RecordSchemaValidationException {
