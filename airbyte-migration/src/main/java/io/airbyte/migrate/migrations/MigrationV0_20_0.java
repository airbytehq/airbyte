 ...
 *
 * <p>Additionally, this migration updates the JSON Schema for StandardWorkspace with a new optional
...
public class MigrationV0_20_0 extends BaseMigration implements Migration {
  ...
  public MigrationV0_20_0(final Migration previousMigration) {
  ...
  public Map<ResourceId, JsonNode> getInputSchema() {
    ...
    outputSchema.put(
        ...
        MigrationUtils.getSchemaFromResourcePath(
            Path.of("migrations/migrationV0_20_0"), STANDARD_WORKSPACE_RESOURCE_ID));
    outputSchema.put(
        STANDARD_SOURCE_DEFINITION_RESOURCE_ID,
        MigrationUtils.getSchemaFromResourcePath(
            Path.of("migrations/migrationV0_20_0"), STANDARD_SOURCE_DEFINITION_RESOURCE_ID));
    outputSchema.put(
        STANDARD_DESTINATION_DEFINITION_RESOURCE_ID,
        MigrationUtils.getSchemaFromResourcePath(
            Path.of("migrations/migrationV0_20_0"), STANDARD_DESTINATION_DEFINITION_RESOURCE_ID));
    outputSchema.put(
        STANDARD_SYNC_RESOURCE_ID,
        MigrationUtils.getSchemaFromResourcePath(
            Path.of("migrations/migrationV0_20_0"), STANDARD_SYNC_RESOURCE_ID));
    return outputSchema;
  }
