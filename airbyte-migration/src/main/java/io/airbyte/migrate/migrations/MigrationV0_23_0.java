...
public class MigrationV0_23_0 extends BaseMigration implements Migration {
  ...
  public MigrationV0_23_0(final Migration previousMigration) {
  ...
  public Map<ResourceId, JsonNode> getOutputSchema() {
    ...
    outputSchema.put(
        ...
        MigrationUtils.getSchemaFromResourcePath(
            Path.of("migrations/migrationV0_23_0"), SOURCE_DEFINITION_RESOURCE_ID));
    outputSchema.put(
        DESTINATION_DEFINITION_RESOURCE_ID,
        MigrationUtils.getSchemaFromResourcePath(
            Path.of("migrations/migrationV0_23_0"), DESTINATION_DEFINITION_RESOURCE_ID));
    outputSchema.put(
        STANDARD_SYNC_RESOURCE_ID,
        MigrationUtils.getSchemaFromResourcePath(
            Path.of("migrations/migrationV0_23_0"), STANDARD_SYNC_RESOURCE_ID));
    return outputSchema;
  }
