...
class InterleavedStreamDetector:
    ...
    def build_dependency_chain(self, start_stream: str, relationships: Dict[str, List[str]], 
                             stream_definitions: Dict[str, Any], visited: Set[str] = None) -> Set[str]:
    ...
    def detect_performance_indicators(self, manifest: Dict[str, Any]) -> Dict[str, Any]:
        ...
        indicators = {
            'incremental_dependency_streams': [],
            'grouped_partition_routers': [],
    ...
    def generate_metadata_extension(self, analysis: Dict[str, Any]) -> Dict[str, Any]:
        ...
        extension = {
            'interleavedStreams': {
                'relationships': analysis['interleaved_streams']
            }
        }
...
def main():
    ...
    parser.add_argument('--generate-metadata', action='store_true', 
                       help='Generate metadata.yaml extensions for undocumented streams')
