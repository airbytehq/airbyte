...
KUBE=true IS_GKE=true SUB_BUILD=PLATFORM USE_EXTERNAL_DEPLOYMENT=true SHOULD_RUN_CHECK_CONNECTION_DURING_SYNC=false ./gradlew :airbyte-tests:acceptanceTests --scan -i
