...
VERSION=dev TRACKING_STRATEGY=logging docker-compose -f docker-compose.yaml -f octavia-cli/integration_tests/docker-compose-proxy.yaml run -d --service-ports nginx-proxy
