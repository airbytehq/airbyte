...
write_standard_creds source-tiktok-marketing "$SOURCE_TIKTOK_MARKETING_TEST_ACCESS_TOKEN_CREDS" "config_access_token.json"
write_standard_creds source-tiktok-marketing "$SOURCE_TIKTOK_MARKETING_OAUTH_CREDS" "config_oauth.json"
