...
write_standard_creds source-braintree-singer "$BRAINTREE_INTEGRATION_TEST_CREDS"
write_standard_creds source-file "$AWS_S3_INTEGRATION_TEST_CREDS" "aws.json"
write_standard_creds source-freshdesk "$FRESHDESK_INTEGRATION_TEST_CREDS"
write_standard_creds source-facebook-marketing-api-singer "$FACEBOOK_MARKETING_API_INTEGRATION_TEST_CREDS"
...
write_standard_creds source-googleanalytics-singer "$GOOGLE_ANALYTICS_INTEGRATION_TEST_CREDS"
write_standard_creds source-googleanalytics-singer "$GOOGLE_ANALYTICS_INTEGRATION_TEST_TRACKING_ID" "tracker.txt"
write_standard_creds source-google-sheets "$GSHEETS_INTEGRATION_TEST_CREDS" "creds.json"
write_standard_creds source-greenhouse "$GREENHOUSE_INTEGRATION_TEST_CREDS"
write_standard_creds source-hubspot-singer "$HUBSPOT_INTEGRATION_TEST_CREDS"
write_standard_creds source-intercom-singer "$INTERCOM_INTEGRATION_TEST_CREDS"
write_standard_creds source-mailchimp "$MAILCHIMP_INTEGRATION_TEST_CREDS"
write_standard_creds source-marketo-singer "$SOURCE_MARKETO_SINGER_INTEGRATION_TEST_CREDS"
...
write_standard_creds source-salesforce-singer "$SALESFORCE_INTEGRATION_TEST_CREDS"
...
write_standard_creds source-slack-singer "$SLACK_INTEGRATION_TEST_CREDS"
write_standard_creds source-stripe-singer "$STRIPE_INTEGRATION_TEST_CREDS"
write_standard_creds source-twilio-singer "$TWILIO_INTEGRATION_TEST_CREDS"
write_standard_creds source-zendesk-singer "$ZENDESK_INTEGRATION_TEST_CREDS"
