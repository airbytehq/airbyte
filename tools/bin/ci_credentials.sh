...
write_standard_creds source-mailchimp "$MAILCHIMP_TEST_CREDS_APIKEY" "config_apikey.json"
write_standard_creds source-mailchimp "$SOURCE_MAILCHIMP_TEST_CREDS_OAUTH" "config_oauth.json"
