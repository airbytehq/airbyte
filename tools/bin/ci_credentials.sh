...
write_standard_creds destination-mysql "$DESTINATION_MYSQL_SSH_KEY_TEST_CREDS" "ssh-key-config.json"
write_standard_creds destination-mysql "$DESTINATION_MYSQL_SSH_PWD_TEST_CREDS" "ssh-pwd-config.json"
