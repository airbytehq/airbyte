...
write_standard_creds destination-s3 "$DESTINATION_S3_CSV_INTEGRATION_TEST_CREDS" "config_csv.json"
write_standard_creds destination-s3 "$DESTINATION_S3_PARQUET_INTEGRATION_TEST_CREDS" "config._parquet.json"
