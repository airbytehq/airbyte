...
read_secrets source-harvest "$SECRET_SOURCE_HARVEST_CREDS"
read_secrets source-harvest "$SECRET_SOURCE_HARVEST_CREDS_OAUTH" "config_oauth.json"
read_secrets source-harvest "$SECRET_SOURCE_HARVEST_CREDS_OLD" "old_config.json"
