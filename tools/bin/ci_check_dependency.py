...
SOURCE_DEFINITIONS_PATH = "./airbyte-config-oss/init/src/main/resources/seed/source_definitions.yaml"
DESTINATION_DEFINITIONS_PATH = "./airbyte-config-oss/init/src/main/resources/seed/destination_definitions.yaml"
IGNORE_LIST = [
    # Java
