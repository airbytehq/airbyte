...
SUB_BUILD=PLATFORM ./gradlew :airbyte-config:config-models:logClientsIntegrationTest  --scan
...
SUB_BUILD=PLATFORM ./gradlew  :airbyte-config:config-models:log4j2IntegrationTest --scan --rerun-tasks -i
