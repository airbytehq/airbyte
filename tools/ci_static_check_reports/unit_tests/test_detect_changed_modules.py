...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
                ...
                [{"folder": "airbyte-cdk/python", "lang": "py", "module": "airbyte-cdk/python"}],
        ),
        (
                [
                    "airbyte-cdk/python/airbyte_cdk/entrypoint.py",
                ...
                [{"folder": "airbyte-cdk/python", "lang": "py", "module": "airbyte-cdk/python"},
                 {"folder": "airbyte-integrations/connectors/source-asana", "lang": "py", "module": "connectors/source-asana"}],
        ),
        (
                [],
                [],
        ...
        (
                ...
                [
                    {"folder": "airbyte-integrations/connectors/destination-amazon-sqs", "lang": "py",
                     "module": "connectors/destination-amazon-sqs"},
                ],
        ),
        (
