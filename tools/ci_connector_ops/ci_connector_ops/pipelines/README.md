...
| `--ci_gcs_credentials_secret`       | False    |                 | `GCP_GSM_CREDENTIALS`               | The service account key to upload files to the GCS buckets (spec cache, metadata service, test reports)                                                                                                    |
