...
CLOUD_CATALOG_URL = "https://stage-connectors.airbyte.com/files/registries/v0/cloud_registry.json"
OSS_CATALOG_URL = "https://stage-connectors.airbyte.com/files/registries/v0/oss_registry.json"
