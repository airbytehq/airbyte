...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/airbyteio/airbyte/Dataline%20CI) ![License](https://img.shields.io/github/license/airbyteio/airbyte)
...
* [Slack](https://join.slack.com/t/airbytehq/shared_invite/zt-h5m88w3a-twQ_6AF9e8SnAzOIkHu2VQ) \(For live discussion with the Community and Dataline team\)
...
Dataline is licensed under the MIT license. See the [LICENSE](https://docs.airbyte.io/license) file for licensing information.
