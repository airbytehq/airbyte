...
public interface ConnectionManagerWorkflow {
  ...
  /**
   * Workflow method to launch a {@link ConnectionManagerWorkflow}. Launches a workflow responsible for scheduling syncs. This workflow will run and
   * then continue running until deleted.
   */
  @WorkflowMethod
