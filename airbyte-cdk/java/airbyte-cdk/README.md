...
|:-----------|:-----------|:------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0.48.19    | 2026-07-07 | [\#81456](https://github.com/airbytehq/airbyte/pull/81456)  | Bound the Debezium CDC event queue by approximate (configurable) byte size to prevent OOMs with large change events. Debezium `max.batch.size`/`max.queue.size`/`max.queue.size.in.bytes` defaults are now overridable by connectors. |
