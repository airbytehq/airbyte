...
class TestJdbcSqlOperations : JdbcSqlOperations() {
    ...
    public override fun insertRecordsInternal(database: JdbcDatabase,
    ...
    @Throws(Exception::class)
    override fun insertRecordsInternalV2(database: JdbcDatabase,
                                         records: List<PartialAirbyteMessage>,
                                         schemaName: String,
                                         tableName: String) {
        // Not required for the testing
    ...
    fun testCreateSchemaIfNotExists() {
        ...
        val exception = Assertions.assertThrows(SQLException::class.java) { createSchemaIfNotExists(db, schemaName) }
