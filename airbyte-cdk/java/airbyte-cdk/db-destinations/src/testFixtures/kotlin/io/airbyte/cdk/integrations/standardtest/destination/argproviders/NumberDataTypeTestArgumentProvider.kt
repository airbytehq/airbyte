...
class NumberDataTypeTestArgumentProvider : ArgumentsProvider {
    ...
    companion object {
        ...
        const val NUMBER_DATA_TYPE_ARRAY_TEST_CATALOG: String = "number_data_type_array_test_catalog.json"
        const val NUMBER_DATA_TYPE_ARRAY_TEST_MESSAGES: String = "number_data_type_array_test_messages.txt"
    }
}
