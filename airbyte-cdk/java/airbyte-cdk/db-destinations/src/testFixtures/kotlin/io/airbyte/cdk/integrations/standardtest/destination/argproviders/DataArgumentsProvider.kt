...
class DataArgumentsProvider : ArgumentsProvider {
    ...
    override fun provideArguments(context: ExtensionContext): Stream<out Arguments> {
        ...
        return Stream.of(
                ...
                Arguments.of(EDGE_CASE_CONFIG.getMessageFileVersion(protocolVersion), EDGE_CASE_CONFIG.getCatalogFileVersion(protocolVersion)) // todo - need to use the new protocol to capture this.
    ...
    companion object {
        val EXCHANGE_RATE_CONFIG: CatalogMessageTestConfigPair = CatalogMessageTestConfigPair("exchange_rate_catalog.json", "exchange_rate_messages.txt")
        val EDGE_CASE_CONFIG: CatalogMessageTestConfigPair = CatalogMessageTestConfigPair("edge_case_catalog.json", "edge_case_messages.txt")
        val NAMESPACE_CONFIG: CatalogMessageTestConfigPair = CatalogMessageTestConfigPair("namespace_catalog.json", "namespace_messages.txt")
    }
}
