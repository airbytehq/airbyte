...
abstract class DestinationAcceptanceTest(
     ...
     * [ getSpecialNumericTypesSupportTest()][.getSpecialNumericTypesSupportTest] method to specify
     * if connector supports Integer/Number NaN or Integer/Number Infinity types
     */
