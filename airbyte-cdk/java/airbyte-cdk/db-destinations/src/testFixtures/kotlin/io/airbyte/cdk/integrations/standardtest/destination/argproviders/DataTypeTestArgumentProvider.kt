...
class DataTypeTestArgumentProvider : ArgumentsProvider {
    private var protocolVersion: ProtocolVersion? = null
    ...
    @JvmRecord
    data class TestCompatibility(val requireBasicCompatibility: Boolean,
                                 val requireArrayCompatibility: Boolean,
                                 val requireObjectCompatibility: Boolean) {
        fun isTestCompatible(supportBasicDataTypeTest: Boolean, supportArrayDataTypeTest: Boolean, supportObjectDataTypeTest: Boolean): Boolean {
            LOGGER.info("---- Data type test compatibility ----")
            LOGGER.info("| Data type test | Require | Support |")
            LOGGER.info("| Basic test     | {}   | {}   |", (if (requireBasicCompatibility) "true " else "false"),
                    (if (supportBasicDataTypeTest) "true " else "false"))
            LOGGER.info("| Array test     | {}   | {}   |", (if (requireArrayCompatibility) "true " else "false"),
                    (if (supportArrayDataTypeTest) "true " else "false"))
            LOGGER.info("| Object test    | {}   | {}   |", (if (requireObjectCompatibility) "true " else "false"),
    ...
    class CatalogMessageTestConfigWithCompatibility(catalogFile: String, messageFile: String, val testCompatibility: TestCompatibility) : DataArgumentsProvider.CatalogMessageTestConfigPair(catalogFile, messageFile)

    companion object {
        private val LOGGER: Logger = LoggerFactory.getLogger(DataTypeTestArgumentProvider::class.java)
        ...
        val BASIC_TEST: CatalogMessageTestConfigWithCompatibility = CatalogMessageTestConfigWithCompatibility("data_type_basic_test_catalog.json", "data_type_basic_test_messages.txt",
                TestCompatibility(true, false, false))
        val ARRAY_TEST: CatalogMessageTestConfigWithCompatibility = CatalogMessageTestConfigWithCompatibility("data_type_array_test_catalog.json", "data_type_array_test_messages.txt",
                TestCompatibility(true, true, false))
        val OBJECT_TEST: CatalogMessageTestConfigWithCompatibility = CatalogMessageTestConfigWithCompatibility("data_type_object_test_catalog.json", "data_type_object_test_messages.txt",
                TestCompatibility(true, false, true))
        val OBJECT_WITH_ARRAY_TEST: CatalogMessageTestConfigWithCompatibility = CatalogMessageTestConfigWithCompatibility("data_type_array_object_test_catalog.json", "data_type_array_object_test_messages.txt",
