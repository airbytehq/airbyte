...
abstract class AbstractJdbcDestination<DestinationState : MinimumDestinationState>(
    ...
    protected open fun modifyDataSourceBuilder(builder: DataSourceFactory.DataSourceBuilder): DataSourceFactory.DataSourceBuilder {
        return builder
    }
    ...
    private fun assertCustomParametersDontOverwriteDefaultParameters(customParameters: Map<String, String>, defaultParameters: Map<String, String>) {
    ...
    protected open fun getDataTransformer(parsedCatalog: ParsedCatalog?, defaultNamespace: String?): StreamAwareDataTransformer {
