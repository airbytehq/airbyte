...
class JdbcInsertFlushFunction(private val recordWriter: RecordWriter<PartialAirbyteMessage?>) : DestinationFlushFunction {
    ...
    override val optimalBatchSizeBytes: Long
        get() =// TODO tune this value - currently SqlOperationUtils partitions 10K records per insert statement,
