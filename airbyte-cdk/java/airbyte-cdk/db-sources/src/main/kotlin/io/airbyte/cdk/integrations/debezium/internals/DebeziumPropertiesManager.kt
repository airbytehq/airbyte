...
abstract class DebeziumPropertiesManager(private val properties: Properties,
    ...
    fun getDebeziumProperties(
        ...
        schemaHistoryManager.ifPresent { m: AirbyteSchemaHistoryStorage? -> m!!.setDebeziumProperties(props) }
