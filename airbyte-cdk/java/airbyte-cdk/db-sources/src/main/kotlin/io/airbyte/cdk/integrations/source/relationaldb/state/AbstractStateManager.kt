...
/**
 * Abstract implementation of the [StateManager] interface that provides common functionality
...
abstract class AbstractStateManager<T, S> @JvmOverloads constructor(catalog: ConfiguredAirbyteCatalog?,
                                                                    ...
                                                                    onlyIncludeIncrementalStreams: Boolean = false) : StateManager {
    /**
     * The [CursorManager] responsible for keeping track of the current cursor value for each
     * stream managed by this state manager.
     */
    private val cursorManager: CursorManager<*> = CursorManager<Any?>(catalog, streamSupplier, cursorFunction, cursorFieldFunction, cursorRecordCountFunction, namespacePairFunction,
    ...
    abstract override fun toState(pair: Optional<AirbyteStreamNameNamespacePair?>): AirbyteStateMessage?
}
