...
open class ConfigBuilder<B : ConfigBuilder<B>> {
    ...
    protected var maxRecords: Long? = null
    protected var maxRecordBytes: Long? = null
    protected var maxTime: Duration? = null
    protected var upperBound: DebeziumComponent.State.Offset? = null
    protected var lsnMapper: DebeziumComponent.Config.LsnMapper<*>? = null
    ...
    fun build() = DebeziumComponent.Config(
    ...
    fun withTestTargets(): B = this
            .withUpperBound(DebeziumComponent.State.Offset(mapOf()))
            .withLsnMapper(object : DebeziumComponent.Config.LsnMapper<Comparable<Any>> {

                override fun get(offset: DebeziumComponent.State.Offset) = object : Comparable<Any> {
