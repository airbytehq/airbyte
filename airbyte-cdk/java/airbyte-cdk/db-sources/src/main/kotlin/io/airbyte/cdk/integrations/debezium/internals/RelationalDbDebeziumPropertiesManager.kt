...
class RelationalDbDebeziumPropertiesManager(properties: Properties,
                                            config: JsonNode,
                                            catalog: ConfiguredAirbyteCatalog) : DebeziumPropertiesManager(properties, config, catalog) {
    ...
    companion object {
        fun getTableIncludelist(catalog: ConfiguredAirbyteCatalog): String {
            ...
            return catalog.streams.stream()
                    ...
                    .map { stream: AirbyteStream -> stream.namespace + "." + stream.name } // debezium needs commas escaped to split properly
        ...
        fun getColumnIncludeList(catalog: ConfiguredAirbyteCatalog): String {
            ...
            return catalog.streams.stream()
                    ...
                    .map { s: AirbyteStream ->
                        ...
                        Pattern.quote(s.namespace + "." + s.name) + (if (StringUtils.isNotBlank(fields)) "\\.$fields" else "")
                    }
