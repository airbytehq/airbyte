...
class JdbcDataSourceUtilsTest {
    @Test
    fun test() {
        val validConfigString = "{\"jdbc_url_params\":\"key1=val1&key3=key3\",\"connection_properties\":\"key1=val1&key2=val2\"}"
        ...
        validKeys.forEach(Consumer { key: String -> Assert.assertTrue(connectionProperties.containsKey(key)) })

        // For an invalid config, there is a conflict betweeen the values of keys in jdbc_url_params and
        // connection_properties
        val invalidConfigString = "{\"jdbc_url_params\":\"key1=val2&key3=key3\",\"connection_properties\":\"key1=val1&key2=val2\"}"
