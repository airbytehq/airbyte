...
internal class DebeziumRecordPublisherTest {
    ...
    fun testTableIncludelistCreation() {
        val catalog = ConfiguredAirbyteCatalog().withStreams(ImmutableList.of(
        ...
        val expectedWhitelist = "\\Qpublic.id_and_name\\E,\\Qpublic.id_\\,something\\E,\\Qpublic.n\"aMéS\\E"
    ...
    fun testColumnIncludelistFiltersFullRefresh() {
        ...
        val expectedWhitelist = "\\Qpublic.id_and_name\\E\\.(\\Qfld2\\E|\\Qfld1\\E),\\Qpublic.id_\\,something\\E,\\Qpublic.n\"aMéS\\E"
    ...
    fun testColumnIncludeListEscaping() {
        ...
        val anchored = "^" + RelationalDbDebeziumPropertiesManager.getColumnIncludeList(catalog) + "$"
