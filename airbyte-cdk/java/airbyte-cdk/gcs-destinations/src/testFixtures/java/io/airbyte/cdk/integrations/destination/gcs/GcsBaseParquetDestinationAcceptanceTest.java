...
public abstract class GcsBaseParquetDestinationAcceptanceTest extends GcsAvroParquetDestinationAcceptanceTest {

  public GcsBaseParquetDestinationAcceptanceTest() {
  ...
  protected List<JsonNode> retrieveRecords(final TestDestinationEnv testEnv,
    ...
    for (final S3ObjectSummary objectSummary : objectSummaries) {
      ...
      try (final ParquetReader<Record> parquetReader = ParquetReader.<Record>builder(new AvroReadSupport<>(), path)
