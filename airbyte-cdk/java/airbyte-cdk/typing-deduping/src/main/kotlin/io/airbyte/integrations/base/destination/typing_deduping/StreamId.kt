 ...
 * [SqlGenerator.buildStreamId] instead.
 *
 *
 ...
 */
class StreamId(finalNamespace: String,
               finalName: String,
               rawNamespace: String,
               rawName: String,
    ...
    companion object {
        ...
        fun concatenateRawTableName(namespace: String, name: String): String {
            ...
            while (i < plainConcat.length) {
                ...
                longestUnderscoreRun = max(longestUnderscoreRun.toDouble(), underscoreRun.toDouble()).toInt()
                i++
            }
