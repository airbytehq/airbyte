...
interface BlobDecorator {
     ...
     */
    fun updateMetadata(metadata: Map<String?, String?>?, metadataKeyMapping: Map<String?, String?>?)
    ...
    companion object {
         ...
         */
        @VisibleForTesting
        fun insertMetadata(metadata: MutableMap<String?, String?>,
                           metadataKeyMapping: Map<String?, String?>,
                           key: String?,
                           value: String?) {
            if (metadataKeyMapping.containsKey(key)) {
                metadata[metadataKeyMapping[key]] = value
            }
        }
    }
}
