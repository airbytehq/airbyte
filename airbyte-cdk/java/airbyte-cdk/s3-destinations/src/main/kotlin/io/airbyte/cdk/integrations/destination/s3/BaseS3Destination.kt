...
abstract class BaseS3Destination protected constructor(protected val configFactory: S3DestinationConfigFactory = S3DestinationConfigFactory()) : BaseConnector(), Destination {
    ...
    override fun getConsumer(config: JsonNode?,
        ...
        return S3ConsumerFactory().create(
                ...
                S3StorageOperations(nameTransformer, s3Config!!.s3Client!!, s3Config),
                nameTransformer,
                getCreateFunction(s3Config, Function<String?, BufferStorage> { fileExtension: String? -> FileBuffer(fileExtension) }),
                s3Config,
                catalog)
    }
