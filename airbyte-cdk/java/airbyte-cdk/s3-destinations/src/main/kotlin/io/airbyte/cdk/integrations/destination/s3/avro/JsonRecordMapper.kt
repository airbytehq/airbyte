...
abstract class JsonRecordMapper<R> {
    fun mapRecordWithSchema(record: JsonNode?, schema: ObjectNode): R {
        ...
        return when (schemaType) {
            ...
            AirbyteJsonSchemaType.TIMESTAMP_WITHOUT_TIMEZONE -> mapDateTimeWithoutTimezone(record, schema)
            ...
            AirbyteJsonSchemaType.OBJECT_WITHOUT_PROPERTIES -> mapObjectWithoutProperties(record, schema)
