...
abstract class S3BaseDestinationAcceptanceTest(
    ...
    protected val outputFormat: FileUploadFormat = FileUploadFormat.RAW_FILES
     ...
     */
    override fun setup(testEnv: DestinationAcceptanceTest.TestDestinationEnv, TEST_SCHEMAS: HashSet<String>) {
