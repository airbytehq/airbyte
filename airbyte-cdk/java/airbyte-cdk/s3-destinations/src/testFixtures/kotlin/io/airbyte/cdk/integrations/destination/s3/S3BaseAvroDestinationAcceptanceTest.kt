...
abstract class S3BaseAvroDestinationAcceptanceTest protected constructor() : S3AvroParquetDestinationAcceptanceTest(S3Format.AVRO) {
    override val formatConfig: JsonNode?
        get() = Jsons.jsonNode(java.util.Map.of(
                "format_type", "Avro",
                "compression_codec", java.util.Map.of(
                "codec", "zstandard",
                "compression_level", 5,
    ...
    protected fun retrieveRecords(testEnv: TestDestinationEnv?,
        ...
        for (objectSummary in objectSummaries!!) {
            ...
            DataFileReader<GenericData.Record>(
                ...
                val jsonReader: ObjectReader = S3DestinationAcceptanceTest.Companion.MAPPER.reader()
    ...
    override val testDataComparator: TestDataComparator
        get() = S3AvroParquetTestDataComparator()
