...
public class S3CsvFormatConfigTest {
  ...
  public void testHandlePartSizeConfig() throws IllegalAccessException {
    ...
    final StreamTransferManager streamTransferManager = StreamTransferManagerFactory
        .create(s3DestinationConfig.bucketName, "objectKey", null)
        .get();
  ...
  public void testGzipCompressionConfig() {
    ...
    assertEquals(
        ...
        ((S3CsvFormatConfig) s3ConfigWithoutGzipCompression.formatConfig).compressionType);
    ...
    assertEquals(
        ...
        ((S3CsvFormatConfig) gcsConfigWithGzipCompression.formatConfig).compressionType);
  }
