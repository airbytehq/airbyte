...
internal class CatalogClientConvertersTest {
    ...
    companion object {
        ...
        private val STREAM: AirbyteStream = AirbyteStream()
        ...
        private val CLIENT_STREAM: io.airbyte.api.client.model.generated.AirbyteStream = io.airbyte.api.client.model.generated.AirbyteStream()
                .name(STREAM_NAME)
        ...
        private val CLIENT_DEFAULT_STREAM_CONFIGURATION: AirbyteStreamConfiguration = AirbyteStreamConfiguration()
        ...
        private val BASIC_MODEL_CATALOG: AirbyteCatalog = AirbyteCatalog().withStreams(
                Lists.newArrayList(STREAM))

        private val EXPECTED_CLIENT_CATALOG: io.airbyte.api.client.model.generated.AirbyteCatalog = io.airbyte.api.client.model.generated.AirbyteCatalog()
