...
internal class MoreResourcesTest {
    ...
    fun testResourceRead() {
        ...
        Assertions.assertThrows(IllegalArgumentException::class.java) { MoreResources.readResource("invalid") }
    }

    @Test
    @Throws(IOException::class)
    fun testResourceReadWithClass() {
        Assertions.assertEquals(CONTENT_1, MoreResources.readResource(MoreResourcesTest::class.java, RESOURCE_TEST))
        Assertions.assertEquals(CONTENT_2, MoreResources.readResource(MoreResourcesTest::class.java, "subdir/resource_test_sub"))

        Assertions.assertEquals(CONTENT_1, MoreResources.readResource(MoreResourcesTest::class.java, "/resource_test"))
        Assertions.assertEquals(CONTENT_2, MoreResources.readResource(MoreResourcesTest::class.java, "/subdir/resource_test_sub"))

        Assertions.assertThrows(IllegalArgumentException::class.java) { MoreResources.readResource(MoreResourcesTest::class.java, "invalid") }
    }
    ...
    @Throws(IOException::class)
    fun testReadBytes() {
        Assertions.assertEquals(CONTENT_1, String(MoreResources.readBytes(RESOURCE_TEST), StandardCharsets.UTF_8))
        Assertions.assertEquals(CONTENT_2, String(MoreResources.readBytes("subdir/resource_test_sub"), StandardCharsets.UTF_8))

        Assertions.assertThrows(IllegalArgumentException::class.java) { MoreResources.readBytes("invalid") }
    }
