...
interface ProcessFactory {
    ...
    companion object {
        ...
        fun extractShortImageName(fullImagePath: String): String {
            val noVersion = fullImagePath.split(VERSION_DELIMITER.toRegex()).dropLastWhile { it.isEmpty() }.toTypedArray()[0]

            val nameParts = noVersion.split(DOCKER_DELIMITER.toRegex()).dropLastWhile { it.isEmpty() }.toTypedArray()
