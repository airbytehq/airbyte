...
object TestConfigHelpers {
    ...
    fun createSyncConfig(multipleNamespaces: Boolean = false): ImmutablePair<Void?, StandardSyncInput> {
        ...
        val sourceConnectionConfig = SourceConnection()
        ...
        val destinationConnectionConfig = DestinationConnection()
        ...
        val normalizationOperation = StandardSyncOperation()
                ...
                .withOperatorNormalization(OperatorNormalization().withOption(OperatorNormalization.Option.BASIC))
                .withTombstone(false)

        val customDbtOperation = StandardSyncOperation()
        ...
        val syncInput = StandardSyncInput()
