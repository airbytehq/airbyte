...
class AirbyteIntegrationLauncher(private val jobId: String,
                                 ...
                                 private val featureFlags: FeatureFlags) : IntegrationLauncher {
    ...
    @Throws(TestHarnessException::class)
    override fun read(jobRoot: Path,
        ...
        val arguments: MutableList<String?> = Lists.newArrayList(
                "read",
                CONFIG, configFilename,
        ...
        return processFactory.create(
                ...
                resourceRequirement,
                allowedHosts,
                java.util.Map.of(Metadata.JOB_TYPE_KEY, Metadata.SYNC_JOB, Metadata.SYNC_STEP_KEY, Metadata.READ_STEP),
                workerMetadata,
                emptyMap(),
                emptyMap(),
    ...
    @Throws(TestHarnessException::class)
    override fun write(jobRoot: Path,
                       configFilename: String?,
                       configContents: String?,
                       catalogFilename: String?,
                       catalogContents: String?,
        ...
        return processFactory.create(
                ...
                resourceRequirement,
                allowedHosts,
                java.util.Map.of(Metadata.JOB_TYPE_KEY, Metadata.SYNC_JOB, Metadata.SYNC_STEP_KEY, Metadata.WRITE_STEP),
                workerMetadata,
                emptyMap(),
    ...
    private val workerMetadata: Map<String, String>
        get() =// We've managed to exceed the maximum number of parameters for Map.of(), so use a builder + convert
                // back to hashmap
            Maps.newHashMap(
                    ImmutableMap.builder<String, String>()
                            ...
                            .put(EnvVariableFeatureFlags.AUTO_DETECT_SCHEMA, featureFlags.autoDetectSchema().toString())
                            .put(EnvVariableFeatureFlags.APPLY_FIELD_SELECTION, featureFlags.applyFieldSelection().toString())
