...
class RecordSizeEstimatorTest {
  ...
  private static final long DATA_0_SIZE = RecordSizeEstimator.getStringByteSize(Jsons.serialize(DATA_0));
  private static final long DATA_1_SIZE = RecordSizeEstimator.getStringByteSize(Jsons.serialize(DATA_1));
  private static final long DATA_2_SIZE = RecordSizeEstimator.getStringByteSize(Jsons.serialize(DATA_2));
  ...
  public void testPeriodicSampling() {
    ...
    final PartialAirbyteRecordMessage record0 = new PartialAirbyteRecordMessage().withStream(stream).withData(DATA_0);
    final PartialAirbyteRecordMessage record1 = new PartialAirbyteRecordMessage().withStream(stream).withData(DATA_1);
    final PartialAirbyteRecordMessage record2 = new PartialAirbyteRecordMessage().withStream(stream).withData(DATA_2);
  ...
  public void testDifferentEstimationPerStream() {
    ...
    final PartialAirbyteRecordMessage record0 = new PartialAirbyteRecordMessage().withStream("stream1").withData(DATA_0);
    final PartialAirbyteRecordMessage record1 = new PartialAirbyteRecordMessage().withStream("stream2").withData(DATA_1);
    final PartialAirbyteRecordMessage record2 = new PartialAirbyteRecordMessage().withStream("stream3").withData(DATA_2);
