...
internal class SSLCertificateUtilsTest {
    ...
    fun testkeyStoreFromCertificateInternal(certString: String?, pwd: String, fs: FileSystem?, directory: String?) {
    ...
    fun testkeyStoreFromCertificate() {
        ...
        val exception: Exception = Assertions.assertThrows(CertificateException::class.java) {
    ...
    @Throws(KeyStoreException::class, IOException::class, CertificateException::class, NoSuchAlgorithmException::class, InvalidKeySpecException::class, InterruptedException::class)
    fun testKeyStoreFromClientCertificateInternal(
            ...
            directory: String?) {
        val ksUri = SSLCertificateUtils.keyStoreFromClientCertificate(certString, keyString, keyStorePassword, filesystem, directory)
        val ks = KeyStore.getInstance("PKCS12")
        val inputStream = Files.newInputStream(Path.of(ksUri))
    ...
    @Test
    @Throws(CertificateException::class, IOException::class, NoSuchAlgorithmException::class, InvalidKeySpecException::class, KeyStoreException::class, InterruptedException::class)
    fun testKeyStoreFromClientCertificate() {
        ...
        val exceptionKey: Exception = Assertions.assertThrows(InvalidKeySpecException::class.java) {
        ...
        val exceptionCert: Exception = Assertions.assertThrows(CertificateException::class.java) {
    ...
    companion object {
        ...
        const val caPem: String = ("-----BEGIN CERTIFICATE-----\n"
        ...
        const val clientKey_wrong_format: String = ("MIIEvwIBADANBgkqhkiG9w0BAQEFAASCBKkwggSlAgEAAoIBAQDBmUvDIVGZ5HsRgnXKns2fTf26pfKND45xu"
