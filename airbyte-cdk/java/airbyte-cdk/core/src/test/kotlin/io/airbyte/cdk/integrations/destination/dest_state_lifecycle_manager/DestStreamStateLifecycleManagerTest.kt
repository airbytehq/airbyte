...
internal class DestStreamStateLifecycleManagerTest {
    ...
    fun testBasicLifeCycle() {
        ...
        Assertions.assertEquals(LinkedList(List.of(STREAM1_MESSAGE2, STREAM2_MESSAGE1)), mgr!!.listPending())
        Assertions.assertTrue(mgr!!.listFlushed().isEmpty())
        Assertions.assertTrue(mgr!!.listCommitted().isEmpty())
        ...
        Assertions.assertTrue(mgr!!.listPending().isEmpty())
        Assertions.assertEquals(LinkedList(List.of(STREAM1_MESSAGE2, STREAM2_MESSAGE1)), mgr!!.listFlushed())
        Assertions.assertTrue(mgr!!.listCommitted().isEmpty())
        ...
        Assertions.assertTrue(mgr!!.listPending().isEmpty())
        Assertions.assertTrue(mgr!!.listFlushed().isEmpty())
        Assertions.assertEquals(LinkedList(List.of(STREAM1_MESSAGE2, STREAM2_MESSAGE1)), mgr!!.listCommitted())
    }
   ...
   */
    ...
    fun testFlushed() {
        ...
        Assertions.assertTrue(mgr!!.listPending().isEmpty())
        Assertions.assertEquals(LinkedList(List.of(STREAM1_MESSAGE1, STREAM2_MESSAGE1)), mgr!!.listFlushed())
        Assertions.assertTrue(mgr!!.listCommitted().isEmpty())
    }
    ...
    fun testCommitted() {
        ...
        Assertions.assertTrue(mgr!!.listPending().isEmpty())
        Assertions.assertTrue(mgr!!.listFlushed().isEmpty())
        Assertions.assertEquals(LinkedList(List.of(STREAM1_MESSAGE1, STREAM2_MESSAGE1)), mgr!!.listCommitted())
    }
   ...
   */
    ...
    companion object {
        private val STREAM1_MESSAGE1: AirbyteMessage = AirbyteMessage()
                .withType(AirbyteMessage.Type.STATE)
                .withState(AirbyteStateMessage()
                        .withType(AirbyteStateMessage.AirbyteStateType.STREAM)
                        .withStream(AirbyteStreamState().withStreamDescriptor(StreamDescriptor().withName("apples")).withStreamState(Jsons.jsonNode("a"))))
        private val STREAM1_MESSAGE2: AirbyteMessage = AirbyteMessage()
                .withType(AirbyteMessage.Type.STATE)
                .withState(AirbyteStateMessage()
                        .withType(AirbyteStateMessage.AirbyteStateType.STREAM)
                        .withStream(AirbyteStreamState().withStreamDescriptor(StreamDescriptor().withName("apples")).withStreamState(Jsons.jsonNode("b"))))
        private val STREAM2_MESSAGE1: AirbyteMessage = AirbyteMessage()
                .withType(AirbyteMessage.Type.STATE)
                .withState(AirbyteStateMessage()
                        .withType(AirbyteStateMessage.AirbyteStateType.STREAM)
                        .withStream(
                                AirbyteStreamState().withStreamDescriptor(StreamDescriptor().withName("bananas")).withStreamState(Jsons.jsonNode("10"))))
    }
}
