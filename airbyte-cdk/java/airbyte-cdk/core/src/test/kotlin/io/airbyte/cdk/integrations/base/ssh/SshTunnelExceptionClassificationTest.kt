...
internal class SshTunnelExceptionClassificationTest {
    ...
    fun `timeout SshException is classified as transient`() {
        ...
        val classified = SshTunnel.classifySshTunnelException(cause)
        ...
        assertEquals(SshTunnel.SSH_TIMEOUT_DISPLAY_MESSAGE, transient.message)
    ...
    @Test
    fun `plain IOException falls through to RuntimeException`() {
        val cause = IOException("some other I/O failure")
