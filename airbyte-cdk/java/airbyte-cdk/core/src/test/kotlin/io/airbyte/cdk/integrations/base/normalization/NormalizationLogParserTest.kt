...
internal class NormalizationLogParserTest {
    ...
    private fun runTest(rawLogs: String, expectedMessages: List<AirbyteMessage>, expectedDbtErrors: List<String>) {
        val messages = parser!!.create(BufferedReader(
                InputStreamReader(
                        ByteArrayInputStream(
                                rawLogs.toByteArray(StandardCharsets.UTF_8)),
