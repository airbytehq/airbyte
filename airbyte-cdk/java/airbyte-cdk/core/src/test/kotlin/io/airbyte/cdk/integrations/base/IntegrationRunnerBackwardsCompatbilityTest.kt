...
class IntegrationRunnerBackwardsCompatbilityTest {
    ...
    fun testByteArrayInputStreamVersusScanner() {
        ...
        for (testInput in testInputs) {
            // get new output
            val stream1: InputStream = ByteArrayInputStream(testInput.toByteArray(StandardCharsets.UTF_8))
            ...
            val stream2: InputStream = ByteArrayInputStream(testInput.toByteArray(StandardCharsets.UTF_8))
