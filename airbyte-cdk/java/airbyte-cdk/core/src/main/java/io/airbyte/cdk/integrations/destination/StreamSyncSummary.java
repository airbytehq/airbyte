 ...
 *                       not track this information. (this is primarily for backwards-compatibility
 *                       with the legacy destinations framework; new implementations should always
 *                       provide this information). If this value is empty, consumers should assume
 *                       that the sync wrote nonzero records for this stream.
 */
