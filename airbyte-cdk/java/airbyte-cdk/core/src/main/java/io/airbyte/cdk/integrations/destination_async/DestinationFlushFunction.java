...
public interface DestinationFlushFunction {
   ...
   * <p>
   * If you increase this, make sure that {@link DetectStreamToFlush#QUEUE_FLUSH_THRESHOLD_BYTES} is
   * larger than this value. Otherwise we may trigger flushes before reaching the optimal batch size.
   *
