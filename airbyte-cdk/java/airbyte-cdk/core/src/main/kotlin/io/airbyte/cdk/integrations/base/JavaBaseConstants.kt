...
object JavaBaseConstants {
    ...
    @JvmField
    val LEGACY_RAW_TABLE_COLUMNS: List<String> = java.util.List.of(
            COLUMN_NAME_AB_ID,
            COLUMN_NAME_DATA,
    ...
    @JvmField
    val V2_RAW_TABLE_COLUMN_NAMES_WITHOUT_META: Set<String> = java.util.Set.of(
            COLUMN_NAME_AB_RAW_ID,
            COLUMN_NAME_AB_EXTRACTED_AT,
            COLUMN_NAME_AB_LOADED_AT,
            COLUMN_NAME_DATA)
    @JvmField
    val V2_RAW_TABLE_COLUMN_NAMES: List<String> = java.util.List.of(
            COLUMN_NAME_AB_RAW_ID,
            COLUMN_NAME_AB_EXTRACTED_AT,
            COLUMN_NAME_AB_LOADED_AT,
            COLUMN_NAME_DATA,
            COLUMN_NAME_AB_META)
    @JvmField
    val V2_FINAL_TABLE_METADATA_COLUMNS: List<String> = java.util.List.of(
            COLUMN_NAME_AB_RAW_ID,
            COLUMN_NAME_AB_EXTRACTED_AT,
            COLUMN_NAME_AB_META)
