...
import io.airbyte.cdk.core.destination.async.DetectStreamToFlush
...
interface DestinationFlushFunction {
     ...
     */
    fun getOptimalBatchSizeBytes(): Long
     ...
     */
    fun getQueueFlushThresholdBytes(): Long {
        return max((10 * 1024 * 1024).toDouble(), getOptimalBatchSizeBytes().toDouble()).toLong()
    }
}
