...
interface GlobalDataSizeConstants {
    companion object {
        ...
        @JvmField
        val DEFAULT_MAX_BATCH_SIZE_BYTES: Int = DataSize.of(25L, ByteUnit.IEC.MEBIBYTE).toUnit(ByteUnit.IEC.BYTE).value.toInt()
         ...
         */
        @JvmField
        val MAX_FILE_SIZE: Long = DataSize.of(100L, ByteUnit.IEC.MEBIBYTE).toUnit(ByteUnit.IEC.BYTE).value.toLong()
    }
}
