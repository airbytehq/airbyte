...
interface Source : Integration {
     ...
     * @return [AutoCloseableIterator] that produces message. The iterator will be consumed until
     * no records remain or until an exception is thrown. [AutoCloseableIterator.close]
