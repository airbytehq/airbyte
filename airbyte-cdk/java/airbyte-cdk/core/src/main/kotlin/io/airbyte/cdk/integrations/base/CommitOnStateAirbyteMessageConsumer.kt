 ...
 */
abstract class CommitOnStateAirbyteMessageConsumer(private val outputRecordCollector: Consumer<AirbyteMessage>) : FailureTrackingAirbyteMessageConsumer(), AirbyteMessageConsumer {
    ...
    companion object {
        private val LOGGER: Logger = LoggerFactory.getLogger(CommitOnStateAirbyteMessageConsumer::class.java)
    }
}
