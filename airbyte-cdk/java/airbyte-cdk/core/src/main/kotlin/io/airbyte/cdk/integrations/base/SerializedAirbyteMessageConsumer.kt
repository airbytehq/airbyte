 ...
 * any messages.
 *  * 3. Consumes ALL records via
 * [SerializedAirbyteMessageConsumer.accept]
 *  * 4. Always (on success or failure) finalize by calling
 * [SerializedAirbyteMessageConsumer.close]
 *
 */
interface SerializedAirbyteMessageConsumer : CheckedBiConsumer<String?, Int?, Exception?>, AutoCloseable {
    /**
