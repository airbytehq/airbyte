 ...
 */
class JdbcSourceOperations : AbstractJdbcCompatibleSourceOperations<JDBCType?>(), SourceOperations<ResultSet?, JDBCType?> {
    ...
    override fun copyToJsonField(resultSet: ResultSet, colIndex: Int, json: ObjectNode?) {
        ...
        when (columnType) {
            JDBCType.BIT, JDBCType.BOOLEAN -> putBoolean(json!!, columnName, resultSet, colIndex)
            JDBCType.TINYINT, JDBCType.SMALLINT -> putShortInt(json!!, columnName, resultSet, colIndex)
            ...
            JDBCType.FLOAT, JDBCType.DOUBLE -> putDouble(json!!, columnName, resultSet, colIndex)
            JDBCType.REAL -> putFloat(json!!, columnName, resultSet, colIndex)
            JDBCType.NUMERIC, JDBCType.DECIMAL -> putBigDecimal(json!!, columnName, resultSet, colIndex)
            JDBCType.CHAR, JDBCType.VARCHAR, JDBCType.LONGVARCHAR -> putString(json!!, columnName, resultSet, colIndex)
            ...
            JDBCType.TIMESTAMP_WITH_TIMEZONE -> putTimestampWithTimezone(json!!, columnName, resultSet, colIndex)
            JDBCType.BLOB, JDBCType.BINARY, JDBCType.VARBINARY, JDBCType.LONGVARBINARY -> putBinary(json!!, columnName, resultSet, colIndex)
    ...
    @Throws(SQLException::class)
    override fun setCursorField(preparedStatement: PreparedStatement,
                                parameterIndex: Int,
                                cursorFieldType: JDBCType?,
                                value: String?) {
        when (cursorFieldType) {
            JDBCType.TIMESTAMP -> setTimestamp(preparedStatement, parameterIndex, value)
            JDBCType.TIMESTAMP_WITH_TIMEZONE -> setTimestampWithTimezone(preparedStatement, parameterIndex, value)
            JDBCType.TIME -> setTime(preparedStatement, parameterIndex, value)
            JDBCType.TIME_WITH_TIMEZONE -> setTimeWithTimezone(preparedStatement, parameterIndex, value)
            ...
            JDBCType.TINYINT, JDBCType.SMALLINT -> setShortInt(preparedStatement, parameterIndex, value!!)
            ...
            JDBCType.FLOAT, JDBCType.DOUBLE -> setDouble(preparedStatement, parameterIndex, value!!)
            JDBCType.REAL -> setReal(preparedStatement, parameterIndex, value!!)
            JDBCType.NUMERIC, JDBCType.DECIMAL -> setDecimal(preparedStatement, parameterIndex, value)
            JDBCType.CHAR, JDBCType.NCHAR, JDBCType.NVARCHAR, JDBCType.VARCHAR, JDBCType.LONGVARCHAR -> setString(preparedStatement, parameterIndex, value)
            JDBCType.BINARY, JDBCType.BLOB -> setBinary(preparedStatement, parameterIndex, value)
            else -> throw IllegalArgumentException(String.format("%s cannot be used as a cursor.", cursorFieldType))
        }
    }

    @Throws(SQLException::class)
    protected fun setTimestampWithTimezone(preparedStatement: PreparedStatement, parameterIndex: Int, value: String?) {
        try {
    ...
    @Throws(SQLException::class)
    protected fun setTimeWithTimezone(preparedStatement: PreparedStatement, parameterIndex: Int, value: String?) {
        try {
    ...
    override fun getAirbyteType(jdbcType: JDBCType?): JsonSchemaType {
        return when (jdbcType) {
            JDBCType.BIT, JDBCType.BOOLEAN -> JsonSchemaType.BOOLEAN
            JDBCType.TINYINT, JDBCType.SMALLINT -> JsonSchemaType.INTEGER
            JDBCType.INTEGER -> JsonSchemaType.INTEGER
            JDBCType.BIGINT -> JsonSchemaType.INTEGER
            JDBCType.FLOAT, JDBCType.DOUBLE -> JsonSchemaType.NUMBER
            JDBCType.REAL -> JsonSchemaType.NUMBER
            JDBCType.NUMERIC, JDBCType.DECIMAL -> JsonSchemaType.NUMBER
            JDBCType.CHAR, JDBCType.NCHAR, JDBCType.NVARCHAR, JDBCType.VARCHAR, JDBCType.LONGVARCHAR -> JsonSchemaType.STRING
            JDBCType.DATE -> JsonSchemaType.STRING
            JDBCType.TIME -> JsonSchemaType.STRING
            JDBCType.TIMESTAMP -> JsonSchemaType.STRING
            JDBCType.BLOB, JDBCType.BINARY, JDBCType.VARBINARY, JDBCType.LONGVARBINARY -> JsonSchemaType.STRING_BASE_64
