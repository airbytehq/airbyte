...
open class JdbcSourceOperations :
    ...
    override fun copyToJsonField(resultSet: ResultSet, colIndex: Int, json: ObjectNode) {
        ...
        when (columnType) {
            ...
            JDBCType.FLOAT,
            JDBCType.DOUBLE,
            -> putDouble(json!!, columnName, resultSet, colIndex)
    ...
    @Throws(SQLException::class)
    override fun setCursorField(preparedStatement: PreparedStatement, parameterIndex: Int, cursorFieldType: JDBCType?, value: String?) {
        when (cursorFieldType) {
            ...
            JDBCType.TINYINT,
            JDBCType.SMALLINT,
            -> setShortInt(preparedStatement, parameterIndex, value!!)
            ...
            JDBCType.FLOAT,
            JDBCType.DOUBLE,
            -> setDouble(preparedStatement, parameterIndex, value!!)
            ...
            JDBCType.VARCHAR,
            JDBCType.LONGVARCHAR,
            -> setString(preparedStatement, parameterIndex, value)
            JDBCType.BINARY,
            JDBCType.BLOB,
            -> setBinary(preparedStatement, parameterIndex, value)
            else ->
