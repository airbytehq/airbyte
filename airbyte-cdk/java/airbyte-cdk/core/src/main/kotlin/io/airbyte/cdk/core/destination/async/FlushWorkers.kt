...
import io.airbyte.cdk.core.destination.async.buffer.StreamAwareQueue
        ...
        val flushTask =
            Runnable {
                ...
                try {
                    ...
                    bufferDequeue.take(desc, destinationFlushFunction.getOptimalBatchSizeBytes()).use { batch ->
