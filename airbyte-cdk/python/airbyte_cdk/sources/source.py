...
class BaseSource(BaseConnector[TConfig], ABC, Generic[TConfig]):
    ...
    @abstractmethod
    def read(
        self, logger: logging.Logger, config: TConfig, catalog: ConfiguredAirbyteCatalog, state: MutableMapping[str, Any] = None
...
class Source(DefaultConnectorMixin, BaseSource[Mapping[str, Any]], ABC):
    ...
