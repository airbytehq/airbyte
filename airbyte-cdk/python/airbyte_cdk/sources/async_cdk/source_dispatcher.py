...
from airbyte_cdk.models import AirbyteMessage, AirbyteStateMessage, AirbyteStreamStatus, ConfiguredAirbyteCatalog, ConfiguredAirbyteStream, ConnectorSpecification
...
class SourceDispatcher(AbstractSource, ABC):
    ...
    def check_connection(self, logger: logging.Logger, config: Mapping[str, Any]) -> Tuple[bool, Optional[Any]]:
        ...
        return loop.run_until_complete(self.async_source.check_connection(logger, config))
