...
from airbyte_cdk.sources.streams.concurrent.partitions.types import QueueItemObject
...
class PartitionEnqueuer:
    ...
    def __init__(self, queue: Queue[QueueItemObject], thread_pool_manager: ThreadPoolManager, sleep_time_in_seconds: float = 0.1) -> None:
        """
    ...
    def generate_partitions(self, stream: AbstractStream) -> None:
        ...
        If an exception is encountered, it will be thrown and visible from the future it was submitted
