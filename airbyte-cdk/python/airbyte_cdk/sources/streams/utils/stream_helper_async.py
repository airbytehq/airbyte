...
async def get_first_stream_slice(stream: AsyncStream) -> Mapping[str, Any]:
    """
    ...
    """
    return await anext(stream.stream_slices(cursor_field=stream.cursor_field, sync_mode=SyncMode.full_refresh))
