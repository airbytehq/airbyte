...
from airbyte_cdk.sources.streams.call_rate import APIBudget, CallRatePolicy, HttpRequestMatcher, Rate, SessionProxyWithCallRate
...
class HttpStream(Stream, ABC):
    ...
    def __init__(self, authenticator: Optional[Union[AuthBase, HttpAuthenticator]] = None):
        ...
        api_budget.add_policy(always_match, CallRatePolicy([Rate(limit=50, interval=1000)]))
