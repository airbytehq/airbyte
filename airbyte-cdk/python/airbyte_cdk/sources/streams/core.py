...
def package_name_from_class(cls: object) -> str:
    ...
    if module is not None:
        ...
        msg = f"Could not find package name for class {cls}"
        ...
        if isinstance(keys, str):
            ...
            for component in keys:
                if isinstance(component, str):
                    ...
                    msg = f"Element must be either list or str. Got: {type(component)}"
                    raise ValueError(msg)
            return wrapped_keys
        else:
            msg = f"Element must be either list or str. Got: {type(keys)}"
            raise ValueError(msg)
