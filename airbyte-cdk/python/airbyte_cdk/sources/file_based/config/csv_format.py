...
class CsvHeaderFromCsv(BaseModel):
    model_config = one_of_model_config(title="From CSV", discriminator="header_definition_type")
    header_definition_type: Literal[CsvHeaderDefinitionType.FROM_CSV.value] = CsvHeaderDefinitionType.FROM_CSV.value
...
class CsvHeaderAutogenerated(BaseModel):
    model_config = one_of_model_config(title="Autogenerated", discriminator="header_definition_type")
    header_definition_type: Literal[CsvHeaderDefinitionType.AUTOGENERATED.value] = CsvHeaderDefinitionType.AUTOGENERATED.value
...
class CsvHeaderUserProvided(BaseModel):
    model_config = one_of_model_config(title="User Provided", discriminator="header_definition_type")
    header_definition_type: Literal[CsvHeaderDefinitionType.USER_PROVIDED.value] = CsvHeaderDefinitionType.USER_PROVIDED.value
