...
@dataclass
class BearerAuthenticator(DeclarativeAuthenticator, ComponentConstructor[BearerAuthenticatorModel]):
    """
...
@dataclass
class BasicHttpAuthenticator(DeclarativeAuthenticator, ComponentConstructor[BasicHttpAuthenticatorModel]):
    """
...
@dataclass
class LegacySessionTokenAuthenticator(DeclarativeAuthenticator, ComponentConstructor[LegacySessionTokenAuthenticatorModel]):
    """
    ...
    def resolve_dependencies(
        ...
        **kwargs: Any,
        ...
        if url_base is None:
            raise ValueError("url_base is required to resolve dependencies for LegacySessionTokenAuthenticator")
