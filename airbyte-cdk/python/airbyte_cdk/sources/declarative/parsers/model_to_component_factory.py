...
class ModelToComponentFactory:
    ...
    def create_jwt_authenticator(model: JwtAuthenticatorModel, config: Config, **kwargs: Any) -> JwtAuthenticator:
        return JwtAuthenticator(
            ...
            kid=model.jwt_headers.get("kid"),
            typ=model.jwt_headers.get("typ"),
            cty=model.jwt_headers.get("cty"),
            additional_jwt_headers=model.additional_jwt_headers,
            iss=model.jwt_payload.get("iss"),
            sub=model.jwt_payload.get("sub"),
            aud=model.jwt_payload.get("aud"),
