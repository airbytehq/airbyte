...
#   filename:  low_code_component_schema.yaml
...
class HttpResponseFilter(BaseModel):
    type: Optional[Literal["HttpResponseFilter"]] = None
    action: Action
...
class WaitTimeFromHeaderBackoffStrategy(BaseModel):
    type: Literal["WaitTimeFromHeaderBackoffStrategy"]
    header: str
    regex: Optional[str] = None
    _options: Optional[Dict[str, Any]] = Field(None, alias="$options")


class WaitUntilTimeFromHeaderBackoffStrategy(BaseModel):
    type: Literal["WaitUntilTimeFromHeaderBackoffStrategy"]
    header: str
...
class DefaultErrorHandler(BaseModel):
    type: Optional[Literal["DefaultErrorHandler"]] = None
...
class CompositeErrorHandler(BaseModel):
    type: Optional[Literal["CompositeErrorHandler"]] = None
...
class LowCodeComponentManifest(BaseModel):
    check: CheckStream
...
class DeclarativeStream(BaseModel):
    ...
    schema_loader: Optional[Union[DefaultSchemaLoader, JsonFileSchemaLoader]] = None
    stream_cursor_field: Optional[Union[str, List[str]]] = None
    transformations: Optional[List[Union[AddFields, RemoveFields]]] = None
    _options: Optional[Dict[str, Any]] = Field(None, alias="$options")
...
LowCodeComponentManifest.update_forward_refs()
