...
class AuthFlow(BaseModel):
    auth_flow_type: AuthFlowType | None = Field(None, description="The type of auth to use", title="Auth flow type")
...
class CursorPagination(BaseModel):
    ...
    decoder: JsonDecoder | None = Field(
        None,
...
class DefaultErrorHandler(BaseModel):
    ...
    backoff_strategies: list[
            ConstantBackoffStrategy | CustomBackoffStrategy | ExponentialBackoffStrategy | WaitTimeFromHeader | WaitUntilTimeFromHeader
        ] | None = Field(
        None,
...
class RecordSelector(BaseModel):
    ...
    record_filter: RecordFilter | None = Field(
        None,
...
class DeclarativeStream(BaseModel):
    ...
    primary_key: PrimaryKey | None = Field("", description="The primary key of the stream.", title="Primary Key")
    schema_loader: InlineSchemaLoader | JsonFileSchemaLoader | None = Field(
        None,
        description="Component used to retrieve the schema for the current stream.",
        title="Schema Loader",
    )
    transformations: list[AddFields | CustomTransformation | RemoveFields] | None = Field(
        None,
...
class HttpRequester(BaseModel):
    ...
    authenticator: ApiKeyAuthenticator | BasicHttpAuthenticator | BearerAuthenticator | CustomAuthenticator | OAuthAuthenticator | NoAuth | SessionTokenAuthenticator | LegacySessionTokenAuthenticator | None = Field(
        None,
    ...
    http_method: str | HttpMethodEnum | None = Field(
        "GET",
