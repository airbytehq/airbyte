...
class SessionTokenAuthenticator(BaseModel):
    ...
    api_url: str = Field(..., description="Base URL of the source.", examples=[None], title="API URL")
    header: str = Field(
        ...,
        description="The name of the header that will be injected in the request.",
        examples=["X-Session"],
        title="Session Token Header",
    )
    login_url: str = Field(
        ...,
        description="Path of the endpoint used to get a new session token.",
        title="Login URL",
    )
    session_token: str
