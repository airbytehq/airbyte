...
class HttpResponseFilter:
    ...
    def _response_matches_predicate(self, response: requests.Response) -> bool:
        return bool(self.predicate.condition and self.predicate.eval(None, response=self._safe_response_json(response), headers=response.headers))  # type: ignore # predicate is always cast to an interpolated string
