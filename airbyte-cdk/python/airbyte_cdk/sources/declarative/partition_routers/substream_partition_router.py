...
from airbyte_cdk.sources.declarative.types import Config, DeclarativeStreamSlice, Record, StreamSlice, StreamState
...
class SubstreamPartitionRouter(StreamSlicer):
    ...
    def _get_request_option(self, option_type: RequestOptionType, stream_slice: Optional[DeclarativeStreamSlice]) -> Mapping[str, Any]:
        params = {}
        if stream_slice:
                ...
                for parent_stream_slice in parent_stream.stream_slices(
                    ...
                    for parent_record in parent_stream.read_records(
                        ...
                        try:
                            ...
                            yield DeclarativeStreamSlice({stream_state_field: stream_state_value, "parent_slice": parent_partition}, {})
