...
@dataclass
class DeclarativeStream(Stream, DeclarativeComponentMixin, serialise_properties=()):
    """DeclarativeStream"""

    schema_loader: SchemaLoader.full_type_definition()
    retriever: Retriever.full_type_definition()

    stream_name: str
    stream_primary_key: str

    stream_cursor_field: Optional[List[str]] = None
    transformations: List = field(default_factory=list)  # TODO This is a list of record transformations...
