...
class SingerSource(BaseSource[ConfigContainer, str, str]):
    ...
    def read_cmd(self, logger: logging.Logger, config_path: str, catalog_path: str, state_path: Optional[str] = None) -> str:
    ...
    def _discover_internal(self, logger: logging.Logger, config_path: str) -> Catalogs:
        ...
        return SingerHelper.get_catalogs(
    ...
    def read(self, logger: logging.Logger, config: ConfigContainer, catalog_path: str, state_path: Optional[str] = None) -> Iterable[AirbyteMessage]:
