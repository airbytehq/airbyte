...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(pa.duration("s"), None, id="test_parquet_duration_s"),
        pytest.param(pa.duration("ms"), None, id="test_parquet_duration_ms"),
        pytest.param(pa.month_day_nano_interval(), None, id="test_parquet_month_day_nano_interval"),
        pytest.param(pa.binary(), None, id="test_binary"),
        pytest.param(pa.string(), {"type": "string"}, id="test_parquet_string"),
        pytest.param(pa.utf8(), {"type": "string"}, id="test_utf8"),
        pytest.param(pa.large_binary(), None, id="test_large_binary"),
