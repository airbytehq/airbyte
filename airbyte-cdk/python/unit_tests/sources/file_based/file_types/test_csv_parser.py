...
class CsvReaderTest(unittest.TestCase):
    ...
    def test_given_autogenerated_headers_when_read_data_then_generate_headers_with_format_fX(self) -> None:
        self._config_format.header_definition = CsvHeaderDefinition(definition_type=CsvHeaderDefinitionType.AUTOGENERATED)
    ...
    def test_given_user_provided_headers_when_read_data_then_use_user_provided_headers(self) -> None:
        self._config_format.header_definition = CsvHeaderDefinition(
            definition_type=CsvHeaderDefinitionType.USER_PROVIDED,
