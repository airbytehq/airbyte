...
@pytest.mark.parametrize(
    "error_code, expected_action, expected_failure_type, expected_error_message",
    [
...
def test_given_error_code_in_response_http_status_error_handler_returns_expected_actions(error_code, expected_action, expected_failure_type, expected_error_message):
    response = requests.Response()
