...
def test_value_is_static():
    ...
    interpolated_string = InterpolatedString(string=static_value)
...
def test_value_from_config():
    string = "{{ config['start'] }}"
    interpolated_string = InterpolatedString(string=string)
...
def test_default_value():
    ...
    default = 5678
    interpolated_string = InterpolatedString(string=static_value, default=default)
...
def test_interpolated_default_value():
    static_value = "{{ config['end'] }}"
    interpolated_string = InterpolatedString(string=static_value, default="{{ config['start'] }}")
