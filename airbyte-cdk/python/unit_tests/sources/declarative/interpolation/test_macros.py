...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("test_datetime_to_format", "datetime_to_format", True),
...
def test_datetime_to_format():
    datetime_to_format = macros['datetime_to_format']
    assert datetime_to_format("2022-01-01T01:01:01Z", "%Y-%m-%d") == "2022-01-01"
    assert datetime_to_format(datetime.datetime(2022, 1, 1, 1, 1, 1), "%Y-%m-%d") == "2022-01-01"
