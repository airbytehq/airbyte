...
@pytest.mark.parametrize(
    ...
    [
        ...
        (DATE_TIME_WITH_TZ_FORMAT, {"created_at": "2021-01-04T00:00:00+00:00"}, None, "2021-01-05T00:00:00+00:00", RECORDS_TO_FILTER_DATE_TIME_WITH_TZ_FORMAT, [3]),
        (DATE_TIME_WITH_TZ_FORMAT, {"created_at": "2021-01-04T00:00:00+00:00"}, None, None, RECORDS_TO_FILTER_DATE_TIME_WITH_TZ_FORMAT, [3, 4]),
        (DATE_TIME_WITH_TZ_FORMAT, {}, "{{ record['id'] % 2 == 1 }}", "2021-01-05T00:00:00+00:00", RECORDS_TO_FILTER_DATE_TIME_WITH_TZ_FORMAT, [3]),
        ...
        (DATE_TIME_WITHOUT_TZ_FORMAT, {"created_at": "2021-01-04T00:00:00"}, None, "2021-01-05T00:00:00", RECORDS_TO_FILTER_DATE_TIME_WITHOUT_TZ_FORMAT, [3]),
        (DATE_TIME_WITHOUT_TZ_FORMAT, {"created_at": "2021-01-04T00:00:00"}, None, None, RECORDS_TO_FILTER_DATE_TIME_WITHOUT_TZ_FORMAT, [3, 4]),
        (DATE_TIME_WITHOUT_TZ_FORMAT, {}, "{{ record['id'] % 2 == 1 }}", "2021-01-05T00:00:00", RECORDS_TO_FILTER_DATE_TIME_WITHOUT_TZ_FORMAT, [3]),
    ],
    ids=[
...
def test_client_side_record_filter_decorator_with_parent_stream(stream_state: Optional[Mapping], expected_record_ids: List[int]):
    ...
    filtered_records = list(
        record_filter_decorator.filter_records(records=RECORDS_TO_FILTER_DATE_FORMAT, stream_state=stream_state,
