...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            None,
            MinMaxDatetime("{{ config['start_date'] }}", min_datetime="2021-01-05T00:00:00.000000+0000"),
            MinMaxDatetime("2021-01-10T00:00:00.000000+0000"),
            "1d",
            InterpolatedString("{{ stream_state['date'] }}"),
            None,
        ...
        (
            ...
            None,
            MinMaxDatetime("{{ config['start_date'] }}"),
            MinMaxDatetime("2021-01-10T00:00:00.000000+0000", max_datetime="2021-01-05T00:00:00.000000+0000"),
            "1d",
            cursor_field,
            None,
            datetime_format,
        ...
        (
            ...
            MinMaxDatetime("2021-01-10", max_datetime="2021-01-05"),
            "1d",
            cursor_field,
            None,
            "%Y-%m-%d",
        ...
        (
            ...
            None,
            MinMaxDatetime("{{ config['start_date'] }}"),
            MinMaxDatetime("2021-01-10", max_datetime="2021-01-05", datetime_format="%Y-%m-%d"),
            "1d",
            cursor_field,
            "3d",
            datetime_format,
