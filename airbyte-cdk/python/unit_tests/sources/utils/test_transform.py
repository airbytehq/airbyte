...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"prop": "12", "number_prop": "aa12", "array": ["12"]},
            "Failed to transform value of type 'string' to 'number', key path: '.number_prop'",
        ),
        ...
        (
            ...
            {"prop": "12", "too_many_types": 1212, "array": ["12"]},
            "Failed to transform value of type 'integer' to '['boolean', 'null', 'string']', key path: '.too_many_types'",
        ),
        # Test null field
        ...
        (
            ...
            {"value": "12"},
            {"value": "12"},
            "Failed to transform value of type 'string' to 'array', key path: '.value'",
        ),
        (
            ...
            {"value": "12"},
            {"value": "12"},
            "Failed to transform value of type 'object' to 'integer', key path: '.'",
        ),
        (
            ...
            {"value": 12},
            {"value": 12},
            "Failed to transform value of type 'integer' to '['string', 'boolean', 'null']', key path: '.value'",
        ),
        (
        ...
        (
            ...
            {"value": {"key": "value"}},
            {"value": {"key": "value"}},
            "Failed to transform value of type 'object' to 'array', key path: '.value'",
        ),
        (
            {"type": "object", "properties": {"value1": {"type": "object", "properties": {"value2": {"type": "string"}}}}},
            {"value1": "value2"},
            {"value1": "value2"},
            "Failed to transform value of type 'string' to 'object', key path: '.value1'",
        ),
    ],
)
