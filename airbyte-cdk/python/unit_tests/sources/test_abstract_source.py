...
# TODO: This test is not necessary after changes. We can remove it.
# If we wanted to we could actually yell or warning if the source got both
# A request to do full refresh and incoming state, if full refresh being
# Sent to the source is not properly removed from the protocol
