...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("format_3_1", [{"d": "2022-02-03T12:34:56.123456+0000"}], {"d": "%Y-%m-%dT%H:%M:%S.%f%z"}),
        ("format_3_1", [{"d": "2022-02-03T12:34:56.123456+0100"}], {"d": "%Y-%m-%dT%H:%M:%S.%f%z"}),
        ("format_3_2", [{"d": "2022-02-03 12:34:56.123456+05:00"}], {"d": "%Y-%m-%d %H:%M:%S.%f%z"}),
