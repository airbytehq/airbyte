...
class OAuthAuthenticator(
    ...
    private val httpClient: OkHttpClient =
        httpClient // TODO: discuss about if we want to add an abstraction for HttpClient like we
    // have
    // [here](https://github.com/airbytehq/airbyte-python-cdk/blob/155cdc8c99f73df15b57ab1a7e4c9761c4dc5cac/airbyte_cdk/sources/streams/http/http_client.py#L76)
    ...
    fun queryForAccessToken(): JsonNode {
        val formBody: RequestBody =
            FormBody.Builder()
                ...
                .build()
        val request: Request = Request.Builder().url(endpoint).method("POST", formBody).build()
