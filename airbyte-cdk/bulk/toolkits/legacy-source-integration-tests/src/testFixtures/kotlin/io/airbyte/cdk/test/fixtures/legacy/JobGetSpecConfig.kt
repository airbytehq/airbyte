...
class JobGetSpecConfig : Serializable {
    ...
    override fun hashCode(): Int {
        var result = 1
        result = ((result * 31) + (if ((this.isCustomConnector == null)) 0 else isCustomConnector.hashCode()))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val rhs = other
        return (((this.isCustomConnector === rhs.isCustomConnector) || ((this.isCustomConnector != null) && (this.isCustomConnector == rhs.isCustomConnector))) && ((this.dockerImage === rhs.dockerImage) || ((this.dockerImage != null) && (this.dockerImage == rhs.dockerImage))))
    }
