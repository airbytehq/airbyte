...
@JsonPropertyOrder(
    "connectionConfiguration", "sourceId", "connectorVersion", "configHash"
)
class StandardDiscoverCatalogInput : Serializable {
    ...
    fun withConnectionConfiguration(connectionConfiguration: JsonNode?): StandardDiscoverCatalogInput {
    ...
    override fun hashCode(): Int {
        ...
        result = ((result * 31) + (if ((this.connectorVersion == null)) 0 else connectorVersion.hashCode()))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val rhs = other
        return (((((this.sourceId === rhs.sourceId) || ((this.sourceId != null) && (this.sourceId == rhs.sourceId))) && ((this.connectorVersion === rhs.connectorVersion) || ((this.connectorVersion != null) && (this.connectorVersion == rhs.connectorVersion)))) && ((this.configHash === rhs.configHash) || ((this.configHash != null) && (this.configHash == rhs.configHash)))) && ((this.connectionConfiguration === rhs.connectionConfiguration) || ((this.connectionConfiguration != null) && (this.connectionConfiguration == rhs.connectionConfiguration))))
    }
