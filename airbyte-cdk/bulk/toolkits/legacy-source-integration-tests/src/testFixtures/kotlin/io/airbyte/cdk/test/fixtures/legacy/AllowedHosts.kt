...
class AllowedHosts : Serializable {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val rhs = other
        return (((this.hosts === rhs.hosts) || ((this.hosts != null) && (this.hosts == rhs.hosts))) && ((this.additionalProperties === rhs.additionalProperties) || ((this.additionalProperties != null) && (this.additionalProperties == rhs.additionalProperties))))
    }
