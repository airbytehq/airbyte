...
class StandardSyncInput : Serializable {
    ...
    var namespaceDefinition: JobSyncConfig.NamespaceDefinitionType? =
        JobSyncConfig.NamespaceDefinitionType.fromValue("source")
    ...
    fun withNamespaceDefinition(
        namespaceDefinition: JobSyncConfig.NamespaceDefinitionType?
    ): StandardSyncInput {
    ...
    override fun toString(): String {
        ...
        sb.append(StandardSyncInput::class.java.name)
            .append('@')
        ...
        sb.append('=')
        sb.append(
            (if ((this.destinationConfiguration == null)) "<null>"
            else this.destinationConfiguration)
        )
        sb.append(',')
    ...
    override fun hashCode(): Int {
        ...
        result =
            ((result * 31) +
                (if ((this.destinationConfiguration == null)) 0
                else destinationConfiguration.hashCode()))
        result =
            ((result * 31) +
                (if ((this.sourceConfiguration == null)) 0 else sourceConfiguration.hashCode()))
        result =
            ((result * 31) +
        ...
        return (((((((((((((((((this.sourceId === rhs.sourceId) ||
            ...
            ((this.namespaceFormat === rhs.namespaceFormat) ||
                ((this.namespaceFormat != null) &&
                    (this.namespaceFormat == rhs.namespaceFormat)))) &&
            ((this.connectionId === rhs.connectionId) ||
                ((this.connectionId != null) && (this.connectionId == rhs.connectionId)))) &&
            ((this.state === rhs.state) || ((this.state != null) && (this.state == rhs.state)))) &&
