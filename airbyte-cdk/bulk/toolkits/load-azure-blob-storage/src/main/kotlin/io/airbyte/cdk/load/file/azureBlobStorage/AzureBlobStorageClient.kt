...
data class AzureBlob(
    ...
    override val storageConfig: BaseAzureBlobStorageConfiguration
) : RemoteObject<BaseAzureBlobStorageConfiguration>

class AzureBlobClient(
    private val serviceClient: BlobServiceClient,
    private val blobConfig: BaseAzureBlobStorageConfiguration
