...
class AzureBlobStreamingUploadTest {
    ...
    fun `complete - no blocks uploaded`() = runBlocking {
        ...
        every { blockBlobClient.setMetadata(mapOf("env" to "dev", "author" to "testUser")) } just runs
        ...
        verify(exactly = 1) { blockBlobClient.setMetadata(mapOf("env" to "dev", "author" to "testUser")) }
