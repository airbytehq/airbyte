...
class RequestMemoryBatchSizeStrategyFactory(private val sizeInBytes: Int) :
    BatchSizeStrategyFactory {
...
class RequestMemoryBatchSizeStrategy(private val response: JsonNode, private val sizeInBytes: Int) :
    BatchSizeStrategy {
    /**
