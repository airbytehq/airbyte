...
/**
 * Exists to make it easier to test file access (read, delete, etc.) by
 * injecting a mock factory.
 */
...
/**
 * File in Kotlin has built-n extensions cannot be directly mocked.
 * This wrapper allows us to mock.
 */
