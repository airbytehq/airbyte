 ...
 * Additionally, CDK devs building new interfaces will probably want to set `[stateAfterUpload] to
 * something other than [BatchState.COMPLETE] to avoid prematurely closing the stream. Specifically,
 * if the destination can recover a loaded object after a failed sync, use [BatchState.PERSISTED] to
