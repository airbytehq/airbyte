...
class ProtobufTypeBasedDecoder {
    ...
    /**
     * Decodes a protobuf value into its corresponding Java type.
     * Returns null if the value is marked as null.
     */
    fun decode(value: AirbyteValueProtobuf): Any? {
        ...
        return when (value.valueCase) {
            ...
            AirbyteValueProtobuf.ValueCase.BIG_INTEGER -> BigIntegerParser.parseWithFastParser(value.bigInteger)
            AirbyteValueProtobuf.ValueCase.NUMBER -> value.number.toBigDecimal()
            AirbyteValueProtobuf.ValueCase.BIG_DECIMAL -> BigDecimalParser.parseWithFastParser(value.bigDecimal)

            AirbyteValueProtobuf.ValueCase.DATE -> LocalDate.ofEpochDay(value.date.toLong())

            AirbyteValueProtobuf.ValueCase.TIME_WITHOUT_TIMEZONE -> LocalTime.ofNanoOfDay(value.timeWithoutTimezone)
            ...
            AirbyteValueProtobuf.ValueCase.VALUE_NOT_SET, null -> null
        }
    }
}
