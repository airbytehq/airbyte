...
sealed class FeedBootstrap<T : Feed>(
    ...
    /** A map of all [StreamRecordConsumer] for this [feed]. Lazy instantiation. */
    val streamRecordConsumers: Map<StreamIdentifier, StreamRecordConsumer> by lazy {
...
class StreamFeedBootstrap(
    ...
    /** The [StreamRecordConsumer] instance for this [Stream], instantiated lazily. */
    val streamRecordConsumer: StreamRecordConsumer by lazy { streamRecordConsumers[stream.id]!! }
}
