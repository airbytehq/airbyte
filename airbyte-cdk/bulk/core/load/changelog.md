...
Initial independent release of bulk-cdk-core-load.

This marks the beginning of separate versioning for the base, extract, and load CDK packages.
The load package contains core-load and load toolkits for building destination connectors.

**Dependencies:**
- bulk-cdk-core-base: 1.0.0

---

## Historical Entries (Unified Bulk CDK)

The entries below are from the unified bulk CDK before the split into separate base, extract, and load packages. All three packages inherit this shared history.
