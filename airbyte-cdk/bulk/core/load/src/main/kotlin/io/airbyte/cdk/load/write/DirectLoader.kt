 ...
 *
 * To enable, declare a `@Singleton` inheriting from [DirectLoaderFactory] in your connector.
 *
 ...
 * [DirectLoaderFactory.inputPartitions] to a number greater than 1.
 * Specifically, up to `numWorkers` DirectLoaders will be created per stream, and each will handle
