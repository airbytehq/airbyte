...
class DiscoverOperation<T : ConfigurationSpecification, C : DestinationConfiguration>(
    ...
    private fun ImportType.toProtocol(): ProtocolDestinationSyncMode = when (this) {
        ...
        else -> throw IllegalArgumentException("Invalid Sync Mode for Destination Discover $this")
    }
}
