...
class DefaultSyncManager(
    ...
    override suspend fun markInputConsumed() {
        ...
        //            throw IllegalStateException(
        //                "Input was fully read, but some streams did not receive a terminal stream
        // status message. This likely indicates an error in the source or platform. Streams without
        // a status message: $prettyStreams"
        //            )
        //        }
