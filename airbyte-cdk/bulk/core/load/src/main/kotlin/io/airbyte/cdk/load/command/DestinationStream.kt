...
data class DestinationStream(
    ...
    /**
     * This is the schema of what we currently write to destinations, but
     * this might not reflect what actually exists, as many destinations
     * have legacy data from before this schema was adopted.
     */
