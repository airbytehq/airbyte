...
object DataCoercionObjectFixtures {
    ...
    val objects =
        listOf(
            test(NULL, NullValue, null),
            test(EMPTY_OBJECT, ObjectValue(linkedMapOf()), emptyMap<String, Any?>()),
            test(
                NORMAL_OBJECT,
...
object DataCoercionArrayFixtures {
    ...
    val arrays =
        listOf(
            test(NULL, NullValue, null),
            test(EMPTY_ARRAY, ArrayValue(emptyList()), emptyList<Any?>()),
            test(NORMAL_ARRAY, ArrayValue(listOf(StringValue("foo"))), listOf("foo")),
        )
...
object DataCoercionUnionFixtures {
    val unions =
        listOf(
            test(NULL, NullValue, null),
            test(UNION_INT_VALUE, IntegerValue(42), 42L),
            test(UNION_STR_VALUE, StringValue("foo"), "foo"),
            test(
                UNION_OBJ_VALUE,
                ObjectValue(linkedMapOf("foo" to StringValue("bar"))),
                mapOf("foo" to "bar")
...
object DataCoercionLegacyUnionFixtures {
    val unions =
        listOf(
            ...
            test(UNION_INT_VALUE, IntegerValue(42), null, Reason.DESTINATION_TYPECAST_ERROR),
