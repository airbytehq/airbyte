        ...
        fun makeOutputRecord(
            ...
            OutputRecord(
                ...
                data =
                    mapOf(
                        "id" to id,
                        "updated_at" to TimestampValue(updatedAt),
                ...
                OutputRecord(
                    ...
                    data =
                        mapOf(
                            "id1" to 1,
                            "id2" to 200,
                            "updated_at" to TimestampValue("2000-01-01T00:01:00Z"),
                            "name" to "Alice2",
                ...
                OutputRecord(
                    ...
                    data =
                        mapOf(
                            "id1" to 1,
                            "id2" to 201,
                            "updated_at" to TimestampValue("2000-01-01T00:02:00Z"),
                            "name" to "Bob1"
                        ),
                    airbyteMeta = OutputRecord.Meta(syncId = 42),
                ),
                ...
                OutputRecord(
                    ...
                    data =
                        mapOf(
                            "id1" to 1,
                            "id2" to 200,
                            "updated_at" to TimestampValue("2000-01-02T00:00:00Z"),
                            "name" to "Alice3",
                            "_ab_cdc_deleted_at" to null
                        ),
                    airbyteMeta = OutputRecord.Meta(syncId = 43),
