...
public class FakeSyncSchedulerClient implements SynchronousSchedulerClient {
    ...
    @Override
    public SynchronousResponse<StandardCheckConnectionOutput> createSourceCheckConnectionJob(SourceConnection source, String dockerImage) throws IOException {
        throw new NotImplementedException();
    }

    @Override
    public SynchronousResponse<StandardCheckConnectionOutput> createDestinationCheckConnectionJob(DestinationConnection destination, String dockerImage) throws IOException {
        throw new NotImplementedException();
    }
